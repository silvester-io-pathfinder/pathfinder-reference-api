...
namespace Silvester.Pathfinder.Official.Api.Rest.Documents.Instances.LicenseAgreements
{
    public class Version2 : IDocumentProvider
    {
        ...
        public Document Document => new Document.Builder(DateTime.Parse("2021-07-01"), DateTime.Parse("2021-10-04"), 1)
            .AddSection("Paizo Community Use Policy", section => 
            {
                section.AddSubSection(null, sub =>
                {
                    sub.AddParagraph("The pf2e.io services uses trademarks and/or copyrights owned by Paizo Inc., used under Paizo's Community Use Policy (paizo.com/communityuse). We are expressly prohibited from charging you to use or access this content. The pf2e.io services are not published, endorsed, or specifically approved by Paizo. For more information about Paizo Inc. and Paizo products, visit paizo.com.");
                });
            })
