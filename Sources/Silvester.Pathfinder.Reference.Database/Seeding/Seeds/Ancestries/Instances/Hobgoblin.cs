...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Ancestries.Instances
{
    public class Hobgoblin : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("2f194a17-bf9c-45b5-98f3-bbc44f8d6da9"), Type = TextBlockType.Text, Text = "Taller and stronger than their goblin kin, hobgoblins are equals in strength and size to humans, with broad shoulders and long, powerful arms." };
        ...
        protected override IEnumerable<TextBlock> GetYouMight()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse(""), Type = TextBlockType.Enumeration, Text = "Look for opportune alliances with other creatures, even if you don’t fully understand or trust them." };
        }
