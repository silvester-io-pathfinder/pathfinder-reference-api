...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Ancestries.Instances
{
    public class Azarketi : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDescription()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse(""), Type = TextBlockType.Text, Text = "The aquatic humanoids of the Inner Sea share a somber and burdened history. Most refer to these aquatic peoples as gillmen or sometimes Low Azlanti, though they typically refer to themselves as azarketi, an Azlanti word that translates roughly to “people of the seas.” After Earthfall, these proud humans were mutated into aquatic servants by their alghollthu foes. Feeling like they don't fully belong with their human brethren nor with the sea that binds them, many azarketis struggle for a sense of identity and purpose. Though they remain distrusted by the surface dwellers, azarketis celebrate their unique lineage and their descent from the venerated Azlanti culture." };
        }
        ...
        {
            yield return new TextBlock { Id = Guid.Parse(""), Type = TextBlockType.Heading, Text = "Alghollthus" };
            yield return new TextBlock { Id = Guid.Parse(""), Type = TextBlockType.Text, Text = "Azarketis have a complex relationship with alghollthus, who saved but then enslaved their people. Alvadnas have the greatest chance of meeting an alghollthu face to face. Azarketi sentiments toward these creatures vary: some fight fiercely against their ancient enemies; others bargain for power or safety, or even serve through compulsion." };
            yield return new TextBlock { Id = Guid.Parse(""), Type = TextBlockType.Heading, Text = "Legacy of Azlant" };
            yield return new TextBlock { Id = Guid.Parse(""), Type = TextBlockType.Text, Text = "Directly descended from the people of Azlant, azarketis have preserved their ancestors' culture through art, oral traditions, songs, and stories. Azarketi scholars study the history of Azlant and Earthfall, elders recite tales of Azlanti legends, and musicians sing songs to long-lost gods. Most azarketis know the location of the nearest Azlanti ruin, and many possess a piece of Azlanti jewelry." };
            yield return new TextBlock { Id = Guid.Parse(""), Type = TextBlockType.Heading, Text = "Other Sea Creatures" };
            yield return new TextBlock { Id = Guid.Parse(""), Type = TextBlockType.Text, Text = "Azarketis are one of many ancestries to live beneath the water's surface. They have the most contact with locathahs, humanoid fish-folk with an easygoing, friendly demeanor. Azarketis find merfolk territorial neighbors, though their shared private tendencies lead to mostly amicable relations. Together they combat their shared enemies, the monstrous but intelligent sahuagins." };
        }

        protected override IEnumerable<TextBlock> GetAdditionalMechanics()
        {
            yield return new TextBlock { Id = Guid.Parse(""), Type = TextBlockType.Heading, Text = "Hydration" };
            yield return new TextBlock { Id = Guid.Parse(""), Type = TextBlockType.Text, Text = "While you are an amphibious being equally as capable on land as in the water, your body requires you to return to aquatic environments at least once in a 24-hour period. You must submerge in water in order to rehydrate your water-acclimated skin. If you fail to do this, your skin begins to crack and your gills become painful. After the first 24 hours outside of water, you take a –1 status penalty to Fortitude saves. After 48 hours, you struggle to breathe air and begin to suffocate until returned to water." };
        }
        ...
        protected override void GetEffects(BooleanEffectBuilder builder)
        {
            ...
            builder.ModifySpecificSpeed(Guid.Parse("eead2016-1846-4b3b-8552-962920663196"), MovementMethod.Walking, ModifierType.Add, modifier: 20);
