...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Ancestries.Instances
{
    public class Poppet : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetAdditionalMechanics()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse(""), Type = TextBlockType.Text, Text = "The materials of your body resist ailments that assail the flesh. You gain a +1 circumstance bonus to saving throws against death effects, disease, and poison as well as to saving throws against effects that would give you the drained, paralyzed, or sickened conditions. Your spark of life means that you're a living creature, and you can be healed by positive energy and harmed by negative energy as normal." };

            yield return new TextBlock { Id = Guid.Parse(""), Type = TextBlockType.Heading, Text = "Flammable" };
            yield return new TextBlock { Id = Guid.Parse(""), Type = TextBlockType.Text, Text = "You have weakness to fire damage equal to one-third your level (minimum 1)." };
        }
        ...
        protected override void GetEffects(BooleanEffectBuilder builder)
        {
            ...
            builder.GainSpecificDamageWeakness(Guid.Parse(""), DamageTypes.Instances.Fire.ID, ModifierType.Divide, modifier: 3, minimum: 1);
        }
