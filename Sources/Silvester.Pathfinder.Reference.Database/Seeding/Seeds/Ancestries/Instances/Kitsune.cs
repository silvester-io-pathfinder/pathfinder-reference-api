...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Ancestries.Instances
{
    public class Kitsune : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDescription()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse(""), Type = TextBlockType.Text, Text = "If you want to play a character with innate magical talents and countless hidden facets, each revealed with a glint of the eye and a twisting grin, you should play a kitsune." };
        }
        ...
        {
            yield return new TextBlock { Id = Guid.Parse(""), Type = TextBlockType.Heading, Text = "Fox Families" };
            yield return new TextBlock { Id = Guid.Parse(""), Type = TextBlockType.Text, Text = "Due to their shifting nature, kitsune often have mixed-ancestry family units. The children of a kitsune and a non-kitsune can inherit either of their parent's lineages, though many assume that a human baby born to a kitsune is simply a kitsune that has yet to reveal their true form. This has led to the widespread misconception that all offspring of kitsune are themselves kitsune." };

            yield return new TextBlock { Id = Guid.Parse(""), Type = TextBlockType.Heading, Text = "Kitsune Settlements" };
            yield return new TextBlock { Id = Guid.Parse(""), Type = TextBlockType.Text, Text = "Though kitsune live all around the world, two major kitsune settlements exist on Golarion: Kihime in Tian Xia, and Angen in the Inner Sea region. Kihime, the central settlement for Souko kitsune, is located in the Forest of Spirits and consists of low, thatched buildings in an intentionally ancient, though effective, design. Rather than torches, star orbs line the streets and glow with soft foxfire to light the darkness—legends state that these star orbs can be unified to cloak Kihime in illusions and abjurations in times of peril. Angen, in the Verduran Forest of Taldor, represents a more modern and cosmopolitan kitsune town, with buildings made in a variety of styles. Angen customs emphasize unity and collectivism, one of the best known being the Foxes' Wedding. In this yearly festival, which occurs spontaneously on the first autumn day that rain falls from a blue sky, all kitsune who became betrothed in the last year are considered married. In celebration, rainbows formed from the mixed sunlight and raindrops are enhanced by kitsune illusions, becoming truly a sight to behold." };

            yield return new TextBlock { Id = Guid.Parse(""), Type = TextBlockType.Heading, Text = "The Lady of Foxes" };
            yield return new TextBlock { Id = Guid.Parse(""), Type = TextBlockType.Text, Text = "Though usually referred to with she/her pronouns, the goddess Daikitsu's nature is fluid; her gender, age, and appearance change at her whim. Kitsune's legends state that they were created when Daikitsu granted her original attendants, fox spirits known as the Nine Bright Grains, one of her own abilities: the power to dance between shapes." };
        }

        protected override IEnumerable<TextBlock> GetAdditionalMechanics()
        {
            yield return new TextBlock { Id = Guid.Parse(""), Type = TextBlockType.Heading, Text = "Change Shape" };
            yield return new TextBlock { Id = Guid.Parse(""), Type = TextBlockType.Text, Text = "As a kitsune, you gain the Change Shape ability." };
        }
        ...
        protected override void GetEffects(BooleanEffectBuilder builder)
        {
            ...
            builder.GainSpecificFeat(Guid.Parse(""), Feats.Instances.ChangeShapeKitsune.ID);
        }
