    ...
    public class StudentOfMagic : Template
    {
        ...
        protected override IEnumerable<Effect> GetEffects()
        {
            ...
            yield return new ChoiceEffect
            {
                ...
                Choices = new Effect[]
                {
                    new RestrictedSkillEffect { Id = Guid.Parse("7dd173a2-6b61-4c12-809f-cedc9368f799"), ProficiencyId = Proficiencies.Instances.Trained.ID, SkillId = Skills.Instances.Arcana.ID },
                    new RestrictedSkillEffect { Id = Guid.Parse("7cf66336-f913-481e-8d5f-768beec22b56"), ProficiencyId = Proficiencies.Instances.Trained.ID, SkillId = Skills.Instances.Nature.ID },
                    new RestrictedSkillEffect { Id = Guid.Parse("fefd6e0e-3299-40be-a4e9-8209fb071872"), ProficiencyId = Proficiencies.Instances.Trained.ID, SkillId = Skills.Instances.Occultism.ID },
                    new RestrictedSkillEffect { Id = Guid.Parse("964f7c4b-b65f-4972-a7ff-75aa257974c4"), ProficiencyId = Proficiencies.Instances.Trained.ID, SkillId = Skills.Instances.Religion.ID }
                }
            };
