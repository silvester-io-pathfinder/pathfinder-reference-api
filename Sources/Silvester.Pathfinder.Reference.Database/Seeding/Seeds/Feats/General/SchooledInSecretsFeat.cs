...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.General
{
    public class SchooledInSecretsFeat : Template
    {
        ...
        {
            yield return new SkillPrerequisite { Id = Guid.Parse("9cc8842c-2060-48d8-9cfb-52d7558e23af"), RequiredSkillId = Skills.Instances.Occultism.ID, RequiredProficiencyId = Proficiencies.Instances.Trained.ID };
        }
