...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.General
{
    public class IncredibleInvestitureFeat : Template
    {
        ...
        {
            yield return new HaveSpecificStatPrerequisite { Id = Guid.Parse("11098127-44c6-4d82-9977-981fc20e637b"), RequiredStatValue = 16, RequiredStatId = Stats.Instances.Charisma.ID };
        }
