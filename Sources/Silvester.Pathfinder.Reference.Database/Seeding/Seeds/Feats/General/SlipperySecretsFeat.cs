...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.General
{
    public class SlipperySecretsFeat : Template
    {
        ...
        {
            yield return new HaveSpecificSkillProficiencyPrerequisite { Id = Guid.Parse("e63447fc-7fdf-4723-be38-734253bb6e15"), RequiredSkillId = Skills.Instances.Deception.ID, RequiredProficiencyId = Proficiencies.Instances.Master.ID};
        }
