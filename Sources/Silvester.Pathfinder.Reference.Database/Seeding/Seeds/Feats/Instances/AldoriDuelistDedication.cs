...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class AldoriDuelistDedication : Template
    {
        ...
        { 
            ...
            builder.HaveSpecificMeleeWeaponSpecificProficiency(Guid.Parse("57b1569f-b038-46b5-90c1-ee55622700ee"), Proficiencies.Instances.Trained.ID, MeleeWeapons.Instances.AldoriDuelingSword.ID);
        }
