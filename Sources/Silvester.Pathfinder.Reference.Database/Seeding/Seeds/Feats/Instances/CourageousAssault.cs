...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class CourageousAssault : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("0fc06ba4-9294-416b-87ad-031c60568484"), Type = TextBlockType.Text, Text = "With a mighty shout, you can stir an ally to attack. If your next action is to cast the (spell: inspire courage) composition cantrip, one ally who gains a status bonus from the spell can immediately use a reaction to make a melee (action: Strike)." };
        }
