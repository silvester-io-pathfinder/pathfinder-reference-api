...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class HauntCunning : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("5d75e9f0-c11f-4a62-bcd6-002016f4b7dc"), Type = TextBlockType.Text, Text = "One of the most useful pieces of cunning knowledge is the ability to notice the emotional echo of a soul that passed on, leaving a haunt in its wake. Even when you aren’t (action: Searching|Search) while in exploration mode, the GM rolls a secret check for you to notice haunts that usually require you to be (action: Searching|Search)." };
