...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class Supertaster : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDetailBlocks()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("53237f73-2b1e-417f-aa53-1b5544761a8d"), Type = TextBlockType.Text, Text = "If you lick or taste something while Investigating or attempting to (action: Recall Knowledge) to identify something, if the taste would provide relevant additional information (at the GM’s discretion), you gain a +2 circumstance bonus to your check." };
        }
