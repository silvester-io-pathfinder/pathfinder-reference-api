...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class AstonishingExplosion : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("cedd3e03-7644-47d5-b899-0f82b25719b2"), Type = TextBlockType.Text, Text = "Your bomb incorporates an explosive spark of wonder that leaves witnesses dumbfounded. Any target hit by your (action: Strike) with the bomb is fascinated by you for 1 round. On a critical success, the target is also stunned 1." };
        }
