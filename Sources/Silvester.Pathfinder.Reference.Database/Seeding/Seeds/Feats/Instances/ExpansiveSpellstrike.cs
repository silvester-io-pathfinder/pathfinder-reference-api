...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class ExpansiveSpellstrike : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDetailBlocks()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("f68886db-b315-4e97-a0cb-57e9179916f0"), Type = TextBlockType.Enumeration, Text = " : If your (action: Strike) critically fails, the spell is lost with no effect." };
            ...
            yield return new TextBlock { Id = Guid.Parse("ce54d376-4a1d-4fda-ae15-e8faf18867fe"), Type = TextBlockType.Enumeration, Text = " : If the spell lets you select a number of targets, it instead targets only the creature you attacked with your (action: Strike)." };
