...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class DirectedChannel : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("2ffa1f92-7134-4bb7-b59e-8e22d398f6f6"), Type = TextBlockType.Text, Text = "You can shape the energy you channel in a single direction, reaching farther and in a more directed fashion. When you cast a version of (spell: harm) or (spell: heal) that has an area, you can make its area a 60-foot cone instead of a 30-foot emanation." };
        }
