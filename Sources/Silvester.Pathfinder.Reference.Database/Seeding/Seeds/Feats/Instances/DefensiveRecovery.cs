...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class DefensiveRecovery : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("8d031fe6-e46c-4eb3-bb1f-950eb0eec88d"), Type = TextBlockType.Text, Text = "Your faith provides temporary protection in addition to healing. If the next action you use is to cast (spell: harm) or (spell: heal) on a single target and the target regains Hit Points from the spell, it also gains a +2 status bonus to AC and saving throws for 1 round." };
        }
