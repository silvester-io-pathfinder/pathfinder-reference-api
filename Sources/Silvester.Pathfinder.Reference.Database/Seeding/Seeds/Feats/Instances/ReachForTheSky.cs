...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class ReachForTheSky : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("ac27dbd3-e2b1-4c2c-abd1-e09797da8597"), Type = TextBlockType.Text, Text = "You command the room, firing a gun into the air and ordering everyone to surrender and put their hands in the air. You fire your firearm and then attempt a single Intimidation check to (action: Demoralize) each enemy within 30 feet. Creatures who become frightened instinctively put their hands in the air. If they had (action: Raised a Shield|Raise a Shield), they lose the benefits, as they raise the shield above their head where it’s of little use to block attacks. With their hands in the air, each of these frightened creatures can’t use reactions or free actions that require their hands, or items held in their hands, until the beginning of their next turn. Regardless of the result, each creature is then temporarily immune to Reach for the Sky for 1 minute." };
        }
