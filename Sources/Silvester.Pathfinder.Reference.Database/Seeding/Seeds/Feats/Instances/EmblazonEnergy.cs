...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class EmblazonEnergy : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("88ddfc25-7373-45e8-a347-0adde37b7cb5"), Type = TextBlockType.Text, Text = "With elemental forces, you make your emblazoned symbols more potent. When you (action: Emblazon an Armament | Emblazon Armament), you can choose from the following effects instead of the effects listed in that feat." };
