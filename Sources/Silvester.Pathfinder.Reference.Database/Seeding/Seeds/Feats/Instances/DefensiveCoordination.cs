...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class DefensiveCoordination : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("e0ad7213-ad30-4ee8-8d2b-12cbe623b661"), Type = TextBlockType.Text, Text = "Like the storied heroes who persist in the face of overwhelming odds, you and your allies will hold the line. If your next action is to cast the (spell: inspire defense) composition cantrip, you can (action: Raise a Shield), and one ally who gains a status bonus from the spell can immediately use a reaction to (action: Raise a Shield)." };
        }
