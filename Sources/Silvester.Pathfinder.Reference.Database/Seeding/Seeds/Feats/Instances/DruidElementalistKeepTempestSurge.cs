...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class DruidElementalistKeepTempestSurge : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("aaed095c-3080-4d17-b406-d52d4e9c47ce"), Type = TextBlockType.Text, Text = "You choose not to replace your starting order spell, (spell: tempest surge), with (spell: updraft)." };
        }
