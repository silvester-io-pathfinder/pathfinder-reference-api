...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class BeastDynamoHowl : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDetailBlocks()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("ac2d680c-c0ea-4198-8c6d-c09167be51a7"), Type = TextBlockType.Text, Text = "You’ve incorporated beast tech from Arcadia into your dynamo, adding in components from various terrifying creatures to enhance your prosthesis’s capabilities. The beast parts can unleash a disturbing howl as you make a powerful attack with your dynamo. Attempt a single Intimidation check to (action: Demoralize) each enemy within 30 feet; you don’t take a penalty when you attempt to (action: Demoralize) a creature that doesn’t understand your language. Then, make a dynamo (action: Strike). Reduce the operational time of your sterling dynamo by 1 hour." };
        }
