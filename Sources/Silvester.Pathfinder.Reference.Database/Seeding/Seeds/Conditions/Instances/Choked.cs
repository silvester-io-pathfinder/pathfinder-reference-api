...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Conditions.Instances
{
    public class Choked : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("1066b273-a9bc-4fd4-82a4-604ccc824308"), Type = Utilities.Text.TextBlockType.Text, Text = "You are choked, either physically by something or someone, by something magical, or by the effects of a disease or illness (such as coughing). You need to pass a flat DC check equal to the severity of the condition when you attempt to cast a spell that has a verbal component to it, or activate an item that has a command component to it." };
