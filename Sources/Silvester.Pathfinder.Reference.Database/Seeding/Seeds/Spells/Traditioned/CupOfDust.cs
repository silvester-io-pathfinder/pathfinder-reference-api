...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    ...
    public class CupOfDust : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse(""), Type = TextBlockType.Text, Text = "You curse the target with a thirst no drink can quench. You can Dismiss the spell. The target must attempt a Fortitude save." };
        }
        ...
        public override IEnumerable<SpellHeightening> GetHeightenings()
        {
            yield return new SpellHeightening
            {
                ...
                {
                    new TextBlock {Id = Guid.Parse(""), Type = TextBlockType.Text, Text = "The thirst becomes more unbearable, increasing the damage each hour by 1d4, or by 2d4 on a critical failure." }
                }
            };
        }
