...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.ClassFeatures.Generic
{
    public class AbilityBoosts : Template
    {
        ...
        {
            builder.GainAnyAbilityBoost(Guid.Parse(""), requiredLevel: 5);
            builder.GainAnyAbilityBoost(Guid.Parse(""), requiredLevel: 5);
            builder.GainAnyAbilityBoost(Guid.Parse(""), requiredLevel: 5);
            builder.GainAnyAbilityBoost(Guid.Parse(""), requiredLevel: 5);

            builder.GainAnyAbilityBoost(Guid.Parse(""), requiredLevel: 10);
            builder.GainAnyAbilityBoost(Guid.Parse(""), requiredLevel: 10);
            builder.GainAnyAbilityBoost(Guid.Parse(""), requiredLevel: 10);
            builder.GainAnyAbilityBoost(Guid.Parse(""), requiredLevel: 10);

            builder.GainAnyAbilityBoost(Guid.Parse(""), requiredLevel: 15);
            builder.GainAnyAbilityBoost(Guid.Parse(""), requiredLevel: 15);
            builder.GainAnyAbilityBoost(Guid.Parse(""), requiredLevel: 15);
            builder.GainAnyAbilityBoost(Guid.Parse(""), requiredLevel: 15);

            builder.GainAnyAbilityBoost(Guid.Parse(""), requiredLevel: 20);
            builder.GainAnyAbilityBoost(Guid.Parse(""), requiredLevel: 20);
            builder.GainAnyAbilityBoost(Guid.Parse(""), requiredLevel: 20);
            builder.GainAnyAbilityBoost(Guid.Parse(""), requiredLevel: 20);
        }
