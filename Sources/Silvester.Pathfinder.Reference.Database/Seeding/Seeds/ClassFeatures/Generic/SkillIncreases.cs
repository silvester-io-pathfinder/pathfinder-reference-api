...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.ClassFeatures.Generic
{
    public class SkillIncreases : Template
    {
        ...
        protected override IEnumerable<Effect> GetEffects()
        {
            ...
            yield return new GainSkillIncreaseEffect { Id = Guid.Parse(""), Prerequisites = new[] { new EffectPrerequisiteBinding { Id = Guid.Parse(""), Prerequisite = new HaveSpecificLevelPrerequisite { Id = Guid.Parse(""), Comparator = Comparator.GreaterThanOrEqualTo,Comparator = Comparator.GreaterThanOrEqualTo, RequiredLevel = 13 } } } };
