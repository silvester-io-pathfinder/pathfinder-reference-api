...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.ClassFeatures.Alchemists
{
    public class Alchemy : Template
    {
        ...
        {
            yield return new DisableFeatPrerequisitesEffect { Id = Guid.Parse(""), FeatId = Feats.Instances.AlchemicalCrafting.ID };
            yield return new GainSpecificFeatEffect { Id = Guid.Parse(""), FeatId = Feats.Instances.AlchemicalCrafting.ID };
            yield return new GainSpecificFeatEffect { Id = Guid.Parse(""), FeatId = Feats.Instances.QuickAlchemcy.ID };
        }
