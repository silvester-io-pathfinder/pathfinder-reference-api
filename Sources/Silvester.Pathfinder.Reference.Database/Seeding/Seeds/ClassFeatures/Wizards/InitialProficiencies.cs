...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.ClassFeatures.Wizards
{
    public class InitialProficiencies : Template
    {
        ...
        protected override void GetEffects(BooleanEffectBuilder builder)
        {
            ...
            //Attacks
            builder.GainSpecificMeleeWeaponProficiency(Guid.Parse(""), Proficiencies.Instances.Trained.ID, MeleeWeapons.Instances.Club.ID);
            builder.GainSpecificRangedWeaponProficiency(Guid.Parse(""), Proficiencies.Instances.Trained.ID, RangedWeapons.Instances.Crossbow.ID);
            builder.GainSpecificMeleeWeaponProficiency(Guid.Parse(""), Proficiencies.Instances.Trained.ID, MeleeWeapons.Instances.Dagger.ID);
            builder.GainSpecificRangedWeaponProficiency(Guid.Parse(""), Proficiencies.Instances.Trained.ID, RangedWeapons.Instances.HeavyCrossbow.ID);
            builder.GainSpecificMeleeWeaponProficiency(Guid.Parse(""), Proficiencies.Instances.Trained.ID, MeleeWeapons.Instances.Staff.ID);
