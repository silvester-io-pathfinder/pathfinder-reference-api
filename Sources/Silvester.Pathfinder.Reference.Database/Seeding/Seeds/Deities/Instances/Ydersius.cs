...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Deities.Instances
{
    public class Ydersius : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDetails()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse(""), Type = TextBlockType.Text, Text = "The serpentfolk god is not dead, but in his decapitated state, he might as well be. Reduced to a feral, animalistic existence, Ydersius is even less aware of his legacy than the lowest of the aapoph. Ydersius's symbol is a snake's skull surrounded by a skeletal ouroboros." };
        }
