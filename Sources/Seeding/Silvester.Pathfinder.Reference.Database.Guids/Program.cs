...
namespace Silvester.Pathfinder.Reference.Database.Guids
{
    public class Program
    {
        ...
        {
            foreach (string filePath in Directory.GetFiles(Path.Combine(Directory.GetCurrentDirectory(), "..", "..", "..", "..", "..", "Seeding", "Silvester.Pathfinder.Reference.Database.Seeding.Seeds"), "*.cs", SearchOption.AllDirectories))
            {
