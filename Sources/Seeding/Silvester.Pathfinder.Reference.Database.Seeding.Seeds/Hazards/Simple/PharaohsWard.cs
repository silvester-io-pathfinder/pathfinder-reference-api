...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Hazards.Simple
{
    public class PharaohsWard : Template
    {
        ...
        {
            builder.Add(Guid.Parse("deb0f675-09fc-450b-90d2-e04da0e1c699"), ActionTypes.Instances.Reaction.ID, "Curse the Intruders", action =>
            {
                action
                    .Trigger("The seal on the tomb is broken from the outside.")
                    .Traits(traits =>
                    {
                        traits.Add(Guid.Parse("ae4fa9d6-245a-4d3a-b48e-de3d3a19763c"), Traits.Instances.Curse.ID);
                        traits.Add(Guid.Parse("b91e2770-bfca-4d0a-84aa-d28c2d91933a"), Traits.Instances.Divine.ID);
                        traits.Add(Guid.Parse("5e4b864c-2c9c-4eee-b431-6bbbe07e52d5"), Traits.Instances.Necromancy.ID);
                    })
                    .Details(details =>
                    {
                        details.Text(Guid.Parse("d9095071-f339-42ec-99a9-b36054c97766"), "Each living creature within 60 feet must succeed at a DC 23 Will save or be subjected to the pharaoh's curse. A cursed creature takes a –2 status penalty to Fortitude saves, and any natural or magical healing it receives is halved. The curse remains until removed by remove curse or similar magic.");
                    });
            });
        }
