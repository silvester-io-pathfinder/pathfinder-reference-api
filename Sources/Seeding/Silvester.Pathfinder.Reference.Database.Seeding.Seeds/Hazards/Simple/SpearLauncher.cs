...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Hazards.Simple
{
    public class SpearLauncher : Template
    {
        ...
        {
            builder.Add(Guid.Parse("09e804f4-5f1b-4255-b1d1-31e90811b52a"), ActionTypes.Instances.Reaction.ID, "Spear", action =>
            {
                action
                    .Trigger("Pressure is applied to the floor tile.")
                    .Details(details =>
                    {
                        details.Text(Guid.Parse("fd11a9dd-3a82-4d6f-9861-62c108f617a5"), "The trap shoots a spear, making a Strike against the creature or object on the floor tile.");
                    });
            });
        }
        ...
        {
            builder.Add(Guid.Parse("22d3b9ca-c328-4524-a312-997c1a2e1398"), AttackTypes.Instances.Ranged.ID, ActionTypes.Instances.NoAction.ID, "Spear", hitModifier: 14, "2d6+6", DamageTypes.Instances.Piercing.ID);
        }
