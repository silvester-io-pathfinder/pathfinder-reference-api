...
{
    public class HiddenPit : Template
    {
        ...
        {
            builder.Add(Guid.Parse("a2bfaa34-76eb-43d8-a990-32b7437d8304"), ActionTypes.Instances.Reaction.ID, "Pitfall", action =>
            {
                action
                    .Trigger("A creature walks onto the trapdoor.")
                    .Details(details =>
                    {
                        details.Text(Guid.Parse("21077b3a-26c5-4556-b3e5-b48e4970f323"), "The triggering creature falls in and takes falling damage (typically 10 bludgeoning damage). That creature can use the Grab an Edge reaction to avoid falling.");
                    });
            });
        }
