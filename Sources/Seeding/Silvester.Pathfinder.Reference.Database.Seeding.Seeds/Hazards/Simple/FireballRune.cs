...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Hazards.Simple
{
    public class FireballRune : Template
    {
        ...
        {
            builder.Add(Guid.Parse("c5259ba8-ad21-4900-bcbf-cf1196ef578a"), ActionTypes.Instances.Reaction.ID, "Fireball", action =>
            {
                action
                    .Trigger("A living creature enters the sensor area.")
                    .Traits(traits =>
                    {
                        traits.Add(Guid.Parse("4f04fdac-5dd5-49b7-941c-30024a2a153a"), Traits.Instances.Arcane.ID);
                        traits.Add(Guid.Parse("f5db699d-dff5-4df4-987a-a6e8f16defeb"), Traits.Instances.Evocation.ID);
                        traits.Add(Guid.Parse("5dc30f59-04ec-4ed6-abff-25e72b6f64a0"), Traits.Instances.Fire.ID);
                    })
                    .Details(details =>
                    {
                        details.Text(Guid.Parse("a93c5058-494c-4df1-988e-f0dc6dee552c"), "The rune detonates a fireball centered on the triggering creature's square. This is a 3rd level fireball spell that deals 6d6 fire damage (DC 22 basic Reflex save).");
                    });
            });
        }
