...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Hazards.Complex
{
    public class TelekineticSwarmTrap : Template
    {
        ...
        {
            builder.Add(Guid.Parse("e4cbe467-b929-4078-8ec6-28b412ea190f"), AttackTypes.Instances.Melee.ID, ActionTypes.Instances.OneAction.ID, "Object", hitModifier: 24, "2d12+10", DamageTypes.Instances.Bludgeoning.ID);
        }
