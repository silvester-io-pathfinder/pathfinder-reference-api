...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Hazards.Complex
{
    public class DrowningPit : Template
    {
        ...
        {
            builder.Add(Guid.Parse("ffe63bc7-f008-4d70-9357-e6ada9e45a25"), ActionTypes.Instances.Reaction.ID, "Pitfall", action =>
            {
                action
                    .Trigger("A creature walks onto the trapdoor")
                    .Details(details => 
                    {
                        details.Text(Guid.Parse("b3fae5a4-340d-41a7-821b-80713b7affd8"), "The triggering creature falls in and takes damage from the fall, reduced by 5 feet for falling into the water (typically 12 bludgeoning damage). A creature can Grab an Edge to avoid falling (page 472). The trapdoor then slams shut, and the hazard rolls initiative.");
                    });
            });
        }
