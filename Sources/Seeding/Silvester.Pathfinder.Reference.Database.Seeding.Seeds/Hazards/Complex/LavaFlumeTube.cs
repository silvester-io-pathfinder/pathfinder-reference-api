...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Hazards.Complex
{
    public class LavaFlumeTube : Template
    {
        ...
        {
            builder.Add(Guid.Parse("d42112ae-d850-451a-ac03-2aba67ec4a75"), ActionTypes.Instances.Reaction.ID, "Flume Activation", action =>
            {
                action
                    .Trigger("A creature tries to leave the room.")
                    .Details(details =>
                    {
                        details.Text(Guid.Parse("1b710bb7-2c56-42fd-a03d-2b2861a8b23f"), "The exits seal instantly and the trap rolls initiative.");
                    });
            });
        }
