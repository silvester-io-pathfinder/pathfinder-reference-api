...
{
    public class SummonningRune : Template
    {
        ...
        {
            builder.Add(Guid.Parse("16402edb-38d3-4cae-a93d-687c9e1814b2"), ActionTypes.Instances.Reaction.ID, "Summon Monster", action =>
            {
                action
                    .Trigger("A creature enters the cloud of magical sensors.")
                    .Traits(traits =>
                    {
                        traits.Add(Guid.Parse("70222254-5bb2-4022-bbb8-e1d08f948b51"), Traits.Instances.Arcane.ID);
                        traits.Add(Guid.Parse("e3791e28-a4ec-4d26-9b43-8e3b316fce1d"), Traits.Instances.Conjuration.ID);
                        traits.Add(Guid.Parse("52bc5e87-d97d-4155-982b-7516ae039d07"), Traits.Instances.Summoned.ID);
                    })
                    .Details(details =>
                    {
                        details.Text(Guid.Parse("cabdbcb0-95c9-461d-a9f5-e1858af03802"), "This trap summons a specific level 1 creature, determined when the trap is created. The creature rolls initiative and remains for 2d6 rounds, after which the spell ends and the creature disappears. The creature also disappears if someone disables the trap before the duration expires. The summoned creature can use 3 actions each round and can use reactions, unlike most summoned creatures.");
                    });
            });
        }
