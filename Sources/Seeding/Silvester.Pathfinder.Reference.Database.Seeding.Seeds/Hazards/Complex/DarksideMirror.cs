...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Hazards.Complex
{
    public class DarksideMirror : Template
    {
        ...
        {
            builder.Add(Guid.Parse("b1955fcd-433f-45dc-b9ea-d69baa5fd5d9"), ActionTypes.Instances.Reaction.ID, "Reflection of Evil", action =>
            {
                action
                    ...
                    .Traits(traits => 
                    {
                        traits.Add(Guid.Parse("990d4536-6082-4bc7-a46f-7be584e56894"), Traits.Instances.Arcane.ID);
                        traits.Add(Guid.Parse("048e7d00-7343-4968-a35c-095be58a8a8e"), Traits.Instances.Conjuration.ID);
                        traits.Add(Guid.Parse("690f64f2-6565-40c6-98b9-c640ce990635"), Traits.Instances.Teleportation.ID);
                    })
                    .Details(details =>
                    {
                        details.Text(Guid.Parse("5c6305bf-8791-4678-b24c-ab95f62fa7ab"), "The mirror absorbs the creature into the mirror, replacing it with an evil mirror duplicate (DC 34 Reflex to avoid being absorbed into the mirror), and rolls initiative.");
                    });
            });
        }
