...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Items.Staves.Instances
{
    public class StaffOfTheMagi : Template
    {
        ...
        {
            builder.Text(Guid.Parse("d516587f-39c5-41b5-a076-da4febaefbf3"), "Sigils and runes of ancient and powerful magic cover the iron cladding on this long wooden staff. A staff of the magi is a +3 major striking staff, and when wielding it you gain a +1 circumstance bonus to saving throws against spells.");;
            builder.Text(Guid.Parse("0188c989-de29-444b-aeb6-efcc2c4c17b4"), "Voluntarily destroying a staff of the magi unleashes a truly devastating wave of arcane energy that surges out, dissipating with distance. When wielding the staff, you can break it using an Interact action. This releases a 30-foot‑burst magical explosion centered on the staff. This deals 2d10 force damage per charge remaining in the staff (DC 40 basic Reflex save), You automatically critically fail your save. The explosion continues to echo beyond the initial blast zone, dealing half as much damage to creatures beyond 30 feet but within a 60-foot burst. A creature reduced to 0 Hit Points by this damage dies instantly; this is a death effect.");;
        }
        ...
        protected override IEnumerable<StaveVariant> GetStaveVariants()
        {
            yield return new StaveVariant
            {
                ...
                InlineActions = new InlineActionCollectionBuilder()
                    .Add(Guid.Parse("cba807ff-eeda-4772-b7fd-c0455d747098"), ActionTypes.Instances.OneToThreeActions.ID, "Activate", action =>
                    {
                        action
                            .Kind("Cast a Spell")
                            .Details(details =>
                            {
                                details.Text(Guid.Parse("7eb69227-d5f6-4324-82f7-664aba978b62"), "You expend a number of charges from the staff to cast a spell from its list.");
                            });
                    })
                    .Build(),
        ...
        {
            builder.Add(Guid.Parse("4bf0a063-63fa-4e74-b3ec-d9e3429ef6d3"), Traits.Instances.Rare.ID);
            builder.Add(Guid.Parse("18631c6f-5d07-4e51-b250-8e0d29eeda0a"), Traits.Instances.Evocation.ID);
            builder.Add(Guid.Parse("9c339bd4-bbe6-46bc-9e3f-0a81e5dfa789"), Traits.Instances.Magical.ID);
            builder.Add(Guid.Parse("ffcedfd6-5ae4-4ffb-83e8-af508df12d41"), Traits.Instances.Staff.ID);
        }
