...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class SunsFury : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("cac7cb0c-1fa7-4e41-b21b-08b2cbf19c32"), Type = TextBlockType.Text, Text = $"The Old Sun Gods have granted you a gift in your fight against Walkena. You gain the {ToMarkdownLink<Models.Entities.Feat>("sun's fury", Feats.Instances.SunsFury.ID)} focus spell. If you don't already have one, you gain a focus pool of 1 Focus Point, which you can regain using the {ToMarkdownLink<Models.Entities.Activity>("Refocus", Activities.Instances.Refocus.ID)} activity to pray to the Old Sun Gods; if you already have a focus pool, increase the number of Focus Points in your focus pool by 1. Your Bright Lion focus spells are divine spells; when you gain this feat, if you aren't already, you become trained in divine spell attacks and spell DCs, using Charisma as your spellcasting ability score." };
        }
        ...
        {
            builder.Add(Guid.Parse("e9f6c72a-c678-4b7f-8dfa-30db9ba9afec"), Traits.Instances.Archetype.ID);
