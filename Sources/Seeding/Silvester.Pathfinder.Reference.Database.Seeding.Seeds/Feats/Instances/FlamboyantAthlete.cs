...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class FlamboyantAthlete : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDetailBlocks()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("2cf58798-bc5e-4ee3-889c-c16473b8a810"), Type = TextBlockType.Enumeration, Text = $" : The DCs of your {ToMarkdownLink<Models.Entities.SkillAction>("High Jumps", SkillActions.Instances.HighJump.ID)} and {ToMarkdownLink<Models.Entities.SkillAction>("Long Jumps", SkillActions.Instances.LongJump.ID)} decrease by 10. This doesn't combine with other abilities that reduce those DCs." };
            yield return new TextBlock { Id = Guid.Parse("4b9c5048-2ec6-40ef-9cba-c3945a5f0d38"), Type = TextBlockType.Enumeration, Text = $" : The distance you can move with a vertical {ToMarkdownLink<Models.Entities.Action>("Leap", Actions.Instances.Leap.ID)} increases to 5 feet. Your distance for a horizontal {ToMarkdownLink<Models.Entities.Action>("Leap", Actions.Instances.Leap.ID)} increases to 15 feet if your Speed is at least 15 feet, or to 20 feet if your Speed is at least 30 feet." };
        }
        ...
        {
            builder.Add(Guid.Parse("5c4b8f82-2f24-4af0-9969-22285a4f7986"), Traits.Instances.Swashbuckler.ID);
