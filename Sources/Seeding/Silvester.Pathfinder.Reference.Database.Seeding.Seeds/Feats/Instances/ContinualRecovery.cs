...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class ContinualRecovery : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("fda3026f-8dcc-4c4b-a332-0b3e055902cb"), Type = TextBlockType.Text, Text = $"You zealously monitor a patient's progress to administer treatment faster. When you {ToMarkdownLink<Models.Entities.SkillAction>("Treat Wounds", SkillActions.Instances.TreatWounds.ID)}, your patient becomes immune for only 10 minutes instead of 1 hour. This applies only to your {ToMarkdownLink<Models.Entities.SkillAction>("Treat Wounds", SkillActions.Instances.TreatWounds.ID)} activities, not any other the patient receives." };
        }
        ...
        {
            builder.Add(Guid.Parse("92cb3a8b-35b2-45d6-9aaa-38529a472583"), Traits.Instances.General.ID);
            builder.Add(Guid.Parse("f82d29be-d04e-4b4b-b4f8-7d4e2412b394"), Traits.Instances.Skill.ID);
