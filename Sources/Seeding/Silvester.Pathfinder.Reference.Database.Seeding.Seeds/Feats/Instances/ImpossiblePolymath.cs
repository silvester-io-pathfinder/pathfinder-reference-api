...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class ImpossiblePolymath : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("47047978-c256-4a87-a081-4eb7462f89fd"), Type = TextBlockType.Text, Text = $"Your esoteric formulas are so unusual that they allow you to dabble in magic from diverse traditions that other bards don't understand. As long as you're trained in Arcana, you can add arcane spells to your book from {ToMarkdownLink<Models.Entities.Feat>("Esoteric Polymath", Feats.Instances.EsotericPolymath.ID)}; as long as you're trained in Nature, you can add primal spells to your book; and as long as you are trained in Religion, you can add divine spells to your book." };
            yield return new TextBlock { Id = Guid.Parse("21d9b799-b9a7-44a3-83ba-b4cc529a8c3d"), Type = TextBlockType.Text, Text = $"Like your other spells in your book, you can add one of these spells from another tradition to your repertoire as an occult spell each day using {ToMarkdownLink<Models.Entities.Feat>("Esoteric Polymath", Feats.Instances.EsotericPolymath.ID)}, but you can't retain any spells from another tradition when you prepare again, even if you have {ToMarkdownLink<Models.Entities.Feat>("Eclectic Polymath", Feats.Instances.EclecticPolymath.ID)}." };
        }
        ...
        {
            builder.Add(Guid.Parse("a38c5588-2c78-401b-b5fa-d9a213fc999e"), Traits.Instances.Bard.ID);
