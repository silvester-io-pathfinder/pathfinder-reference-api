...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class ElectrifyArmor : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDetailBlocks()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("356080ae-b2a8-47a9-b842-14f65130ecd9"), Type = TextBlockType.Text, Text = $"~ Unstable Function: You create an unstable chain reaction, sending countless sparks dancing across your armor. Add the {ToMarkdownLink<Models.Entities.Trait>("unstable", Traits.Instances.Unstable.ID)} trait to Electrify Armor. The effects last for 1 minute instead of 1 round, and the damage dice increase from d4s to d12s." };
        }
        ...
        {
            builder.Add(Guid.Parse("ff4ef3c2-6498-48a0-94a8-e8914066e42d"), Traits.Instances.Inventor.ID);
            builder.Add(Guid.Parse("5e85157e-60c0-4106-8498-562f41104e03"), Traits.Instances.Manipulate.ID);
