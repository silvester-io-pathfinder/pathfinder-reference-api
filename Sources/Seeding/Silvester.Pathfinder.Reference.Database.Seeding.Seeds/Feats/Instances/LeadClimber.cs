...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class LeadClimber : Template
    {
        ...
        {
            builder.Add(Guid.Parse("29d53fac-438d-4423-a8a8-bc1429d52d91"), Traits.Instances.General.ID);
            builder.Add(Guid.Parse("c4627f16-e71b-48b3-b64e-451ce00259d2"), Traits.Instances.Skill.ID);
