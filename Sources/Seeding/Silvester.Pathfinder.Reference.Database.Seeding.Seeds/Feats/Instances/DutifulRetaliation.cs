...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class DutifulRetaliation : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("6d56a769-3c19-450c-8fc8-6037c6732988"), Type = TextBlockType.Text, Text = $"Your eidolon instinctively flashes with ectoplasmic energy, allowing them to strike back against an enemy who dares to harm you. Your eidolon makes a melee unarmed {ToMarkdownLink<Models.Entities.Action>("Strike", Actions.Instances.Strike.ID)} against the triggering enemy, even if that enemy isn't within your eidolon's reach." };
        }
