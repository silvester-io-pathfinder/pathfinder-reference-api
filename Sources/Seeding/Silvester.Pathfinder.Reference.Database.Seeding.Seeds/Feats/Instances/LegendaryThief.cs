...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class LegendaryThief : Template
    {
        ...
        {
            builder.Add(Guid.Parse("cb67f025-9507-4959-90da-9c80f6793726"), Traits.Instances.General.ID);
            builder.Add(Guid.Parse("290a00ce-d7ff-4e81-aa02-12d6701ce1bb"), Traits.Instances.Skill.ID);
