...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class GreaterVitalEvolution : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("f741ada7-6516-422c-9798-3ac2c35c0411"), Type = TextBlockType.Text, Text = $"Vital power surges through you like a font of energy. Twice per day, you can {ToMarkdownLink<Models.Entities.Rule>("Cast a Spell", Rules.Instances.CastASpell.ID)} after you've run out of spell slots of the appropriate spell level; the two spells you cast with this feat must be of different spell levels." };
        }
        ...
        {
            builder.Add(Guid.Parse("369f923f-1d3e-49b6-a279-3c89d8fbc537"), Traits.Instances.Sorcerer.ID);
