...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class CautiousDelver : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("e1b82619-c9a5-4739-b9fd-82cf5704749c"), Type = TextBlockType.Text, Text = $"You've studied the many ways that ancient architects and spellcasters protected their possessions, such as by implementing deadly traps and curses, and learned some magic to counteract them. You can cast {ToMarkdownLink<Models.Entities.Spell>("dispel magic", Spells.Instances.DispelMagic.ID)}, {ToMarkdownLink<Models.Entities.Spell>("knock", Spells.Instances.Knock.ID)}, and {ToMarkdownLink<Models.Entities.Spell>("resist energy", Spells.Instances.ResistEnergy.ID)} as innate spells, each once per day. If you can already cast spells, these spells are of the same tradition. Otherwise, they're arcane spells, you use Intelligence as your spellcasting ability, and you become trained in spell attack rolls and spell DCs for arcane spells." };
        }
        ...
        {
            builder.Add(Guid.Parse("75878a9b-bea6-4a11-93e9-fa1ac64a5ac4"), Traits.Instances.Archetype.ID);
