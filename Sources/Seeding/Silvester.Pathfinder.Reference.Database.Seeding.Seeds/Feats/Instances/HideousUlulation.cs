...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class HideousUlulation : Template
    {
        ...
        {
            builder.Add(Guid.Parse("daf2825a-5e4f-4da3-95b1-882cc196f029"), Traits.Instances.Archetype.ID);
            builder.Add(Guid.Parse("b15729bf-e359-4560-b43c-63050d762790"), Traits.Instances.Skill.ID);
