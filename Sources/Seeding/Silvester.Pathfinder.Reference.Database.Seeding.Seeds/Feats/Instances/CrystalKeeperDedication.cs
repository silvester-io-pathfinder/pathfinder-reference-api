...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class CrystalKeeperDedication : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("a7b26667-e16d-4f72-9ce8-24d27cc9ef71"), Type = TextBlockType.Text, Text = $"You can use Arcana, Occultism, Religion, or Society to {ToMarkdownLink<Models.Entities.SkillAction>("Decipher Writing", SkillActions.Instances.DecipherWriting.ID)} by meditating before a crystal, regardless of the type of writing. When you {ToMarkdownLink<Models.Entities.SkillAction>("Decipher Writing", SkillActions.Instances.DecipherWriting.ID)} and roll a critical failure, you get a failure instead, and when you {ToMarkdownLink<Models.Entities.SkillAction>("Decipher Writing", SkillActions.Instances.DecipherWriting.ID)} and roll a success, you get a critical success instead." };
        ...
        {
            builder.Add(Guid.Parse("077e4609-ea4f-4973-8634-3f32917a454c"), Traits.Instances.Archetype.ID);
            builder.Add(Guid.Parse("031367e9-2266-49d6-b5d8-c2041de58750"), Traits.Instances.Dedication.ID);
