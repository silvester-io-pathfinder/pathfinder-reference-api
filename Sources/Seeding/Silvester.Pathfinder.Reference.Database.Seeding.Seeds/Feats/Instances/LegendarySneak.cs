...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class LegendarySneak : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("f7eccff3-850a-4039-8ddc-bced109ebf30"), Type = TextBlockType.Text, Text = $"You're always sneaking unless you choose to be seen, even when there's nowhere to hide. You can {ToMarkdownLink<Models.Entities.SkillAction>("Hide", SkillActions.Instances.Hide.ID)} and {ToMarkdownLink<Models.Entities.SkillAction>("Sneak", SkillActions.Instances.Sneak.ID)} even without cover or being concealed. When you employ an exploration tactic other than {ToMarkdownLink<Models.Entities.Activity>("Avoiding Notice", Activities.Instances.AvoidNotice.ID)}, you also gain the benefits of {ToMarkdownLink<Models.Entities.Activity>("Avoiding Notice", Activities.Instances.AvoidNotice.ID)} unless you choose not to." };
        }
        ...
        {
            builder.Add(Guid.Parse("6f749859-f3f3-442d-a3f4-727ef43e48c2"), Traits.Instances.General.ID);
            builder.Add(Guid.Parse("038e40c8-df89-4048-9d84-6085a9491314"), Traits.Instances.Skill.ID);
