...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class QuahBond : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDetailBlocks()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("3ce23bda-a8e5-48a5-996e-44e210a61ff5"), Type = TextBlockType.Text, Text = $"You grew up among the Shoanti tribes, with the spirits watching over you, and they offer you guidance. You gain the trained proficiency rank in the skill listed for your quah (or another skill of your choice, if you're already trained in that skill). You gain the {ToMarkdownLink<Models.Entities.Feat>("Assurance", Feats.Instances.Assurance.ID)} skill feat in that skill, as the spirits' help guides your actions." };
        ...
        {
            builder.Add(Guid.Parse("e0c1b636-0fa5-4ee6-b397-35e4a360ea7e"), Traits.Instances.Human.ID);
