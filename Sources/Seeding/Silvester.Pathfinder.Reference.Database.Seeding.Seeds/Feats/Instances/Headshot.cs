...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class Headshot : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("3ce9a3e3-4be4-4b4c-b9fa-3034cf797861"), Type = TextBlockType.Text, Text = $"You attempt to finish your target with a final, well-placed shot. Make a crossbow or firearm {ToMarkdownLink<Models.Entities.Action>("Strike", Actions.Instances.Strike.ID)}. If you've damaged the target within the last minute with the same weapon and you get a critical success on your attack roll, the target must succeed at a Fortitude save against your class DC or die; this is a {ToMarkdownLink<Models.Entities.Trait>("death", Traits.Instances.Death.ID)} and {ToMarkdownLink<Models.Entities.Trait>("incapacitation", Traits.Instances.Incapacitation.ID)} effect. A creature that survives is temporarily immune for 1 day. Creatures with no head (such as dullahans or oozes) are immune to this ability, and creatures with redundant heads (such as ettins) might survive the destruction of a head." };
        }
        ...
        {
            builder.Add(Guid.Parse("2dbaacd9-aab9-4cea-ac15-51333e1ebb9e"), Traits.Instances.Concentrate.ID);
            builder.Add(Guid.Parse("fdbd151e-9ac0-4025-8683-ab834678bcb9"), Traits.Instances.Gunslinger.ID);
