...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class RapidMantel : Template
    {
        ...
        {
            builder.Add(Guid.Parse("1e3fe247-3de6-4d23-815f-b4c8bdda62eb"), Traits.Instances.General.ID);
            builder.Add(Guid.Parse("f5613a1f-a09b-42d7-8580-af27f7843149"), Traits.Instances.Skill.ID);
