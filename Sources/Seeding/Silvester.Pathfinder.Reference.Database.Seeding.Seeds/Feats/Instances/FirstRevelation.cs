...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class FirstRevelation : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDetailBlocks()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("3c9a93a1-daad-45e8-8e1f-459990118dd2"), Type = TextBlockType.Text, Text = $"If you don't have one, you gain a focus pool of 1 Focus Point. You can {ToMarkdownLink<Models.Entities.Activity>("Refocus", Activities.Instances.Refocus.ID)} by reconciling the conflicting nature of your mystery, which also reduces your curse to minor." };
        }
        ...
        {
            builder.Add(Guid.Parse("69f3c40b-6093-4388-be8d-acbb358e3565"), Traits.Instances.Archetype.ID);
