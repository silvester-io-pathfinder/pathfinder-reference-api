...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class GoblinJubileeDisplay : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDetailBlocks()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("977d1f61-43aa-42ac-b3cb-c4de7481ccf2"), Type = TextBlockType.Text, Text = $"~ Goblin Jubilee: THREE-ACTIONS ({ToMarkdownLink<Models.Entities.Trait>("fire", Traits.Instances.Fire.ID)}, {ToMarkdownLink<Models.Entities.Trait>("sonic", Traits.Instances.Sonic.ID)}, {ToMarkdownLink<Models.Entities.Trait>("visual", Traits.Instances.Visual.ID)}) **Cost** 3 batches of infused reagents; **Effect** Chaos fills a 20-foot burst within 120 feet. All creatures in the area takes 3d6 fire damage and 3d6 sonic damage and must attempt a Fortitude save. A goblin jubilee display costs 3 batches of infused reagents, rather than 1." };
        }
        ...
        {
            builder.Add(Guid.Parse("f9a26140-969d-49dd-8b6f-ec7a033aef5c"), Traits.Instances.Archetype.ID);
