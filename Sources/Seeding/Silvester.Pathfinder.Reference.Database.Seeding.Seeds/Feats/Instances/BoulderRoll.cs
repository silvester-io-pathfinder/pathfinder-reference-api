...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class BoulderRoll : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("299bc2be-7711-4e2c-88c0-ed3af05014ce"), Type = TextBlockType.Text, Text = $"Your dwarven build allows you to push foes around, just like a mighty boulder tumbles through a subterranean cavern. Take a {ToMarkdownLink<Models.Entities.Action>("Step", Actions.Instances.Step.ID)} into the square of a foe that is your size or smaller, and the foe must move into the empty space directly behind it. The foe must move even if doing so places it in harm's way. The foe can attempt a Fortitude saving throw against your Athletics DC to block your {ToMarkdownLink<Models.Entities.Action>("Step", Actions.Instances.Step.ID)}. If the foe attempts this saving throw, unless it critically succeeds, it takes bludgeoning damage equal to your level plus your Strength modifier." };
        ...
        {
            builder.Add(Guid.Parse("084d39bf-df54-4a7e-91dd-9ba7988b1c04"), Traits.Instances.Dwarf.ID);
