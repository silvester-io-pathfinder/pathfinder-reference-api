...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class AssuredKnowledge : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("2a8c202c-c619-45dd-96d4-34d8c59004eb"), Type = TextBlockType.Text, Text = $"You can procure information with confidence. Whenever you {ToMarkdownLink<Models.Entities.SkillAction>("Recall Knowledge", SkillActions.Instances.RecallKnowledge.ID)} using any skill (including Loremaster Lore), you can forgo rolling your check to instead receive a result of 10 + your proficiency bonus (don't apply any other bonuses, penalties, or modifiers). As long as you are an expert in a skill, you meet the prerequisites for the {ToMarkdownLink<Models.Entities.Feat>("Automatic Knowledge", Feats.Instances.AutomaticKnowledge.ID)} skill feat in that skill, even if you don't have {ToMarkdownLink<Models.Entities.Feat>("Assurance", Feats.Instances.Assurance.ID)} in that skill." };
        }
        ...
        {
            builder.Add(Guid.Parse("cae0251e-2416-4003-97e1-e5283799b63a"), Traits.Instances.Bard.ID);
