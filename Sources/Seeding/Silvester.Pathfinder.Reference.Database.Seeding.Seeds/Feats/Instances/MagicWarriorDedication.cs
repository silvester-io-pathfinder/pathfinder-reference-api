...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class MagicWarriorDedication : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDetailBlocks()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("c7f0ce55-39a4-40e3-a568-94a4f54fe656"), Type = TextBlockType.Text, Text = $"You hide your identity behind a mask representing an animal of your choice, corresponding to one of the general animal types in the {ToMarkdownLink<Models.Entities.Spell>("animal form", Spells.Instances.AnimalForm.ID)} spell. You gain a +1 circumstance bonus to saves against {ToMarkdownLink<Models.Entities.Trait>("divination", Traits.Instances.Divination.ID)} effects, though sometimes refusing to remove your mask can cause issues in areas that don't respect or understand the magic warrior tradition." };
        ...
        {
            builder.Add(Guid.Parse("f090061c-418f-4833-b855-6969a2e644b1"), Traits.Instances.Archetype.ID);
            builder.Add(Guid.Parse("b9ffe165-7a3e-454f-a2e4-04c4d40b1e30"), Traits.Instances.Dedication.ID);
