...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class HagMagicIllusoryDisguise : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("ffdd31d2-8ed4-406a-98d6-200a647bbcca"), Type = TextBlockType.Text, Text = "You can cast (spell: illusory disguise) once per day as a 4th-level occult innate spell." };
        }
