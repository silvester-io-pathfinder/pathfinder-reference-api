...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class FocusedFascination : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("4d27366f-ea68-456d-9cc6-0f44cecff9e0"), Type = TextBlockType.Text, Text = $"When you use {ToMarkdownLink<Models.Entities.Feat>("Fascinating Performance", Feats.Instances.FascinatingPerformance.ID)} in a combat encounter, you need only a success, rather than a critical success, to fascinate your target. This works only if you're attempting to fascinate one target. For example, if you were an expert in Performance, you could choose to target multiple creatures normally or target one creature and fascinate it on a success." };
        }
        ...
        {
            builder.Add(Guid.Parse("3581c6bf-04a9-4694-a8cd-282127fc8a6a"), Traits.Instances.Swashbuckler.ID);
