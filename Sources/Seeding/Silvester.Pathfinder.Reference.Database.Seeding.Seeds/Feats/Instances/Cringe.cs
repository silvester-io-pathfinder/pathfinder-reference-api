...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class Cringe : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("ab9f7c89-23f5-4ecc-81b4-72a6a74a6020"), Type = TextBlockType.Text, Text = $"With pitiful posturing, you cause your foe to pull back a deadly attack. The attacking creature takes a circumstance penalty to the damage of the triggering {ToMarkdownLink<Models.Entities.Action>("Strike", Actions.Instances.Strike.ID)} equal to your level + 2. This penalty applies after doubling the damage for a critical hit. The attacker is then immune to your Cringe for 24 hours." };
        }

        protected override void GetTraits(ITraitBindingBuilder<FeatTraitBinding, Feat> builder)
        {
            builder.Add(Guid.Parse("f9a8499e-facd-4278-b214-42fd3ac9a3ea"), Traits.Instances.Emotion.ID);
            builder.Add(Guid.Parse("83affe6d-078d-4b21-871e-5bafe90d9b43"), Traits.Instances.Kobold.ID);
            builder.Add(Guid.Parse("fd0e9346-238c-4bfc-82b3-ffd5468f1708"), Traits.Instances.Mental.ID);
            builder.Add(Guid.Parse("72d2ea66-eecb-4ce1-b581-a29d33ec7ec7"), Traits.Instances.Visual.ID);
