...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class UnshakableIdealism : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("7530883d-4a88-44ea-8563-20fa39963d95"), Type = TextBlockType.Text, Text = $"Your faith and hope can't be shaken, and you won't flee when lives are at stake. You gain a +1 circumstance bonus on saves against {ToMarkdownLink<Models.Entities.Trait>("fear", Traits.Instances.Fear.ID)} effects and {ToMarkdownLink<Models.Entities.Trait>("emotion", Traits.Instances.Emotion.ID)} effects that inflict despair. When you would gain the fleeing condition, you can choose to stand your ground and be stunned for the effect's duration as well, preventing you from running and allowing you to re-enter the fight more quickly when the effect ends." };
        }
        ...
        {
            builder.Add(Guid.Parse("5ed84bf6-fd46-4953-91e9-375eb507cddc"), Traits.Instances.Archetype.ID);
