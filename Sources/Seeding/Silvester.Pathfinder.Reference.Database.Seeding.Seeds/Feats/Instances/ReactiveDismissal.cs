...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class ReactiveDismissal : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("69561e62-d28d-4f22-a2ba-4ab99277242e"), Type = TextBlockType.Text, Text = $"You abruptly dismiss your eidolon to reduce the damage it takes, though this makes summoning it again more difficult. Reduce the triggering damage to your eidolon by double your level, and your eidolon unmanifests. You can't {ToMarkdownLink<Models.Entities.Feat>("Manifest your Eidolon", Feats.Instances.ManifestEidolon.ID)} again until after the end of your next turn." };
        }

        protected override void GetTraits(ITraitBindingBuilder<FeatTraitBinding, Feat> builder)
        {
            builder.Add(Guid.Parse("32dbf0bc-93cf-4457-bd51-91fb72b917cc"), Traits.Instances.Summoner.ID);
