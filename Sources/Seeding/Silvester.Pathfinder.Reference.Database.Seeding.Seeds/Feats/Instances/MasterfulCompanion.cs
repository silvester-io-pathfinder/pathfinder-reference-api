...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class MasterfulCompanion : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("f06ee6a2-88dc-4e60-a66d-e6749958feac"), Type = TextBlockType.Text, Text = $"Your animal companion shares your incredible hunting skills, allowing it to take down your shared prey with ease. When you {ToMarkdownLink<Models.Entities.Feat>("Hunt Prey", Feats.Instances.HuntPrey.ID)}, your animal companion gains the masterful hunter benefit associated with your hunter's edge, rather than just your original hunter's edge benefit." };
        }
        ...
        {
            builder.Add(Guid.Parse("3e08885e-21ce-4351-b378-2e122d3f3e0b"), Traits.Instances.Ranger.ID);
