...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class GeomancerDedication : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDetailBlocks()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("4920d0c2-b1de-4923-b863-72dd3b7560ea"), Type = TextBlockType.Enumeration, Text = $" Aquatic: ({ToMarkdownLink<Models.Entities.Trait>("water", Traits.Instances.Water.ID)}) You ride the currents of water. If you're in the water, you gain a swim Speed equal to your land Speed. If you're on a surface, temporary waves of water follow your movements, allowing you to use your swim Speed—if you have one—as your land Speed." };
            yield return new TextBlock { Id = Guid.Parse("f35eab1c-b34f-41ab-9b6e-3de6055cbb7c"), Type = TextBlockType.Enumeration, Text = $" Arctic: ({ToMarkdownLink<Models.Entities.Trait>("cold", Traits.Instances.Cold.ID)}) Arctic rime covers your foes' bodies. Enemies must attempt a Fortitude save. They take a –5-foot status penalty to their Speeds for 2 rounds (–10-foot on a critical failure)." };
            yield return new TextBlock { Id = Guid.Parse("5e333a6a-1aa0-4be0-ac81-1269000df606"), Type = TextBlockType.Enumeration, Text = $" Desert: ({ToMarkdownLink<Models.Entities.Trait>("fire", Traits.Instances.Fire.ID)}) The scorching heat of the desert dehydrates your foes. Enemies must attempt a Fortitude save. On a failure, they're fatigued until they drink water or another potable liquid." };
            yield return new TextBlock { Id = Guid.Parse("4aea8322-c1a4-41bf-8378-61745f8502db"), Type = TextBlockType.Enumeration, Text = $" Forest: ({ToMarkdownLink<Models.Entities.Trait>("plant", Traits.Instances.Plant.ID)}) Branches and vines reach out to get in your foes' way. Enemies must attempt a Reflex save. On a failure, they become clumsy 1 for 1 round (clumsy 2 on a critical failure)." };
            yield return new TextBlock { Id = Guid.Parse("833dce8d-8516-4598-8a57-b4ec1b23681c"), Type = TextBlockType.Enumeration, Text = $" Mountain: ({ToMarkdownLink<Models.Entities.Trait>("earth", Traits.Instances.Earth.ID)}) The rugged endurance of the mountain protects you from harm. You gain resistance to physical damage (except adamantine) equal to the spell level for 1 round." };
            yield return new TextBlock { Id = Guid.Parse("4795b306-7a94-4f9c-ae2e-6a73d4212bbe"), Type = TextBlockType.Enumeration, Text = $" Plains: ({ToMarkdownLink<Models.Entities.Trait>("plant", Traits.Instances.Plant.ID)}) The growing fields and pulsing vitality of the plains provide you vigor. You gain temporary Hit Points equal to the spell level for 1 round." };
            yield return new TextBlock { Id = Guid.Parse("e0d87128-4150-4583-b161-9609bbee815f"), Type = TextBlockType.Enumeration, Text = $" Sky: ({ToMarkdownLink<Models.Entities.Trait>("air", Traits.Instances.Air.ID)}) A gust of wind carries you aloft. You can {ToMarkdownLink<Models.Entities.Action>("Fly", Actions.Instances.Fly.ID)} up to 10 feet. If you're in the air at the end of the turn and don't have a fly Speed, you fall." };
            yield return new TextBlock { Id = Guid.Parse("bcbb8ec7-9768-47a9-9d21-1496dea981c6"), Type = TextBlockType.Enumeration, Text = $" Swamp: ({ToMarkdownLink<Models.Entities.Trait>("plant", Traits.Instances.Plant.ID)}) Your magic draws in noxious swamp gas to fumigate your foes. Affected foes take persistent poison damage equal to half the spell's level (minimum 1 damage) with a basic Fortitude save." };
            yield return new TextBlock { Id = Guid.Parse("bc9588ba-8dce-4017-8afa-50f391b9315c"), Type = TextBlockType.Enumeration, Text = $" Underground: ({ToMarkdownLink<Models.Entities.Trait>("earth", Traits.Instances.Earth.ID)}) The endless darkness of the cavern depths opens up its secrets to your senses. For 1 round, you gain darkvision as well as imprecise tremorsense out to 15 feet." };
        }
        ...
        {
            builder.Add(Guid.Parse("b70ce939-36fd-4e2d-9de2-5215bdfcd811"), Traits.Instances.Archetype.ID);
            builder.Add(Guid.Parse("e8f33b6d-b2c7-4895-ae93-5addf2f738cb"), Traits.Instances.Dedication.ID);
