...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class WitchsHut : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDetailBlocks()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("b2f5a38f-27d3-4772-baa4-9f9c066a8dbc"), Type = TextBlockType.Text, Text = "The hut can't attack or attempt skill checks. You can give the hut a command as a single action, which has the (trait: auditory) and (trait: concentrate) traits; after 1 round of reconfiguring itself, the hut then follows that command until you give it a different command." };
            ...
            yield return new TextBlock { Id = Guid.Parse("ef3d718d-fa9e-4b4d-a373-f18f3c4f9e6f"), Type = TextBlockType.Enumeration, Text = " Lock: Each entrance to the hut is sealed with a (spell: lock) spell." };
            ...
            yield return new TextBlock { Id = Guid.Parse("15e71418-43de-4d71-9198-9dd68d8f3256"), Type = TextBlockType.Enumeration, Text = " Hide: The hut appears to be a normal, mundane object of its type. This is a 10th-level (trait: illusion) effect." };
