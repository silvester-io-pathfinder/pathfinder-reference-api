...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class AnalyzeIdiolect : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("05e8a742-fd92-41f6-ba00-c9ff42a7e70f"), Type = TextBlockType.Text, Text = $"You break down a specific individual's idiolect, memorizing their speech mannerisms and habits. If you interact with someone for at least 10 minutes, when you later attempt to {ToMarkdownLink<Models.Entities.SkillAction>("Impersonate", SkillActions.Instances.Impersonate.ID)} that individual, you gain a +4 circumstance bonus to your Deception checks and DCs. Due to the intense character study required, you can't remember more than one idiolect at a time." };
        }
        ...
        {
            builder.Add(Guid.Parse("2fe2c2d7-a4ab-4b33-9173-1239ae5977e9"), Traits.Instances.Archetype.ID);
            builder.Add(Guid.Parse("b254cefe-860e-4d9e-877d-a78a671c4d84"), Traits.Instances.Skill.ID);
