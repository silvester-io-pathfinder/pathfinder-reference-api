...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class SowRumor : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDetailBlocks()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("34a4c403-0a9c-4f33-af2b-44f627fc0e81"), Type = TextBlockType.Text, Text = $"You spread rumors, which may or may not be true, about a specific subject. If the subject of your rumor is not currently the subject of any contradictory rumors, this takes as long as it would normally take you to {ToMarkdownLink<Models.Entities.SkillAction>("Gather Information", SkillActions.Instances.GatherInformation.ID)} (typically 2 hours), at the end of which the GM rolls a secret Deception check to see how well you spread the rumor. If your rumor matches any current rumors about the subject, it takes less time to spread the rumor, and if you are attempting to overtake a particularly popular and contradictory rumor, it takes much longer or may be impossible. The DC similarly increases or decreases depending on how plausible your rumor is." };
        }
        ...
        {
            builder.Add(Guid.Parse("a0c83ec6-1bc6-482c-95b2-08b8bdb9d273"), Traits.Instances.General.ID);
            builder.Add(Guid.Parse("26af6449-fb22-4af3-8b7e-a0a9002f8cac"), Traits.Instances.Secret.ID);
            builder.Add(Guid.Parse("fc01e28f-c7f4-4dfb-9a3b-406cf0e76ca6"), Traits.Instances.Skill.ID);
