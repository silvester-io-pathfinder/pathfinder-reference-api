...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class PactOfInfernalProwess : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("a430937d-62c6-4c5e-8f2f-697db2912476"), Type = TextBlockType.Text, Text = "You've sworn a pact with devils, granting you success in life in exchange for your soul in the afterlife. Once per day, when you critically fail a check, you can reroll the check as a free action; this is a (trait: fortune) effect. Additionally, you can choose to automatically succeed at checks to (action: Earn Income) for tasks below your level, without rolling." };
