...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class MaulerDedication : Template
    {
        ...
        {
            builder.Add(Guid.Parse("2f0fdb2f-be08-4294-b37c-2a2915887a74"), Traits.Instances.Archetype.ID);
            builder.Add(Guid.Parse("ccaf0069-8f04-4202-8729-382986bb071a"), Traits.Instances.Dedication.ID);
