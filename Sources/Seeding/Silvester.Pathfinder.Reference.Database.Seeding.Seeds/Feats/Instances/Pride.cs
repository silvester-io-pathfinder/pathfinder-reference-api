...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class Pride : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDetailBlocks()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("0d418a97-4490-4141-8961-a0f3bbb73642"), Type = TextBlockType.Text, Text = $"~ Emotional Fervor: Each time you cast an illusion spell, until the start of your next turn, any critical failure you roll on an attack roll or saving throw is a failure instead. Spell: {ToMarkdownLink<Models.Entities.Spell>("color spray", Spells.Instances.ColorSpray.ID)}" };
            yield return new TextBlock { Id = Guid.Parse("e7af872c-7bd9-4283-a9b7-8197c5276b1a"), Type = TextBlockType.Text, Text = $"~ Emotional Fallout: You momentarily lose track of what's real, becoming confused for 1 round. Spell: {ToMarkdownLink<Models.Entities.Spell>("mirror image", Spells.Instances.MirrorImage.ID)}" };
            yield return new TextBlock { Id = Guid.Parse("6a8b2050-a28c-4ea2-a9d5-4539d03cf3f1"), Type = TextBlockType.Text, Text = $"~ Focus Spell: {ToMarkdownLink<Models.Entities.Spell>("veil of confidence", Spells.Instances.VeilOfConfidence.ID)}" };
        }
