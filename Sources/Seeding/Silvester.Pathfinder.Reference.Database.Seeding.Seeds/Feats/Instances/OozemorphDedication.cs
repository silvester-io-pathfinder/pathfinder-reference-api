...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class OozemorphDedication : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("7399bd7b-d168-4e56-85c8-14c3eaf7257e"), Type = TextBlockType.Text, Text = $"You are plagued by sporadic anatomical rearrangements, which grant you insights into other creatures with unusual anatomies. You become trained in Occultism and Ooze Lore; if you were already trained, you become an expert instead. You gain a +2 circumstance bonus to Reflex saves to avoid being Engulfed by creatures, and to checks to {ToMarkdownLink<Models.Entities.Action>("Escape", Actions.Instances.Escape.ID)} after being Engulfed." };
        ...
        {
            builder.Add(Guid.Parse("4b9c5f47-2838-489a-aff3-79a95cd81317"), Traits.Instances.Archetype.ID);
            builder.Add(Guid.Parse("6323acfb-e8b6-4e4c-a558-b5c662639697"), Traits.Instances.Dedication.ID);
