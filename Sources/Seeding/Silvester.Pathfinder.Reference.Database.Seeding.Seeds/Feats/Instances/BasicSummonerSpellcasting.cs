...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class BasicSummonerSpellcasting : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("6368bdfe-b6af-4b12-a770-918b9f7248b5"), Type = TextBlockType.Text, Text = $"You gain a 1st and 2nd-level spell slot. At 10th level, replace your 1st-level spell slot with a 3rd-level spell slot. You gain the {ToMarkdownLink<Models.Entities.Rule>("Cast a Spell", Rules.Instances.CastASpell.ID)} activity. Your key spellcasting ability for summoner archetype spells is Charisma, and they are summoner spells of your eidolon's tradition. You become trained in spell attack rolls and spell DCs of that tradition. You gain a spell repertoire and two cantrips. Each time you gain a spell slot of a new level from the summoner archetype, add a spell of that level or lower to your repertoire. You can select one spell from your repertoire as a signature spell. Each time you lose spell slots of a particular level, remove those spells from your repertoire." };
        }
        ...
        {
            builder.Add(Guid.Parse("7d0272d6-778f-4e8d-a59a-2e9740288ab5"), Traits.Instances.Archetype.ID);
