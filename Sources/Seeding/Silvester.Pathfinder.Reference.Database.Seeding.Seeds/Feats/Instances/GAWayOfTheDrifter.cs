...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class GAWayOfTheDrifter : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDetailBlocks()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("1b453487-09fd-43ba-9487-58664276d40b"), Type = TextBlockType.Text, Text = $"~ Slinger's Reload: {ToMarkdownLink<Models.Entities.Feat>("Reloading Strike", Feats.Instances.ReloadingStrike.ID)}" };
            yield return new TextBlock { Id = Guid.Parse("63057192-5322-40df-84e8-ed030bfb2141"), Type = TextBlockType.Text, Text = $"~ Deeds: __Initial__ {ToMarkdownLink<Models.Entities.Feat>("Into the Fray", Feats.Instances.IntoTheFray.ID)}; __Advanced__ {ToMarkdownLink<Models.Entities.Feat>("Finish the Job", Feats.Instances.FinishTheJob.ID)}; __Greater__ {ToMarkdownLink<Models.Entities.Feat>("Drifter's Wake", Feats.Instances.DriftersWake.ID)}" };
