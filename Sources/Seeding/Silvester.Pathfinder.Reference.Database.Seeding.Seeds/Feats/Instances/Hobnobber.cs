...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class Hobnobber : Template
    {
        ...
        {
            builder.Add(Guid.Parse("44eac4ff-0388-48d8-8da3-3dc3d9c8e745"), Traits.Instances.General.ID);
            builder.Add(Guid.Parse("4a2f5b34-c1bf-4ba6-84e4-165371e1cd6d"), Traits.Instances.Skill.ID);
