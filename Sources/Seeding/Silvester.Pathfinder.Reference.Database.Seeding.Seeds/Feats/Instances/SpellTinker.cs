...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class SpellTinker : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("4fa3d644-1e44-4397-86d1-2b5adbfa9a84"), Type = TextBlockType.Text, Text = "You've learned to alter choices you make when casting spells on yourself. After casting a spell on only yourself that offers several choices of effect (such as (Spell: resist energy), (Spell: spell immunity), or a polymorph spell that offers several potential forms), you can alter the choice you made when (activity: Casting the Spell | Cast a Spell) (for instance, choosing a different type of damage for (Spell: resist energy)). However, your tinkering weakens the spell's integrity, reducing its remaining duration by half." };
