...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class TitanWrestler : Template
    {
        ...
        {
            builder.Add(Guid.Parse("279fb233-c328-4d2c-aab2-b2ea566145a1"), Traits.Instances.General.ID);
            builder.Add(Guid.Parse("89f883e3-5de6-406b-94af-7200afb8c90b"), Traits.Instances.Skill.ID);
