...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class AdvancedDeitysDomain : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("489c4f52-5e0f-4465-a60f-424b9feae8d4"), Type = TextBlockType.Text, Text = $"Through your conviction, you have glimpsed the deeper secrets of your deity's domain. You gain an advanced domain spell from the domain you chose with {ToMarkdownLink<Models.Entities.Feat>("Deity's Domain", Feats.Instances.DeitysDomain.ID)}. You can cast that spell as a devotion spell. Increase the number of Focus Points in your focus pool by 1." };
        }
        ...
        {
            builder.Add(Guid.Parse("69b26f7e-6646-454e-9c4b-5ccda24aa675"), Traits.Instances.Champion.ID);
