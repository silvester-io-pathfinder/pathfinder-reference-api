...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class CraftersAppraisal : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("f6600d6d-2cd6-4400-a439-54afc4609afd"), Type = TextBlockType.Text, Text = $"Your knowledge of items' construction allows you to discern their magical effects as well. You can use Crafting instead of a skill associated with a magic tradition to {ToMarkdownLink<Models.Entities.SkillAction>("Identify Magic", SkillActions.Instances.IdentifyMagic.ID)} on magic items, though not on any other sorts of magic." };
        }
        ...
        {
            builder.Add(Guid.Parse("329815ed-dc1c-45b4-832e-d96621f9db7b"), Traits.Instances.General.ID);
            builder.Add(Guid.Parse("1bec2900-caa0-4fff-8905-dcdd762300e1"), Traits.Instances.Skill.ID);
