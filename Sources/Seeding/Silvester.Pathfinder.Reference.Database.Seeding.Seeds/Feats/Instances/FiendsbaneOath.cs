...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class FiendsbaneOath : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDetailBlocks()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("80d42237-7809-46f2-9b4a-69722d409e13"), Type = TextBlockType.Text, Text = "Your (feat: Retributive Strike) gains a +4 circumstance bonus to damage against a fiend, or a +6 circumstance bonus if you have master proficiency with the weapon you used." };
            yield return new TextBlock { Id = Guid.Parse("9af2bc00-94c2-4ad2-a412-c6462fabeef0"), Type = TextBlockType.Text, Text = "Your (feat: Glimpse of Redemption)'s resistance against damage from a fiend is 7 + your level." };
            yield return new TextBlock { Id = Guid.Parse("3b989bc5-3d4f-4fac-b4a1-2c990f21ea34"), Type = TextBlockType.Text, Text = "If you use (feat: Liberating Step) triggered by a fiend, your ally gains a +4 circumstance bonus to checks granted by your (feat: Liberating Step), and the ally can (action: Step) twice afterward." };
