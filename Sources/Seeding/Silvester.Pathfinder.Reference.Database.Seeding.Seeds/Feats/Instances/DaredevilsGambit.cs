...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class DaredevilsGambit : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("b063c371-aeae-4af5-8b25-56804e5c67b8"), Type = TextBlockType.Text, Text = $"If you critically succeed at your {ToMarkdownLink<Models.Entities.Feat>("Daring Act", Feats.Instances.DaringAct.ID)}, you can enter the target's space and remain there until the beginning of your next turn or until the target moves, whichever comes first. You gain a +2 circumstance bonus to AC, and your target is flat-footed against your attacks while you are sharing its space in this way." };
        ...
        {
            builder.Add(Guid.Parse("176b5f1e-6217-4ad7-95ae-44cd8f3b5de2"), Traits.Instances.Archetype.ID);
