...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class Acclimatization : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("41247174-5281-4991-a59e-64666d123406"), Type = TextBlockType.Text, Text = $"Your time spent in the hostile parts of the world has inured you to extreme climates. In your favored terrain, you gain resistance equal to half your level to all environmental damage and are affected by temperature effects as though they were one step less severe (incredible heat or cold becomes extreme, extreme heat or cold becomes severe, and so on). When other creatures {ToMarkdownLink<Models.Entities.Activity>("Follow the Expert", Activities.Instances.FollowTheExpert.ID)} with you as a guide in your favored terrain, they too treat temperature effects as one step less severe." };
        }
        ...
        {
            builder.Add(Guid.Parse("4569179a-cade-4dd0-9b7b-bacce4897894"), Traits.Instances.Archetype.ID);
