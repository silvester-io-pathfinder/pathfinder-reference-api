...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class ArcaneCascade : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("3294c280-f3bf-4b4a-8a22-3d67df684079"), Type = TextBlockType.Text, Text = $"You divert a portion of the spell's magical power and keep it cycling through your body and weapon using specialized forms, breathing, or footwork. While you're in the stance, your melee {ToMarkdownLink<Models.Entities.Action>("Strikes", Actions.Instances.Strike.ID)} deal 1 extra damage. This damage increases to 2 if you have weapon specialization and 3 if you have greater weapon specialization. Any {ToMarkdownLink<Models.Entities.Action>("Strike", Actions.Instances.Strike.ID)} that benefits from this damage gains the arcane trait, making it magical." };
