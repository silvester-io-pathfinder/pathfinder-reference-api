...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class ShadowReservoir : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDetailBlocks()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("29a6f891-db2a-4731-b817-3bd300f9e598"), Type = TextBlockType.Text, Text = $"Spells cast from your shadow reservoir gain the {ToMarkdownLink<Models.Entities.Trait>("shadow", Traits.Instances.Shadow.ID)} trait, and affected creatures might be able to disbelieve them. If the spell requires an attack roll, use the higher of the target's AC or their Will DC. If the spell requires a saving throw, the target uses their Will saving throw or the spell's normal saving throw, whichever is higher. Each time a creature fails its saving throw against a spell cast from your reservoir, you gain a small tattoo inked on your flesh out of pure shadowstuff." };
        ...
        {
            builder.Add(Guid.Parse("27e2d87a-0d61-425d-b172-e07594145da2"), Traits.Instances.Archetype.ID);
