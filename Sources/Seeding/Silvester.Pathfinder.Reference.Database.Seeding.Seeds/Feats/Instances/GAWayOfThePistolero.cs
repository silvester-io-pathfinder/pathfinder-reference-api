...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class GAWayOfThePistolero : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDetailBlocks()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("a8ddeca6-f541-4fee-9d75-6c4b32a7ca3a"), Type = TextBlockType.Text, Text = $"~ Slinger's Reload: {ToMarkdownLink<Models.Entities.Feat>("Raconteur's Reload", Feats.Instances.RaconteursReload.ID)}" };
            yield return new TextBlock { Id = Guid.Parse("bd3b5eed-c2b6-4ca5-832a-e629b87c355e"), Type = TextBlockType.Text, Text = $"~ Deeds: __Initial__ {ToMarkdownLink<Models.Entities.Feat>("Ten Paces", Feats.Instances.TenPaces.ID)}; __Advanced__ {ToMarkdownLink<Models.Entities.Feat>("Pistolero's Retort", Feats.Instances.PistolersRetort.ID)}; __Greater__ {ToMarkdownLink<Models.Entities.Feat>("Grim Swagger", Feats.Instances.GrimSwagger.ID)}" };
