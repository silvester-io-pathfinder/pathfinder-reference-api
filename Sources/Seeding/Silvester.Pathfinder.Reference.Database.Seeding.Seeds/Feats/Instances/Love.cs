...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class Love : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("ee420239-a53f-40d0-b30b-88f13ae6f58e"), Type = TextBlockType.Text, Text = $"You're joined by the bonds of love and nothing can break that, but love can distract you from other things in your life. Your {ToMarkdownLink<Models.Entities.Feat>("emotional focus", Feats.Instances.EmotionalFocus.ID)} is someone you're in love with; they aren't required to love you back." };
            ...
            yield return new TextBlock { Id = Guid.Parse("ff8b3005-8be4-4c5b-8f99-b5d25de521af"), Type = TextBlockType.Text, Text = $"~ Emotional Fervor: You gain a +1 status bonus to Will saves. If you cast a spell to benefit your emotional focus, this bonus increases to +3 until the start of your next turn. Spell: {ToMarkdownLink<Models.Entities.Spell>("soothe", Spells.Instances.Soothe.ID)}" };
            ...
            yield return new TextBlock { Id = Guid.Parse("9e74c6d6-4b45-4231-9b4a-bf03667b33e4"), Type = TextBlockType.Text, Text = $"~ Focus Spell: {ToMarkdownLink<Models.Entities.Spell>("soothing words", Spells.Instances.SoothingWords.ID)}" };
        }
