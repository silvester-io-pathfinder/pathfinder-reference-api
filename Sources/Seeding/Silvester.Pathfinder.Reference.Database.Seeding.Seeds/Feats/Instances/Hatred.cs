...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class Hatred : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("e950f341-6378-4326-b955-1936b6f6de46"), Type = TextBlockType.Text, Text = $"Your unabashed hatred consumes your soul and causes your foe to falter. Your {ToMarkdownLink<Models.Entities.Feat>("emotional focus", Feats.Instances.EmotionalFocus.ID)} is an individual enemy you detest." };
            ...
            yield return new TextBlock { Id = Guid.Parse("1bfcf7bd-96d6-46e1-af4d-4022eb7f023d"), Type = TextBlockType.Text, Text = $"~ Catharsis Activation: You can {ToMarkdownLink<Models.Entities.Action>("Step", Actions.Instances.Step.ID)} or {ToMarkdownLink<Models.Entities.Action>("Stride", Actions.Instances.Stride.ID)}. You must end this movement closer to your emotional focus." };
            yield return new TextBlock { Id = Guid.Parse("601fb187-d424-4067-b21f-18649ae4ac8b"), Type = TextBlockType.Text, Text = $"~ Emotional Fervor: Your emotional focus is flat-footed to you and takes a –2 status penalty to saves against your spells. You're flat-footed to your emotional focus and take a –2 status penalty to saves against it. Spell: {ToMarkdownLink<Models.Entities.Spell>("blood vendetta", Spells.Instances.BloodVendetta.ID)}" };
            ...
            yield return new TextBlock { Id = Guid.Parse("d20266e5-f27e-41c7-a908-8f27b38bc7dc"), Type = TextBlockType.Text, Text = $"~ Focus Spell: {ToMarkdownLink<Models.Entities.Spell>("cry of destruction", Spells.Instances.CryOfDestruction.ID)}" };
        }
