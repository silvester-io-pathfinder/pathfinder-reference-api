...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class Juggle : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDetailBlocks()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("5b8b570c-7c74-449c-8dfb-a6024b89622a"), Type = TextBlockType.Text, Text = $"As long as you're Juggling fewer than your maximum number of items, you have a free hand. You can wield weapons you are Juggling (but not shields or other items) as long as they can be wielded in one hand. For example, while you Juggle a {ToMarkdownLink<Models.Items.Instances.MeleeWeapon>("dagger", Items.MeleeWeapons.Instances.Dagger.ID)} in one hand and wield a shield in the other, you are wielding the {ToMarkdownLink<Models.Items.Instances.MeleeWeapon>("dagger", Items.MeleeWeapons.Instances.Dagger.ID)} but still have a free hand to {ToMarkdownLink<Models.Entities.Rule>("Cast a Spell", Rules.Instances.CastASpell.ID)} with a material component. Juggling two or more weapons with one hand doesn't allow you to use feats that require two weapons each held in a different hand." };
        }
        ...
        {
            builder.Add(Guid.Parse("049defe5-c67f-489e-84c7-319327022df4"), Traits.Instances.Concentrate.ID);
            builder.Add(Guid.Parse("fb2ce52b-d816-4db0-966c-01f86409a95e"), Traits.Instances.General.ID);
            builder.Add(Guid.Parse("8d5db89d-c5cd-4c24-9e04-0de66b2a5b04"), Traits.Instances.Manipulate.ID);
            builder.Add(Guid.Parse("1565a7de-8af8-4ea7-ad9a-a740492151d1"), Traits.Instances.Skill.ID);
