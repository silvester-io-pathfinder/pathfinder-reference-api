...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class QuickDisguise : Template
    {
        ...
        {
            builder.Add(Guid.Parse("37d332d3-a4e9-40c2-8dda-d44c66bde469"), Traits.Instances.General.ID);
            builder.Add(Guid.Parse("900a0836-29d4-45e7-be0a-d44c2cfb4736"), Traits.Instances.Skill.ID);
