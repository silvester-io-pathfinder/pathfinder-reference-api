...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class AuraOfUnbreakableVirtue : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDetailBlocks()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("f227bb3d-2e52-4a60-8998-34b8674ccb25"), Type = TextBlockType.Text, Text = $"You are a paragon of all that is good, your overwhelming aura causing evildoers to cower. All evil creatures within 15 feet of you take a -1 status penalty to checks and DCs that target you or your allies. This penalty is -2 against creatures you have taken an oath against (such as dragons if you have the {ToMarkdownLink<Models.Entities.Feat>("Dragonslayer Oath", Feats.Instances.DragonslayerOath.ID)} feat). You can choose to suppress or resume this aura as an action, which has the {ToMarkdownLink<Models.Entities.Trait>("concentrate", Traits.Instances.Concentrate.ID)} trait." };
        }
        ...
        {
            builder.Add(Guid.Parse("74cffe33-4325-48cb-96f1-7c6fa05a8119"), Traits.Instances.Champion.ID);
