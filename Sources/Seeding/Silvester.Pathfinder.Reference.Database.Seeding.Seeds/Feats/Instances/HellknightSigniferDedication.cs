...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class HellknightSigniferDedication : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("071a5183-92f0-40c0-b7ef-69e3ad0b354b"), Type = TextBlockType.Text, Text = $"You have bolstered your force of will with the power of the Measure and the Chain. Upon initiation, you receive a signifer mask, often devoid of eyeholes or other decorative features. The mask doesn't obscure your vision, though it makes it impossible for others to see your eyes. While wearing your signifer's mask, you gain +1 circumstance bonus to Deception checks to {ToMarkdownLink<Models.Entities.SkillAction>("Lie", SkillActions.Instances.Lie.ID)}, Intimidation checks, and Deception DCs against {ToMarkdownLink<Models.Entities.Action>("Sense Motive", Actions.Instances.SenseMotive.ID)}. You gain expert proficiency in Intimidation (or in another skill in which you're trained of your choice, if you were already an expert in Intimidation) as well as in your choice of Arcana, Nature, Occultism, or Religion." };
        }
        ...
        {
            builder.Add(Guid.Parse("e0300f8c-5df8-453d-8b22-5ca81b7533f6"), Traits.Instances.Archetype.ID);
            builder.Add(Guid.Parse("1e0041c4-816a-46ec-906e-c762e686cfcd"), Traits.Instances.Dedication.ID);
