...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class ScrollmasterDedication : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDetailBlocks()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("1d57cb53-b683-4b88-9158-9a0eee1b0fa5"), Type = TextBlockType.Text, Text = $"If you have the {ToMarkdownLink<Models.Entities.Feat>("Thorough Reports", Feats.Instances.ThoroughReports.ID)} feat and have expert proficiency in the skill you're using to {ToMarkdownLink<Models.Entities.SkillAction>("Recall Knowledge", SkillActions.Instances.RecallKnowledge.ID)}, your circumstance bonus to {ToMarkdownLink<Models.Entities.SkillAction>("Recall Knowledge", SkillActions.Instances.RecallKnowledge.ID)} about creatures from that feat increases to +4." };
        }
        ...
        {
            builder.Add(Guid.Parse("dc20f6bf-9e5c-4d2d-9c9b-6c7b015d3658"), Traits.Instances.Archetype.ID);
            builder.Add(Guid.Parse("f51bfec2-5f28-43d5-a075-2e734c503d01"), Traits.Instances.Dedication.ID);
