...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class EmblazonAntimagic : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("ad295f68-3531-489c-baf6-913fbe738352"), Type = TextBlockType.Text, Text = $"Your deity's symbol protects against offensive magic. When you {ToMarkdownLink<Models.Entities.Feat>("Emblazon an Armament", Feats.Instances.EmblazonArmament.ID)}, you can choose from the following effects instead of the effects listed in that feat." };
            ...
            yield return new TextBlock { Id = Guid.Parse("5fa16b40-7c75-40de-8681-523223fd03d7"), Type = TextBlockType.Enumeration, Text = $" Shield: When the wielder has the shield raised, they gain the shield's circumstance bonus to saving throws against magic, and they can use {ToMarkdownLink<Models.Entities.Ability>("Shield Block", Abilities.Instances.ShieldBlock.ID)} against damage from their enemies' spells." };
        ...
        {
            builder.Add(Guid.Parse("1df6dabf-a4b1-456b-ac46-0fe903d4e788"), Traits.Instances.Cleric.ID);
