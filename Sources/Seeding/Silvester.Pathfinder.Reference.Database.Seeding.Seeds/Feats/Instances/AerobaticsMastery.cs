...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class AerobaticsMastery : Template
    {
        ...
        {
            builder.Add(Guid.Parse("5404cd8c-832b-4fd8-9af2-a50b2c5f5339"), Traits.Instances.General.ID);
            builder.Add(Guid.Parse("ef5cd357-e167-47a4-ab36-407331124f3d"), Traits.Instances.Skill.ID);
