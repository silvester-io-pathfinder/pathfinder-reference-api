...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class ScrollTricksterDedication : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("1d8cfd11-33f7-426c-a350-15e68e4ab609"), Type = TextBlockType.Text, Text = $"You've studied scrolls in depth. This might have been a comprehensive education in formal setting, or the sort of education where you somehow obtain a number of scrolls and try not to explode anything you didn't mean to explode. You gain the {ToMarkdownLink<Models.Entities.Feat>("Trick Magic Item", Feats.Instances.TrickMagicItem.ID)} feat, and you gain a +2 circumstance bonus to skill checks to {ToMarkdownLink<Models.Entities.Feat>("Trick", Feats.Instances.TrickMagicItem.ID)} scrolls. If you roll a critical failure to {ToMarkdownLink<Models.Entities.Feat>("Trick a Magic Item", Feats.Instances.TrickMagicItem.ID)} that's a scroll, you get a failure instead." };
        }
        ...
        {
            builder.Add(Guid.Parse("2a49a593-6e00-453d-94d1-82abd5e90761"), Traits.Instances.Archetype.ID);
            builder.Add(Guid.Parse("750b6cd3-378f-40d9-a86f-a36dcbd57aff"), Traits.Instances.Dedication.ID);
