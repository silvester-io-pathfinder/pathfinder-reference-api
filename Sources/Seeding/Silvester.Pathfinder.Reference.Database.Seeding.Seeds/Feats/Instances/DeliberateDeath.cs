...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class DeliberateDeath : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("30619f72-91d7-4cd2-8cc1-a527097c554d"), Type = TextBlockType.Text, Text = $"Once, you died because someone—murderer or monster, soldier or executioner— chose to strike you down. Just before losing consciousness, make a melee {ToMarkdownLink<Models.Entities.Action>("Strike", Actions.Instances.Strike.ID)} against the triggering creature." };
        }

        protected override void GetTraits(ITraitBindingBuilder<FeatTraitBinding, Feat> builder)
        {
            builder.Add(Guid.Parse("1cecbcaf-7d3a-44f4-bafa-b7c4762c97bd"), Traits.Instances.Duskwalker.ID);
