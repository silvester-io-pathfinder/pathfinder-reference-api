...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class DomainInitiate : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDetailBlocks()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("32f96044-cc98-4675-8762-bc75cb9613df"), Type = TextBlockType.Text, Text = $"Domain spells are a type of focus spell. It costs 1 Focus Point to cast a focus spell, and you start with a focus pool of 1 Focus Point. You refill your focus pool during your daily preparations, and you can regain 1 Focus Point by spending 10 minutes using the {ToMarkdownLink<Models.Entities.Activity>("Refocus", Activities.Instances.Refocus.ID)} activity to pray to your deity or do service toward their causes." };
        ...
        {
            builder.Add(Guid.Parse("fd706619-37cc-414b-9b12-a5b6eca4410d"), Traits.Instances.Cleric.ID);
