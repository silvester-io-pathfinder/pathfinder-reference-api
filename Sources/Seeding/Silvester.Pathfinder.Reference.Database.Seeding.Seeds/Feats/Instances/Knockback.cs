...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class Knockback : Template
    {
        ...
        {
            builder.Add(Guid.Parse("c44833ed-af5c-4376-8378-94cb136fd8a6"), Traits.Instances.Barbarian.ID);
            builder.Add(Guid.Parse("c1855150-f024-446f-9cae-99f1a82523d4"), Traits.Instances.Rage.ID);
