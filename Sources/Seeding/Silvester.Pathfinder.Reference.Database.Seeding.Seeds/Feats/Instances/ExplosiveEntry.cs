...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class ExplosiveEntry : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("ccc4d19b-517c-4f9c-9b28-54d4597610da"), Type = TextBlockType.Text, Text = $"You know exactly how to make a memorable entrance... by detonating a bomb to produce a devastating explosion, of course! You {ToMarkdownLink<Models.Entities.Feat>("Set Explosives", Feats.Instances.SetExplosives.ID)} on a door, window, container, or heavy gate. When the explosives detonate, you can attempt an Engineering Lore check to {ToMarkdownLink<Models.Entities.SkillAction>("Force Open", SkillActions.Instances.ForceOpen.ID)} the target. If a bomb would add an item bonus to attack rolls, add that item bonus to your Engineering Lore check. Since you're blasting your way in, you can't avoid breaking the object or structure. If you roll a critical success, you get a success instead." };
        }
        ...
        {
            builder.Add(Guid.Parse("ae68ed79-940b-43ba-b7b7-b074b9e84541"), Traits.Instances.Archetype.ID);
