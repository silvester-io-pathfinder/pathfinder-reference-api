...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class EldritchDebilitations : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("b2de8ed4-50d6-4e9c-8353-b41e1f77e9e7"), Type = TextBlockType.Text, Text = $"You know how to apply debilitations that are particularly troublesome for spellcasters. Add the following debilitations to the list you can choose from when you use {ToMarkdownLink<Models.Entities.Feat>("Debilitating Strike", Feats.Instances.DebilitatingStrike.ID)}." };
            ...
            yield return new TextBlock { Id = Guid.Parse("356d8718-eace-4237-9818-c379b87c027d"), Type = TextBlockType.Enumeration, Text = $" Debilitation: The target can't {ToMarkdownLink<Models.Entities.Action>("Step", Actions.Instances.Step.ID)}." };
        }
        ...
        {
            builder.Add(Guid.Parse("a909b68d-7af0-4e35-9eae-8bb7e8551eaa"), Traits.Instances.Rogue.ID);
