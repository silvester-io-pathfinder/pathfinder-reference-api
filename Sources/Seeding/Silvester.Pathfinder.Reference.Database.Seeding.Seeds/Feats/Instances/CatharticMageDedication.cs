...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class CatharticMageDedication : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDetailBlocks()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("4e300d62-2f0d-4fdc-95d9-d3aa72923542"), Type = TextBlockType.Text, Text = $"If you don't already cast spells from spell slots, you learn to cast spontaneous spells and gain the {ToMarkdownLink<Models.Entities.Rule>("Cast a Spell", Rules.Instances.CastASpell.ID)} activity. You gain a spell repertoire with one cantrip of your choice, from a spell list of your choice. You choose this cantrip from the common spells on your chosen spell list or from other spells to which you have access on that list. You're trained in spell attack rolls and spell DCs for that tradition. Your key spellcasting ability for these spells is Charisma." };
            ...
            yield return new TextBlock { Id = Guid.Parse("9c2af386-acd9-4ef8-bd61-7028b0a87028"), Type = TextBlockType.Text, Text = $"You gain the {ToMarkdownLink<Models.Entities.Feat>("Catharsis", Feats.Instances.Catharsis.ID)} reaction and the {ToMarkdownLink<Models.Entities.Feat>("Settle Emotions", Feats.Instances.SettleEmotions.ID)} activity" };
        }
        ...
        {
            builder.Add(Guid.Parse("9ddaf5ef-9ca8-4670-9573-493df821dc0e"), Traits.Instances.Archetype.ID);
            builder.Add(Guid.Parse("c12a8c11-30eb-42ab-98eb-43a7c9f872ff"), Traits.Instances.Dedication.ID);
