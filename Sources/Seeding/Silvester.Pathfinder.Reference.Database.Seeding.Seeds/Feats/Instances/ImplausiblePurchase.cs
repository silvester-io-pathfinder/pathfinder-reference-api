...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class ImplausiblePurchase : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("7a2edba7-043a-4d8b-973f-ff39f17f0d77"), Type = TextBlockType.Text, Text = $"Even when impossible, you always have exactly what you need. You can use {ToMarkdownLink<Models.Entities.Feat>("Prescient Planner", Feats.Instances.PrescientPlanner.ID)} even if you have already used it after purchasing goods, and you can {ToMarkdownLink<Models.Entities.Action>("Interact", Actions.Instances.Interact.ID)} to draw the item as a single action instead of a 2-action activity. In addition, five times per day, you can use {ToMarkdownLink<Models.Entities.Feat>("Prescient Planner", Feats.Instances.PrescientPlanner.ID)} to pull out a common consumable item up to 6 levels lower than your level." };
        }
