...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class MagicalResilience : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("5f01e5e6-07bc-45a6-8df4-d546ffe71af3"), Type = TextBlockType.Text, Text = $"You gain a +2 status bonus to saving throws and AC against spells. If you're 5th level or higher, you can cast {ToMarkdownLink<Models.Entities.Spell>("dispel magic", Spells.Instances.DispelMagic.ID)} once as an innate spell. The spell level is equal to 1 lower than half your level rounded up (2nd level if you're 5th or 6th level, and so on)." };
