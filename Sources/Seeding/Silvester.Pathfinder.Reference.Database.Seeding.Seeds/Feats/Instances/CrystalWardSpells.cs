...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class CrystalWardSpells : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("0f88b007-1c25-480f-b553-3405d6f31bb4"), Type = TextBlockType.Text, Text = $"Your study of crystals and the energies held within a gem's facets grants you special arcane crystal ward spells, which are a type of focus spell. It costs 1 Focus Point to cast a focus spell, and you start with a focus pool of 1 Focus Point. You refill your focus pool when you make your next daily preparations, and you can regain 1 Focus Point by spending 10 minutes using the {ToMarkdownLink<Models.Entities.Activity>("Refocus", Activities.Instances.Refocus.ID)} activity to research and memorize the properties of gems." };
            yield return new TextBlock { Id = Guid.Parse("7858e82b-bfa0-46e1-a87c-3e1e5f64e3d9"), Type = TextBlockType.Text, Text = $"Focus spells are automatically heightened to half your level rounded up. Certain feats can give you more focus spells and increase the size of your focus pool, though your focus pool can never hold more than 3 Focus Points. You gain the {ToMarkdownLink<Models.Entities.Spell>("electrified crystal ward", Spells.Instances.ElectrifiedCrystalWard.ID)} focus spell, and you are trained in arcane spell attack rolls and spell DCs. Your spellcasting ability is Intelligence." };
        }
        ...
        {
            builder.Add(Guid.Parse("7e633dcc-f6aa-4c0f-942f-32c705e11f0c"), Traits.Instances.Archetype.ID);
