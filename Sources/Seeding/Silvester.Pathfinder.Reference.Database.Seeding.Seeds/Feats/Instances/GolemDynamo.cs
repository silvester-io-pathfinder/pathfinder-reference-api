...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class GolemDynamo : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDetailBlocks()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("72a8cb0d-52b4-4d0a-ac1e-ff9e80aff6a5"), Type = TextBlockType.Text, Text = $"You've learned the secrets of Jistkan golem prostheses, allowing you to incorporate golem components into your dynamo and gain a portion of their magic. You gain a +1 status bonus to saving throws against magic, and your dynamo {ToMarkdownLink<Models.Entities.Action>("Strikes", Actions.Instances.Strike.ID)} become {ToMarkdownLink<Models.Entities.Trait>("magical", Traits.Instances.Magical.ID)}." };
        }
        ...
        {
            builder.Add(Guid.Parse("ddc862cf-f18b-4358-b72f-f06d0b693e91"), Traits.Instances.Archetype.ID);
