...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class AutomatonArmament : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("05d3f11e-f54b-42e2-aba9-2e3e937acbff"), Type = TextBlockType.Text, Text = $"You've been provided a body part designed for combat. You gain either a claw or pincer unarmed attack. The claw deals 1d4 slashing damage, is in the brawling group, and has the {ToMarkdownLink<Models.Entities.Trait>("agile", Traits.Instances.Agile.ID)}, {ToMarkdownLink<Models.Entities.Trait>("finesse", Traits.Instances.Finesse.ID)}, and {ToMarkdownLink<Models.Entities.Trait>("unarmed", Traits.Instances.Unarmed.ID)} traits. The pincer deals 1d6 piercing damage, is in the brawling group, and has the {ToMarkdownLink<Models.Entities.Trait>("grapple", Traits.Instances.Grapple.ID)} and {ToMarkdownLink<Models.Entities.Trait>("unarmed", Traits.Instances.Unarmed.ID)} traits." };
        ...
        {
            builder.Add(Guid.Parse("54e2d5c8-72b8-4120-9476-b17bc8e99117"), Traits.Instances.Automaton.ID);
