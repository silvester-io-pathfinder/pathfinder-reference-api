...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class LengthyDiversion : Template
    {
        ...
        {
            builder.Add(Guid.Parse("32eac4fc-09c6-4464-ab0e-13979f2a76b8"), Traits.Instances.General.ID);
            builder.Add(Guid.Parse("340f2033-f356-4e8a-9cde-fc345af24d02"), Traits.Instances.Skill.ID);
