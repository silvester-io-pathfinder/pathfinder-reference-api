...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class TerrifyingResistance : Template
    {
        ...
        {
            builder.Add(Guid.Parse("98bfa719-c0a8-4835-a20a-0cd1e3913b91"), Traits.Instances.General.ID);
            builder.Add(Guid.Parse("543a44a6-a99c-428f-92e1-3ea99165398c"), Traits.Instances.Skill.ID);
