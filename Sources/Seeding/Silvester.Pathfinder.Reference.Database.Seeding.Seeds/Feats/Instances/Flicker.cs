...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class Flicker : Template
    {
        ...
        {
            builder.Add(Guid.Parse("e05d728a-8163-471c-927c-988b9fac5c63"), Traits.Instances.Archetype.ID);
