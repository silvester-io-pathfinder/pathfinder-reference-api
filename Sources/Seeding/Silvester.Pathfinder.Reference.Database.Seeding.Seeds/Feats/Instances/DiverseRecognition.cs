...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class DiverseRecognition : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("0bbf8537-a814-47dc-a354-4d416f86acba"), Type = TextBlockType.Text, Text = $"Your Pathfinder training allows you to quickly size up numerous threats. Attempt to {ToMarkdownLink<Models.Entities.SkillAction>("Recall Knowledge", SkillActions.Instances.RecallKnowledge.ID)} against a different kind of creature you can see using the same skill. You must still meet the requirements to attempt this check." };
        }
        ...
        {
            builder.Add(Guid.Parse("efa8bf5d-3348-403c-b0ec-9fabfb730a8f"), Traits.Instances.Archetype.ID);
            builder.Add(Guid.Parse("4f48dce9-bba8-444b-b259-a0845e01227a"), Traits.Instances.Skill.ID);
