...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class ApexCompanion : Template
    {
        ...
        {
            builder.Add(Guid.Parse("22e3b79e-0da3-4404-8b04-f4525f6ed8e0"), Traits.Instances.Druid.ID);
