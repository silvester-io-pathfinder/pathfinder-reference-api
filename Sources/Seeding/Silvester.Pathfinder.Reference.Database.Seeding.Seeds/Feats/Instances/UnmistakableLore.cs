...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class UnmistakableLore : Template
    {
        ...
        {
            builder.Add(Guid.Parse("85923ece-16c4-4eb0-bcc9-9d22784ab882"), Traits.Instances.General.ID);
            builder.Add(Guid.Parse("2230e75b-501c-4ca1-88a8-0f5ebc434f04"), Traits.Instances.Skill.ID);
