...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class HuntPrey : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDetailBlocks()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("5a4e0b18-1abf-4e9c-8503-c2522cd01d5d"), Type = TextBlockType.Text, Text = "You gain a +2 circumstance bonus to Perception checks when you (action: Seek) your prey and a +2 circumstance bonus to Survival checks when you (action: Track) your prey. You also ignore the penalty for making ranged attacks within your second range increment against the prey you're hunting." };
