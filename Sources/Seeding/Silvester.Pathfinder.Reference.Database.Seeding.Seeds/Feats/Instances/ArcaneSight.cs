...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class ArcaneSight : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("529e4415-a4cf-4b53-829a-778d2fb8aada"), Type = TextBlockType.Text, Text = $"You've trained yourself to constantly be on the lookout for magical effects, even when focusing on looking out for other things. When you are {ToMarkdownLink<Models.Entities.Activity>("Searching", Activities.Instances.Search.ID)}, you also gain the benefits of {ToMarkdownLink<Models.Entities.Spell>("Detect Magic", Spells.Instances.DetectMagic.ID)} unless you choose not to." };
        }
        ...
        {
            builder.Add(Guid.Parse("4801355f-9ee8-455f-9485-6304ef427329"), Traits.Instances.Goloma.ID);
