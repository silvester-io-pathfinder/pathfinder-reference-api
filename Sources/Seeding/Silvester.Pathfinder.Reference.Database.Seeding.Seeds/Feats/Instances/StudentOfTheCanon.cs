...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class StudentOfTheCanon : Template
    {
        ...
        {
            builder.Add(Guid.Parse("0e39fec3-bf5d-4d49-bc3a-c25dacb25809"), Traits.Instances.General.ID);
            builder.Add(Guid.Parse("336547dd-6a09-4e10-8ac9-d5fafbebff58"), Traits.Instances.Skill.ID);
