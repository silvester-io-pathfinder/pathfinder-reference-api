...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class ManifoldEdge : Template
    {
        ...
        {
            builder.Add(Guid.Parse("7526bbe6-8ec9-4c21-89f5-f3a510c5c000"), Traits.Instances.Ranger.ID);
