...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class AgathionMagic : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("6e7f6211-2b33-4489-84f1-65f44d9c2e4e"), Type = TextBlockType.Text, Text = $"The harmonious magic of Nirvana flows through you. You can cast {ToMarkdownLink<Models.Entities.Spell>("animal form", Spells.Instances.AnimalForm.ID)} and {ToMarkdownLink<Models.Entities.Spell>("calm emotions", Spells.Instances.CalmEmotions.ID)} each once per day as 2nd-level divine innate spells." };
        }
        ...
        {
            builder.Add(Guid.Parse("24b597aa-4b01-4712-b046-fda71efd6203"), Traits.Instances.Aasimar.ID);
