...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class PeshSkin : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDetailBlocks()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("bf43fdc2-2f4b-466d-bc66-e4e089791800"), Type = TextBlockType.Text, Text = $"Increase the damage to 2d6 if the {ToMarkdownLink<Models.Entities.Trait>("polymorph", Traits.Instances.Polymorph.ID)} spell is 8th level or higher, or to 3d6 if it's 10th level." };
        ...
        {
            builder.Add(Guid.Parse("bbb41a41-6afb-46be-9e39-f2aeb4e04f39"), Traits.Instances.Druid.ID);
            builder.Add(Guid.Parse("2f04f08f-c004-496e-afda-c2c9e73dcf83"), Traits.Instances.Morph.ID);
