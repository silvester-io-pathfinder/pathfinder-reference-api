...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class RuleOfThree : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("a217647f-4466-43e1-9f6b-6300ab0c88ff"), Type = TextBlockType.Text, Text = $"You've learned that there is great value in repetition, especially in sets of three. You must be able to speak your intent to the world and call out to the subject of your {ToMarkdownLink<Models.Entities.Feat>("Esoteric Antithesis", Feats.Instances.EsotericAntithesis.ID)}, but the subject doesn't need to understand or even hear you for your Rule of Three to take effect. The benefits depend on how many times you've uttered the Rule of Three and last as long as the creature is subject to your {ToMarkdownLink<Models.Entities.Feat>("Esoteric Antithesis", Feats.Instances.EsotericAntithesis.ID)}." };
            yield return new TextBlock { Id = Guid.Parse("4e6490a7-1eb1-4271-ac42-5a3748d7f3ec"), Type = TextBlockType.Enumeration, Text = $" First Utterance: No benefit. If you've used {ToMarkdownLink<Models.Entities.Feat>("Find Flaws", Feats.Instances.FindFlaws.ID)} in the presence of the creature, that counts as the first utterance (but not if you {ToMarkdownLink<Models.Entities.Feat>("Found Flaws", Feats.Instances.FindFlaws.ID)} while {ToMarkdownLink<Models.Entities.Activity>("Investigating", Activities.Instances.Investigate.ID)} the creature)." };
        ...
        {
            builder.Add(Guid.Parse("52a1f208-d538-48ca-af10-39b03822142d"), Traits.Instances.Archetype.ID);
            builder.Add(Guid.Parse("76a9aa9a-343a-47ad-a7b4-becfacb4cb45"), Traits.Instances.Auditory.ID);
            builder.Add(Guid.Parse("15bdf381-fec9-4992-a449-989553264630"), Traits.Instances.Linguistic.ID);
            builder.Add(Guid.Parse("5c60e567-16c7-4724-b002-d72cb81ff013"), Traits.Instances.Magical.ID);
