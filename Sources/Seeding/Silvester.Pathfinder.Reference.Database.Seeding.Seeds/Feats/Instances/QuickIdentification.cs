...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class QuickIdentification : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("2d3feead-6443-4a16-adbb-9cb413ede270"), Type = TextBlockType.Text, Text = $"You can {ToMarkdownLink<Models.Entities.SkillAction>("Identify Magic", SkillActions.Instances.IdentifyMagic.ID)} swiftly. You take only 1 minute when using {ToMarkdownLink<Models.Entities.SkillAction>("Identify Magic", SkillActions.Instances.IdentifyMagic.ID)} to determine the properties of an item, ongoing effect, or location, rather than 10 minutes. If you're a master, it takes a 3-action activity, and if you're legendary, it takes 1 action." };
        }
        ...
        {
            builder.Add(Guid.Parse("6d647a74-a0f3-4a8d-bc2e-537e167ca609"), Traits.Instances.General.ID);
            builder.Add(Guid.Parse("d08dd145-48bc-4ca1-abd1-f6dcebdcf25a"), Traits.Instances.Skill.ID);
