...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class AutonomicTelepathy : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDetailBlocks()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("2c49afba-fc0f-412b-ab50-c5143f145fec"), Type = TextBlockType.Text, Text = $"In addition, when communicating via any form of telepathy, you gain a +1 circumstance bonus to Perception when attempting to {ToMarkdownLink<Models.Entities.Action>("Sense Motive", Actions.Instances.SenseMotive.ID)} or detect a {ToMarkdownLink<Models.Entities.SkillAction>("Lie", SkillActions.Instances.Lie.ID)}." };
        }
