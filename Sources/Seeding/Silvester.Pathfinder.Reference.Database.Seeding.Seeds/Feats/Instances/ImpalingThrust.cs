...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class ImpalingThrust : Template
    {
        ...
        {
            builder.Add(Guid.Parse("414ce17c-e717-47f9-b351-349811a7716b"), Traits.Instances.Barbarian.ID);
            builder.Add(Guid.Parse("ee641601-2c20-43eb-a096-57dc67c1108b"), Traits.Instances.Rage.ID);
