...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class FullAutomation : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDetailBlocks()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("c448fbd5-5d19-4389-8731-abb8e85d83ff"), Type = TextBlockType.Enumeration, Text = $" Armor: Your armor responds to the most subtle stimuli to move you in the right direction as long as you are wearing it. You can use the extra action to {ToMarkdownLink<Models.Entities.Action>("Stride", Actions.Instances.Stride.ID)}, {ToMarkdownLink<Models.Entities.Action>("Step", Actions.Instances.Step.ID)}, or use a form of movement provided by your innovation (such as {ToMarkdownLink<Models.Entities.Action>("Fly", Actions.Instances.Fly.ID)} or {ToMarkdownLink<Models.Entities.SkillAction>("Swim", SkillActions.Instances.Swim.ID)})." };
            ...
            yield return new TextBlock { Id = Guid.Parse("206475e5-cf49-4a67-800f-2cd4597d7beb"), Type = TextBlockType.Enumeration, Text = $" Weapon: Your weapon becomes easier to wield with deadly efficacy, almost as if it is an extension of your body. It speeds effortlessly toward whatever target you choose as long as you are holding it. You can use the extra action to {ToMarkdownLink<Models.Entities.Action>("Strike", Actions.Instances.Strike.ID)} with your innovation." };
        }
        ...
        {
            builder.Add(Guid.Parse("e8e5dbc1-3f0c-4b58-ab36-9cdc0f694e10"), Traits.Instances.Inventor.ID);
