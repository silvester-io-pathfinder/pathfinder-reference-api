...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class CritterShape : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("50802202-cdb0-4677-82cc-d635e8ffb36e"), Type = TextBlockType.Text, Text = $"Once per hour, you can use {ToMarkdownLink<Models.Entities.Feat>("Change Shape", Feats.Instances.ChangeShapeBeastkin.ID)} to enter a critter shape. While in critter shape, you gain the effect of a 1st-level {ToMarkdownLink<Models.Entities.Spell>("pest form", Spells.Instances.PestForm.ID)}, except you can only transform into an animal matching your inherent animal. You can remain in critter shape for up to 10 minutes, after which you transform back into your hybrid shape and can't enter your critter shape again for 1 hour." };
        ...
        {
            builder.Add(Guid.Parse("01387677-7031-45f3-ab65-53178c7c0aeb"), Traits.Instances.Beastkin.ID);
