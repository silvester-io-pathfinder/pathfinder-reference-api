...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class LegendaryPerformer : Template
    {
        ...
        {
            builder.Add(Guid.Parse("0db0a91e-a281-4469-b398-f5904e2cc2e9"), Traits.Instances.General.ID);
            builder.Add(Guid.Parse("f61b69fb-1904-4f70-8450-8537b9b54d5c"), Traits.Instances.Skill.ID);
