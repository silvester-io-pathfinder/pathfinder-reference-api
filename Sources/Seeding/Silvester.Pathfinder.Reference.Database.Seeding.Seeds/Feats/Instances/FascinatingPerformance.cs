...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class FascinatingPerformance : Template
    {
        ...
        {
            builder.Add(Guid.Parse("f6576c83-4749-4d41-a1a4-959007849859"), Traits.Instances.General.ID);
            builder.Add(Guid.Parse("439f766d-957c-432d-b7c6-6a6293b31fe4"), Traits.Instances.Skill.ID);
