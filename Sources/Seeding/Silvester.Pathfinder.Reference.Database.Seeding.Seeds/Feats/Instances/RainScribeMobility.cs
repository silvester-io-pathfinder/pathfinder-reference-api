...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class RainScribeMobility : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("25f70b63-c7bf-4f44-a017-8fb79764ab9c"), Type = TextBlockType.Text, Text = $"You surround yourself in a mantle of Rain-Scribe magic and {ToMarkdownLink<Models.Entities.Action>("Stride", Actions.Instances.Stride.ID)} twice; difficult terrain does not reduce your Speed, even if the difficult terrain has been manipulated by magic. Your magic clears the difficult terrain in each square you entered; until your next turn, those squares aren't difficult terrain for any creature walking through them (or are normal difficult terrain if they were previously greater difficult terrain)." };
        }
        ...
        {
            builder.Add(Guid.Parse("64e17339-283b-430f-b6df-8f44c71698d2"), Traits.Instances.Archetype.ID);
