...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class DiabolicCertitude : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("ea6aeefc-361d-4565-89f7-2c4e7707beb3"), Type = TextBlockType.Text, Text = $"Your Hellknight training drilled details of Hell's denizens deep into your mind. Make an attempt to {ToMarkdownLink<Models.Entities.SkillAction>("Recall Knowledge", SkillActions.Instances.RecallKnowledge.ID)} about a devil you're observing. If you roll a critical failure on this check, you get a failure instead." };
        }
        ...
        {
            builder.Add(Guid.Parse("2ba5971d-4a12-42a0-a43e-1a5f2999818e"), Traits.Instances.Archetype.ID);
            builder.Add(Guid.Parse("f5eb3d27-49d7-45c5-ab0a-920050379afc"), Traits.Instances.Skill.ID);
