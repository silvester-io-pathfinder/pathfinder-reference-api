...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class Unseat : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("0ffe861a-0fbe-48ab-9132-b8fca4ead8ef"), Type = TextBlockType.Text, Text = $"You attempt to knock an opponent off their mount. Make a melee {ToMarkdownLink<Models.Entities.Action>("Strike", Actions.Instances.Strike.ID)} against a mounted opponent. If your attack hits, attempt an Athletics check against the opponent's Fortitude DC. If you succeed, the foe is knocked off its mount into a space of its choice adjacent to its mount. If you critically succeed, it lands prone." };
        }
        ...
        {
            builder.Add(Guid.Parse("19cc6281-941a-4f39-9421-0e0c38843ba2"), Traits.Instances.Archetype.ID);
