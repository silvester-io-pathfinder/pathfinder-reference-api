...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class PilgrimsToken : Template
    {
        ...
        {
            builder.Add(Guid.Parse("8eaaec70-867c-4952-812e-c8c4fda0cdc2"), Traits.Instances.General.ID);
            builder.Add(Guid.Parse("5ec84dba-4b08-4b51-ac45-b069da4272f7"), Traits.Instances.Skill.ID);
