...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class CloudStep : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("8f7e362b-8a30-406d-9ddd-84f3e1e2ac07"), Type = TextBlockType.Text, Text = $"Using fantastic acrobatic skill, you can walk for brief stretches across insubstantial surfaces. When you {ToMarkdownLink<Models.Entities.Action>("Stride", Actions.Instances.Stride.ID)}, you can move across water, air, and solid surfaces that can hold only limited weight as if they were normal ground. If you {ToMarkdownLink<Models.Entities.Action>("Stride", Actions.Instances.Stride.ID)} over a trap with a weight-sensitive pressure plate, you don't trigger it. At the end of your turn, you sink, fall, break fragile surfaces, or trigger traps as normal for your current location." };
        }
        ...
        {
            builder.Add(Guid.Parse("bd077da1-c250-482a-a579-eca77d50a1e9"), Traits.Instances.Rogue.ID);
