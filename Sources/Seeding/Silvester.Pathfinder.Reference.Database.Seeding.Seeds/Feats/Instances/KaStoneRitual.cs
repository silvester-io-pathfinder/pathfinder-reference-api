...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class KaStoneRitual : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDetailBlocks()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("5df06281-739c-4142-ba8f-eb3adf6b4f12"), Type = TextBlockType.Text, Text = $"The ka stone grants you a +1 item bonus to saves against {ToMarkdownLink<Models.Entities.Trait>("death", Traits.Instances.Death.ID)} effects and {ToMarkdownLink<Models.Entities.Trait>("negative", Traits.Instances.Negative.ID)} effects, which increases to +2 at 8th level, +3 at 14th level, and +4 at 20th level." };
            yield return new TextBlock { Id = Guid.Parse("9a371570-b694-4a39-9028-e8aacdd8b63d"), Type = TextBlockType.Text, Text = $"~ Activate: TWO-ACTIONS (envision), or a different activation if otherwise specified; **Frequency** a number of times each day equal to the number of class feats you have from the Living Monolith archetype; **Effect** You cast {ToMarkdownLink<Models.Entities.Spell>("enlarge", Spells.Instances.Enlarge.ID)} on yourself or use one of the other activated abilities granted by a later Living Monolith feat." };
        }
        ...
        {
            builder.Add(Guid.Parse("cc24a192-13e6-4e0f-ac4a-96877e3dafe5"), Traits.Instances.Archetype.ID);
