...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class GAWayOfTheVanguard : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDetailBlocks()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("2bb9f7ac-63fa-460a-a5a1-b7e3583d4fa5"), Type = TextBlockType.Text, Text = $"~ Slinger's Reload: {ToMarkdownLink<Models.Entities.Feat>("Clear a Path", Feats.Instances.ClearAPath.ID)}" };
            yield return new TextBlock { Id = Guid.Parse("432ff57f-c6d2-4159-a305-af9bba056978"), Type = TextBlockType.Text, Text = $"~ Deeds: __Initial__ {ToMarkdownLink<Models.Entities.Feat>("Living Fortification", Feats.Instances.LivingFortification.ID)}; __Advanced__ {ToMarkdownLink<Models.Entities.Feat>("Spinning Crush", Feats.Instances.SpinningCrush.ID)}; __Greater__ {ToMarkdownLink<Models.Entities.Feat>("Siegebreaker", Feats.Instances.Siegebreaker.ID)}" };
