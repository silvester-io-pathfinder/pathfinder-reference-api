...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class TasteBlood : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDetailBlocks()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("a1f4e772-520b-47b2-98aa-dbd979224276"), Type = TextBlockType.Text, Text = $"To drink a creature's blood, either your last action must have been a fangs {ToMarkdownLink<Models.Entities.Action>("Strike", Actions.Instances.Strike.ID)} that damaged the target, or the target must be restrained or unconscious and your last action must have been a {ToMarkdownLink<Models.Entities.Action>("Strike", Actions.Instances.Strike.ID)} that dealt piercing or slashing damage to them. If the target is willing, they don't need to be restrained or unconscious for the latter." };
            yield return new TextBlock { Id = Guid.Parse("10327330-655a-498b-ac75-174050853e85"), Type = TextBlockType.Text, Text = $"Draining the life force from an unwilling humanoid creature is a greater violation than just drinking their blood. Taste Blood has the {ToMarkdownLink<Models.Entities.Trait>("evil", Traits.Instances.Evil.ID)} trait unless the target is willing or is an active foe in combat." };
        }
