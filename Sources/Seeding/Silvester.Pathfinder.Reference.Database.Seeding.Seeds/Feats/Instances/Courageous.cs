...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class Courageous : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("a6f20111-db42-4481-b292-64f67bfdcda3"), Type = TextBlockType.Text, Text = $"You bellow a ferocious call to arms, inspiring yourself to lash out at a foe. Make a melee {ToMarkdownLink<Models.Entities.Action>("Strike", Actions.Instances.Strike.ID)} against the triggering creature. If the attack is a critical hit and the trigger was a manipulate action, the action is disrupted." };
        }
