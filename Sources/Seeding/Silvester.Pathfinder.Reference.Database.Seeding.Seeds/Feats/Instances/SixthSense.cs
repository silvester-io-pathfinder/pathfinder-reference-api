...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class SixthSense : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("13926e22-95f6-41bf-a99c-6b8b44ab4fa5"), Type = TextBlockType.Text, Text = $"You can detect the lingering thoughts of spirits and similar entities with your psychic abilities. While you're exploring but not {ToMarkdownLink<Models.Entities.Activity>("Searching", Activities.Instances.Search.ID)}, the GM rolls a secret check for you to find haunts that usually require {ToMarkdownLink<Models.Entities.Activity>("Searching", Activities.Instances.Search.ID)} as well as spirits, creatures on the Ethereal Plane, and beings made entirely of spiritual essence, such as celestials, fiends, and monitors." };
            yield return new TextBlock { Id = Guid.Parse("45a48281-ae1d-44a9-817d-0ff1fa3466cb"), Type = TextBlockType.Text, Text = $"You can also potentially notice ethereal creatures and spirits inside solid objects, provided they're within 30 feet of you. This applies while {ToMarkdownLink<Models.Entities.Activity>("Searching", Activities.Instances.Search.ID)}, while {ToMarkdownLink<Models.Entities.Action>("Seeking", Actions.Instances.Seek.ID)}, and on the automatic secret check from Sixth Sense. You can still notice spirits only on a successful check, and you can't see them if they're more than 5 feet inside an object." };
