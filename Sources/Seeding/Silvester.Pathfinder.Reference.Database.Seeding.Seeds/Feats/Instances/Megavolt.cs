...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class Megavolt : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDetailBlocks()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("6f13cf0b-134b-43cf-baf1-c53c565706f8"), Type = TextBlockType.Text, Text = $"~ Unstable Function: You overload and supercharge the voltage even higher. Add the {ToMarkdownLink<Models.Entities.Trait>("unstable", Traits.Instances.Unstable.ID)} trait to Megavolt. The area increases to a 60-foot line and the damage increases from d4s to d12s." };
        ...
        {
            builder.Add(Guid.Parse("526d56df-cb6b-43d6-a390-1841c6b67b47"), Traits.Instances.Electricity.ID);
            builder.Add(Guid.Parse("882f8ab2-57e7-4501-9da0-c87041bc3f81"), Traits.Instances.Inventor.ID);
            builder.Add(Guid.Parse("b3e9c86f-da39-41d8-adc0-dd27854f6d45"), Traits.Instances.Manipulate.ID);
