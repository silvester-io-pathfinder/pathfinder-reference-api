...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class MegatonStrike : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDetailBlocks()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("3cb8111e-d6ff-47ff-ab9c-80d765d60e8e"), Type = TextBlockType.Enumeration, Text = " Construct: Your minion innovation (action: Strikes | Strike)." };
            yield return new TextBlock { Id = Guid.Parse("33233921-7227-4405-b1c2-b020f82615b0"), Type = TextBlockType.Enumeration, Text = " Weapon: You (action: Strike) with your weapon innovation." };
            yield return new TextBlock { Id = Guid.Parse("8d2ac919-142a-495a-a621-77266351c479"), Type = TextBlockType.Text, Text = "----" };
            yield return new TextBlock { Id = Guid.Parse("1fbd9251-9e3e-4d1a-bdb7-a8ad262ce140"), Type = TextBlockType.Text, Text = "~ Unstable Function: You put even more force into the (action: Strike), though you risk stress fractures to your innovation. Add the (trait: unstable) trait to Megaton Strike. The (action: Strike) deals another extra damage die, for a total of two extra dice at 4th level, three at 10th level, and four at 18th level." };
        }
