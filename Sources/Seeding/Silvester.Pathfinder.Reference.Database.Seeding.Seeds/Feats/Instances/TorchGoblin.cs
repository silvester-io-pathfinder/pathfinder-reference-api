...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class TorchGoblin : Template
    {
        ...
        {
            builder.Add(Guid.Parse("cf74f7ca-9af6-4127-a9e7-c9246cfb6202"), Traits.Instances.Goblin.ID);
