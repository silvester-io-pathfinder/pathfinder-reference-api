...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class Forager : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("1745f830-564a-4efc-bb10-1561aa9a9723"), Type = TextBlockType.Text, Text = $"While using Survival to {ToMarkdownLink<Models.Entities.SkillAction>("Subsist", SkillActions.Instances.Subsist.ID)}, if you roll any result worse than a success, you get a success. On a success, you can provide subsistence living for yourself and four additional creatures, and on a critical success, you can take care of twice as many creatures as on a success." };
        ...
        {
            builder.Add(Guid.Parse("8ccc4e7e-661e-4b8e-ac69-1d9a32105b83"), Traits.Instances.General.ID);
            builder.Add(Guid.Parse("89eb169d-1cf1-4216-b46e-0ed6ca0fce0f"), Traits.Instances.Skill.ID);
