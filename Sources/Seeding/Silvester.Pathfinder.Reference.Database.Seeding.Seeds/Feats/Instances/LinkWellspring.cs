...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class LinkWellspring : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("61e79e14-0c37-4208-9504-0ce55ca79032"), Type = TextBlockType.Text, Text = $"Your bond replenishes your focus. If you have spent at least 3 Focus Points since the last time you {ToMarkdownLink<Models.Entities.Activity>("Refocused", Activities.Instances.Refocus.ID)}, you recover 3 Focus Points when you {ToMarkdownLink<Models.Entities.Activity>("Refocus", Activities.Instances.Refocus.ID)} instead of 1." };
        }
        ...
        {
            builder.Add(Guid.Parse("6b989fa0-b56a-46a6-8ae5-6e57db549664"), Traits.Instances.Summoner.ID);
