...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class RubyResurrestion : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("4af6b483-a778-434a-9cda-2dc97c385732"), Type = TextBlockType.Text, Text = $"In a burst of flame, you return to health like a phoenix rising from the ashes. Change your current Hit Points to 30 and cast a 6th-level {ToMarkdownLink<Models.Entities.Spell>("fireball", Spells.Instances.Fireball.ID)} centered on yourself. This fireball doesn't affect you. Your hair turns brilliant red for 1 hour." };
