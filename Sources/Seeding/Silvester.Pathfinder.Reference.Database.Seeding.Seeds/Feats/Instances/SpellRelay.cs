...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class SpellRelay : Template
    {
        ...
        {
            builder.Add(Guid.Parse("2c09f4ec-ab53-4596-a64b-0d2cdc8ff49d"), Traits.Instances.Concentrate.ID);
            builder.Add(Guid.Parse("7eff43fa-983d-4d7c-9588-5ecc2f51bc6d"), Traits.Instances.Sorcerer.ID);
