...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.ClassFeatures.Wizards
{
    public class InitialProficiencies : Template
    {
        ...
        protected override void GetEffects(BooleanEffectBuilder builder)
        {
            ...
            //Attacks
            builder.GainSpecificMeleeWeaponProficiency(Guid.Parse("a236e6db-64cc-45c8-b42f-841a9fc39dea"), Proficiencies.Instances.Trained.ID, Items.MeleeWeapons.Instances.Club.ID);
            builder.GainSpecificRangedWeaponProficiency(Guid.Parse("5e951a01-cc06-4fc1-a230-0b97982eeb29"), Proficiencies.Instances.Trained.ID, Items.RangedWeapons.Instances.Crossbow.ID);
            builder.GainSpecificMeleeWeaponProficiency(Guid.Parse("8ba0a861-aae7-4b8b-a4e8-08f720767f71"), Proficiencies.Instances.Trained.ID, Items.MeleeWeapons.Instances.Dagger.ID);
            builder.GainSpecificRangedWeaponProficiency(Guid.Parse("08a2a446-3fd8-4fa2-a0e6-fd31af4da4bf"), Proficiencies.Instances.Trained.ID, Items.RangedWeapons.Instances.HeavyCrossbow.ID);
            builder.GainSpecificMeleeWeaponProficiency(Guid.Parse("fc6bdf6c-4edc-4ba0-9493-2f88f176f4bb"), Proficiencies.Instances.Trained.ID, Items.MeleeWeapons.Instances.Staff.ID);
