...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.ClassFeatures.Rogues
{
    public class WeaponTricks : Template
    {
        ...
        protected override void GetEffects(BooleanEffectBuilder builder)
        {
            ...
            builder.GainSpecificMeleeWeaponProficiency(Guid.Parse("b9b305f2-e0b6-4ba9-8fad-c75bd351042e"), Proficiencies.Instances.Expert.ID, Items.MeleeWeapons.Instances.Rapier.ID);
            builder.GainSpecificMeleeWeaponProficiency(Guid.Parse("71e8b73f-3f74-46ed-bb87-68e989338305"), Proficiencies.Instances.Expert.ID, Items.MeleeWeapons.Instances.Sap.ID);
            builder.GainSpecificMeleeWeaponProficiency(Guid.Parse("efd519a5-0ca3-4f48-abb9-3021597b6785"), Proficiencies.Instances.Expert.ID, Items.MeleeWeapons.Instances.Shortsword.ID);
            builder.GainSpecificRangedWeaponProficiency(Guid.Parse("5fabdbf8-3b2d-46ba-b8e2-9336f2c870f2"), Proficiencies.Instances.Expert.ID, Items.RangedWeapons.Instances.Shortbow.ID);
