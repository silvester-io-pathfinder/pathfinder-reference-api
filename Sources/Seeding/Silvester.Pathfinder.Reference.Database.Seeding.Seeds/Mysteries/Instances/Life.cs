...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Mysteries.Instances
{
    public class Life : Template
    {
        ...
        protected override void GetEffects(BooleanEffectBuilder builder)
        {
            ...
            //Trained Skill
            builder.GainSpecificSkillProficiency(Guid.Parse("1e5e3d2c-0d9f-434d-91c9-dd23b731efaa"), Proficiencies.Instances.Trained.ID, Skills.Instances.Medicine.ID);

            //Granted Cantrip
            builder.GainSpecificSpell(Guid.Parse("1109c795-f8ea-4eac-ad96-3845fa7727f5"), Spells.Instances.Stabilize.ID);

            //Initial Revelation Spell
            builder.GainSpecificSpell(Guid.Parse("81ed4ea9-404f-4089-abae-ea363eb73da3"), Spells.Instances.LifeLink.ID);

            //Advanced Revelation Spell
            builder.GainSpecificSpell(Guid.Parse("689b36f5-fa5c-4d62-9745-ce8fba29c4a3"), Spells.Instances.DelayAffliction.ID)
                .AddPrerequisites(Guid.Parse("9ccc736c-4d7d-4837-9056-2aeac8881248"), prerequisites =>
                {
                    prerequisites.HaveSpecificFeat(Guid.Parse("91891196-4f43-4246-8f42-1c4a84a1a9c9"), Feats.Instances.AdvancedRevelation.ID);
                });

            //Greater Revelation Spell
            builder.GainSpecificSpell(Guid.Parse("753f62eb-20ef-4b7a-9b35-4c9e47f91ba9"), Spells.Instances.LifeGivingForm.ID)
                .AddPrerequisites(Guid.Parse("35323680-1b1f-415e-8071-253805bfa9c8"), prerequisites =>
                {
                    prerequisites.HaveSpecificFeat(Guid.Parse("087631e2-91a9-4f22-af2c-068538ad1d68"), Feats.Instances.GreaterRevelation.ID);
                });
        }
