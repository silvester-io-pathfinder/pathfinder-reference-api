...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Mysteries.Instances
{
    public class Flames : Template
    {
        ...
        {
            //Mystery Benefits
            builder.GainSpecificSavingThrowProficiency(Guid.Parse("a47c3a91-e97f-4ed8-912a-7f0e01827d9e"), Proficiencies.Instances.Expert.ID, SavingThrowStats.Instances.Reflex.ID);
            builder.AddAnd(Guid.Parse("05505f66-1965-4b30-88f9-4c6766f713b9"), and =>
            {
                and.AddPrerequisites(Guid.Parse("b713e3a1-f8da-406f-be95-730e35ff8863"), prerequisites =>
                {
                    prerequisites.HaveSpecificLevel(Guid.Parse("0f735f40-cf8a-4d00-ac37-c8e26894c32e"), Comparator.GreaterThanOrEqualTo, requiredLevel: 13);
                });
                and.GainSpecificSavingThrowProficiency(Guid.Parse("4ecc89cb-b836-4032-80de-eceae59d785c"), Proficiencies.Instances.Master.ID, SavingThrowStats.Instances.Reflex.ID);
                and.ImproveSpecificSavingThrow(Guid.Parse("9606dfec-914e-42ec-b1a9-e3779029e7bd"), SavingThrowStats.Instances.Reflex.ID, RollResult.Success, becomes: RollResult.CriticalSuccess);
            });

            //Trained Skill
            builder.GainSpecificSkillProficiency(Guid.Parse("31e9d104-19f2-4154-874b-2edb8d69d2cb"), Proficiencies.Instances.Trained.ID, Skills.Instances.Acrobatics.ID);

            //Granted Cantrip
            builder.GainSpecificSpell(Guid.Parse("d5f401e6-bf23-4ee2-9c23-60468bff8c93"), Spells.Instances.ProduceFlame.ID);

            //Initial Revelation Spell
            builder.GainSpecificSpell(Guid.Parse("4741a0cb-129b-47a1-a685-51459329fe5e"), Spells.Instances.IncendiaryAura.ID);

            //Advanced Revelation Spell
            builder.GainSpecificSpell(Guid.Parse("16f48a47-4941-40a2-bd18-e220797afa02"), Spells.Instances.WhirlingFlames.ID)
                .AddPrerequisites(Guid.Parse("5b0e79ec-0044-46c1-84f2-ec561969ef00"), prerequisites =>
                {
                    prerequisites.HaveSpecificFeat(Guid.Parse("cbc97a9c-5763-4006-a6dc-e9b0e8dad5be"), Feats.Instances.AdvancedRevelation.ID);
                });

            //Greater Revelation Spell
            builder.GainSpecificSpell(Guid.Parse("cd4ed300-0e51-452e-892e-267edfc142ad"), Spells.Instances.FlamingFusillade.ID)
                .AddPrerequisites(Guid.Parse("638fafa7-32e2-41a9-9497-a95022360e57"), prerequisites =>
                {
                    prerequisites.HaveSpecificFeat(Guid.Parse("4a9098f6-8441-4d62-ba63-bde5b0488a8a"), Feats.Instances.GreaterRevelation.ID);
                });
        }
