...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Mysteries.Instances
{
    public class Ancestors : Template
    {
        ...
        {
            //Mystery Benefits
            builder.GainAnyAncestryFeat(Guid.Parse("d66d631c-8703-4505-ad31-e9c5f48dcb7c")); //TODO: Add restriction on physiological effects, such as addtional senses or unarmed attacks.
            builder.GainAnyAncestryFeat(Guid.Parse("6469677b-d4a5-4a4b-b455-52ba80c5d7e8"))
                .AddPrerequisites(Guid.Parse("2152240b-df45-444f-9257-d0fc9fe6e019"), prerequisites => 
                {
                    prerequisites.HaveSpecificLevel(Guid.Parse("56a021b9-6a37-4135-a008-9fc94e0818e2"), Comparator.GreaterThanOrEqualTo, requiredLevel: 11);
                });

            //Trained Skill
            builder.GainSpecificSkillProficiency(Guid.Parse("305c026c-8b18-4227-844a-f0037ae087e9"), Proficiencies.Instances.Trained.ID, Skills.Instances.Society.ID);
            
            //Granted Cantrip
            builder.GainSpecificSpell(Guid.Parse("96acbd46-ff17-4854-b784-0f7ef01830da"), Spells.Instances.Guidance.ID);
            
            //Initial Revelation Spell
            builder.GainSpecificSpell(Guid.Parse("f46ab361-5e73-421b-9435-143d6de55d70"), Spells.Instances.AncestralTouch.ID);

            //Advanced Revelation Spell
            builder.GainSpecificSpell(Guid.Parse("6984ea88-2586-4e18-9dd8-c272f39643aa"), Spells.Instances.AncestralDefense.ID)
                .AddPrerequisites(Guid.Parse("588522a1-cd9e-4d1d-a0a6-b620502eb2cc"), prerequisites =>
                {
                    prerequisites.HaveSpecificFeat(Guid.Parse("e2ada115-d70c-4bc7-ab96-b59c71a1a2dd"), Feats.Instances.AdvancedRevelation.ID);
                });

            //Greater Revelation Spell
            builder.GainSpecificSpell(Guid.Parse("09f32c1b-4ab3-4b1f-9856-bf7550973f25"), Spells.Instances.AncestralForm.ID)
                .AddPrerequisites(Guid.Parse("f67592ac-cbeb-4f92-90ba-4e81b638135e"), prerequisites =>
                {
                    prerequisites.HaveSpecificFeat(Guid.Parse("6005fa0c-879c-465b-8307-a12a10adb305"), Feats.Instances.GreaterRevelation.ID);
                });
        }
