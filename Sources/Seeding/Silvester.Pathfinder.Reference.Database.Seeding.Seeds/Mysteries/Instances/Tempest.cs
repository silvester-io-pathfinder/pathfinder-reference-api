...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Mysteries.Instances
{
    public class Tempest : Template
    {
        ...
        protected override void GetEffects(BooleanEffectBuilder builder)
        {
            ...
            //Trained Skill
            builder.GainSpecificSkillProficiency(Guid.Parse("bbe79dd5-ea6c-4261-906d-630856c165fa"), Proficiencies.Instances.Trained.ID, Skills.Instances.Nature.ID);

            //Granted Cantrip
            builder.GainSpecificSpell(Guid.Parse("2b239072-56b0-4ad5-b6e7-e1cdcb160a50"), Spells.Instances.ElectricArc.ID);

            //Initial Revelation Spell
            builder.GainSpecificSpell(Guid.Parse("cdadf4f3-22d8-4a51-9233-5e2cf454f250"), Spells.Instances.TempestTouch.ID);

            //Advanced Revelation Spell
            builder.GainSpecificSpell(Guid.Parse("4ed24e6b-bcd3-4ea6-926f-7c9ce83e58e3"), Spells.Instances.Thunderburst.ID)
                .AddPrerequisites(Guid.Parse("8f7be18b-b82d-4d18-aa45-86964f4fe271"), prerequisites =>
                {
                    prerequisites.HaveSpecificFeat(Guid.Parse("35592655-5ed6-42e9-a8b5-5f756ec6a09a"), Feats.Instances.AdvancedRevelation.ID);
                });

            //Greater Revelation Spell
            builder.GainSpecificSpell(Guid.Parse("ab95ac32-d284-4062-bdac-10cbc1aed313"), Spells.Instances.TempestForm.ID)
                .AddPrerequisites(Guid.Parse("8b5c688e-acdc-4385-be48-a1d8f97c216a"), prerequisites =>
                {
                    prerequisites.HaveSpecificFeat(Guid.Parse("22423667-3d66-451c-b367-710761895861"), Feats.Instances.GreaterRevelation.ID);
                });
        }
