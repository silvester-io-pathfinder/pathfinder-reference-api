...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Innovations.Instances
{
    public class Armor : Template
    {
        ...
        protected override void GetEffects(BooleanEffectBuilder builder)
        {
            ...
            {
                or.GainSpecificArmor(Guid.Parse("0320f580-23ca-4a56-8ccb-494c8d106c68"), Items.Armors.Instances.PowerSuit.ID);
                or.GainSpecificArmor(Guid.Parse("909e7896-20a8-43f2-ac48-906b137ce10b"), Items.Armors.Instances.SubterfugeSuit.ID);
            });
