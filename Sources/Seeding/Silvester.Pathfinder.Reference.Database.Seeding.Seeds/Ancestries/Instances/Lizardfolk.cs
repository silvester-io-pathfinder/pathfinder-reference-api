...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Ancestries.Instances
{
    public class Lizardfolk : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("1f0e9a6f-d046-4b84-afaa-751e6e76f012"), Type = TextBlockType.Heading, Text = "Droon" };
            yield return new TextBlock { Id = Guid.Parse("d2d83e04-4ce6-4b82-842b-236d169b1407"), Type = TextBlockType.Text, Text = "Long before the birth of Azlant, iruxi realms girdled Golarion. Today, only one nation recalls the splendor of that bygone era: Droon, a vast empire on the coast of southern Garund. Here, lizardfolk rule astride dinosaurs. Iruxi nobles settle feuds via ceratosaur duels. Sauropod caravan trains haul goods across seemingly impossible distances. Wizards breed spell-laced rhamphorhynchus familiars, and no thief worth their salt pulls a job without a whistling velociraptor lookout." };

            yield return new TextBlock { Id = Guid.Parse("caa986ae-75ca-4e48-8164-071b5a8f90e4"), Type = TextBlockType.Heading, Text = "Iruxi" };
            yield return new TextBlock { Id = Guid.Parse("d01c39b4-b165-4584-96ae-74be6bfecbb6"), Type = TextBlockType.Text, Text = "While most lizardfolk permit humans and others to refer to them by that moniker, they call themselves iruxi. This ancient word arose from the Draconic tongue, though its exact etymology is unclear. In Droon, iruxi astronomers point to the jagged constellation of the Maw and the starry figure who stands against it. Today, while this constellation is called the Lone Mother and features in fables about environmental conservation, she once had another name in dragon lore: Erux, meaning “defiance.”" };

            yield return new TextBlock { Id = Guid.Parse("21804191-fe82-45e9-be9b-6a347568a00e"), Type = TextBlockType.Heading, Text = "Iruxi Ancestors" };
            yield return new TextBlock { Id = Guid.Parse("1e495dcb-e95c-4d60-982c-3a7ddd5035a7"), Type = TextBlockType.Text, Text = "Ancestor worship is central to iruxi spiritual life. Lizardfolk keep their elders' physical remains close, incorporating them into the architecture of their settlements. The bones of deceased iruxi shore up protective walls and fill great vaulting ossuaries. Preserved and suffused with ritual veneration, these bones become magical reservoirs of power. It's rumored that in times of great need, iruxi ancestors will reanimate their bones and fight for their descendants." };
        }

        protected override IEnumerable<TextBlock> GetAdditionalMechanics()
        {
            yield return new TextBlock { Id = Guid.Parse("93e2340f-3fbd-4331-9715-8bb430f0aa9f"), Type = TextBlockType.Heading, Text = "Aquatic Adaptation" };
            yield return new TextBlock { Id = Guid.Parse("98e84676-fc21-4681-97c9-4483f2e25a29"), Type = TextBlockType.Text, Text = "Your reptilian biology allows you to hold your breath for a long time. You gain the Breath Control general feat as a bonus feat." };

            yield return new TextBlock { Id = Guid.Parse("7cec3702-2027-400d-9c65-5484c793faae"), Type = TextBlockType.Heading, Text = "Claws" };
            yield return new TextBlock { Id = Guid.Parse("885b4bcb-4a59-481d-b042-403d8a25eeb5"), Type = TextBlockType.Text, Text = "Your sharp claws offer an alternative to the fists other humanoids bring to a fight. You have a claw unarmed attack that deals 1d4 slashing damage and has the agile and finesse traits." };
        }
        ...
        protected override void GetEffects(BooleanEffectBuilder builder)
        {
            ...
            builder.GainSpecificFeat(Guid.Parse("73528fdb-ca66-4b48-be11-643c0ffb6ddd"), Feats.Instances.AquaticAdaptation.ID);
            builder.GainSpecificUnarmedAttack(Guid.Parse("f97ea79a-cd05-42fb-b4bd-34b66b4b5764"), UnarmedWeapons.Instances.Claws.ID, WeaponGroups.Instances.Brawling.ID, DamageTypes.Instances.Slashing.ID, damage: "1d4");
        }
