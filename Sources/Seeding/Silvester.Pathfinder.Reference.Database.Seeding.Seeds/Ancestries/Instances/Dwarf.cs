...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Ancestries.Instances
{
    public class Dwarf : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("61558349-580c-49d0-80f6-42a98adcec97"), Type = TextBlockType.Heading, Text = "Clan Dagger" };
            yield return new TextBlock { Id = Guid.Parse("294005f6-c5ba-4f8b-9b2b-26e76b8d96b3"), Type = TextBlockType.Text, Text = "You get one clan dagger of your clan for free, as it was given to you at birth. Selling this dagger is a terrible taboo and earns you the disdain of other dwarves." };
        }
        ...
        protected override void GetEffects(BooleanEffectBuilder builder)
        {
            ...
            builder.GainSpecificSense(Guid.Parse("603bea7d-fd96-4dd6-a815-37fe453179b3"), Senses.Instances.Darkvision.ID, SenseAccuracies.Instances.Precise.ID);
            builder.GainSpecificMeleeWeapon(Guid.Parse("0c6129d7-512b-4d82-a8b0-9a293e326668"), Items.MeleeWeapons.Instances.ClanDagger.ID);
        }
