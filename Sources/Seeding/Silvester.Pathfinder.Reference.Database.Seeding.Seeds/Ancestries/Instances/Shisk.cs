...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Ancestries.Instances
{
    public class Shisk : Template
    {
        ...
        protected override void GetEffects(BooleanEffectBuilder builder)
        {
            ...
            builder.GainSpecificSense(Guid.Parse("508c559e-a184-4341-a3ff-1c7952a21b12"), Senses.Instances.Darkvision.ID, SenseAccuracies.Instances.Precise.ID);
        }
