...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Ancestries.Instances
{
    public class Anadi : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDescription()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("f9b67d6f-947b-4227-b692-92978cfa7c43"), Type = TextBlockType.Text, Text = "Early efforts with their new approach to diplomacy have yielded much better results, though sporadic contact means that some outsiders whisper false legends about anadi, such as claims that they are humans who transform into monstrous spiders at moonrise. Even contemporary explorers have reported anadi as human-spider hybrids. The anadi people of the current day strive to slowly but surely create a world where they no longer need to hide their true nature." };
        }
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("22a3d3e4-e79c-4d0d-81e1-d7d784c953a2"), Type = TextBlockType.Heading, Text = "Fangs" };
            yield return new TextBlock { Id = Guid.Parse("7c1015bf-46f4-40d5-b96a-e580c95d9daa"), Type = TextBlockType.Text, Text = "You were born with a natural means for hunting and self-defense. You gain a fangs unarmed attack that deals 1d6 piercing damage. Your fangs are in the brawling group and have the finesse and unarmed traits." };
        }
        ...
        protected override void GetEffects(BooleanEffectBuilder builder)
        {
            ...
            builder.GainSpecificFeat(Guid.Parse("a5a2ecd0-d9ba-4497-86dd-58e504ace5d2"), Feats.Instances.ChangeShapeAnadi.ID);
            builder.GainSpecificUnarmedAttack(Guid.Parse("d66384e3-2cf5-4ffc-b033-bbf9c4d5b947"), UnarmedWeapons.Instances.Fangs.ID, WeaponGroups.Instances.Brawling.ID, DamageTypes.Instances.Piercing.ID, damage: "1d6");
