...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Ancestries.Instances
{
    public class Automaton : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDescription()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("62fffb5b-97dd-4013-a022-2d075d8f7600"), Type = TextBlockType.Text, Text = "If you want to play a character who is a living construct with powerful potential and ties to ancient magic, you should play an automaton." };
        }
        ...
        protected override void GetEffects(BooleanEffectBuilder builder)
        {
            ...
            builder.GainSpecificSense(Guid.Parse("ae69a0f4-2575-42bc-b86b-dddeb3d10b48"), Senses.Instances.LowLightVision.ID, SenseAccuracies.Instances.Precise.ID);
