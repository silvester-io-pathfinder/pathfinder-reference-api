...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Ancestries.Instances
{
    public class Human : Template
    {
        ...
        protected override void GetEffects(BooleanEffectBuilder builder)
        {
            ...
            builder.GainAnyAbilityBoost(Guid.Parse("7e294e86-8f91-490a-8569-a4bc07243e67"));
            builder.GainAnyAbilityBoost(Guid.Parse("7bcfed93-8a24-4f81-801f-8b31f1684d4c"));
