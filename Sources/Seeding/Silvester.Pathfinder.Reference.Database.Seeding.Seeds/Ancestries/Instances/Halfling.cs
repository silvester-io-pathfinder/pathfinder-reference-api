...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Ancestries.Instances
{
    public class Halfling : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDescription()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("34c04492-a969-4966-948d-0732f5678026"), Type = TextBlockType.Text, Text = "If you want to play a character who must contend with these opposing drives toward adventure and comfort, you should play a halfling." };
        }
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("37111e9c-c07a-4adb-a9fa-ea6b2b16957d"), Type = TextBlockType.Heading, Text = "Keen Eyes" };
            yield return new TextBlock { Id = Guid.Parse("3415d5c5-ba29-482b-ac8f-777831bfd360"), Type = TextBlockType.Text, Text = "Your eyes are sharp, allowing you to make out small details about concealed or even invisible creatures that others might miss. You gain a +2 circumstance bonus when using the Seek action to find hidden or undetected creatures within 30 feet of you. When you target an opponent that is concealed from you or hidden from you, reduce the DC of the flat check to 3 for a concealed target or 9 for a hidden one." };
        }
