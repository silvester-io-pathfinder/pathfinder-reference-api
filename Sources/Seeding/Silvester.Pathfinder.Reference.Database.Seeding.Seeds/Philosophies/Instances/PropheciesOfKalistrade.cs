...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Philosophies.Instances
{
    ...
    {
        public static readonly Guid ID = Guid.Parse("7baaf8d2-7dfa-4490-857f-915dc39b1fa0");
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("ed472b0b-5f7b-45e4-adbb-0ae11bdc137d"), Type = TextBlockType.Text, Text = "The secular prophecies of Kalistrade are famously centered on a single principle: amassing personal wealth both in search of and as evidence of personal enlightenment. The prophets of Kalistrade, often referred to as Kalistocrats, believe that achieving purity of body, mind, and spirit will lead to financial success, and thus they avoid certain foods and eschew contact with most persons and objects as impure. To avoid contamination and contact with nonbelievers they wear long, white gloves, and they wear distinctive, all-white clothing to represent their purity�often incorporating their symbol, a circle inside a triangle that is itself inscribed in a larger circle." };
        }
        ...
        protected override SourcePage GetSourcePage()
        {
            ...
            {
                Id = Guid.Parse("83f4ff2f-dc2a-4632-b181-57b74597db82"),
