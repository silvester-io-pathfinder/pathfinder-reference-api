...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Deities.Instances
{
    ...
    {
        public static readonly Guid ID = Guid.Parse("f81ee461-5dee-4cf7-a596-a6887a65e67b");
        ...
        protected override IEnumerable<Guid> GetFavoredMeleeWeapons()
        {
            ...
            yield return Items.MeleeWeapons.Instances.Falchion.ID;
        }
        ...
        protected override DivineIntercession? GetDivineIntercession()
        {
            ...
            {
                Id = Guid.Parse("73203309-6ed6-4b6e-a16b-0b976ce6dfbc"),
                ...
                {
                    Id = Guid.Parse("de17f696-40da-4118-8b7b-bf2f6c0bcaa0"),
        ...
        protected override SourcePage GetSourcePage() 
        {
            ...
            {
                Id = Guid.Parse("b1b50f1c-8b28-4517-b960-d064e02447b0"),
