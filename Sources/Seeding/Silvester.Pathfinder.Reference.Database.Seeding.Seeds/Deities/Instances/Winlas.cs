...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Deities.Instances
{
    ...
    {
        public static readonly Guid ID = Guid.Parse("6f56603c-ddfc-4fa0-b9e0-e07c527e549e");
        ...
        {
            builder.GainSpecificSpell(Guid.Parse("38f52d12-abb7-4a0f-ad6b-e6b1d3f6f2c7"), Spells.Instances.ShareLore.ID);
            builder.GainSpecificSpell(Guid.Parse("e0d8c765-4ac3-4d2a-a77e-26c051cbf490"), Spells.Instances.ComprehendLanguage.ID);
            builder.GainSpecificSpell(Guid.Parse("3a954748-73fd-493d-899d-3f9c900caf6d"), Spells.Instances.Veil.ID);
        }
        ...
        protected override SourcePage GetSourcePage() 
        {
            ...
            {
                Id = Guid.Parse("b4470095-a6d3-44a5-8036-c50875862f27"),
