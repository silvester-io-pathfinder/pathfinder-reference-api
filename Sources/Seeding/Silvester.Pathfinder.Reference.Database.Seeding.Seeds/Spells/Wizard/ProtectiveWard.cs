...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class ProtectiveWard : Template
    {
        ...
        {
            builder.Add(Guid.Parse("4c9fbd07-2ef5-43df-b6f0-f51853c4a8d4"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("e102c361-b396-4a61-b274-52537b2cb4ba"), Traits.Instances.Abjuration.ID);
            builder.Add(Guid.Parse("717acbbd-9de1-4d77-b1bf-93eee8b1b9ef"), Traits.Instances.Wizard.ID);
        }
