...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class WarpedTerrain : Template
    {
        ...
        {
            builder.Add(Guid.Parse("2c59e46b-84f1-4272-b76a-6c61836bb047"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("d1b2c0ab-f905-4159-9985-b2bad5b3b8e5"), Traits.Instances.Illusion.ID);
            builder.Add(Guid.Parse("fa83cfd9-fd77-4f0e-a099-2edeb76fc2ca"), Traits.Instances.Visual.ID);
            builder.Add(Guid.Parse("40315dcb-e1dd-4405-aa13-880b93887e35"), Traits.Instances.Wizard.ID);
        }
