...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class LitanyAgainstSloth : Template
    {
        ...
        {
            builder.Add(Guid.Parse("d17961e2-3234-4653-b741-d41ff025bfca"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("1ea39818-0b4a-4753-bde1-6e65a5f91dbd"), Traits.Instances.Champion.ID);
            builder.Add(Guid.Parse("7f953b4e-9e08-47a8-ab78-477b3c3f7b78"), Traits.Instances.Evocation.ID);
            builder.Add(Guid.Parse("e25c7394-c124-499a-83fd-e8396f775c79"), Traits.Instances.Good.ID);
            builder.Add(Guid.Parse("08401962-bc29-4ba8-8fd8-d435cc991ac3"), Traits.Instances.Litany.ID);
        }
