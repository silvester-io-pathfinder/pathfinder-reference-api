...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class TouchOfCorruption : Template
    {
        ...
        {
            builder.Add(Guid.Parse("069b6834-ee78-4d0d-9127-e69f08dd7ece"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("9ea466d7-368b-447b-a725-17905ed4958b"), Traits.Instances.Champion.ID);
            builder.Add(Guid.Parse("93cf6dac-ee20-4c66-9c8a-a11f5c6ebe69"), Traits.Instances.Necromancy.ID);
            builder.Add(Guid.Parse("7d9fbf0b-35aa-445d-8403-ab976c3ff6a7"), Traits.Instances.Negative.ID);
        }
