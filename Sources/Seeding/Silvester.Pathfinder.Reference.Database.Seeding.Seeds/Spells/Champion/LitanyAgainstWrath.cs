...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class LitanyAgainstWrath : Template
    {
        ...
        {
            builder.Add(Guid.Parse("e63afa4b-37c1-4540-94d7-c35ca32a07f2"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("23cea6fa-68cb-4857-a563-50fd96fe45b9"), Traits.Instances.Champion.ID);
            builder.Add(Guid.Parse("1f30c4e2-0632-4d1a-8287-e917ee32c695"), Traits.Instances.Evocation.ID);
            builder.Add(Guid.Parse("dc9b06a8-8eb5-401f-bd87-06686e071da6"), Traits.Instances.Good.ID);
            builder.Add(Guid.Parse("03585199-a3f6-48a3-9752-3e70c87340e0"), Traits.Instances.Litany.ID);
        }
