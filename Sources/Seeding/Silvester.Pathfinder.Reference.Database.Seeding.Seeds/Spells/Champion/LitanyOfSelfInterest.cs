...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class LitanyOfSelfInterest : Template
    {
        ...
        {
            builder.Add(Guid.Parse("1ca38818-f358-42c7-9783-ce976d02b0a3"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("02234e59-522a-467b-929b-2150bcdabae9"), Traits.Instances.Champion.ID);
            builder.Add(Guid.Parse("6c46f2b2-e239-4ee7-ace8-18529e29ad32"), Traits.Instances.Enchantment.ID);
            builder.Add(Guid.Parse("f5342c17-ebd1-4097-933d-324feaa1d0fd"), Traits.Instances.Evil.ID);
            builder.Add(Guid.Parse("8842fecb-bb31-4038-b035-65fe2c60b791"), Traits.Instances.Litany.ID);
            builder.Add(Guid.Parse("d7601579-c6d2-4430-b49a-63ffe41462b5"), Traits.Instances.Mental.ID);
        }
