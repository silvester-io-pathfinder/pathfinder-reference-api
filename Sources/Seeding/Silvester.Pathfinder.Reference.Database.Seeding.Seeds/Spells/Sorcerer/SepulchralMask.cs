...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class SepulchralMask : Template
    {
        ...
        {
            builder.Add(Guid.Parse("bce2797c-70fe-4f95-a705-33a5d38afee5"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("edbaf70a-81c3-4afe-8e36-09f164d32788"), Traits.Instances.Divination.ID);
            builder.Add(Guid.Parse("c90a447b-5671-4f86-bc63-7784ef9f32fb"), Traits.Instances.Emotion.ID);
            builder.Add(Guid.Parse("950825b8-698f-40df-b6ce-921a6e224f55"), Traits.Instances.Mental.ID);
            builder.Add(Guid.Parse("3795cb76-2497-4073-a57d-8622588dea42"), Traits.Instances.Sorcerer.ID);
            builder.Add(Guid.Parse("87ae8f96-4651-4f96-b0ba-06a9e4391b76"), Traits.Instances.Visual.ID);
        }
