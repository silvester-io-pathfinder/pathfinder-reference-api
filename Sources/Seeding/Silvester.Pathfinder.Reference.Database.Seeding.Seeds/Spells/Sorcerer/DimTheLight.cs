...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class DimTheLight : Template
    {
        ...
        {
            builder.Add(Guid.Parse("37d74cd2-5f50-4381-b664-9e5aec11e69e"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("51e3c214-6983-45e0-bfd8-7c9731da5265"), Traits.Instances.Darkness.ID);
            builder.Add(Guid.Parse("12029e6c-d3a2-484e-aa7b-ac4760c5bd87"), Traits.Instances.Evocation.ID);
            builder.Add(Guid.Parse("e7ffbc0a-7a57-4c7b-b7cc-f2b7955522ea"), Traits.Instances.Sorcerer.ID);
        }
