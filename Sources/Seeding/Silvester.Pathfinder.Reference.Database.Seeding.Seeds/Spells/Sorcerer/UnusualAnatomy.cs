...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class UnusualAnatomy : Template
    {
        ...
        {
            builder.Add(Guid.Parse("07f1a2f1-f5a2-447d-a035-7066b80a44f0"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("6271f8ce-3357-4f96-83d2-0eb07b9c5d6c"), Traits.Instances.Polymorph.ID);
            builder.Add(Guid.Parse("2beb0fc7-ad2a-489f-9690-7c0b7ad03262"), Traits.Instances.Sorcerer.ID);
            builder.Add(Guid.Parse("27fcba91-29cb-4db1-b179-5016be8fef8e"), Traits.Instances.Transmutation.ID);
        }
