...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class AncestralMemories : Template
    {
        ...
        {
            builder.Add(Guid.Parse("0f70fe2b-8438-4163-8347-203d8325f03b"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("1651246a-8f2a-4bc1-9185-342789ff4787"), Traits.Instances.Divination.ID);
            builder.Add(Guid.Parse("478f840c-bc0c-4cd0-bd33-2cb9a17b409c"), Traits.Instances.Sorcerer.ID);
        }
