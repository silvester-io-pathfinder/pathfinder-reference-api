...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class ElementalMotion : Template
    {
        ...
        {
            builder.Add(Guid.Parse("362b2284-f431-44a5-bd6c-62c1c8ea2a1a"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("cac98b78-706c-4672-8738-80c350cc19b5"), Traits.Instances.Evocation.ID);
            builder.Add(Guid.Parse("d76ac905-e548-4690-be4c-a2a637aa1c66"), Traits.Instances.Sorcerer.ID);
        }
