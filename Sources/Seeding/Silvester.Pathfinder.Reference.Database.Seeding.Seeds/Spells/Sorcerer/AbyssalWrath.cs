...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class AbyssalWrath : Template
    {
        ...
        {
            builder.Add(Guid.Parse("4177fb9d-4334-4a82-925a-ce0546827237"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("a9412b1d-6f34-4327-b46a-451d1fae7d4b"), Traits.Instances.Evocation.ID);
            builder.Add(Guid.Parse("c4318a7c-0887-49e3-be5d-d214746f120c"), Traits.Instances.Sorcerer.ID);
        }
