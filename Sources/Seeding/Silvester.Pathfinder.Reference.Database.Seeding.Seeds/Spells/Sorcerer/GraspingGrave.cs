...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class GraspingGrave : Template
    {
        ...
        {
            builder.Add(Guid.Parse("bdabb84b-04b1-4202-9e36-19e96f738e55"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("344c0bb2-3bd3-4215-82d3-315611e32117"), Traits.Instances.Necromancy.ID);
            builder.Add(Guid.Parse("abdde79e-4774-41d0-a763-823072f93d1d"), Traits.Instances.Sorcerer.ID);
        }
