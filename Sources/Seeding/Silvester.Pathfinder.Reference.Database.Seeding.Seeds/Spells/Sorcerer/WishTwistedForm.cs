...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class WishTwistedForm : Template
    {
        ...
        {
            builder.Add(Guid.Parse("bd915787-977a-43fa-812c-e0cec444e621"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("d63cedf1-cd07-4cbc-a85f-81da17c61de4"), Traits.Instances.Sorcerer.ID);
            builder.Add(Guid.Parse("48093b5f-b529-48e7-9041-681ac94279e5"), Traits.Instances.Transmutation.ID);
        }
