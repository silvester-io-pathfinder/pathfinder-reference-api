...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class FaerieDust : Template
    {
        ...
        {
            builder.Add(Guid.Parse("addee89e-4a3f-4df8-b662-1a763d5a09e9"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("7218248b-2049-46ba-aed4-95ed9e2cc916"), Traits.Instances.Enchantment.ID);
            builder.Add(Guid.Parse("dff3091e-fd03-435f-8342-5c0a8b2b79cb"), Traits.Instances.Mental.ID);
            builder.Add(Guid.Parse("b1b554cc-71cb-4b59-8de0-7feec312ca32"), Traits.Instances.Sorcerer.ID);
        }
