...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class UndeathsBlessing : Template
    {
        ...
        {
            builder.Add(Guid.Parse("7d506f0d-5b04-4950-aeec-54b1fb46c11e"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("6c6a2ad7-48b6-41ef-8efa-a0e9f795cf3e"), Traits.Instances.Necromancy.ID);
            builder.Add(Guid.Parse("7ad67661-6fb1-4b44-a6b9-417d11d7954a"), Traits.Instances.Negative.ID);
            builder.Add(Guid.Parse("40d98f19-79c8-42b1-b918-79401dcefa17"), Traits.Instances.Sorcerer.ID);
        }
