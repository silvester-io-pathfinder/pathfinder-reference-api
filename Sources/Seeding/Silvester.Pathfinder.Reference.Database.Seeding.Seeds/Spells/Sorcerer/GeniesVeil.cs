...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class GeniesVeil : Template
    {
        ...
        {
            builder.Add(Guid.Parse("080028b0-2fce-4625-af42-8868e8da4db9"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("b2698f60-197b-41f0-a543-418ba8e4f6be"), Traits.Instances.Abjuration.ID);
            builder.Add(Guid.Parse("c8cfefb8-b45e-4cd3-90fe-a42533471062"), Traits.Instances.Sorcerer.ID);
        }
