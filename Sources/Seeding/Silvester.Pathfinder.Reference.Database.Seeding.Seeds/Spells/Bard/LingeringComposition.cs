...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class LingeringComposition : Template
    {
        ...
        {
            builder.Add(Guid.Parse("65583c50-e2aa-4bda-9d49-467d343ba505"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("e9733516-0afd-47f3-acd3-77651a2f9653"), Traits.Instances.Bard.ID);
            builder.Add(Guid.Parse("4565907d-b6e0-44e2-802b-80f620b3c2be"), Traits.Instances.Enchantment.ID);
        }
