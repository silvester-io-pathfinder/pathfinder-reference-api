...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class SplashOfArt : Template
    {
        ...
        {
            builder.Add(Guid.Parse("6f7772e9-3bbe-4529-b37f-43aceeee27f0"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("0a389d15-67c3-40d5-83ff-8e61d2661149"), Traits.Instances.Cleric.ID);
            builder.Add(Guid.Parse("c0ca67d2-7950-401e-a1b6-3819c892b3ac"), Traits.Instances.Illusion.ID);
            builder.Add(Guid.Parse("ccc39922-06e2-4536-8e68-760201cd1a7c"), Traits.Instances.Visual.ID);
        }
