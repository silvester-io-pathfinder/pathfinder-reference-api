...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class ScholarlyRecollection : Template
    {
        ...
        {
            builder.Add(Guid.Parse("20cee5fe-3cec-4982-b638-7f33776dbf59"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("be28a7e2-0859-40cc-9124-0755a6c8340d"), Traits.Instances.Cleric.ID);
            builder.Add(Guid.Parse("4ca968da-b6e3-44f4-b172-8de746344723"), Traits.Instances.Divination.ID);
            builder.Add(Guid.Parse("02eccf5f-d953-413a-be2b-cad91ecfbf08"), Traits.Instances.Fortune.ID);
        }
