...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class WeaponSurge : Template
    {
        ...
        {
            builder.Add(Guid.Parse("f8573b07-fb21-4280-ae29-f0d2180a4c37"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("cd106c92-9489-45f6-9957-17e11bb09df3"), Traits.Instances.Cleric.ID);
            builder.Add(Guid.Parse("dde64823-ae98-4153-845d-f24986249690"), Traits.Instances.Evocation.ID);
        }
