...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class Overstuff : Template
    {
        ...
        {
            builder.Add(Guid.Parse("8e42620e-18e7-4113-84ba-e9ef6172d912"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("cbc35ff3-e99a-4d1e-b1d7-3adc63008281"), Traits.Instances.Cleric.ID);
            builder.Add(Guid.Parse("68e0d8b1-9f58-4884-a625-2e7809afa507"), Traits.Instances.Transmutation.ID);
        }
