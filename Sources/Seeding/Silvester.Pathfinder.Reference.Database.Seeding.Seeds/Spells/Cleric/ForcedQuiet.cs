...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class ForcedQuiet : Template
    {
        ...
        {
            builder.Add(Guid.Parse("a656188c-7c83-4203-9ed0-d48986f7fcdf"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("be993aa3-6eb8-44b7-a5ff-3963408349f4"), Traits.Instances.Abjuration.ID);
            builder.Add(Guid.Parse("6aef752f-4a89-4890-a331-e3753dbf6d7e"), Traits.Instances.Cleric.ID);
        }
