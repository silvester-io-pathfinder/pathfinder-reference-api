...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class ArtisticFlourish : Template
    {
        ...
        {
            builder.Add(Guid.Parse("681f0dba-1ece-4881-9265-a9a3d88ca103"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("c727487f-670d-417e-b1ca-a4f9f1ae582e"), Traits.Instances.Cleric.ID);
            builder.Add(Guid.Parse("9b96001c-f2d7-49cd-b474-868c016e6fe6"), Traits.Instances.Transmutation.ID);
        }
