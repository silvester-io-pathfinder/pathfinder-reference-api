...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class TouchOfUndeath : Template
    {
        ...
        {
            builder.Add(Guid.Parse("c658dc37-18f4-4f20-bba2-473634d41c04"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("ae388319-d445-481b-8620-cffb32589884"), Traits.Instances.Cleric.ID);
            builder.Add(Guid.Parse("20cf75b1-8dbf-4db2-b8fc-04677be78e73"), Traits.Instances.Necromancy.ID);
            builder.Add(Guid.Parse("287f8cb8-6411-4faf-b047-d954fe7d522d"), Traits.Instances.Negative.ID);
        }
