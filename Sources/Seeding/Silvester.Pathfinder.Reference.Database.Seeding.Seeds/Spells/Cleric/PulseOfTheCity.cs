...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class PulseOfTheCity : Template
    {
        ...
        {
            builder.Add(Guid.Parse("3949a301-d5db-4186-8462-6a5e7ebde028"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("c2526743-bb39-439d-be26-3b705bf25d98"), Traits.Instances.Cleric.ID);
            builder.Add(Guid.Parse("c269b8ed-30f0-40dd-a353-42fceb6fb7bb"), Traits.Instances.Divination.ID);
            builder.Add(Guid.Parse("b622d242-d914-40a0-b1bc-89535c80764f"), Traits.Instances.Scrying.ID);
        }
