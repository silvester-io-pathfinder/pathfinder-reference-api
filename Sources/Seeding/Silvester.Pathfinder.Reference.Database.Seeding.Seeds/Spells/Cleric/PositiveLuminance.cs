...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class PositiveLuminance : Template
    {
        ...
        {
            builder.Add(Guid.Parse("36ac19e9-bc45-43da-b5dd-2543057803a7"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("198eff5b-08cb-43b2-88eb-bfedd254f024"), Traits.Instances.Cleric.ID);
            builder.Add(Guid.Parse("5ac8aed5-d2e9-4dd4-a30d-741cc175a3c9"), Traits.Instances.Light.ID);
            builder.Add(Guid.Parse("eb32f486-7d5f-4899-9a0e-b622fba1dda6"), Traits.Instances.Necromancy.ID);
            builder.Add(Guid.Parse("a109256a-0030-49f2-9286-498935fe6a71"), Traits.Instances.Positive.ID);
        }
