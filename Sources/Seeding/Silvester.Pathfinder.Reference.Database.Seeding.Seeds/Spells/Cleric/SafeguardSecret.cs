...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class SafeguardSecret : Template
    {
        ...
        {
            builder.Add(Guid.Parse("e56175d1-1c5f-4f2c-bbe9-45febf73461a"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("631b8f8d-6e13-43a8-84cb-8dec680990e0"), Traits.Instances.Abjuration.ID);
            builder.Add(Guid.Parse("38b1f1c6-a74b-428a-b544-ce97da3a8d60"), Traits.Instances.Cleric.ID);
            builder.Add(Guid.Parse("efde69f3-4c51-4ddd-88c3-e0304b2fd5a1"), Traits.Instances.Mental.ID);
        }
