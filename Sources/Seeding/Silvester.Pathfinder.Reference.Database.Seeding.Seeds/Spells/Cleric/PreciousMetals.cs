...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class PreciousMetals : Template
    {
        ...
        {
            builder.Add(Guid.Parse("266207cd-2503-4a4e-ad3b-9591b0aee034"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("cf4d8d19-eccc-4e08-92d9-ddd72d830346"), Traits.Instances.Cleric.ID);
            builder.Add(Guid.Parse("ae97302a-2c55-48dc-9430-a22e2fd8dafb"), Traits.Instances.Transmutation.ID);
        }
