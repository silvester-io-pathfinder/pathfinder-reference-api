...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class WordOfTruth : Template
    {
        ...
        {
            builder.Add(Guid.Parse("bb2d6e95-a6be-489f-8712-a0f40528ba31"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("18125bb3-cadf-477b-9991-40c02023dba7"), Traits.Instances.Cleric.ID);
            builder.Add(Guid.Parse("697fd541-b5d5-4fe5-b725-d3f8aa856fb7"), Traits.Instances.Divination.ID);
        }
