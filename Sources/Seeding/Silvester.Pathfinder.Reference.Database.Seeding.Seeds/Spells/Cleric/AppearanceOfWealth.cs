...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class AppearanceOfWealth : Template
    {
        ...
        {
            builder.Add(Guid.Parse("865756b5-e46a-4cff-8e59-641e5eec8189"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("2c6c127f-bb84-4761-98ee-d1862faa5c0d"), Traits.Instances.Cleric.ID);
            builder.Add(Guid.Parse("988494d0-38db-4d52-9b20-58c9f46196fd"), Traits.Instances.Illusion.ID);
        }
