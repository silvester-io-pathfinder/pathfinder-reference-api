...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class LocalizedQuake : Template
    {
        ...
        {
            builder.Add(Guid.Parse("1951f9b5-c7da-4ced-a83f-fbace7874caa"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("04f3ef2d-5de9-4f18-81db-e8a4cd931f4d"), Traits.Instances.Cleric.ID);
            builder.Add(Guid.Parse("9c478c7c-eaab-4594-92c6-4c56de1eaca1"), Traits.Instances.Earth.ID);
            builder.Add(Guid.Parse("d9254744-7540-447b-90a0-177503dbc6e7"), Traits.Instances.Transmutation.ID);
        }
