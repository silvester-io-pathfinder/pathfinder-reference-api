...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class TouchOfTheMoon : Template
    {
        ...
        {
            builder.Add(Guid.Parse("cb6ecd6d-8d89-4ba0-acc3-fe6fffc3cd92"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("9d63a6a5-e3b5-43d0-b4d0-e74d91a9e4e7"), Traits.Instances.Cleric.ID);
            builder.Add(Guid.Parse("d80afa87-422d-4f0e-9775-e1579f2ed62a"), Traits.Instances.Enchantment.ID);
        }
