...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class CascadeCountermeasure : Template
    {
        ...
        {
            builder.Add(Guid.Parse("df76e1fe-ebca-48f3-b71e-61ae098c5f91"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("1ef9199f-bca6-4a58-943b-ae0750b1b3fe"), Traits.Instances.Abjuration.ID);
            builder.Add(Guid.Parse("489b2793-dcb7-449d-adf8-540cdd222cce"), Traits.Instances.Magus.ID);
        }
