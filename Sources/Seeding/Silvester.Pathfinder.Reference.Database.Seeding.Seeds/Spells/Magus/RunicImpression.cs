...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class RunicImpression : Template
    {
        ...
        {
            builder.Add(Guid.Parse("fba5a1fb-feff-4df5-a782-d3a71cd13f49"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("72cae6fd-36f9-4069-99b6-9bd777205f4a"), Traits.Instances.Evocation.ID);
            builder.Add(Guid.Parse("c1f20917-bfd2-4e25-b506-316321dd67cd"), Traits.Instances.Magus.ID);
        }
