...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class Darklight : Template
    {
        ...
        {
            builder.Add(Guid.Parse("6081c86f-d9cf-402e-a099-fdde9738a1ae"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("dde2159d-46e7-4b6c-9a6d-f8230fccbc65"), Traits.Instances.Darkness.ID);
            builder.Add(Guid.Parse("fd052f26-a504-4b5a-bf57-c5a0aecb0577"), Traits.Instances.Evocation.ID);
            builder.Add(Guid.Parse("80db256b-5d47-4f62-909b-078fd1ab8406"), Traits.Instances.Shadow.ID);
        }
