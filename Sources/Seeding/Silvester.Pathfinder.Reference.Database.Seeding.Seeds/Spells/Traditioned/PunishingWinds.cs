...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class PunishingWinds : Template
    {
        ...
        {
            builder.Add(Guid.Parse("ee3765aa-6cad-4a3a-908b-aa1b795cd072"), Traits.Instances.Air.ID);
            builder.Add(Guid.Parse("519677d6-8d27-434d-b3dd-4206e34e3a6d"), Traits.Instances.Evocation.ID);
        }
