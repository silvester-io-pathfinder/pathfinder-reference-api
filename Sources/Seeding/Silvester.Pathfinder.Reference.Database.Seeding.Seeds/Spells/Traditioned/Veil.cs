...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class Veil : Template
    {
        ...
        {
            builder.Add(Guid.Parse("416eb07b-cb0e-4313-a737-63fa01318b16"), Traits.Instances.Illusion.ID);
            builder.Add(Guid.Parse("e8f4c102-e832-4cee-bc82-9b03279b5645"), Traits.Instances.Visual.ID);
        }
