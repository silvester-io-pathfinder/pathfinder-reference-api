...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class SpiritSong : Template
    {
        ...
        {
            builder.Add(Guid.Parse("cd5de264-0284-4728-b0c0-6ecfec749494"), Traits.Instances.Force.ID);
            builder.Add(Guid.Parse("544e7cf1-85a5-43ac-af9c-8417aa45f910"), Traits.Instances.Necromancy.ID);
        }
