...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class ObscuringMist : Template
    {
        ...
        {
            builder.Add(Guid.Parse("b6506198-2d55-455c-8775-f58c7a94309b"), Traits.Instances.Water.ID);
            builder.Add(Guid.Parse("6e265b5b-f76a-4c40-961a-7247d3ca9273"), Traits.Instances.Conjuration.ID);
        }
