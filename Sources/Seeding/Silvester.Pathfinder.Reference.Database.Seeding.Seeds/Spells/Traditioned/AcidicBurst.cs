...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class AcidicBurst : Template
    {
        ...
        {
            builder.Add(Guid.Parse("1bc74ae6-7e0a-463b-bb1a-3242eb95896d"), Traits.Instances.Acid.ID);
            builder.Add(Guid.Parse("cf5d97e9-b50b-46d8-ac48-e14debbee5e9"), Traits.Instances.Evocation.ID);
        }
