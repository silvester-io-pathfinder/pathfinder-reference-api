...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class UnrelentingObservation : Template
    {
        ...
        {
            builder.Add(Guid.Parse("db84969d-eaca-4941-bb49-b773a040057b"), Traits.Instances.Divination.ID);
            builder.Add(Guid.Parse("802e9444-2974-404b-b260-bc9414a7821d"), Traits.Instances.Scrying.ID);
        }
