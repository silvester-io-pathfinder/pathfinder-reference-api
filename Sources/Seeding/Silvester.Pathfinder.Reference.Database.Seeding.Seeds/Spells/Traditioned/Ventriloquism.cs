...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class Ventriloquism : Template
    {
        ...
        {
            builder.Add(Guid.Parse("9fc0cb08-272a-4cfc-81c6-bad93371b027"), Traits.Instances.Auditory.ID);
            builder.Add(Guid.Parse("41e76c74-012b-4222-9e9b-230ade4c9ed8"), Traits.Instances.Illusion.ID);
        }
