...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class WeaponOfJudgement : Template
    {
        ...
        {
            builder.Add(Guid.Parse("2cbfe000-6486-4dab-934c-404746004b06"), Traits.Instances.Evocation.ID);
            builder.Add(Guid.Parse("c053619c-d7c0-4496-9f99-9f94b34671ad"), Traits.Instances.Force.ID);
        }
