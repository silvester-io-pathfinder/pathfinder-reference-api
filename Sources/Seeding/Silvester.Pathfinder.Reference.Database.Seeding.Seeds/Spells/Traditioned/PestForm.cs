...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class PestForm : Template
    {
        ...
        {
            builder.Add(Guid.Parse("2223110f-e1a5-41f4-96b5-8525a1e11429"), Traits.Instances.Polymorph.ID);
            builder.Add(Guid.Parse("3676cd1d-9db4-43af-8842-a14b42b9eb4c"), Traits.Instances.Transmutation.ID);
        }
