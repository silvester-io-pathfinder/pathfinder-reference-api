...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class TreeStride : Template
    {
        ...
        {
            builder.Add(Guid.Parse("c13f25ea-10d7-4058-af2a-3dc9f9d6c89a"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("02fba293-2edf-49b3-9095-7eb53ad0736a"), Traits.Instances.Conjuration.ID);
            builder.Add(Guid.Parse("bb7ee066-cbe8-41be-9431-e86b3c35479b"), Traits.Instances.Plant.ID);
            builder.Add(Guid.Parse("a8f05a10-25af-43a5-9711-c2ffb923825a"), Traits.Instances.Teleportation.ID);
        }
