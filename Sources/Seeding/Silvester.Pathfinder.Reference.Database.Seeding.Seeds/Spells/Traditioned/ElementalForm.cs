...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class ElementalForm : Template
    {
        ...
        {
            builder.Add(Guid.Parse("b4b63b30-6e77-4ab9-9fe9-3a1bf7495423"), Traits.Instances.Polymorph.ID);
            builder.Add(Guid.Parse("21586c28-dde7-4075-bdef-07e41c0c106f"), Traits.Instances.Transmutation.ID);
        }
