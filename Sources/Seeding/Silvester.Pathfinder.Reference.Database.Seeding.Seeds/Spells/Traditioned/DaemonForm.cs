...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class DaemonForm : Template
    {
        ...
        {
            builder.Add(Guid.Parse("acbf0657-4d42-4b50-95e9-289c9d67dbf5"), Traits.Instances.Evil.ID);
            builder.Add(Guid.Parse("96ea4653-4a63-465a-a2ee-2f87ed3dcece"), Traits.Instances.Polymorph.ID);
            builder.Add(Guid.Parse("1837e0e5-231d-4579-9475-cd8ba4167a05"), Traits.Instances.Transmutation.ID);
        }
