...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class RighteousMight : Template
    {
        ...
        {
            builder.Add(Guid.Parse("846d5676-e727-4e2e-b8b1-4b19aecc3bec"), Traits.Instances.Polymorph.ID);
            builder.Add(Guid.Parse("5ef4c014-a88e-4bd0-9ccf-8e259f15f889"), Traits.Instances.Transmutation.ID);
        }
