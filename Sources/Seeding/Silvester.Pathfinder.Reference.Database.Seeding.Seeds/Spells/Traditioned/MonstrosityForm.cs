...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class MonstrosityForm : Template
    {
        ...
        {
            builder.Add(Guid.Parse("44c20573-8c22-44aa-bbe8-0415a2128c2c"), Traits.Instances.Polymorph.ID);
            builder.Add(Guid.Parse("750b8975-35a6-4b39-99be-d2edb0854a13"), Traits.Instances.Transmutation.ID);
        }
