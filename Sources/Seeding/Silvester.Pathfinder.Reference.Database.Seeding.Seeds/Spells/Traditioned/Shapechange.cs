...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class Shapechange : Template
    {
        ...
        {
            builder.Add(Guid.Parse("e5d66954-50aa-4452-afe3-fe5104fdcc6f"), Traits.Instances.Polymorph.ID);
            builder.Add(Guid.Parse("c35e12c1-1253-4f40-91e0-6cbc527adfa0"), Traits.Instances.Transmutation.ID);
        }
