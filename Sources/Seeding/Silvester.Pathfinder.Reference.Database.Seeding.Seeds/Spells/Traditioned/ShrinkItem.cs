...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class ShrinkItem : Template
    {
        ...
        {
            builder.Add(Guid.Parse("dfc9e6d6-78fe-4fa0-9998-c1ab95977789"), Traits.Instances.Polymorph.ID);
            builder.Add(Guid.Parse("c207703c-1b98-454f-b167-c50860514a5a"), Traits.Instances.Transmutation.ID);
        }
