...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class PrismaticSphere : Template
    {
        ...
        {
            builder.Add(Guid.Parse("e96b05da-f9d8-4b97-b39f-f45b4f07a626"), Traits.Instances.Abjuration.ID);
            builder.Add(Guid.Parse("93bd28e7-344f-4d29-95dd-3372d9456be8"), Traits.Instances.Light.ID);
        }
