...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class Jump : Template
    {
        ...
        {
            builder.Add(Guid.Parse("2feabdec-697e-4a53-b32b-e971ec4a3a0f"), Traits.Instances.Move.ID);
            builder.Add(Guid.Parse("9cbee4a6-e144-42f7-ae4f-eb375600d6f7"), Traits.Instances.Transmutation.ID);
        }
