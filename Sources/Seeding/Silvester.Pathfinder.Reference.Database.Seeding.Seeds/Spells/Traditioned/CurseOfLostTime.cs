...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class CurseOfLostTime : Template
    {
        ...
        {
            builder.Add(Guid.Parse("574f2a2a-2671-4b00-bb52-0b48f5b72019"), Traits.Instances.Curse.ID);
            builder.Add(Guid.Parse("bd955250-f51d-4f60-8d33-86dce6c4a605"), Traits.Instances.Negative.ID);
            builder.Add(Guid.Parse("8bfa9005-ae7c-4321-8e86-cc7880ea84ab"), Traits.Instances.Transmutation.ID);
        }
