...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class HypnoticPattern : Template
    {
        ...
        {
            builder.Add(Guid.Parse("ace49e9e-2bfc-43f6-916f-7f9cb5fe5b6e"), Traits.Instances.Illusion.ID);
            builder.Add(Guid.Parse("34a087f3-2713-40ff-acea-c22bd6771262"), Traits.Instances.Visual.ID);
        }
