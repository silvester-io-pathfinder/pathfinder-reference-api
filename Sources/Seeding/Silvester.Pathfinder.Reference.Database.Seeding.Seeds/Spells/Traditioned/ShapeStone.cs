...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class ShapeStone : Template
    {
        ...
        {
            builder.Add(Guid.Parse("8c029144-a0de-4f80-a709-d977f166a5ab"), Traits.Instances.Earth.ID);
            builder.Add(Guid.Parse("97a8ac25-af2d-476f-8192-acdf435bf909"), Traits.Instances.Transmutation.ID);
        }
