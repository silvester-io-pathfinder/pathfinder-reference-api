...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class Locate : Template
    {
        ...
        {
            builder.Add(Guid.Parse("ac9db474-c20f-476a-9fcd-89d982d2c87c"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("9e967705-445b-4535-8b72-db687db2bde9"), Traits.Instances.Detection.ID);
            builder.Add(Guid.Parse("13ae6b19-9273-44e7-af2c-aa3478235f81"), Traits.Instances.Divination.ID);
        }
