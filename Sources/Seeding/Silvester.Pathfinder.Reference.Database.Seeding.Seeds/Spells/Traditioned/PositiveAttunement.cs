...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class PositiveAttunement : Template
    {
        ...
        {
            builder.Add(Guid.Parse("8298a1cf-6ba1-4b13-9907-97744e59ee83"), Traits.Instances.Healing.ID);
            builder.Add(Guid.Parse("c306486e-5f8c-4a79-9b1c-81e334a2d595"), Traits.Instances.Necromancy.ID);
            builder.Add(Guid.Parse("823a3cd3-10ea-4a09-aa9e-fe36b3366066"), Traits.Instances.Positive.ID);
        }
