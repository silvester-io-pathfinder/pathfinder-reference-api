...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class FamiliarsFace : Template
    {
        ...
        {
            builder.Add(Guid.Parse("7d6f75ed-975e-4283-8971-bf36e6051c29"), Traits.Instances.Divination.ID);
            builder.Add(Guid.Parse("7855211c-0f8c-48ae-ada8-4d4bfdbd706b"), Traits.Instances.Scrying.ID);
        }
