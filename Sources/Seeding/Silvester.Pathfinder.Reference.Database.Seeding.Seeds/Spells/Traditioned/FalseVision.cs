...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class FalseVision : Template
    {
        ...
        {
            builder.Add(Guid.Parse("e9bd522d-579d-4b96-9803-1d0da95b8d9a"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("dd33a628-cf40-46ab-ab8e-8947cb5b2363"), Traits.Instances.Illusion.ID);
        }
