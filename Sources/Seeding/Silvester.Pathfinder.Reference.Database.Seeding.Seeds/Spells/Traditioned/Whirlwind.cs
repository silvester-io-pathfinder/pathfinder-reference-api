...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class Whirlwind : Template
    {
        ...
        {
            builder.Add(Guid.Parse("c5591e57-b53f-403c-82ed-331ac1213940"), Traits.Instances.Air.ID);
            builder.Add(Guid.Parse("5756b113-6f05-4ef0-8825-5684bb81abf3"), Traits.Instances.Evocation.ID);
        }
