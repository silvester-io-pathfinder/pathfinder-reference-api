...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class Shatter : Template
    {
        ...
        {
            builder.Add(Guid.Parse("5208aa85-e7f5-4c22-8cd7-6cd762df3cbf"), Traits.Instances.Evocation.ID);
            builder.Add(Guid.Parse("d3511108-e9e6-4557-b2b7-d1b08fe1fce1"), Traits.Instances.Sonic.ID);
        }
