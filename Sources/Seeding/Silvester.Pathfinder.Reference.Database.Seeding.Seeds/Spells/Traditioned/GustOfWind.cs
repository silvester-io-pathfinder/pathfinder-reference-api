...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class GustOfWind : Template
    {
        ...
        {
            builder.Add(Guid.Parse("f0316845-22ac-4658-b6b2-8cd66fd99262"), Traits.Instances.Air.ID);
            builder.Add(Guid.Parse("dd18afef-1f9c-40d5-aaf9-20b23e66ed43"), Traits.Instances.Evocation.ID);
        }
