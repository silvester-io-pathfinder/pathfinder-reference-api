...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class NecromancersGenerosity : Template
    {
        ...
        {
            builder.Add(Guid.Parse("ec82fbd0-38fe-4f5b-8c49-24c203246953"), Traits.Instances.Necromancy.ID);
            builder.Add(Guid.Parse("b261b5cc-c64e-47c4-8162-e7993bce26ba"), Traits.Instances.Negative.ID);
        }
