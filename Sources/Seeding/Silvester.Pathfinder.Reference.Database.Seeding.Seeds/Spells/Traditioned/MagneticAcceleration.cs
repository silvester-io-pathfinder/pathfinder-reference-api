...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class MagneticAcceleration : Template
    {
        ...
        {
            builder.Add(Guid.Parse("be23b15c-5488-46ce-8ecd-ba4aa4d46522"), Traits.Instances.Attack.ID);
            builder.Add(Guid.Parse("017a8dee-bdb8-4a5f-a324-b145077340b4"), Traits.Instances.Evocation.ID);
        }
