...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class LoseThePath : Template
    {
        ...
        {
            builder.Add(Guid.Parse("7570170c-c40c-448a-b4e6-603e402ff123"), Traits.Instances.Illusion.ID);
            builder.Add(Guid.Parse("7f796aed-819d-4c59-bd09-69a92f6892ca"), Traits.Instances.Mental.ID);
            builder.Add(Guid.Parse("81e72406-2b69-445d-8561-31d02c4322df"), Traits.Instances.Visual.ID);
        }
