...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class ReverseGravity : Template
    {
        ...
        {
            builder.Add(Guid.Parse("04fdad03-c831-4356-998b-e23801d5bcac"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("f6a1bfd3-f6cc-4274-a254-9b5cdafc5444"), Traits.Instances.Occult.ID);
        }
