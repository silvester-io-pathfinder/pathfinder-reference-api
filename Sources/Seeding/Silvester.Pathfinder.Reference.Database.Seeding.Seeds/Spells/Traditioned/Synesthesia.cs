...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class Synesthesia : Template
    {
        ...
        {
            builder.Add(Guid.Parse("4f8b2324-fe66-4fea-8b8a-6ce086476ff3"), Traits.Instances.Divination.ID);
            builder.Add(Guid.Parse("e4aa7b9f-2f69-4007-ab80-ee7dab90c00c"), Traits.Instances.Mental.ID);
        }
