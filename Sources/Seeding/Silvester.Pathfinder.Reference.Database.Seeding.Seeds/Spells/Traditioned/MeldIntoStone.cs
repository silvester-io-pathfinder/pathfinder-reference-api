...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class MeldIntoStone : Template
    {
        ...
        {
            builder.Add(Guid.Parse("5439c6ef-5d2f-4313-b373-5ac04ee41630"), Traits.Instances.Earth.ID);
            builder.Add(Guid.Parse("5ca13530-fe13-4896-8642-49a81a163fbb"), Traits.Instances.Transmutation.ID);
        }
