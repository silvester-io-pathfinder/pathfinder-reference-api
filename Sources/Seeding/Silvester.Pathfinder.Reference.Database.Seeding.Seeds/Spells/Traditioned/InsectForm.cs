...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class InsectForm : Template
    {
        ...
        {
            builder.Add(Guid.Parse("f37eaffa-0d85-4211-b1cd-6771ab27671e"), Traits.Instances.Polymorph.ID);
            builder.Add(Guid.Parse("62f736a6-7e9e-41a9-8504-3aacc23ca6b1"), Traits.Instances.Transmutation.ID);
        }
