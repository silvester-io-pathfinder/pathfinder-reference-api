...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class FieldOfLife : Template
    {
        ...
        {
            builder.Add(Guid.Parse("b7c62f75-96e8-49d7-b78d-5abcb9292e26"), Traits.Instances.Healing.ID);
            builder.Add(Guid.Parse("338a7385-1cb0-4df1-8579-87641c72ab65"), Traits.Instances.Necromancy.ID);
            builder.Add(Guid.Parse("008eeb18-23c5-414c-a2e8-4a349b25fc8f"), Traits.Instances.Positive.ID);
        }
