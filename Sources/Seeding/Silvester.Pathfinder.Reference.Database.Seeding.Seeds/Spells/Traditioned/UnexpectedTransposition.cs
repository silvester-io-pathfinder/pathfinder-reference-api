...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class UnexpectedTransposition : Template
    {
        ...
        {
            builder.Add(Guid.Parse("17e37cbf-5c3f-406e-af60-22619e8591d5"), Traits.Instances.Conjuration.ID);
            builder.Add(Guid.Parse("af1f87c6-7344-4c3e-8479-f98a331313da"), Traits.Instances.Teleportation.ID);
        }
