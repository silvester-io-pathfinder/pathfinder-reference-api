...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class WebOfEyes : Template
    {
        ...
        {
            builder.Add(Guid.Parse("558649d1-eeb5-41e8-9c69-7828405ca0c7"), Traits.Instances.Divination.ID);
            builder.Add(Guid.Parse("d381b296-a62c-49a2-bd0b-acefd74d56b0"), Traits.Instances.Scrying.ID);
        }
