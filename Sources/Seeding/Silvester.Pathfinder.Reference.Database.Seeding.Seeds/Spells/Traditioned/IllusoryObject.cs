...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class IllusoryObject : Template
    {
        ...
        {
            builder.Add(Guid.Parse("10ade93f-d216-41c7-85d8-fc5c3a9ee354"), Traits.Instances.Illusion.ID);
            builder.Add(Guid.Parse("78a8ab5a-1b1a-4d73-891b-e2728a61111f"), Traits.Instances.Visual.ID);
        }
