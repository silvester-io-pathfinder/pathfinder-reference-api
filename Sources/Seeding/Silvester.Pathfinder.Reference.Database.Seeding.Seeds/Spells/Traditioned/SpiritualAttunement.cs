...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class SpiritualAttunement : Template
    {
        ...
        {
            builder.Add(Guid.Parse("a6f893ed-4f59-4456-ae40-15714bc9c81c"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("5455d04b-fd26-4665-a8fd-ae42f1c3fa9a"), Traits.Instances.Abjuration.ID);
        }
