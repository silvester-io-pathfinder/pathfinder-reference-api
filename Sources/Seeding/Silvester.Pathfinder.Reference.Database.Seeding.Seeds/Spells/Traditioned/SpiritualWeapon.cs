...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class SpiritualWeapon : Template
    {
        ...
        {
            builder.Add(Guid.Parse("aab95255-9adb-43bf-a193-cfd843987caf"), Traits.Instances.Evocation.ID);
            builder.Add(Guid.Parse("b587b930-4ae7-4815-a9a6-d7cdafa06a9c"), Traits.Instances.Force.ID);
        }
