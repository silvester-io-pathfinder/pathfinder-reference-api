...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class DistractingChatter : Template
    {
        ...
        {
            builder.Add(Guid.Parse("27b20cbd-c96e-46ac-90ef-538581a3e220"), Traits.Instances.Auditory.ID);
            builder.Add(Guid.Parse("94ec7957-dee4-426c-9fd0-3113dacb1049"), Traits.Instances.Illusion.ID);
        }
