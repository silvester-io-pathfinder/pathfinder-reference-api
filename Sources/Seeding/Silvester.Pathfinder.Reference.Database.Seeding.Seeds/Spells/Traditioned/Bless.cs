...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class Bless : Template
    {
        ...
        {
            builder.Add(Guid.Parse("e6c8744d-9fb7-4780-af79-6c1a27c9c417"), Traits.Instances.Enchantment.ID);
            builder.Add(Guid.Parse("9b12e9fa-a383-4e37-99c8-0419d3c4e47c"), Traits.Instances.Mental.ID);
        }
