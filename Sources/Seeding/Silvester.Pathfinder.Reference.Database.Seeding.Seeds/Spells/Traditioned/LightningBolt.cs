...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class LightningBolt : Template
    {
        ...
        {
            builder.Add(Guid.Parse("9e3f25d4-2288-45ee-81af-901ace9ed832"), Traits.Instances.Electricity.ID);
            builder.Add(Guid.Parse("15ba5cbb-7dfc-4119-9d9e-b105cdd94fdb"), Traits.Instances.Evocation.ID);
        }
