...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class PrismaticWall : Template
    {
        ...
        {
            builder.Add(Guid.Parse("a761b3fc-fdd5-4c8b-8b86-888262285a05"), Traits.Instances.Abjuration.ID);
            builder.Add(Guid.Parse("8c9feba9-372f-4c1e-a4d1-dee21a66a800"), Traits.Instances.Light.ID);
        }
