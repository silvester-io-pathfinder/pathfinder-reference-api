...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class Necrotize : Template
    {
        ...
        {
            builder.Add(Guid.Parse("4555e353-f311-4fab-a165-2cbf14650d8d"), Traits.Instances.Necromancy.ID);
            builder.Add(Guid.Parse("0d837926-8615-47bb-a28b-2842efe13d37"), Traits.Instances.Negative.ID);
        }
