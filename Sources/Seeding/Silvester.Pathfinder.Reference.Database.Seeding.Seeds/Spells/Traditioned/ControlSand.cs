...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class ControlSand : Template
    {
        ...
        {
            builder.Add(Guid.Parse("edd79f44-94b9-43c0-bc47-d2a24f55e669"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("33510e1b-1555-4063-bbe2-4603815acda6"), Traits.Instances.Earth.ID);
            builder.Add(Guid.Parse("ba51c4e3-6d23-49c0-9d63-b6e1a2be60a6"), Traits.Instances.Evocation.ID);
        }
