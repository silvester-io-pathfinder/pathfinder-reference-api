...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class PhantasmalTreasure : Template
    {
        ...
        {
            builder.Add(Guid.Parse("d9f715be-fce2-4365-8a85-0c669d3e39ee"), Traits.Instances.Emotion.ID);
            builder.Add(Guid.Parse("15f9c4b2-2cdb-4e30-8b72-3cd40ff114b6"), Traits.Instances.Illusion.ID);
            builder.Add(Guid.Parse("018bf598-4a58-405c-b02d-4d32d66d85dc"), Traits.Instances.Mental.ID);
        }
