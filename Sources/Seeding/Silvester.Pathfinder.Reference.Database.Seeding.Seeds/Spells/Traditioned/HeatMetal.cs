...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class HeatMetal : Template
    {
        ...
        {
            builder.Add(Guid.Parse("0a8731be-6e01-4aa4-8efc-a7d23ee8fdcb"), Traits.Instances.Evocation.ID);
            builder.Add(Guid.Parse("e38a56a7-d391-4661-883a-a2cb34c58abe"), Traits.Instances.Fire.ID);
        }
