...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class ConeOfCold : Template
    {
        ...
        {
            builder.Add(Guid.Parse("79f11da9-ac32-41f4-be02-6b7b3d58316b"), Traits.Instances.Cold.ID);
            builder.Add(Guid.Parse("b198b542-a5d5-442e-9e69-e3b111edc4ed"), Traits.Instances.Evocation.ID);
        }
