...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class AnimalMessenger : Template
    {
        ...
        {
            builder.Add(Guid.Parse("c8470e1b-bb09-4628-92d9-9cbe91b0ad48"), Traits.Instances.Enchantment.ID);
            builder.Add(Guid.Parse("8024659d-2fa6-4093-a126-447f1bb5cbb0"), Traits.Instances.Mental.ID);
        }
