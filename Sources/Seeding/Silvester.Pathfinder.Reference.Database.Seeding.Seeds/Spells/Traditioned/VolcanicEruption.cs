...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class VolcanicEruption : Template
    {
        ...
        {
            builder.Add(Guid.Parse("0d065e06-b7b9-4813-b140-c84d5d0bf9e9"), Traits.Instances.Evocation.ID);
            builder.Add(Guid.Parse("bdb334a3-14af-43d5-809e-6bf4320a7858"), Traits.Instances.Fire.ID);
        }
