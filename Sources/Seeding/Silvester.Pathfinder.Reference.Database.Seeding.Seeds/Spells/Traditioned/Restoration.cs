...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class Restoration : Template
    {
        ...
        {
            builder.Add(Guid.Parse("7c7fdeef-2d8d-4ada-bc87-23aa0bc13606"), Traits.Instances.Healing.ID);
            builder.Add(Guid.Parse("4ec88c6f-d064-43e8-bd90-d40613f90f3e"), Traits.Instances.Necromancy.ID);
        }
