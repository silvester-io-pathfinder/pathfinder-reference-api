...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class Repulsion : Template
    {
        ...
        {
            builder.Add(Guid.Parse("c2b53064-2b44-4668-9c73-b8d3ee343c9f"), Traits.Instances.Abjuration.ID);
            builder.Add(Guid.Parse("c12488c0-e0b4-4972-81fe-a1ad2c5921c7"), Traits.Instances.Aura.ID);
            builder.Add(Guid.Parse("eca7f279-df28-43c3-b766-9afd2722552b"), Traits.Instances.Mental.ID);
        }
