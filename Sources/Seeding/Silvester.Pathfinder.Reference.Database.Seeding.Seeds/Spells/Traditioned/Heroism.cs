...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class Heroism : Template
    {
        ...
        {
            builder.Add(Guid.Parse("3e85cc58-64f4-4256-93b0-bc6dab95e2e1"), Traits.Instances.Enchantment.ID);
            builder.Add(Guid.Parse("2eb824a0-8f39-4895-bc0f-88fad5e51b52"), Traits.Instances.Mental.ID);
        }
