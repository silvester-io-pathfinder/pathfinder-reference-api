...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class DivineLance : Template
    {
        ...
        {
            builder.Add(Guid.Parse("0046d708-2e33-46ba-8e67-25cb6536bc4b"), Traits.Instances.Attack.ID);
            builder.Add(Guid.Parse("7625a9b3-94bc-445d-878f-1f2c5a743da7"), Traits.Instances.Cantrip.ID);
            builder.Add(Guid.Parse("0e3192b5-0846-42c5-9321-ffbe1211c011"), Traits.Instances.Evocation.ID);
        }
