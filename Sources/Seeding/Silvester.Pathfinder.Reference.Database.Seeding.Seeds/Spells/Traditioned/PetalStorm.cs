...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class PetalStorm : Template
    {
        ...
        {
            builder.Add(Guid.Parse("68fcf1d7-fe1a-4f60-978c-d5244b409f9b"), Traits.Instances.Air.ID);
            builder.Add(Guid.Parse("bfcff77b-f97b-4a92-ba83-085d0fe34eed"), Traits.Instances.Conjuration.ID);
            builder.Add(Guid.Parse("bc4bf8bf-4ea7-4e3a-8bc3-8414e0a16db5"), Traits.Instances.Plant.ID);
        }
