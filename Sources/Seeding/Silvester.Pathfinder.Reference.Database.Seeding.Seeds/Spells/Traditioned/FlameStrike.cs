...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class FlameStrike : Template
    {
        ...
        {
            builder.Add(Guid.Parse("e9cacfb5-11be-4a67-abdb-59a3c6fd62ee"), Traits.Instances.Evocation.ID);
            builder.Add(Guid.Parse("faa9e1cd-f415-411c-838f-669ef63e3e92"), Traits.Instances.Fire.ID);
        }
