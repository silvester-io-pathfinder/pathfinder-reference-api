...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class PummelingRubble : Template
    {
        ...
        {
            builder.Add(Guid.Parse("c5379977-1ff8-46c7-90ef-15b4828b217f"), Traits.Instances.Earth.ID);
            builder.Add(Guid.Parse("7ec7c5f1-0377-4696-91c2-0bc28290a3d2"), Traits.Instances.Evocation.ID);
        }
