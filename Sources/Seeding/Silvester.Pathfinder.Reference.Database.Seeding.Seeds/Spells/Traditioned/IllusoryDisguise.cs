...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class IllusoryDisguise : Template
    {
        ...
        {
            builder.Add(Guid.Parse("c87fa90f-05f7-411d-8f23-1c3e3a23f84e"), Traits.Instances.Illusion.ID);
            builder.Add(Guid.Parse("b5c73fb4-bc5a-4ad4-9bde-1e3281e615d1"), Traits.Instances.Visual.ID);
        }
