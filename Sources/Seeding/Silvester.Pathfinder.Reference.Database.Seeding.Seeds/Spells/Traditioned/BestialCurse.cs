...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class BestialCurse : Template
    {
        ...
        {
            builder.Add(Guid.Parse("cecf20ae-2f07-43a4-b0f4-8fe952ebd7cf"), Traits.Instances.Curse.ID);
            builder.Add(Guid.Parse("d395700f-b021-47dc-9ec4-902ecd34e331"), Traits.Instances.Polymorph.ID);
            builder.Add(Guid.Parse("3b395a6c-fecf-4c2c-b244-00d992cf2afc"), Traits.Instances.Transmutation.ID);
        }
