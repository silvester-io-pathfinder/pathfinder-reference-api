...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class Banishment : Template
    {
        ...
        {
            builder.Add(Guid.Parse("b9722e67-4c76-4242-93d0-82096dfd2009"), Traits.Instances.Abjuration.ID);
            builder.Add(Guid.Parse("86825aeb-97ea-4da2-a19c-7f24669e5336"), Traits.Instances.Incapacitation.ID);
        }
