...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class AnathematicReprisal : Template
    {
        ...
        {
            builder.Add(Guid.Parse("70515941-ccdc-40c7-8a85-f1c0cc3b00a2"), Traits.Instances.Enchantment.ID);
            builder.Add(Guid.Parse("0d5a459e-bd45-4cec-9774-a48b37cd8277"), Traits.Instances.Mental.ID);
        }
        ...
        protected override SourcePage GetSourcePage()
        {
            ...
            {
                Id = Guid.Parse("2431509c-f493-49ca-bbd8-b4462fcbaf39"),
