...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class BindSoul : Template
    {
        ...
        {
            builder.Add(Guid.Parse("70eb5944-fcf6-4469-8698-e05adf100d0c"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("1c400028-c922-40a0-abb0-15cd2eb603f0"), Traits.Instances.Evil.ID);
            builder.Add(Guid.Parse("9408b7c1-6429-450c-b5a5-7dcb406abbdd"), Traits.Instances.Necromancy.ID);
        }
