...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class BlightburnBlast : Template
    {
        ...
        {
            builder.Add(Guid.Parse("cc3b7492-d67c-49df-a884-fb677edd5d31"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("41da8f57-4c99-4df2-8606-4147891f258f"), Traits.Instances.Disease.ID);
            builder.Add(Guid.Parse("5ca35a83-f002-4f64-a1eb-c0e7fe1f32dc"), Traits.Instances.Evocation.ID);
        }
