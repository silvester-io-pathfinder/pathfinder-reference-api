...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class VampiricMaiden : Template
    {
        ...
        {
            builder.Add(Guid.Parse("fba04f6e-2bb6-48d3-85b4-3e24335f1e66"), Traits.Instances.Necromancy.ID);
            builder.Add(Guid.Parse("8fb1e340-9f9a-4953-b733-cb41a5421437"), Traits.Instances.Negative.ID);
        }
