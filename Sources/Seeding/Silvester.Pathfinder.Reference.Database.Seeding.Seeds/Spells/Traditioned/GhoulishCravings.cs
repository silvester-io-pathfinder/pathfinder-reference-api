...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class GhoulishCravings : Template
    {
        ...
        {
            builder.Add(Guid.Parse("65819d96-6f40-4df9-aba5-3536abe9640a"), Traits.Instances.Disease.ID);
            builder.Add(Guid.Parse("a79464c4-a084-46fe-b124-7f6adc1a8286"), Traits.Instances.Evil.ID);
            builder.Add(Guid.Parse("e1a02291-0da9-4dbd-894f-3a528f62149f"), Traits.Instances.Necromancy.ID);
        }
