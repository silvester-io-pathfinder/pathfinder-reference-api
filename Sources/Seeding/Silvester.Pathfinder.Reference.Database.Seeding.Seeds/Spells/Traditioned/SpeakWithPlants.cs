...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class SpeakWithPlants : Template
    {
        ...
        {
            builder.Add(Guid.Parse("d47bd37d-a970-420a-9159-b6a96aab12a2"), Traits.Instances.Divination.ID);
            builder.Add(Guid.Parse("d2f498bb-70e6-46af-9370-712965cfe617"), Traits.Instances.Plant.ID);
        }
