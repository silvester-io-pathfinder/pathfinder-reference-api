...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class SpellTurning : Template
    {
        ...
        {
            builder.Add(Guid.Parse("7333f55b-8667-4dbc-b9f9-05a0efeafe44"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("3d77975d-88ad-425f-be7c-e3dd10f69555"), Traits.Instances.Abjuration.ID);
        }
