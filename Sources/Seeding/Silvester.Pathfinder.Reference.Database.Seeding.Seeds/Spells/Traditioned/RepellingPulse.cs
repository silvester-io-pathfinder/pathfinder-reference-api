...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class RepellingPulse : Template
    {
        ...
        {
            builder.Add(Guid.Parse("5d8d0a93-5ee7-450c-bf80-afd1d3596fdc"), Traits.Instances.Evocation.ID);
            builder.Add(Guid.Parse("551b139d-cf3d-4011-9856-3b918bfa99dd"), Traits.Instances.Force.ID);
        }
