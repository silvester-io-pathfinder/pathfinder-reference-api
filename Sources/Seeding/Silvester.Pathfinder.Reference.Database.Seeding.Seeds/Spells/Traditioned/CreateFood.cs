...
{
    public class CreateFood : Template
    {
        ...
        {
            builder.Add(Guid.Parse("aaf007a0-7cb9-4987-b97c-860756d61afa"), Traits.Instances.Conjuration.ID);
        }
        ...
        protected override SourcePage GetSourcePage()
        {
            ...
            {
                Id = Guid.Parse("c77fb18e-86eb-4a6f-9568-448fe3c1c04f"),
