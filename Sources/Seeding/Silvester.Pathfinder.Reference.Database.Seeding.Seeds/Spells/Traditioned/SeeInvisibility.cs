...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class SeeInvisibility : Template
    {
        ...
        {
            builder.Add(Guid.Parse("2c446dcf-e1db-4967-ae9a-cb69a443b51d"), Traits.Instances.Divination.ID);
            builder.Add(Guid.Parse("cbc33b1b-9426-4b13-a032-b5bbfa365bbc"), Traits.Instances.Revelation.ID);
        }
