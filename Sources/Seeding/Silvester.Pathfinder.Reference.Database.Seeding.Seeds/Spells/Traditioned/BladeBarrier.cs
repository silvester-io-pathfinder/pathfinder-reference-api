...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class BladeBarrier : Template
    {
        ...
        {
            builder.Add(Guid.Parse("56514cb3-17a3-4eb8-a4ac-a56e98478a58"), Traits.Instances.Evocation.ID);
            builder.Add(Guid.Parse("58b1cc08-72b6-4e34-a56c-e97db932168e"), Traits.Instances.Force.ID);
        }
        ...
        protected override SourcePage GetSourcePage()
        {
            ...
            {
                Id = Guid.Parse("6fb2aaa7-c527-466a-b887-b31717270d0f"),
