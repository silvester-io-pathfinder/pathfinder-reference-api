...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class CharitableUrge : Template
    {
        ...
        {
            builder.Add(Guid.Parse("b8936b4d-b0d7-49a0-9596-7de9eb1bd76f"), Traits.Instances.Enchantment.ID);
            builder.Add(Guid.Parse("a2f7e909-2055-4553-8ef5-929389c173ad"), Traits.Instances.Incapacitation.ID);
            builder.Add(Guid.Parse("94f278ba-90df-4d94-a6b1-d0a2c7523dd6"), Traits.Instances.Mental.ID);
        }
