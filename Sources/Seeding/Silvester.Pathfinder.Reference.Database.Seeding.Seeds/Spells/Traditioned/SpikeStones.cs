...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class SpikeStones : Template
    {
        ...
        {
            builder.Add(Guid.Parse("b327452a-72ee-4a4e-8bac-ae13884d4814"), Traits.Instances.Conjuration.ID);
            builder.Add(Guid.Parse("46ca9205-52db-4034-8853-102bc20d6c20"), Traits.Instances.Earth.ID);
        }
