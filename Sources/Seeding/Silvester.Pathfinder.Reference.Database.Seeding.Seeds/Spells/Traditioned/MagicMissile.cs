...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class MagicMissile : Template
    {
        ...
        {
            builder.Add(Guid.Parse("e189e5bb-7352-4f60-b2a7-bc9662104378"), Traits.Instances.Auditory.ID);
            builder.Add(Guid.Parse("d89fbcba-82ed-4c27-92cd-17b1c019bf32"), Traits.Instances.Illusion.ID);
            builder.Add(Guid.Parse("365171ea-2311-4ccc-a0af-20bb76a8da30"), Traits.Instances.Visual.ID);
        }
