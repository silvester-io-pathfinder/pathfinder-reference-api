...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class PhantasmalCalamity : Template
    {
        ...
        {
            builder.Add(Guid.Parse("7a3d32e1-94f3-49b6-83ad-c7a55c0995af"), Traits.Instances.Illusion.ID);
            builder.Add(Guid.Parse("9837ca74-e4a1-4bcd-adf5-a6e1bbe633a6"), Traits.Instances.Mental.ID);
        }
