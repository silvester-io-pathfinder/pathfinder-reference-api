...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class FireShield : Template
    {
        ...
        {
            builder.Add(Guid.Parse("034a4427-4221-4797-ab6a-6c1306dbc0f4"), Traits.Instances.Evocation.ID);
            builder.Add(Guid.Parse("0180732b-1def-4574-8a12-c534f4bd74ff"), Traits.Instances.Fire.ID);
        }
