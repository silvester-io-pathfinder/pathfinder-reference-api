...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class BloodsprayCurse : Template
    {
        ...
        {
            builder.Add(Guid.Parse("05a4644c-c41a-444b-a54a-368fe23733c9"), Traits.Instances.Curse.ID);
            builder.Add(Guid.Parse("884a525d-30f8-4057-b027-8afe4c8b9014"), Traits.Instances.Necromancy.ID);
        }
