...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class Hallucination : Template
    {
        ...
        {
            builder.Add(Guid.Parse("5bdc270b-36ee-4b4e-8084-b7e6b231df10"), Traits.Instances.Illusion.ID);
            builder.Add(Guid.Parse("9f2059c2-8d63-447f-9158-4b9c8e166e73"), Traits.Instances.Incapacitation.ID);
            builder.Add(Guid.Parse("7075f711-e454-4184-bb3b-ede2cab57e2f"), Traits.Instances.Mental.ID);
        }
