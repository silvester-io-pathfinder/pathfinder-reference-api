...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class DinosaurForm : Template
    {
        ...
        {
            builder.Add(Guid.Parse("dd421e3e-10cd-46d8-a1f9-fed9555f9e8b"), Traits.Instances.Polymorph.ID);
            builder.Add(Guid.Parse("8a032a5c-c503-4057-9bb4-b7d250dbaff3"), Traits.Instances.Transmutation.ID);
        }
