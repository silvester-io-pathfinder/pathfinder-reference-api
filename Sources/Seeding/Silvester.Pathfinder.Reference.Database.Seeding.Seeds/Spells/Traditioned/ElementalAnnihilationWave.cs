...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class ElementalAnnihilationWave : Template
    {
        ...
        {
            builder.Add(Guid.Parse("cbfb6f63-b7d8-4a88-8189-f3800dc54688"), Traits.Instances.Air.ID);
            builder.Add(Guid.Parse("e76c2f3c-b906-4eed-8c2c-232a3bdea03b"), Traits.Instances.Earth.ID);
            builder.Add(Guid.Parse("be5c8721-8227-4bc3-bce2-9c1c68d7be96"), Traits.Instances.Evocation.ID);
            builder.Add(Guid.Parse("00ce57a0-a60a-4208-8afa-4f5ad5167142"), Traits.Instances.Fire.ID);
            builder.Add(Guid.Parse("66f36a88-0385-4f2a-9970-f2865cbc60d5"), Traits.Instances.Water.ID);
        }
