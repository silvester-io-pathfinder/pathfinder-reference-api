...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class Quench : Template
    {
        ...
        {
            builder.Add(Guid.Parse("a9fb65cd-764e-40ec-880d-d7a51d61c50a"), Traits.Instances.Abjuration.ID);
            builder.Add(Guid.Parse("845e2def-2d1c-4f05-a6ad-14e7dd0f1dc5"), Traits.Instances.Water.ID);
        }
