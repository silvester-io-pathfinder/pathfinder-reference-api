...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class IceStorm : Template
    {
        ...
        {
            builder.Add(Guid.Parse("e51beee0-fcd9-44f3-8430-cc7ec72d46aa"), Traits.Instances.Cold.ID);
            builder.Add(Guid.Parse("02c259c5-7b69-490f-861c-59ffba8cb7b0"), Traits.Instances.Evocation.ID);
        }
