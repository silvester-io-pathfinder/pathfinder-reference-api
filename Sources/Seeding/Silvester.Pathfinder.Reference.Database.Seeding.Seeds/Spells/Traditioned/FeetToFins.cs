...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class FeetToFins : Template
    {
        ...
        {
            builder.Add(Guid.Parse("2aee0e04-b99d-4360-bc82-ebcc7fa2a2db"), Traits.Instances.Morph.ID);
            builder.Add(Guid.Parse("3ea11007-4136-4e8b-9bae-ccaf0a7dc689"), Traits.Instances.Transmutation.ID);
        }
