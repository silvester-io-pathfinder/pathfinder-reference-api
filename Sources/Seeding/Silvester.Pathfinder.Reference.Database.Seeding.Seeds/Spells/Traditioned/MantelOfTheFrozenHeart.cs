...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class MantelOfTheFrozenHeart : Template
    {
        ...
        {
            builder.Add(Guid.Parse("08eb9026-ad68-4e2a-898d-3e24a1b0870d"), Traits.Instances.Cold.ID);
            builder.Add(Guid.Parse("09bdf8cf-71aa-4195-8b9c-6699c0d446ff"), Traits.Instances.Morph.ID);
            builder.Add(Guid.Parse("fcec3314-f480-43fc-a5e2-a5a8357ca4f4"), Traits.Instances.Transmutation.ID);
        }
