...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class RestoreSenses : Template
    {
        ...
        {
            builder.Add(Guid.Parse("f9a1d510-2340-4065-9eed-3464e3408731"), Traits.Instances.Healing.ID);
            builder.Add(Guid.Parse("1b5f8d03-da07-4d00-8503-1b5c50e16a2a"), Traits.Instances.Necromancy.ID);
        }
