...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class CrashingWave : Template
    {
        ...
        {
            builder.Add(Guid.Parse("5879fad2-15b8-46ae-9877-18cec0b1c318"), Traits.Instances.Evocation.ID);
            builder.Add(Guid.Parse("3f326e59-522d-43cb-b76e-8a37aee02664"), Traits.Instances.Water.ID);
        }
