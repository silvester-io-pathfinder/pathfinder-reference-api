...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class HealingWell : Template
    {
        ...
        {
            builder.Add(Guid.Parse("2504e59e-fa57-4068-b4df-ab2db74df0c3"), Traits.Instances.Healing.ID);
            builder.Add(Guid.Parse("3d6f0938-9ef9-4101-9852-a528ea0838b2"), Traits.Instances.Necromancy.ID);
            builder.Add(Guid.Parse("6739800f-2144-44ae-b217-9e0801251c7b"), Traits.Instances.Positive.ID);
        }
