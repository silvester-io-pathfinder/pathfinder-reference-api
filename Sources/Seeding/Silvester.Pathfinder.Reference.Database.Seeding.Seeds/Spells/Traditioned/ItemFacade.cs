...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class ItemFacade : Template
    {
        ...
        {
            builder.Add(Guid.Parse("d3665fda-6b58-4105-891b-ea6bc4743117"), Traits.Instances.Illusion.ID);
            builder.Add(Guid.Parse("136c39a7-16f3-4393-ba9a-c5141b8aafe0"), Traits.Instances.Visual.ID);
        }
