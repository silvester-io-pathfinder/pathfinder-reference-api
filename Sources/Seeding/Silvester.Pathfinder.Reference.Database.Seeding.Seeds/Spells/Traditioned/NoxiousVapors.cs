...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class NoxiousVapors : Template
    {
        ...
        {
            builder.Add(Guid.Parse("2485a8de-6a3c-4d4b-aef7-0f167a544416"), Traits.Instances.Evocation.ID);
            builder.Add(Guid.Parse("63b6948a-72d4-4619-84f5-842fb6acb7d4"), Traits.Instances.Poison.ID);
        }
