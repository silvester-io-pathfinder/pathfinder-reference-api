...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class FungalHyphae : Template
    {
        ...
        {
            builder.Add(Guid.Parse("6650055d-ac13-4e42-81ff-02b0c6fd632f"), Traits.Instances.Fungus.ID);
            builder.Add(Guid.Parse("3439b73b-7553-45e3-ab0b-3f9f52e6c59e"), Traits.Instances.Necromancy.ID);
        }
