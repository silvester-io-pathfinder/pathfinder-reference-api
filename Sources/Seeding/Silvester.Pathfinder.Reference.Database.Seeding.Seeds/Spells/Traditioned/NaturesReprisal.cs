...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class NaturesReprisal : Template
    {
        ...
        {
            builder.Add(Guid.Parse("befb58a5-2ab1-45af-974d-3773516a2d9c"), Traits.Instances.Plant.ID);
            builder.Add(Guid.Parse("f6d08c4a-20b1-4192-a68e-df7a460c5b52"), Traits.Instances.Poison.ID);
            builder.Add(Guid.Parse("2ad279c3-8bb6-4fe3-b38b-aab1a45bfea7"), Traits.Instances.Transmutation.ID);
        }
