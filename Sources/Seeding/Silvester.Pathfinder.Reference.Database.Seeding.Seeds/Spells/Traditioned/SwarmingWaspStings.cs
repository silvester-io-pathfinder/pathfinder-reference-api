...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class SwarmingWaspStings : Template
    {
        ...
        {
            builder.Add(Guid.Parse("3dcdf805-fac7-4307-9278-9a4779f07d21"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("1ff6fd86-faaa-476c-bae0-5fc23570899b"), Traits.Instances.Necromancy.ID);
            builder.Add(Guid.Parse("c307543e-ab20-4b56-8351-7cfb2aa1119d"), Traits.Instances.Poison.ID);
        }
