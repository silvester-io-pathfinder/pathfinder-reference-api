...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class StinkingCloud : Template
    {
        ...
        {
            builder.Add(Guid.Parse("b84e25b9-7997-4832-a292-faaaf5082bb4"), Traits.Instances.Conjuration.ID);
            builder.Add(Guid.Parse("dd951df6-a119-4749-9808-1d7ded0c6c73"), Traits.Instances.Poison.ID);
        }
