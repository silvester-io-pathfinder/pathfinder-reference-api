...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class BoilBlood : Template
    {
        ...
        {
            builder.Add(Guid.Parse("245f141c-995a-4e14-b21a-fe34fe1db345"), Traits.Instances.Evocation.ID);
            builder.Add(Guid.Parse("7658994a-ace7-4c3f-8a83-35a782f0708a"), Traits.Instances.Fire.ID);
        }
