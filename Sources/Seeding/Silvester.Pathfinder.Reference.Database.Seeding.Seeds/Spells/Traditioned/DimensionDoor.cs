...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class DimensionDoor : Template
    {
        ...
        {
            builder.Add(Guid.Parse("59a156dd-5e6b-44f9-bb17-fc071ce96c2b"), Traits.Instances.Conjuration.ID);
            builder.Add(Guid.Parse("d8c6d4b3-c1fc-48f7-9ee5-a15882232c12"), Traits.Instances.Teleportation.ID);
        }
