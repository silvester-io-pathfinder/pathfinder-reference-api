...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class AnimalForm : Template
    {
        ...
        {
            builder.Add(Guid.Parse("d789bb8a-875a-4d51-9bc5-1a63eb5417e8"), Traits.Instances.Polymorph.ID);
            builder.Add(Guid.Parse("d07aa75c-afef-4ff5-9b42-afbd944876f2"), Traits.Instances.Transmutation.ID);
        }
