...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class Scrying : Template
    {
        ...
        {
            builder.Add(Guid.Parse("9709212f-5ff9-41a1-9502-159142154ead"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("2d2a6491-57c2-4b8a-9d39-8cfd292dde03"), Traits.Instances.Divination.ID);
            builder.Add(Guid.Parse("58e28060-5acd-432f-af24-60d7bd114734"), Traits.Instances.Scrying.ID);
        }
