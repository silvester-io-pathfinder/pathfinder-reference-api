...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class PrivateSanctum : Template
    {
        ...
        {
            builder.Add(Guid.Parse("a62cbe85-e32b-4d26-add2-9844ff268998"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("de04a468-afa1-4141-9816-fc21e9599b58"), Traits.Instances.Abjuration.ID);
        }
