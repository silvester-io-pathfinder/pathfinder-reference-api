...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class ChainLightning : Template
    {
        ...
        {
            builder.Add(Guid.Parse("9e49a50d-a3c0-4b23-b3ba-f6ad25ef2331"), Traits.Instances.Electricity.ID);
            builder.Add(Guid.Parse("5bb576ae-96ff-4b1f-b319-9818291cbe42"), Traits.Instances.Evocation.ID);
        }
