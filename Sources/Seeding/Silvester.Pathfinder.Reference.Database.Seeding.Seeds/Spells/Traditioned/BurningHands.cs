...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class BurningHands : Template
    {
        ...
        {
            builder.Add(Guid.Parse("5a45fa57-1c9c-4fcb-99cf-dc500dafbbbb"), Traits.Instances.Evocation.ID);
            builder.Add(Guid.Parse("3f5a3c43-4b01-45db-bb72-4efce44334d7"), Traits.Instances.Fire.ID);
        }
