...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class ProliferatingEyes : Template
    {
        ...
        {
            builder.Add(Guid.Parse("f62b53fd-d315-47f1-bfc0-265d1b148c91"), Traits.Instances.Divination.ID);
            builder.Add(Guid.Parse("8cdac09f-25fd-4153-b52e-0d4f4bbb2c12"), Traits.Instances.Scrying.ID);
        }
