...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class OneiricMire : Template
    {
        ...
        {
            builder.Add(Guid.Parse("cd59e66a-df31-4448-aa1e-d977625eab40"), Traits.Instances.Illusion.ID);
            builder.Add(Guid.Parse("b274b739-8d84-4228-881a-243912216d47"), Traits.Instances.Mental.ID);
            builder.Add(Guid.Parse("3407fc61-3dc9-4973-969c-1bcccb1dc927"), Traits.Instances.Visual.ID);
        }
