...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class PillarsOfSand : Template
    {
        ...
        {
            builder.Add(Guid.Parse("1da19837-5388-4b70-8c71-082e95307d8e"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("f85f012f-057f-4cfe-ab5d-77cc162dbd87"), Traits.Instances.Conjuration.ID);
            builder.Add(Guid.Parse("84ad4e7b-fcb3-4734-a223-c2e2ffe29dd7"), Traits.Instances.Earth.ID);
        }
