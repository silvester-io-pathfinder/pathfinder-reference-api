...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class FinalSacrifice : Template
    {
        ...
        {
            builder.Add(Guid.Parse("44fd563f-e5fa-472e-a23c-4733052a1d9e"), Traits.Instances.Evocation.ID);
            builder.Add(Guid.Parse("71e0c1a2-c183-4d61-b42e-26a1d0c64f76"), Traits.Instances.Fire.ID);
        }
