...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class Enervation : Template
    {
        ...
        {
            builder.Add(Guid.Parse("46b8f6a2-e9ec-49ef-8ae6-71e2c4e87faa"), Traits.Instances.Necromancy.ID);
            builder.Add(Guid.Parse("ac31b98f-2daa-4c05-b338-91543fcdd426"), Traits.Instances.Negative.ID);
        }
