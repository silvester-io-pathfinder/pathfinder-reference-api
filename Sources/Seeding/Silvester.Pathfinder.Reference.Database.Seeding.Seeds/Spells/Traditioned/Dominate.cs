...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class Dominate : Template
    {
        ...
        {
            builder.Add(Guid.Parse("197350da-78f5-4638-bce3-05dbc4cf9c53"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("b3f19047-ee21-49b6-b153-3289dfe24a59"), Traits.Instances.Enchantment.ID);
            builder.Add(Guid.Parse("9e3f450b-d5ce-43e6-9b83-56cf1e189fcf"), Traits.Instances.Incapacitation.ID);
            builder.Add(Guid.Parse("7ef42a82-42a6-4298-bc89-b414e335d51f"), Traits.Instances.Mental.ID);
        }
