...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class ZeroGravity : Template
    {
        ...
        {
            builder.Add(Guid.Parse("4c019da5-9c85-47ae-8474-ea87f2afd706"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("63ab4572-7158-4dbc-9423-637023153a80"), Traits.Instances.Evocation.ID);
        }
