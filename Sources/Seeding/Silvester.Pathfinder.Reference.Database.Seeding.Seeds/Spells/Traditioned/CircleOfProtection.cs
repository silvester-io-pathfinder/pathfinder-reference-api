...
{
    public class CircleOfProtection : Template
    {
        ...
        {
            builder.Add(Guid.Parse("c3c54cfc-7136-4bc4-a16d-f0e7a88b2b8a"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("2f348c1c-ae49-4b9e-8767-96f0ee7ec75d"), Traits.Instances.Abjuration.ID);
        }
        ...
        protected override SourcePage GetSourcePage()
        {
            ...
            {
                Id = Guid.Parse("611fc1a1-1957-4ad9-83a8-417a739badc3"),
