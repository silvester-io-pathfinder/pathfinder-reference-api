...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class CloakOfColors : Template
    {
        ...
        {
            builder.Add(Guid.Parse("33f3b723-887b-41ef-8b8e-b940fc58cbaf"), Traits.Instances.Illusion.ID);
            builder.Add(Guid.Parse("97b93ea0-bafa-4af5-9128-211dab2bfb95"), Traits.Instances.Visual.ID);
        }
        ...
        protected override SourcePage GetSourcePage()
        {
            ...
            {
                Id = Guid.Parse("d441fae2-ff1a-4e9a-aa07-28e004ad1b1a"),
