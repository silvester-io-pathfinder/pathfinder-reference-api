...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class Guidance : Template
    {
        ...
        {
            builder.Add(Guid.Parse("45a64ad3-0c8c-48bc-99b7-7497f949ac17"), Traits.Instances.Cantrip.ID);
            builder.Add(Guid.Parse("2f142390-c430-4369-9ffd-0459e6c4da13"), Traits.Instances.Divination.ID);
        }
