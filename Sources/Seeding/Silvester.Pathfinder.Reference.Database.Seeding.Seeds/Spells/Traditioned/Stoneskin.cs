...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class Stoneskin : Template
    {
        ...
        {
            builder.Add(Guid.Parse("75286517-b1d2-4fd4-a297-92cb7ce8c4e2"), Traits.Instances.Abjuration.ID);
            builder.Add(Guid.Parse("2b166239-c8aa-41c7-95a5-036d2ab261f7"), Traits.Instances.Earth.ID);
        }
