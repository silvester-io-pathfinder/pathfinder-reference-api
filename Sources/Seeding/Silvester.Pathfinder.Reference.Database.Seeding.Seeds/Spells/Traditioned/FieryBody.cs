...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class FieryBody : Template
    {
        ...
        {
            builder.Add(Guid.Parse("3a7fc420-67d2-4929-8b20-7683a2fd828c"), Traits.Instances.Fire.ID);
            builder.Add(Guid.Parse("b0e0e40b-a7fc-4ac7-88d1-40ab1823fb42"), Traits.Instances.Polymorph.ID);
            builder.Add(Guid.Parse("b4b99078-f671-46b2-be2f-07346bebec58"), Traits.Instances.Transmutation.ID);
        }
