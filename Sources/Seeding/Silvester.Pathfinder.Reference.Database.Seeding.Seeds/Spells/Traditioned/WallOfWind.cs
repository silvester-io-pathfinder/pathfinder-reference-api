...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class WallOfWind : Template
    {
        ...
        {
            builder.Add(Guid.Parse("a9feba80-8a3b-47e4-86f5-4b86d3077ffe"), Traits.Instances.Air.ID);
            builder.Add(Guid.Parse("e8d86c8f-eaa1-4fdb-93a4-282116bef341"), Traits.Instances.Evocation.ID);
        }
