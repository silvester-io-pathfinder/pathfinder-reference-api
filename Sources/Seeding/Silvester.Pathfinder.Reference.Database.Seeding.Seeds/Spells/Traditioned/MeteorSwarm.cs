...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class MeteorSwarm : Template
    {
        ...
        {
            builder.Add(Guid.Parse("f9216a87-7c3d-4755-80ce-d707e59feaf2"), Traits.Instances.Evocation.ID);
            builder.Add(Guid.Parse("3ac6de39-efd8-4156-9e06-bf27ed6b5627"), Traits.Instances.Fire.ID);
        }
