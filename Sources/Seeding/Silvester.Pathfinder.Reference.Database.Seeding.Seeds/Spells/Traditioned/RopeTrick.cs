...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class RopeTrick : Template
    {
        ...
        {
            builder.Add(Guid.Parse("45c23553-a665-43da-b465-07b33018e52b"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("b899e32c-a748-49a9-849d-2e11b52cd248"), Traits.Instances.Conjuration.ID);
            builder.Add(Guid.Parse("66a2df22-9d42-4df1-88d4-1fe6bdfc5f60"), Traits.Instances.Extradimensional.ID);
        }
