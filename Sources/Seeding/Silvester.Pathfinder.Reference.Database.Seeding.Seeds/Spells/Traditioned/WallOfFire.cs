...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class WallOfFire : Template
    {
        ...
        {
            builder.Add(Guid.Parse("abfd7abf-d97d-4e51-980b-59ecc04aca4b"), Traits.Instances.Evocation.ID);
            builder.Add(Guid.Parse("fe1ee0f0-cd0b-48fe-b2ba-fb8847d869de"), Traits.Instances.Fire.ID);
        }
