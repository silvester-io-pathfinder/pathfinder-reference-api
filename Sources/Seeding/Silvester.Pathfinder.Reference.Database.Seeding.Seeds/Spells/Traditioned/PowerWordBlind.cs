...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class PowerWordBlind : Template
    {
        ...
        {
            builder.Add(Guid.Parse("838205b9-4750-4ca1-b80d-2640c30b9e95"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("ff95a756-2a40-4a13-987c-0dc541199525"), Traits.Instances.Auditory.ID);
            builder.Add(Guid.Parse("9e0adfef-67b8-48a5-8c44-759b4599ab33"), Traits.Instances.Enchantment.ID);
            builder.Add(Guid.Parse("84373578-3fd2-42d0-99a0-ade8d50a696e"), Traits.Instances.Mental.ID);
        }
