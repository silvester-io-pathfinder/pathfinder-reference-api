...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class PowerWordKill : Template
    {
        ...
        {
            builder.Add(Guid.Parse("f4a6f9fa-2c6f-4bef-a0d3-558c93da0035"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("9dc2b60b-e64b-4711-b08f-434c5c181bff"), Traits.Instances.Auditory.ID);
            builder.Add(Guid.Parse("c46b17dc-01de-4043-b7b8-249e1566bcd3"), Traits.Instances.Death.ID);
            builder.Add(Guid.Parse("fabf6559-83b9-4596-b1a7-998df55d8967"), Traits.Instances.Enchantment.ID);
            builder.Add(Guid.Parse("d590eaec-be91-4ecb-bfff-ca67314f1a80"), Traits.Instances.Mental.ID);
        }
