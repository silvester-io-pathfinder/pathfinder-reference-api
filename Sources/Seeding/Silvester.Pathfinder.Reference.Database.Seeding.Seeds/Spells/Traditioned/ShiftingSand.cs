...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    ...
    public class ShiftingSand : Template
    {
        ...
        {
            builder.Add(Guid.Parse("7a268daa-c4b7-49d6-bb75-afc372df1d19"), Traits.Instances.Earth.ID);
            builder.Add(Guid.Parse("54033461-330d-4299-bf9b-cfa8db33177f"), Traits.Instances.Transmutation.ID);
        }
