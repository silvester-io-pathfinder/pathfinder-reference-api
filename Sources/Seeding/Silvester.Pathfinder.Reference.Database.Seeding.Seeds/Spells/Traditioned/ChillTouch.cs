...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class ChillTouch : Template
    {
        ...
        {
            builder.Add(Guid.Parse("ba12dd05-c319-4721-89c7-c306548627c4"), Traits.Instances.Cantrip.ID);
            builder.Add(Guid.Parse("71bf96f3-95ac-4a3b-96d1-5e25f02ae17c"), Traits.Instances.Necromancy.ID);
            builder.Add(Guid.Parse("7fb34375-6504-440d-8c10-ed6294d8ea97"), Traits.Instances.Negative.ID);
        }
