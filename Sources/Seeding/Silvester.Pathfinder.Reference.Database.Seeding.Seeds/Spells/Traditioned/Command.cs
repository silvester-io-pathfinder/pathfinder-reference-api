...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class Command : Template
    {
        ...
        {
            builder.Add(Guid.Parse("0af0573e-b869-43e5-bfac-4e2c5872b3ed"), Traits.Instances.Auditory.ID);
            builder.Add(Guid.Parse("7beb08a4-d1ee-4ce5-8ae9-3c71ccb302e7"), Traits.Instances.Enchantment.ID);
            builder.Add(Guid.Parse("0ae73978-7d48-43c1-a707-057328b43950"), Traits.Instances.Linguistic.ID);
            builder.Add(Guid.Parse("ea871035-a110-4cab-bb4e-06a6ff7c102f"), Traits.Instances.Mental.ID);
        }
