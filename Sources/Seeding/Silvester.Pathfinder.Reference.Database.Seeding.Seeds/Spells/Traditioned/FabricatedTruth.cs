...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class FabricatedTruth : Template
    {
        ...
        {
            builder.Add(Guid.Parse("8b9713de-a2fe-41c5-812a-ab30e56681bf"), Traits.Instances.Enchantment.ID);
            builder.Add(Guid.Parse("248a3364-29eb-4504-a502-cbd498c59caf"), Traits.Instances.Incapacitation.ID);
            builder.Add(Guid.Parse("01e1cc64-4c14-4f89-98ad-16810201dcea"), Traits.Instances.Mental.ID);
        }
