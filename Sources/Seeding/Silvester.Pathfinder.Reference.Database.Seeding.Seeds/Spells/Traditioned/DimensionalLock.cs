...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class DimensionalLock : Template
    {
        ...
        {
            builder.Add(Guid.Parse("62e38c04-01f9-4759-ba18-4a9c3d5d752c"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("6acad768-8646-43af-9b47-9478ba79390d"), Traits.Instances.Abjuration.ID);
        }
        ...
        protected override SourcePage GetSourcePage()
        {
            ...
            {
                Id = Guid.Parse("79eae97e-dbb7-4bcb-bdd5-f71d1f97d46e"),
