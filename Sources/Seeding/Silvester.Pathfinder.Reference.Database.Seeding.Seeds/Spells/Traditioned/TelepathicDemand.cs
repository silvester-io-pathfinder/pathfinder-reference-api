...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class TelepathicDemand : Template
    {
        ...
        {
            builder.Add(Guid.Parse("1a908f1e-eb04-4246-a553-e124c45ab30e"), Traits.Instances.Enchantment.ID);
            builder.Add(Guid.Parse("954eaf93-b347-48da-9fd6-fe742d1ab81c"), Traits.Instances.Incapacitation.ID);
            builder.Add(Guid.Parse("8ac4e298-f17a-4629-8ec7-333a332f0453"), Traits.Instances.Linguistic.ID);
            builder.Add(Guid.Parse("f3fac3af-75dd-49fc-9d9b-2695805e6323"), Traits.Instances.Mental.ID);
        }
