...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class RemoveParalysis : Template
    {
        ...
        {
            builder.Add(Guid.Parse("7eff9b06-2165-4679-bbab-886896b69d23"), Traits.Instances.Healing.ID);
            builder.Add(Guid.Parse("a584b5dc-867a-49a2-ae57-9cff7417bd1f"), Traits.Instances.Necromancy.ID);
        }
