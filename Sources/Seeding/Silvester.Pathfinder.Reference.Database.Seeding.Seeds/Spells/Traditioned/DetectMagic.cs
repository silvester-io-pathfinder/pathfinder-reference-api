...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class DetectMagic : Template
    {
        ...
        {
            builder.Add(Guid.Parse("8c9905a9-8a14-4aa8-937f-91bc97528bff"), Traits.Instances.Cantrip.ID);
            builder.Add(Guid.Parse("cb226da0-a8c7-4b29-ab32-c3bd941fcdcc"), Traits.Instances.Detection.ID);
            builder.Add(Guid.Parse("611c46cf-6164-451e-ad49-b8d818197f3b"), Traits.Instances.Divination.ID);
        }
