...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class SearingLight : Template
    {
        ...
        {
            builder.Add(Guid.Parse("a1135038-db69-45f2-baee-092990bb8081"), Traits.Instances.Attack.ID);
            builder.Add(Guid.Parse("84579204-f512-4703-ab6a-7d93cc8b1d3c"), Traits.Instances.Evocation.ID);
            builder.Add(Guid.Parse("56f48af1-ef6d-42ee-a123-ea917df54eac"), Traits.Instances.Fire.ID);
            builder.Add(Guid.Parse("a27c3aab-9062-4e54-8d47-4d55659023da"), Traits.Instances.Good.ID);
            builder.Add(Guid.Parse("49e2d029-fb16-462c-8c56-2e3cacaf206d"), Traits.Instances.Light.ID);
        }
