...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class DreamMessage : Template
    {
        ...
        {
            builder.Add(Guid.Parse("33d5b6a1-af8f-4658-89ee-bd01f4e5dc9c"), Traits.Instances.Enchantment.ID);
            builder.Add(Guid.Parse("4bd47c4e-8fae-4475-aacf-15bb6fb05157"), Traits.Instances.Mental.ID);
        }
