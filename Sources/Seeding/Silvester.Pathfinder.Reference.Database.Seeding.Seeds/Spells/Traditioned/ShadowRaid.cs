...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class ShadowRaid : Template
    {
        ...
        {
            builder.Add(Guid.Parse("63d4e967-5100-4980-966a-f48e7ad8e7c3"), Traits.Instances.Illusion.ID);
            builder.Add(Guid.Parse("ab7ed186-d4a1-41db-8c77-3b3dad47394a"), Traits.Instances.Shadow.ID);
        }
