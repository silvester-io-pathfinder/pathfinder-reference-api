...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class Confusion : Template
    {
        ...
        {
            builder.Add(Guid.Parse("f72726c5-1334-4dea-b07f-a105c709dca2"), Traits.Instances.Emotion.ID);
            builder.Add(Guid.Parse("568ffe20-5857-4395-ab1f-51d6d61979fc"), Traits.Instances.Enchantment.ID);
            builder.Add(Guid.Parse("3dd02a8b-b035-46e0-a7f6-61c3fe81686e"), Traits.Instances.Mental.ID);
        }
