...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class Disintegrate : Template
    {
        ...
        {
            builder.Add(Guid.Parse("a307950c-68be-4eda-8eac-b9bf0a8b2514"), Traits.Instances.Attack.ID);
            builder.Add(Guid.Parse("70240b12-aa84-4f91-8d51-cbe3482c6038"), Traits.Instances.Evocation.ID);
        }
