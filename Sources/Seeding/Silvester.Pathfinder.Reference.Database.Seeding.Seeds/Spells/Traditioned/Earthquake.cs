...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class Earthquake : Template
    {
        ...
        {
            builder.Add(Guid.Parse("8e681afa-6a2e-481b-8627-c8afef052a6e"), Traits.Instances.Earth.ID);
            builder.Add(Guid.Parse("2ced01d1-2f21-4ff1-ad02-454e9cb7ea76"), Traits.Instances.Evocation.ID);
        }
