...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class PryingEye : Template
    {
        ...
        {
            builder.Add(Guid.Parse("eea28472-4dfa-4f13-9f56-5ee52b5470ad"), Traits.Instances.Divination.ID);
            builder.Add(Guid.Parse("1ea05f5f-e761-435e-8f7c-06c5f0d1f937"), Traits.Instances.Scrying.ID);
        }
