...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class ShadowSiphon : Template
    {
        ...
        {
            builder.Add(Guid.Parse("92bafa6f-5573-4534-bf1a-f01a29309bdc"), Traits.Instances.Illusion.ID);
            builder.Add(Guid.Parse("5374cc46-d885-40a2-be77-e9250fa2a095"), Traits.Instances.Shadow.ID);
        }
