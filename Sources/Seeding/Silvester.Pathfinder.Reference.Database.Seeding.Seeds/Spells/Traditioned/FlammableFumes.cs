...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class FlammableFumes : Template
    {
        ...
        {
            builder.Add(Guid.Parse("a68beb8f-31c9-4250-981e-93aa78bc1997"), Traits.Instances.Conjuration.ID);
            builder.Add(Guid.Parse("26dd98f4-82ba-4d40-88d3-20cf4f4413ed"), Traits.Instances.Poison.ID);
        }
