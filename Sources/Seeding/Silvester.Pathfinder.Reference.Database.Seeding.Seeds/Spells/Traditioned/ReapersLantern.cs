...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class ReapersLantern : Template
    {
        ...
        {
            builder.Add(Guid.Parse("8b5fb754-1cf1-438a-92ac-c31be52cfeff"), Traits.Instances.Death.ID);
            builder.Add(Guid.Parse("e626fd43-863c-49d1-84c8-80893e0f60a9"), Traits.Instances.Light.ID);
            builder.Add(Guid.Parse("d7997e7f-f135-444d-a489-604cee0e7ebf"), Traits.Instances.Necromancy.ID);
        }
