...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class ModifyMemory : Template
    {
        ...
        {
            builder.Add(Guid.Parse("27af7e39-d101-46f2-9bfe-24dd91486455"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("25622719-7b06-4c98-9eae-6f2a0033c144"), Traits.Instances.Divination.ID);
            builder.Add(Guid.Parse("ef9cce4c-6768-4a21-bb99-1c41fe86ea8d"), Traits.Instances.Mental.ID);
        }
