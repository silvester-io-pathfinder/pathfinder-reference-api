...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class WallOfForce : Template
    {
        ...
        {
            builder.Add(Guid.Parse("5db3577b-b058-42e5-a215-4e50a60ae182"), Traits.Instances.Evocation.ID);
            builder.Add(Guid.Parse("aa5ff60a-1d68-4d0b-bdf7-f67b310e03e2"), Traits.Instances.Force.ID);
        }
