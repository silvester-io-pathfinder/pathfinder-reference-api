...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class RaiseDead : Template
    {
        ...
        {
            builder.Add(Guid.Parse("4b7b6a7c-5f28-4bad-8111-f38fda200d5b"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("fe777fe9-c367-4547-9cfd-507b1ea5a863"), Traits.Instances.Healing.ID);
            builder.Add(Guid.Parse("27a5b2f6-b222-4b72-8309-7cd3828989cf"), Traits.Instances.Necromancy.ID);
        }
