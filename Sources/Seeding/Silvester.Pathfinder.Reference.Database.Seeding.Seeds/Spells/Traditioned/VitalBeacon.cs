...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class VitalBeacon : Template
    {
        ...
        {
            builder.Add(Guid.Parse("3dc18d5b-c3d6-4f85-9ce4-937e844031fe"), Traits.Instances.Healing.ID);
            builder.Add(Guid.Parse("5fa1abff-63da-4a1a-8341-1404f6cd2fa2"), Traits.Instances.Necromancy.ID);
            builder.Add(Guid.Parse("9694d62c-9cd6-487e-851e-415aa64d35ea"), Traits.Instances.Positive.ID);
        }
