...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class ShatteringGem : Template
    {
        ...
        {
            builder.Add(Guid.Parse("9ddad0b8-f5b7-4fc6-9b05-3f4ef7b5b1b0"), Traits.Instances.Abjuration.ID);
            builder.Add(Guid.Parse("69515cf8-1386-4f93-bd7c-fbe452cfe2d9"), Traits.Instances.Earth.ID);
        }
