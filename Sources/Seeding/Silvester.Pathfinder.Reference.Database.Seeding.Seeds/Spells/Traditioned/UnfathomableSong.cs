...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    ...
    {
        public static readonly Guid ID = Guid.Parse("71731631-7fb9-4bea-8b7e-d2c4ddcd655c");
        ...
        {
            builder.Add(Guid.Parse("a2a24710-c08e-477f-9c95-7c4a506e1d29"), Traits.Instances.Auditory.ID);
            builder.Add(Guid.Parse("44d2b76a-d3f4-482a-b082-9ee4aa20c19a"), Traits.Instances.Emotion.ID);
            builder.Add(Guid.Parse("227896e7-5b0a-4ff8-aa0a-3c35f97e85f6"), Traits.Instances.Enchantment.ID);
            builder.Add(Guid.Parse("16c365f1-e19a-40b6-9165-7557c977829e"), Traits.Instances.Fear.ID);
            builder.Add(Guid.Parse("cdd77b17-c1fd-47b6-a692-ff34f8107ff9"), Traits.Instances.Incapacitation.ID);
            builder.Add(Guid.Parse("f7c5ac8e-01e9-4819-b573-32a6dc28eecd"), Traits.Instances.Mental.ID);
        }
        ...
        protected override SourcePage GetSourcePage()
        {
            ...
            {
                Id = Guid.Parse("6c233263-a22f-4453-9cc9-bc37a80732f5"),
