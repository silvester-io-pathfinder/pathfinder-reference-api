...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class PurpleWormSting : Template
    {
        ...
        {
            builder.Add(Guid.Parse("7e1c167f-469b-4b15-8e8a-d3e8e0759d9f"), Traits.Instances.Necromancy.ID);
            builder.Add(Guid.Parse("64c0ffaf-18e1-4d8f-b6f1-52fdeb9ae74a"), Traits.Instances.Poison.ID);
        }
