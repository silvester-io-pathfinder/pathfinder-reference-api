...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class FloatingDisk : Template
    {
        ...
        {
            builder.Add(Guid.Parse("3be9d91b-1aa1-425a-9b8e-f678b77fed09"), Traits.Instances.Conjuration.ID);
            builder.Add(Guid.Parse("d816cbe9-00de-491f-ba14-3d783f1c8a57"), Traits.Instances.Force.ID);
        }
