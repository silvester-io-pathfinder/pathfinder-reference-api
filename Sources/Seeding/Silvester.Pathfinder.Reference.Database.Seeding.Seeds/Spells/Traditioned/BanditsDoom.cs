...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class BanditsDoom : Template
    {
        ...
        {
            builder.Add(Guid.Parse("2615f8b7-ab1d-41f0-87d2-9f3796bfbed7"), Traits.Instances.Abjuration.ID);
            builder.Add(Guid.Parse("aa5c7051-58fd-4fdd-a085-283e311f543f"), Traits.Instances.Curse.ID);
        }
