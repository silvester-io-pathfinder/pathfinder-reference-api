...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class AnimalVision : Template
    {
        ...
        {
            builder.Add(Guid.Parse("d78c0335-61cf-470f-95da-9405bee7337f"), Traits.Instances.Divination.ID);
            builder.Add(Guid.Parse("22ecba71-bc2f-4a46-ba51-04a56964cc39"), Traits.Instances.Mental.ID);
        }
