...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class RayOfEnfeeblement : Template
    {
        ...
        {
            builder.Add(Guid.Parse("b52c1990-581b-4768-bae1-7a019880bcc0"), Traits.Instances.Attack.ID);
            builder.Add(Guid.Parse("22055c85-042b-4d88-b024-052f51e143a4"), Traits.Instances.Necromancy.ID);
        }
