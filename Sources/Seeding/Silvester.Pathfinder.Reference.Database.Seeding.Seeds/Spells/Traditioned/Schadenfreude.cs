...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class Schadenfreude : Template
    {
        ...
        {
            builder.Add(Guid.Parse("8a5acbc7-1e86-4b09-b9d4-d582d02d3733"), Traits.Instances.Emotion.ID);
            builder.Add(Guid.Parse("258a8265-c761-4829-ba6e-92d275c44cb5"), Traits.Instances.Enchantment.ID);
            builder.Add(Guid.Parse("1b682e62-9537-4491-b146-6ff6f24a335f"), Traits.Instances.Mental.ID);
        }
