...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class WallOfIce : Template
    {
        ...
        {
            builder.Add(Guid.Parse("82fd0332-4c88-4994-b557-a1e090e32bec"), Traits.Instances.Cold.ID);
            builder.Add(Guid.Parse("f49ea77f-964f-4a20-ab64-905736388b1f"), Traits.Instances.Evocation.ID);
            builder.Add(Guid.Parse("681698e6-0d6e-47bc-aaaf-bbe9df22cc81"), Traits.Instances.Water.ID);
        }
