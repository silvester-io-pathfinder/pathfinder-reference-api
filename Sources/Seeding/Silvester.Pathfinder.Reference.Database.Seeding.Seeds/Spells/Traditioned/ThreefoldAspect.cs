...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class ThreefoldAspect : Template
    {
        ...
        {
            builder.Add(Guid.Parse("6fbde74e-a951-4b4e-8f9f-a6d9f78ced05"), Traits.Instances.Polymorph.ID);
            builder.Add(Guid.Parse("170d29d1-de64-46a5-8722-8b13a2e6c42f"), Traits.Instances.Transmutation.ID);
        }
