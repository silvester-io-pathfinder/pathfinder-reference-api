...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class IllOmen : Template
    {
        ...
        {
            builder.Add(Guid.Parse("9c66b9ee-49de-4d94-820c-13873e848eda"), Traits.Instances.Curse.ID);
            builder.Add(Guid.Parse("2ecd7c50-945b-4399-9af0-7417c5cfa8c7"), Traits.Instances.Divination.ID);
            builder.Add(Guid.Parse("8d9787f3-fc31-4c02-9984-c7c96416e48a"), Traits.Instances.Misfortune.ID);
        }
