...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class SpiritLink : Template
    {
        ...
        {
            builder.Add(Guid.Parse("4b8b34d3-0170-4fe5-8752-3d4ccf7284ad"), Traits.Instances.Healing.ID);
            builder.Add(Guid.Parse("26bef200-7073-4d84-adc2-5a549cf55d72"), Traits.Instances.Necromancy.ID);
        }
