...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class VampiricTouch : Template
    {
        ...
        {
            builder.Add(Guid.Parse("b90b68d9-5b91-4a72-bbc7-9f9881d10b04"), Traits.Instances.Death.ID);
            builder.Add(Guid.Parse("f5b3de8f-37e1-441d-96b3-619599c79edf"), Traits.Instances.Necromancy.ID);
            builder.Add(Guid.Parse("aa257b66-ad3c-4895-8c65-1b62e919dded"), Traits.Instances.Negative.ID);
        }
