...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class HydraulicPush : Template
    {
        ...
        {
            builder.Add(Guid.Parse("2509628f-9ea6-4e17-bd77-12e707c8144f"), Traits.Instances.Attack.ID);
            builder.Add(Guid.Parse("2a0fe590-c786-4171-adad-6a6e0244df53"), Traits.Instances.Evocation.ID);
            builder.Add(Guid.Parse("2216f0fb-c912-45f1-b26a-245dfbdd8649"), Traits.Instances.Water.ID);
        }
