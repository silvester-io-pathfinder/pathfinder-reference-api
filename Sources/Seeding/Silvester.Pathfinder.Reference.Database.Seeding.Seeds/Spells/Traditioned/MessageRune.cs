...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class MessageRune : Template
    {
        ...
        {
            builder.Add(Guid.Parse("1169969a-299d-49f3-a5e5-9bd158c5a0e5"), Traits.Instances.Divination.ID);
            builder.Add(Guid.Parse("8d9d6fd7-266d-400f-902c-41242d48b2a8"), Traits.Instances.Linguistic.ID);
            builder.Add(Guid.Parse("18a10e1d-4291-47bf-9c25-612286131e92"), Traits.Instances.Mental.ID);
        }
