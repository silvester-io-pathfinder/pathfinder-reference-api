...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class Fireball : Template
    {
        ...
        {
            builder.Add(Guid.Parse("9c538583-a86e-4066-85c6-18cd06a11ac9"), Traits.Instances.Evocation.ID);
            builder.Add(Guid.Parse("4963e58a-a084-4600-b532-9812e8e2198e"), Traits.Instances.Fire.ID);
        }
