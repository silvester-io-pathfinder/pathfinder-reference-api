...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class Shrink : Template
    {
        ...
        {
            builder.Add(Guid.Parse("3363acb5-15d7-4614-84cf-c7c3afcd6abe"), Traits.Instances.Polymorph.ID);
            builder.Add(Guid.Parse("47c8174d-8d9a-4ab6-8b4a-8aa9c1b075d7"), Traits.Instances.Transmutation.ID);
        }
