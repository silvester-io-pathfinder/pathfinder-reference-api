...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class MindProbe : Template
    {
        ...
        {
            builder.Add(Guid.Parse("aede5bb1-a3a3-45f2-a77a-281d42a818bd"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("9bd21a70-8e27-410a-ae96-f3f26b02341c"), Traits.Instances.Divination.ID);
            builder.Add(Guid.Parse("952a68ed-e674-43c1-a434-2e6802ce4a58"), Traits.Instances.Linguistic.ID);
            builder.Add(Guid.Parse("1cb6577e-ff5d-442d-83a1-5096b367c723"), Traits.Instances.Mental.ID);
        }
