...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class ThoughtfulGift : Template
    {
        ...
        {
            builder.Add(Guid.Parse("9b38a4ae-2f60-4e06-bb90-e7f2f230acc3"), Traits.Instances.Conjuration.ID);
            builder.Add(Guid.Parse("5ed02706-fba0-4577-ac72-44ad4dc34e47"), Traits.Instances.Teleportation.ID);
        }
