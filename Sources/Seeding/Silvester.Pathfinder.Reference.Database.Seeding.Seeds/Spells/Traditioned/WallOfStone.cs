...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class WallOfStone : Template
    {
        ...
        {
            builder.Add(Guid.Parse("7fc00b46-0937-43c1-8b85-e2f00b4c1058"), Traits.Instances.Conjuration.ID);
            builder.Add(Guid.Parse("d0288caa-c2ab-4f23-9587-bbdf82f76122"), Traits.Instances.Earth.ID);
        }
