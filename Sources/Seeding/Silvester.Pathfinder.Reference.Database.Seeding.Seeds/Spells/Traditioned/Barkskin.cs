...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class Barkskin : Template
    {
        ...
        {
            builder.Add(Guid.Parse("209946e5-ca6f-485f-a2a6-ac03d76511b0"), Traits.Instances.Abjuration.ID);
            builder.Add(Guid.Parse("edf96cda-cd1f-41f0-8006-508d4cdd4f58"), Traits.Instances.Plant.ID);
        }
