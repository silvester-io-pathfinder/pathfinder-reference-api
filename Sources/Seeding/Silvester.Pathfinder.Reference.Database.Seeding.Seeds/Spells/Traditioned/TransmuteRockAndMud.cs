...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class TransmuteRockAndMud : Template
    {
        ...
        {
            builder.Add(Guid.Parse("8034e628-b6af-4be8-8830-7073c505c0d6"), Traits.Instances.Earth.ID);
            builder.Add(Guid.Parse("0d089b5f-60fc-491c-814f-05f7addc6c33"), Traits.Instances.Transmutation.ID);
        }
