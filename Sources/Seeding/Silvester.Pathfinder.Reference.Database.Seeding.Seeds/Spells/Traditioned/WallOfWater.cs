...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class WallOfWater : Template
    {
        ...
        {
            builder.Add(Guid.Parse("98a2074e-659c-4fc5-81bc-0529790f6d41"), Traits.Instances.Conjuration.ID);
            builder.Add(Guid.Parse("ff26229b-e5e7-4f1b-a247-a1af12a69ea6"), Traits.Instances.Water.ID);
        }
