...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class AgonizingDespair : Template
    {
        ...
        {
            builder.Add(Guid.Parse("59d22d2e-a26a-4b62-9240-70688f7a51b6"), Traits.Instances.Emotion.ID);
            builder.Add(Guid.Parse("7d817aaf-906d-47f7-a6f2-6a72b86137de"), Traits.Instances.Enchantment.ID);
            builder.Add(Guid.Parse("e2624699-5cf5-4a9e-b81f-e37e759ca6c4"), Traits.Instances.Fear.ID);
            builder.Add(Guid.Parse("b74e4e34-2061-40df-8b77-a53748dacaa1"), Traits.Instances.Mental.ID);
        }
