...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class AcidStorm : Template
    {
        ...
        {
            builder.Add(Guid.Parse("6309041d-5831-4698-8e70-4319acefea9e"), Traits.Instances.Acid.ID);
            builder.Add(Guid.Parse("29075698-fd2d-4185-a549-a067dd96675a"), Traits.Instances.Evocation.ID);
        }
