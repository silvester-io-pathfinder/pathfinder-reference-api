...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class DivineVessel : Template
    {
        ...
        {
            builder.Add(Guid.Parse("710d9167-e865-40e7-b350-81dbf065f08e"), Traits.Instances.Morph.ID);
            builder.Add(Guid.Parse("974a69d7-f2e4-4e0f-a71c-481516fd2544"), Traits.Instances.Transmutation.ID);
        }
