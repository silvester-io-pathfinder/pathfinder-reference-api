...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class ZealousConviction : Template
    {
        ...
        {
            builder.Add(Guid.Parse("f3d178a9-b17d-4279-9fea-f2a12ce9fa3a"), Traits.Instances.Emotion.ID);
            builder.Add(Guid.Parse("4c317bd8-b935-4321-b84e-a65829f5b74d"), Traits.Instances.Enchantment.ID);
            builder.Add(Guid.Parse("8b7e2b5d-7be4-41bf-8ed2-39303b3e51ae"), Traits.Instances.Mental.ID);
        }
