...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    ...
    public class PenumbralDisguise : Template
    {
        ...
        {
            builder.Add(Guid.Parse("df9471cc-77ac-44eb-bb9c-eb562ad50d14"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("7f58ba71-3b94-4dba-9f86-ffaf99afa493"), Traits.Instances.Illusion.ID);
            builder.Add(Guid.Parse("05b940b3-8b2f-4664-8fae-dfeb4f74b66e"), Traits.Instances.Shadow.ID);
        }
