...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class AcidArrow : Template
    {
        ...
        {
            builder.Add(Guid.Parse("04d89851-1023-4530-92e6-e5d4d0534e76"), Traits.Instances.Acid.ID);
            builder.Add(Guid.Parse("2a6cd341-019c-445d-88e5-e9569b08d31b"), Traits.Instances.Attack.ID);
            builder.Add(Guid.Parse("08692d88-3595-4e16-a666-33d7261667fb"), Traits.Instances.Evocation.ID);
        }
