...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class VisionsOfDanger : Template
    {
        ...
        {
            builder.Add(Guid.Parse("8e21cfcf-84ae-4ba6-a778-d8cffd1b431d"), Traits.Instances.Auditory.ID);
            builder.Add(Guid.Parse("8b5e8408-50e3-44c2-a589-0809bbef43e3"), Traits.Instances.Illusion.ID);
            builder.Add(Guid.Parse("ae5f81db-17fc-4b01-95f1-58a0d779e56a"), Traits.Instances.Visual.ID);
        }
