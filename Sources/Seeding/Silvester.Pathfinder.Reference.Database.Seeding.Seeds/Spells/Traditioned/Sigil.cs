...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class Sigil : Template
    {
        ...
        {
            builder.Add(Guid.Parse("db0d5439-838c-4292-b638-9fd994c2b946"), Traits.Instances.Cantrip.ID);
            builder.Add(Guid.Parse("b4b0a130-3afe-4750-8409-519d4891085c"), Traits.Instances.Transmutation.ID);
        }
