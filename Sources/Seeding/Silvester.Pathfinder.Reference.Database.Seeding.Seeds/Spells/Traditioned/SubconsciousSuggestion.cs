...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class SubconsciousSuggestion : Template
    {
        ...
        {
            builder.Add(Guid.Parse("9f7dbc0e-bd4a-465d-bd7b-906d1af671c2"), Traits.Instances.Enchantment.ID);
            builder.Add(Guid.Parse("87bf8233-631e-41cc-87ee-a91ff5b6f7fc"), Traits.Instances.Incapacitation.ID);
            builder.Add(Guid.Parse("19be20fe-ed7b-4402-be6a-76d7c5874247"), Traits.Instances.Linguistic.ID);
            builder.Add(Guid.Parse("f0e11cc5-81a1-4d77-9356-ac0ad028dba9"), Traits.Instances.Mental.ID);
        }
