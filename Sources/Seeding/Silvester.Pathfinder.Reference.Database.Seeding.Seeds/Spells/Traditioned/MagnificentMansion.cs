...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class MagnificentMansion : Template
    {
        ...
        {
            builder.Add(Guid.Parse("700a38ff-50f3-46a6-8b27-9a233ed0b3cc"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("26b3d921-15c0-465b-aa3c-7e03e2b7539a"), Traits.Instances.Conjuration.ID);
            builder.Add(Guid.Parse("eafb07ff-2e47-4360-9483-549f7c922d5c"), Traits.Instances.Extradimensional.ID);
        }
