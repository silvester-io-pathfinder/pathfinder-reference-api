...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class AnimusMine : Template
    {
        ...
        {
            builder.Add(Guid.Parse("58665d3e-1fed-4e96-8a48-c690dc4a038d"), Traits.Instances.Abjuration.ID);
            builder.Add(Guid.Parse("15e00677-93f0-4dc9-b3c7-ad1ff73b48ae"), Traits.Instances.Mental.ID);
        }
