...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class EnvenomCompanion : Template
    {
        ...
        {
            builder.Add(Guid.Parse("e58fc0b5-37e2-4ef3-a5dd-86c932206938"), Traits.Instances.Necromancy.ID);
            builder.Add(Guid.Parse("931b9c81-a5e5-4e69-b912-a7a5af879f8d"), Traits.Instances.Poison.ID);
        }
