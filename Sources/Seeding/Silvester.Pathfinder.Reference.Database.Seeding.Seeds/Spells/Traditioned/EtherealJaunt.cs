...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class EtherealJaunt : Template
    {
        ...
        {
            builder.Add(Guid.Parse("b87e5659-6c24-436a-8153-b9ae5864dadf"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("f0b49227-5d1c-479c-8ade-e2fd598e6730"), Traits.Instances.Conjuration.ID);
            builder.Add(Guid.Parse("3ab56f00-946d-4df4-8f8e-d77e6a4242a7"), Traits.Instances.Teleportation.ID);
        }
