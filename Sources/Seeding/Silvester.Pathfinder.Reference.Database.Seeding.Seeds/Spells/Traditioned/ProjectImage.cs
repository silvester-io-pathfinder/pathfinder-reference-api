...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class ProjectImage : Template
    {
        ...
        {
            builder.Add(Guid.Parse("28325db7-164b-4e2c-aaf7-ce1e4b230d92"), Traits.Instances.Illusion.ID);
            builder.Add(Guid.Parse("78881956-7c58-46ac-8d8b-70e92600f7c5"), Traits.Instances.Mental.ID);
        }
