...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class FingerOfDeath : Template
    {
        ...
        {
            builder.Add(Guid.Parse("564daa65-08ab-48e3-918c-ec69cea71810"), Traits.Instances.Death.ID);
            builder.Add(Guid.Parse("935b6bf9-9520-45ad-b858-d51461f18506"), Traits.Instances.Necromancy.ID);
        }
