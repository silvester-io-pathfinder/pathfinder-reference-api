...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class Remake : Template
    {
        ...
        {
            builder.Add(Guid.Parse("555ed15a-ef0d-49d2-b493-87b0a82c90f3"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("0162a01c-fbb8-4db1-9d52-d2ea272ee229"), Traits.Instances.Conjuration.ID);
        }
