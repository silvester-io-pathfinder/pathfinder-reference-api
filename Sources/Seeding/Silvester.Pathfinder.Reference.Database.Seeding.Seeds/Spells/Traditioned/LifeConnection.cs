    ...
    public class LifeConnection : Template
    {
        ...
        protected override IEnumerable<InlineAction> GetInlineActions()
        {
            yield return new InlineAction
            {
                ...
                Traits = new[]
                {
                    new InlineActionTraitBinding { Id = Guid.Parse("054f85e3-50eb-4e6e-b516-365f865ececc"), TraitId = Traits.Instances.Concentrate.ID },
                },
                Effect = new[]
                {
        ...
        {
            builder.Add(Guid.Parse("fe3623dc-a005-4fb5-98be-517026ebdd46"), Traits.Instances.Contingency.ID);
            builder.Add(Guid.Parse("52b93304-8b28-4b00-9d3e-b632696366bd"), Traits.Instances.Necromancy.ID);
        }
