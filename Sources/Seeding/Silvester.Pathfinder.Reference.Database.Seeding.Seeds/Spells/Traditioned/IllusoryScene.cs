...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class IllusoryScene : Template
    {
        ...
        {
            builder.Add(Guid.Parse("6967c6c8-ef40-4702-9744-8b38dde16024"), Traits.Instances.Auditory.ID);
            builder.Add(Guid.Parse("1466270d-082e-4566-a20f-a53dd1c7cdf7"), Traits.Instances.Illusion.ID);
            builder.Add(Guid.Parse("32257d4d-2a29-4300-a898-cc26650c5c6d"), Traits.Instances.Olfactory.ID);
            builder.Add(Guid.Parse("e75e5483-ecd8-4526-b9b9-0f048a764e50"), Traits.Instances.Visual.ID);
        }
