...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class Sunburst : Template
    {
        ...
        {
            builder.Add(Guid.Parse("db4dc79b-2e1b-4ac7-99fb-20ab453a68ac"), Traits.Instances.Evocation.ID);
            builder.Add(Guid.Parse("d13a2509-612a-488f-91ce-3c386b9e2354"), Traits.Instances.Fire.ID);
            builder.Add(Guid.Parse("42f9538e-3bbc-43e2-ae36-1ed8690f4013"), Traits.Instances.Light.ID);
            builder.Add(Guid.Parse("b7c195f4-7351-45f3-b2d8-35907ea6a9a3"), Traits.Instances.Positive.ID);
        }
