...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class Possession : Template
    {
        ...
        {
            builder.Add(Guid.Parse("66b63f86-5f13-4f53-a3f9-c0e00775f241"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("6a860fa6-7ecd-45bd-a9a7-122ef31cb2a5"), Traits.Instances.Incapacitation.ID);
            builder.Add(Guid.Parse("29ca7047-ab9e-449e-a683-326e32d747ff"), Traits.Instances.Mental.ID);
            builder.Add(Guid.Parse("04c18049-1563-490e-a256-8c78737326f5"), Traits.Instances.Necromancy.ID);
            builder.Add(Guid.Parse("0c9a6bfa-2ee9-45b6-a5a1-1dfff222fd28"), Traits.Instances.Possession.ID);
        }
