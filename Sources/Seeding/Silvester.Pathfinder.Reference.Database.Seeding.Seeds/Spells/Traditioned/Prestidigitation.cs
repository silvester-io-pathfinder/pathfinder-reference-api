...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class Prestidigitation : Template
    {
        ...
        {
            builder.Add(Guid.Parse("9a2dcf33-974d-4639-8fd3-25e96afe4f1b"), Traits.Instances.Cantrip.ID);
            builder.Add(Guid.Parse("4828470e-daa7-454c-be2a-8fb856bee7fb"), Traits.Instances.Evocation.ID);
        }
