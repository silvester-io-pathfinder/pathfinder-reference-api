...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class HorridWilting : Template
    {
        ...
        {
            builder.Add(Guid.Parse("c4c5655a-54f0-4191-a76f-88d976e9be74"), Traits.Instances.Necromancy.ID);
            builder.Add(Guid.Parse("0c854412-299d-4fc7-b486-a50412dec364"), Traits.Instances.Negative.ID);
        }
