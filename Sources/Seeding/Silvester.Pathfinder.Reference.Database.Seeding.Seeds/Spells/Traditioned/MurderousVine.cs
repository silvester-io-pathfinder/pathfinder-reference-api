...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class MurderousVine : Template
    {
        ...
        {
            builder.Add(Guid.Parse("c8bf1b45-e1eb-49aa-aeec-b8b61829fdbe"), Traits.Instances.Attack.ID);
            builder.Add(Guid.Parse("0767a9e8-6215-44ad-8c23-9a7d683b0a65"), Traits.Instances.Conjuration.ID);
            builder.Add(Guid.Parse("669d0bff-358a-4ddb-9179-cd48f0addc8b"), Traits.Instances.Plant.ID);
        }
