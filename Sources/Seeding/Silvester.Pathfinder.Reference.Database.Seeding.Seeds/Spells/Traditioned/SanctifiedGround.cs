...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class SanctifiedGround : Template
    {
        ...
        {
            builder.Add(Guid.Parse("c959c521-9ba6-4c2c-a7b0-efa943109367"), Traits.Instances.Abjuration.ID);
            builder.Add(Guid.Parse("f7a91177-6710-4175-8720-2fb7120b148a"), Traits.Instances.Consecration.ID);
        }
