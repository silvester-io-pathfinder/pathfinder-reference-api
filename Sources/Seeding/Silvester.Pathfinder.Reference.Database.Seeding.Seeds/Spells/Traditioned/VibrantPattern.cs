...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class VibrantPattern : Template
    {
        ...
        {
            builder.Add(Guid.Parse("1f9b9b1b-bb80-4680-b4da-04dbbe73325e"), Traits.Instances.Illusion.ID);
            builder.Add(Guid.Parse("601a3cc6-fead-423d-94dc-68b4658ba6e2"), Traits.Instances.Incapacitation.ID);
            builder.Add(Guid.Parse("a8866f4c-1bef-48ef-963b-637edfb7d3c2"), Traits.Instances.Visual.ID);
        }
