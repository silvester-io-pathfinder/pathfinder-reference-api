...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class Enthrall : Template
    {
        ...
        {
            builder.Add(Guid.Parse("5cfecbab-edf8-4648-b97d-6abc83e45347"), Traits.Instances.Auditory.ID);
            builder.Add(Guid.Parse("2b9ae336-de3e-4878-b9be-9f142d182c0e"), Traits.Instances.Emotion.ID);
            builder.Add(Guid.Parse("2c489662-1c37-4b60-a98d-7612b651ea9f"), Traits.Instances.Enchantment.ID);
        }
