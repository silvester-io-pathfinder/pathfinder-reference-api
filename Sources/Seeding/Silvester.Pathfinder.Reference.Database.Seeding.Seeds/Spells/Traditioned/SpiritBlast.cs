...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class SpiritBlast : Template
    {
        ...
        {
            builder.Add(Guid.Parse("77d22fc9-b5af-4bbc-be59-3a47f6a493d9"), Traits.Instances.Force.ID);
            builder.Add(Guid.Parse("a4739c20-c2f1-45ed-91e1-4ab95736aad2"), Traits.Instances.Necromancy.ID);
        }
