...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class BlazingFissure : Template
    {
        ...
        {
            builder.Add(Guid.Parse("fea3e274-c740-475f-9302-7770c2dbb5fc"), Traits.Instances.Earth.ID);
            builder.Add(Guid.Parse("a4f2a09e-81b7-4415-b92b-40d9ffd6a3b3"), Traits.Instances.Evocation.ID);
            builder.Add(Guid.Parse("2d35d51a-5f79-4253-b4e4-d40d7f597847"), Traits.Instances.Fire.ID);
        }
