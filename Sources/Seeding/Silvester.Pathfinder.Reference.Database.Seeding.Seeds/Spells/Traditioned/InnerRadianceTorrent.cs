...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class InnerRadianceTorrent : Template
    {
        ...
        {
            builder.Add(Guid.Parse("acae866b-f8a8-49e9-a5fc-8eb108309f58"), Traits.Instances.Force.ID);
            builder.Add(Guid.Parse("510c4c9e-b8a6-4564-82c2-b4c3bc9fb39d"), Traits.Instances.Light.ID);
            builder.Add(Guid.Parse("87ca1ae3-1b2e-4b30-b56d-6645c98f58ad"), Traits.Instances.Necromancy.ID);
        }
