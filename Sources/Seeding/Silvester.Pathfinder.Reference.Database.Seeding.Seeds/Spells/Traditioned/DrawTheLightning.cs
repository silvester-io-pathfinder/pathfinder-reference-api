...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class DrawTheLightning : Template
    {
        ...
        {
            builder.Add(Guid.Parse("21865b81-8ef3-4f8c-952f-3ffa987b7d4b"), Traits.Instances.Electricity.ID);
            builder.Add(Guid.Parse("255963d2-5771-4f09-88e4-593b247a7102"), Traits.Instances.Evocation.ID);
        }
