...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class Pyrotechnics : Template
    {
        ...
        {
            builder.Add(Guid.Parse("55f3b495-04c0-4d05-b13d-4848c5dccf37"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("b492893b-3c60-42b0-8cc0-9eecbfa8227a"), Traits.Instances.Fire.ID);
            builder.Add(Guid.Parse("4b7b7cf2-85ec-402b-b405-866006c92594"), Traits.Instances.Transmutation.ID);
        }
