...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class SoothingSpring : Template
    {
        ...
        {
            builder.Add(Guid.Parse("7a553076-4319-4109-a0fb-17836ba595c1"), Traits.Instances.Healing.ID);
            builder.Add(Guid.Parse("eb556983-eab7-44f4-ae0d-4f75b24283c3"), Traits.Instances.Necromancy.ID);
            builder.Add(Guid.Parse("55bdf045-9eb9-4183-b255-5fc45d3e2f8f"), Traits.Instances.Positive.ID);
            builder.Add(Guid.Parse("fbaffea4-defe-4d2c-ba86-31c61aa59f3a"), Traits.Instances.Water.ID);
        }
