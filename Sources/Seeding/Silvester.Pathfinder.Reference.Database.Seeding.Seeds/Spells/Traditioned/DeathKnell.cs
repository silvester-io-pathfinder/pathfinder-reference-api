...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class DeathKnell : Template
    {
        ...
        {
            builder.Add(Guid.Parse("36e95e66-6107-4f59-bf81-a5ba832a538e"), Traits.Instances.Death.ID);
            builder.Add(Guid.Parse("9d1d27fc-928b-48de-adbe-a5937651d321"), Traits.Instances.Necromancy.ID);
        }
        ...
        protected override SourcePage GetSourcePage()
        {
            ...
            {
                Id = Guid.Parse("d25f5d33-88ea-4309-9f17-3332c18c80be"),
