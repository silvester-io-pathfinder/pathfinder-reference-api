...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class LightningStorm : Template
    {
        ...
        {
            builder.Add(Guid.Parse("c9ec76a8-0926-4758-92c8-5e3ec7a65b66"), Traits.Instances.Electricity.ID);
            builder.Add(Guid.Parse("25f58f5c-2f18-4c99-911b-6426a26db03c"), Traits.Instances.Evocation.ID);
        }
