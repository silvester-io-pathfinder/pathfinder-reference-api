...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class SanguineMist : Template
    {
        ...
        {
            builder.Add(Guid.Parse("388c0c8b-1c5b-4347-a696-3bf64f2d2172"), Traits.Instances.Death.ID);
            builder.Add(Guid.Parse("d866163d-6b5f-43c7-b81f-be195af37723"), Traits.Instances.Necromancy.ID);
            builder.Add(Guid.Parse("21973412-1b0f-4b00-af95-78197cf8d724"), Traits.Instances.Negative.ID);
        }
