...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class CosmicForm : Template
    {
        ...
        {
            builder.Add(Guid.Parse("a2a45f3a-f37e-404e-8e53-cfc3a22831f8"), Traits.Instances.Polymorph.ID);
            builder.Add(Guid.Parse("dedd17d2-49af-49d8-994e-f2455dfcc2c2"), Traits.Instances.Transmutation.ID);
        }
