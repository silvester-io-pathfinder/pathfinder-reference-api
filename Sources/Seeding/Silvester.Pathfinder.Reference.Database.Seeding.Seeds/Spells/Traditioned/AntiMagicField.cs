...
{
    public class AntiMagicField : Template
    {
        ...
        {
            builder.Add(Guid.Parse("6db4f28d-ed3e-44ad-8a7f-834ae8198402"), Traits.Instances.Rare.ID);
            builder.Add(Guid.Parse("783a23b7-b4fb-47e0-a6ea-d2063881b384"), Traits.Instances.Abjuration.ID);
        }
        ...
        protected override SourcePage GetSourcePage()
        {
            ...
            {
                Id = Guid.Parse("cea943b3-b4c4-4880-94e1-76cc50bbc112"),
