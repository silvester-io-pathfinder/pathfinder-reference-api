...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class AirWalk : Template
    {
        ...
        {
            builder.Add(Guid.Parse("63e5180d-73b7-4e5e-926a-391477f2063d"), Traits.Instances.Air.ID);
            builder.Add(Guid.Parse("66d52117-28cb-4042-a713-9d6a9c2e2c10"), Traits.Instances.Transmutation.ID);
        }
