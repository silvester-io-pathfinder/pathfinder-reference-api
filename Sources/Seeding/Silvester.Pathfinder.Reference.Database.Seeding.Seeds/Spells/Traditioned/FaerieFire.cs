...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class FaerieFire : Template
    {
        ...
        {
            builder.Add(Guid.Parse("5243f2a5-1cb0-462d-b5c1-7380c37788fe"), Traits.Instances.Evocation.ID);
            builder.Add(Guid.Parse("58069ecd-d595-48f1-a399-91d06ba49003"), Traits.Instances.Light.ID);
        }
