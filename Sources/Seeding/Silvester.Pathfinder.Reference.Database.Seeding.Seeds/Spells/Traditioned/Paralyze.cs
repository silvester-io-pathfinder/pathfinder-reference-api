...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class Paralyze : Template
    {
        ...
        {
            builder.Add(Guid.Parse("a34a2ccc-98f9-4884-92f6-db2a7613d9f3"), Traits.Instances.Enchantment.ID);
            builder.Add(Guid.Parse("162c50aa-ee5f-4ffb-857f-e8afcbe1144e"), Traits.Instances.Incapacitation.ID);
            builder.Add(Guid.Parse("71bee845-5443-47b6-9422-5a3ecf38f08c"), Traits.Instances.Mental.ID);
        }
