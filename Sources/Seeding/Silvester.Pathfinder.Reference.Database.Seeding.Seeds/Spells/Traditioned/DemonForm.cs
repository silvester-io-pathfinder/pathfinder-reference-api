...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class DemonForm : Template
    {
        ...
        {
            builder.Add(Guid.Parse("4ee85851-5829-430a-9204-7f5076aa888a"), Traits.Instances.Chaotic.ID);
            builder.Add(Guid.Parse("3f3e7361-7959-4092-b7f6-94dcbc99ece7"), Traits.Instances.Evil.ID);
            builder.Add(Guid.Parse("fa7547a7-ca0b-47ab-a5f0-3be18af083ab"), Traits.Instances.Polymorph.ID);
            builder.Add(Guid.Parse("4b1fdeb6-ed91-429a-889f-94f4ceeabeff"), Traits.Instances.Transmutation.ID);
        }
