...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class Massacre : Template
    {
        ...
        {
            builder.Add(Guid.Parse("46a3bffc-5bf9-4d67-97f7-35a4f4e4b193"), Traits.Instances.Death.ID);
            builder.Add(Guid.Parse("dee6337e-0b09-430a-a935-c3b3aad536a2"), Traits.Instances.Necromancy.ID);
            builder.Add(Guid.Parse("ca196a6e-3ced-41dd-b948-02e7c50191ef"), Traits.Instances.Negative.ID);
        }
