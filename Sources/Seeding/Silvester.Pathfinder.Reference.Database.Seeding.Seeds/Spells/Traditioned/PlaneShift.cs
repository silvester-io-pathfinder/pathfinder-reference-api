...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class PlaneShift : Template
    {
        ...
        {
            builder.Add(Guid.Parse("5de2709d-e387-4b57-8299-6438b94f6422"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("c86be935-ba94-4e15-9025-5c8da55dd438"), Traits.Instances.Conjuration.ID);
            builder.Add(Guid.Parse("c1db0d55-ce8a-4dc3-8908-ac058ccc6a81"), Traits.Instances.Teleportation.ID);
        }
