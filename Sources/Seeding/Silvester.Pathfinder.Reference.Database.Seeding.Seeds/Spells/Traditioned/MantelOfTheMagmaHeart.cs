...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class MantelOfTheMagmaHeart : Template
    {
        ...
        {
            builder.Add(Guid.Parse("3a7d04a7-159a-44da-b6f2-37fd81990ac0"), Traits.Instances.Fire.ID);
            builder.Add(Guid.Parse("f305c0f0-75a7-4d52-be78-d6c37e0d0e56"), Traits.Instances.Morph.ID);
            builder.Add(Guid.Parse("e4e6fca5-c661-40e8-ade6-d6b83b81f45a"), Traits.Instances.Transmutation.ID);
        }
