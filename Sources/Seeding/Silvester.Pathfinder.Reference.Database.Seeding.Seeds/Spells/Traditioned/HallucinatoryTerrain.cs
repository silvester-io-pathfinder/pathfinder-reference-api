...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class HallucinatoryTerrain : Template
    {
        ...
        {
            builder.Add(Guid.Parse("48752a24-b80f-436d-86f3-6849afbda81a"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("901a2544-fbed-4de4-ad65-2a611837bea4"), Traits.Instances.Illusion.ID);
        }
