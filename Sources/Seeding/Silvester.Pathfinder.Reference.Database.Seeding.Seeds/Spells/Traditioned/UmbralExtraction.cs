...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class UmbralExtraction : Template
    {
        ...
        {
            builder.Add(Guid.Parse("d256a73a-09c1-48f4-85d0-ee2e4064ccb2"), Traits.Instances.Illusion.ID);
            builder.Add(Guid.Parse("5861b677-54d7-4a83-ab83-4d7bc7402956"), Traits.Instances.Mental.ID);
            builder.Add(Guid.Parse("47f861f4-d4c8-40fb-9baf-e83d04254fd0"), Traits.Instances.Shadow.ID);
        }
