...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class ShiftBlame : Template
    {
        ...
        {
            builder.Add(Guid.Parse("91c2733e-4ebe-4cbf-a3c7-31b361104fc8"), Traits.Instances.Enchantment.ID);
            builder.Add(Guid.Parse("82624ea4-95d6-407c-a608-e0ffce252b69"), Traits.Instances.Mental.ID);
        }
