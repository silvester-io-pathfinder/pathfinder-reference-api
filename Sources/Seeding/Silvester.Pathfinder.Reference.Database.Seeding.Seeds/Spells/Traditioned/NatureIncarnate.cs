...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class NatureIncarnate : Template
    {
        ...
        {
            builder.Add(Guid.Parse("f92b427b-5534-4bd3-b987-8d46bfe1ac50"), Traits.Instances.Polymorph.ID);
            builder.Add(Guid.Parse("3a7b36f7-ecc9-43e5-91a7-f9ac42eb5d3a"), Traits.Instances.Transmutation.ID);
        }
