...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class Harm : Template
    {
        ...
        {
            builder.Add(Guid.Parse("56e31578-f66c-4966-a9e6-32f20adda1c2"), Traits.Instances.Necromancy.ID);
            builder.Add(Guid.Parse("81c44443-a31b-49b8-a767-629323875078"), Traits.Instances.Negative.ID);
        }
