...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class ConcordantChoir : Template
    {
        ...
        {
            builder.Add(Guid.Parse("538109c8-63ad-48c6-9fe4-210621faad8d"), Traits.Instances.Evocation.ID);
            builder.Add(Guid.Parse("a6f6e806-c461-4464-86ee-fb98f3e8972e"), Traits.Instances.Sonic.ID);
        }
