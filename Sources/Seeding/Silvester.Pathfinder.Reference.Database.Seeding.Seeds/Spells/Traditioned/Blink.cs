...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class Blink : Template
    {
        ...
        {
            builder.Add(Guid.Parse("382f92cc-926b-49f0-95cf-a243e0a608ec"), Traits.Instances.Conjuration.ID);
            builder.Add(Guid.Parse("1d2900ad-147a-40eb-a641-9269e223a45c"), Traits.Instances.Teleportation.ID);
        }
