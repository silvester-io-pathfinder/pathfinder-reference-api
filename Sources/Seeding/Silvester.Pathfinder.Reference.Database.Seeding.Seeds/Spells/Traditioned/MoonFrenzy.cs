...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class MoonFrenzy : Template
    {
        ...
        {
            builder.Add(Guid.Parse("f79213f2-d2d6-4113-a91e-8938b1f29e80"), Traits.Instances.Morph.ID);
            builder.Add(Guid.Parse("6f9ae4f8-a01f-420e-b646-e8482ed72f03"), Traits.Instances.Transmutation.ID);
        }
