...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class IllusoryCreature : Template
    {
        ...
        {
            builder.Add(Guid.Parse("f7df8e68-eb6a-4fe9-a9ef-43e7ede7a73e"), Traits.Instances.Auditory.ID);
            builder.Add(Guid.Parse("5903688a-ff43-4fab-9893-f6ddc396ac0a"), Traits.Instances.Illusion.ID);
            builder.Add(Guid.Parse("dd7bc731-7d32-423b-ad0e-ac3ed9cf7cd1"), Traits.Instances.Olfactory.ID);
            builder.Add(Guid.Parse("1d9fe915-7a0e-4725-9038-a82d2479d696"), Traits.Instances.Visual.ID);
        }
