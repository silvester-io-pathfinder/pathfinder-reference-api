...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class SpiderSting : Template
    {
        ...
        {
            builder.Add(Guid.Parse("6ed3c7b2-e8bc-4b8e-9dc2-da9dfe270a68"), Traits.Instances.Necromancy.ID);
            builder.Add(Guid.Parse("863de8cb-3fc7-4700-b183-a8a7b424f25d"), Traits.Instances.Poison.ID);
        }
