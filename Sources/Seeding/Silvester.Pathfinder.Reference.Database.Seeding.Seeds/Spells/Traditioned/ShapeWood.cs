...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class ShapeWood : Template
    {
        ...
        {
            builder.Add(Guid.Parse("9a66dd0e-b4a4-48a2-8789-939ae017369d"), Traits.Instances.Plant.ID);
            builder.Add(Guid.Parse("1b6c4a93-3394-4ce1-8168-d1e267692530"), Traits.Instances.Transmutation.ID);
        }
