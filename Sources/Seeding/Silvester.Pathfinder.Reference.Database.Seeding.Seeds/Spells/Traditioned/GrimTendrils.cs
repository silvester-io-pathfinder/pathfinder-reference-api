...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class GrimTendrils : Template
    {
        ...
        {
            builder.Add(Guid.Parse("922fd5b3-223d-4400-9781-b53e74bebd2f"), Traits.Instances.Necromancy.ID);
            builder.Add(Guid.Parse("b55951ab-ce58-40cd-bf05-18b553e697d9"), Traits.Instances.Negative.ID);
        }
