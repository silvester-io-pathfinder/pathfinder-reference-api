...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class JuvenileCompanion : Template
    {
        ...
        {
            builder.Add(Guid.Parse("992ae29e-e847-498e-a922-e5c26f1b87e4"), Traits.Instances.Polymorph.ID);
            builder.Add(Guid.Parse("13538a12-f181-43f8-b692-69e583eb8cba"), Traits.Instances.Transmutation.ID);
        }
