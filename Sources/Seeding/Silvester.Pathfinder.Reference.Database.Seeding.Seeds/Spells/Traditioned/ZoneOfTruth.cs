...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class ZoneOfTruth : Template
    {
        ...
        {
            builder.Add(Guid.Parse("c78d4338-3151-4fe7-9c20-885224fc89bd"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("f7af0c73-6026-4c23-8456-e2984a14279c"), Traits.Instances.Enchantment.ID);
            builder.Add(Guid.Parse("3aad0567-8a3b-43b3-a8cb-a0521fe34bfe"), Traits.Instances.Mental.ID);
        }
