...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class Paranoia : Template
    {
        ...
        {
            builder.Add(Guid.Parse("ee9e5fe6-f4b2-4765-b14f-5a77fc091aa5"), Traits.Instances.Illusion.ID);
            builder.Add(Guid.Parse("a52aba8a-79f6-4cbf-848c-5d5e1e392f85"), Traits.Instances.Mental.ID);
        }
