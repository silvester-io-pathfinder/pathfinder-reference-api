...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class Enlarge : Template
    {
        ...
        {
            builder.Add(Guid.Parse("09989da6-5895-4181-baa6-15333c043ab5"), Traits.Instances.Polymorph.ID);
            builder.Add(Guid.Parse("d539b18e-9f9b-405d-a896-49fefbaeddec"), Traits.Instances.Transmutation.ID);
        }
