...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class MagicAura : Template
    {
        ...
        {
            builder.Add(Guid.Parse("58c2c3ff-3b47-4995-9e4e-ce2899c268ed"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("f636d476-dffc-49d2-b2c8-d64e94add7e4"), Traits.Instances.Illusion.ID);
        }
