...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class MomentOfRenewal : Template
    {
        ...
        {
            builder.Add(Guid.Parse("75fb0e4d-14e8-4049-bd0d-1c8906236961"), Traits.Instances.Healing.ID);
            builder.Add(Guid.Parse("737c1b54-8c22-4edc-af3e-d090aeb6e0c5"), Traits.Instances.Necromancy.ID);
        }
