...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class EvolutionSurge : Template
    {
        ...
        {
            builder.Add(Guid.Parse("760f8a84-b7ce-4f62-b605-df55df9c022a"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("4ef9c32a-6582-45ab-8196-38b66cae814e"), Traits.Instances.Morph.ID);
            builder.Add(Guid.Parse("7120f548-7f10-4c90-bfbe-939c5a957bc9"), Traits.Instances.Summoner.ID);
            builder.Add(Guid.Parse("4df4ae3d-a83f-4ca7-9328-7804ed03db05"), Traits.Instances.Transmutation.ID);
        }
