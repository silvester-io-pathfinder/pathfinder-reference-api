...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class PowerfulInhalation : Template
    {
        ...
        {
            builder.Add(Guid.Parse("b7eaacc4-4460-4b66-a2d8-66bc27eb1fae"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("72ca2ecd-2236-4ee6-898c-4cb557bc2908"), Traits.Instances.Air.ID);
            builder.Add(Guid.Parse("729dce77-b3fe-4f81-9ce9-91aa53b85497"), Traits.Instances.Evocation.ID);
        }
