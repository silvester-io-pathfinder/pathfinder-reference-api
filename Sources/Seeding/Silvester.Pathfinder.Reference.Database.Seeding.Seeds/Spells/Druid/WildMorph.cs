...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class WildMorph : Template
    {
        ...
        {
            builder.Add(Guid.Parse("ae4934f5-2bbc-4248-9990-a37636b94277"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("c351bdeb-62d0-4ed8-8b4e-d614e8afbe53"), Traits.Instances.Druid.ID);
            builder.Add(Guid.Parse("9b3d2e53-1965-48c3-b20a-e48084f773a9"), Traits.Instances.Morph.ID);
            builder.Add(Guid.Parse("ea82f8d7-32a3-486e-bcff-d37321898250"), Traits.Instances.Transmutation.ID);
        }
