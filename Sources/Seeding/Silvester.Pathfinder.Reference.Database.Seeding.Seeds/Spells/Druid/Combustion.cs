...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class Combustion : Template
    {
        ...
        {
            builder.Add(Guid.Parse("5d228b06-dcc6-415b-ba1b-a48f3e5d057f"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("42dbd980-6411-45a2-81b6-23ccebafa795"), Traits.Instances.Evocation.ID);
            builder.Add(Guid.Parse("ab56eff8-317a-4804-a524-08bb87a715ee"), Traits.Instances.Fire.ID);
        }
