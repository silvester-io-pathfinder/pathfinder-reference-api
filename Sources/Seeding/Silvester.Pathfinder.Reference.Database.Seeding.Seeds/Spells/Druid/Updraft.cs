...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class Updraft : Template
    {
        ...
        {
            builder.Add(Guid.Parse("98d3085b-c284-43cd-91ed-596d69f5f306"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("9699ca12-c36a-4806-bd59-1c8033872457"), Traits.Instances.Air.ID);
            builder.Add(Guid.Parse("f883f942-36b8-4cdb-9d2f-7ba6b1605edf"), Traits.Instances.Evocation.ID);
        }
