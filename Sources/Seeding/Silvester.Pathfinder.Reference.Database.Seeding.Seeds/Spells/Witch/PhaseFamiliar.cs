...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class PhaseFamiliar : Template
    {
        ...
        {
            builder.Add(Guid.Parse("4c0a9911-7287-4a9f-a061-2e6d71611859"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("04ae09e9-e954-4e35-8f97-bf4459df6a89"), Traits.Instances.Abjuration.ID);
            builder.Add(Guid.Parse("ad2af83b-c28e-4c33-8f85-848bae272d54"), Traits.Instances.Hex.ID);
            builder.Add(Guid.Parse("b024e53d-1390-4636-966f-697c394ec4bd"), Traits.Instances.Witch.ID);
        }
