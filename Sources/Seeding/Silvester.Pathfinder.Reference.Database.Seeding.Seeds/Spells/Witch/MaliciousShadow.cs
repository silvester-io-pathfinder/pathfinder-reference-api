...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class MaliciousShadow : Template
    {
        ...
        {
            builder.Add(Guid.Parse("9292bd40-6de2-4700-b178-ab106bb8b021"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("20166c18-0d76-4292-96c7-2839d54e88d9"), Traits.Instances.Evocation.ID);
            builder.Add(Guid.Parse("1a47fb7a-b6ee-443f-ad95-1853b8889ac8"), Traits.Instances.Hex.ID);
            builder.Add(Guid.Parse("616536bc-5965-42bb-afa8-2f0e18639ca4"), Traits.Instances.Shadow.ID);
            builder.Add(Guid.Parse("52923443-f8c5-466c-b317-2a46616f93f5"), Traits.Instances.Witch.ID);
        }
