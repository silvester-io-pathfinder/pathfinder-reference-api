...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class StrokeTheHeart : Template
    {
        ...
        {
            builder.Add(Guid.Parse("10f27b82-1960-4d7b-8f4e-02cd5672e3f3"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("85096f77-0b39-4d88-b695-93c15f954928"), Traits.Instances.Cantrip.ID);
            builder.Add(Guid.Parse("c6dd90c9-c3ba-42c9-ab5c-b96073d84405"), Traits.Instances.Emotion.ID);
            builder.Add(Guid.Parse("20d62e42-ef13-451b-bd0e-ea8530809c47"), Traits.Instances.Enchantment.ID);
            builder.Add(Guid.Parse("974b87af-92b4-417e-ae99-604f2f8aa5b4"), Traits.Instances.Hex.ID);
            builder.Add(Guid.Parse("1a99686e-ec21-4f6b-9ed1-e9a4568dc326"), Traits.Instances.Witch.ID);
        }
