...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class CurseOfDeath : Template
    {
        ...
        {
            builder.Add(Guid.Parse("1b154890-b62a-432b-8df8-0b7a7fd576ad"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("7ea29902-ec01-4e2d-951b-1696f647867b"), Traits.Instances.Curse.ID);
            builder.Add(Guid.Parse("081fb892-a6fa-4122-b59c-dc4a34e8c065"), Traits.Instances.Death.ID);
            builder.Add(Guid.Parse("c2c327a6-6899-47b0-9e6e-c110fd72ed7b"), Traits.Instances.Hex.ID);
            builder.Add(Guid.Parse("5b7a09b4-839a-4765-9e22-08752a0dabf6"), Traits.Instances.Necromancy.ID);
            builder.Add(Guid.Parse("654afb6b-8938-42ee-aad5-f0b709437a48"), Traits.Instances.Witch.ID);
        }
