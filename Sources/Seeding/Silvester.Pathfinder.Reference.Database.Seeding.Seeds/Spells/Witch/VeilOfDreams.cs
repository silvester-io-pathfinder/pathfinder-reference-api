...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class VeilOfDreams : Template
    {
        ...
        {
            builder.Add(Guid.Parse("ca3ac880-0d6d-43ce-9a3b-ac2860dec5d9"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("15837ec5-5f44-42f1-b645-5db0f015f87b"), Traits.Instances.Enchantment.ID);
            builder.Add(Guid.Parse("259cb822-48b6-4239-b0ce-74b67dd700f1"), Traits.Instances.Hex.ID);
            builder.Add(Guid.Parse("941ad747-2822-4b6c-97e0-adddeabc6bc5"), Traits.Instances.Mental.ID);
            builder.Add(Guid.Parse("f4770256-34e6-4fe0-acf7-fc32aca32d7b"), Traits.Instances.Witch.ID);
        }
