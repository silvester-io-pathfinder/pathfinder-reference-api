...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class AnimalFeature : Template
    {
        ...
        {
            builder.Add(Guid.Parse("43e190b1-469b-4592-8fb1-946fa9596bc8"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("d140b6e2-3d35-4072-89e6-7dd85dc28a3d"), Traits.Instances.Morph.ID);
            builder.Add(Guid.Parse("b234179a-6470-4d3a-8d6b-51a805d8d2df"), Traits.Instances.Ranger.ID);
        }
