...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class SnareHopping : Template
    {
        ...
        {
            builder.Add(Guid.Parse("791fc468-fb25-4be6-b989-0bce43bcc7a7"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("cf07dd05-83dd-4c29-a88b-d4864d8e8cc8"), Traits.Instances.Conjuration.ID);
            builder.Add(Guid.Parse("84e79922-bb96-47b1-af9e-b1a9aa0a5200"), Traits.Instances.Ranger.ID);
            builder.Add(Guid.Parse("08df8680-4e28-451b-9f6c-5d7c82a2384c"), Traits.Instances.Teleportation.ID);
        }
