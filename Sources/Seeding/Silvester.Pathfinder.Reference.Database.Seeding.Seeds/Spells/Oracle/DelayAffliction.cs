...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class DelayAffliction : Template
    {
        ...
        {
            builder.Add(Guid.Parse("3a30466f-8b0a-4fe1-8755-c62358216479"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("8aee0d00-52db-4fb6-9103-8bd25caa0e56"), Traits.Instances.Cursebound.ID);
            builder.Add(Guid.Parse("f261293b-9aac-4c67-b1a9-0a0f2dcb5844"), Traits.Instances.Healing.ID);
            builder.Add(Guid.Parse("5cab1cc3-9c42-43ff-9e7f-5cc144b6df5d"), Traits.Instances.Necromancy.ID);
            builder.Add(Guid.Parse("dd7c74a7-60e4-4c0e-b3af-2863de6ce2ab"), Traits.Instances.Oracle.ID);
            builder.Add(Guid.Parse("cb681636-cb06-43e6-bf9e-0fded3ba1753"), Traits.Instances.Positive.ID);
        }
