...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class FlamingFusillade : Template
    {
        ...
        {
            builder.Add(Guid.Parse("70ca5387-5e60-4737-b56b-48f3d91be3e7"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("58513328-0ecc-412f-ac0e-426d710f5f43"), Traits.Instances.Cursebound.ID);
            builder.Add(Guid.Parse("91ec7824-26f0-4896-a339-f68c7faaae9a"), Traits.Instances.Divination.ID);
            builder.Add(Guid.Parse("451e810d-275f-4364-9646-6931dfb8f662"), Traits.Instances.Mental.ID);
            builder.Add(Guid.Parse("9c755396-1f4d-43c9-acf3-468d93ee7ed1"), Traits.Instances.Oracle.ID);
        }
