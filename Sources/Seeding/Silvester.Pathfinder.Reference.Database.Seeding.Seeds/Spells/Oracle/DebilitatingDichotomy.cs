...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class DebilitatingDichotomy : Template
    {
        ...
        {
            builder.Add(Guid.Parse("6c1c4ac3-9756-4c73-b6e4-cd5488f5d35a"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("cfe65472-a277-44a6-be97-75db82abec33"), Traits.Instances.Cursebound.ID);
            builder.Add(Guid.Parse("42b999c2-f48f-4db1-949b-f6674aaa5c9c"), Traits.Instances.Evocation.ID);
            builder.Add(Guid.Parse("7aead4b2-53b7-4a70-b4e3-7a66d4d76558"), Traits.Instances.Mental.ID);
            builder.Add(Guid.Parse("9424ea58-90db-4944-8f6c-f319ca58e0ab"), Traits.Instances.Oracle.ID);
        }
