...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Spells.Instances
{
    public class LifeLink : Template
    {
        ...
        {
            builder.Add(Guid.Parse("4bee5fe2-1618-4bcc-b2ff-ecfaa6860e7e"), Traits.Instances.Uncommon.ID);
            builder.Add(Guid.Parse("32b5ef54-fe79-4ec6-8102-19faa50c9d03"), Traits.Instances.Cursebound.ID);
            builder.Add(Guid.Parse("bfcddd7f-2c53-480f-ac52-28f465fab4f4"), Traits.Instances.Healing.ID);
            builder.Add(Guid.Parse("aef13bad-6a9c-4193-b45c-f79523115d21"), Traits.Instances.Necromancy.ID);
            builder.Add(Guid.Parse("2633ca2f-89da-47f6-a4cd-9b6a46c00a5d"), Traits.Instances.Oracle.ID);
            builder.Add(Guid.Parse("04b2d263-e921-4568-b346-fe767281b1b5"), Traits.Instances.Positive.ID);
        }
