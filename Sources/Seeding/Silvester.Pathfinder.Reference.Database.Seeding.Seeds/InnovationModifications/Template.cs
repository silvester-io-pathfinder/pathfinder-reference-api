...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.InnovationModifications
{
    ...
    {
        protected override InnovationModification GetEntity(ISeedBuilder builder)
        {
            ...
            builder.AddEffect(modification, GetEffects, e => e.EffectId);
        ...
        {
            builder.HaveSpecificInnovation(modification.Id.Increment(1), modification.InnovationId);
        }
    }
}
