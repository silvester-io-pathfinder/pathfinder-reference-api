...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.ResearchFields.Instances
{
    public class Chirurgeon : Template
    {
        ...
        protected override void GetEffects(BooleanEffectBuilder builder)
        {
            ...
            {
                or.GainSpecificElixirFormula(Guid.Parse("2ed5460c-8a51-40ec-ac88-ce9cdee4cf97"), AlchemicalElixirs.Instances.Antidote.ID, Potencies.Instances.Lesser.ID);
                or.GainSpecificElixirFormula(Guid.Parse("18f05ec4-129e-4f7c-bb8d-bbab60576fa2"), AlchemicalElixirs.Instances.Antiplague.ID, Potencies.Instances.Lesser.ID);
                or.GainSpecificElixirFormula(Guid.Parse("00314b51-3e7e-4698-8379-36a386e03014"), AlchemicalElixirs.Instances.ElixirOfLife.ID, Potencies.Instances.Minor.ID);
            });
