...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.GunslingersWays
{
    ...
    {
        protected override GunslingersWay GetEntity(ISeedBuilder builder)
        {
            ...
            builder.AddEffect(way, GetEffects, e => e.EffectId);
            builder.AddPrerequisite(way, GetPrerequisites);

            builder.AddJoinData<GunslingersWay, Skill>(way, GetWaySkills());
