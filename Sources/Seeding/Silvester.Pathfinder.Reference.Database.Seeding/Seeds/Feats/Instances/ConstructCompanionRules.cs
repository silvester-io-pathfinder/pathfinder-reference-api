...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class ConstructCompanionRules : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDetailBlocks()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("389515a5-d062-4f17-885c-36115bcc539f"), Type = TextBlockType.Enumeration, Text = "**Riding Construct Companions***" };
            ...
            yield return new TextBlock { Id = Guid.Parse("e845e7a4-461e-41ca-8632-1f0d0daecc7a"), Type = TextBlockType.Enumeration, Text = "**Prototype Construct Companions***" };
            ...
            yield return new TextBlock { Id = Guid.Parse("8355088a-4696-491c-a831-14cf4e23142d"), Type = TextBlockType.Enumeration, Text = "*Construct Trait**" };
            yield return new TextBlock { Id = Guid.Parse("ec9dfceb-fd51-41fe-9c8a-79beb3e40c2a"), Type = TextBlockType.Text, Text = "A construct companion has the (trait: construct) trait. It's not a living creature, nor is it undead." };
            yield return new TextBlock { Id = Guid.Parse("da238f8f-865f-4672-a99a-050effd4c1d2"), Type = TextBlockType.Enumeration, Text = "*Proficiencies**" };
            ...
            yield return new TextBlock { Id = Guid.Parse("122f5589-539d-4963-a64f-449ed37235fd"), Type = TextBlockType.Enumeration, Text = "*Size**" };
            ...
            yield return new TextBlock { Id = Guid.Parse("45769eb1-9715-4d63-a0cc-d5acead16841"), Type = TextBlockType.Enumeration, Text = "*Strikes**" };
            ...
            yield return new TextBlock { Id = Guid.Parse("7a3792fe-0663-4ae6-9226-b5c219b83619"), Type = TextBlockType.Enumeration, Text = "*Ability Modifiers**" };
            ...
            yield return new TextBlock { Id = Guid.Parse("f0cfb889-bb55-4c43-9278-9827c1a8dddc"), Type = TextBlockType.Enumeration, Text = "*Hit Points**" };
            ...
            yield return new TextBlock { Id = Guid.Parse("9951c34a-a36f-41bd-bec9-7ed615cb53d5"), Type = TextBlockType.Enumeration, Text = "*Immunities**" };
            ...
            yield return new TextBlock { Id = Guid.Parse("c3fde546-4411-4bc9-aa96-c36b4c86b54b"), Type = TextBlockType.Enumeration, Text = "*Senses**" };
            ...
            yield return new TextBlock { Id = Guid.Parse("9f0ef0d3-4fd6-4446-aaa3-75683fa81fa5"), Type = TextBlockType.Enumeration, Text = "*Speed**" };
            ...
            yield return new TextBlock { Id = Guid.Parse("e0c22af0-f3dc-4ebc-8a83-49166f55c7ad"), Type = TextBlockType.Enumeration, Text = "**Advanced Construct Companions***" };
            ...
            yield return new TextBlock { Id = Guid.Parse("5c445d76-ca3f-4b78-a2c8-6b764870d17e"), Type = TextBlockType.Enumeration, Text = "**Incredible Construct Companions***" };
            ...
            yield return new TextBlock { Id = Guid.Parse("8c62b4f7-2e4d-43c5-92a7-ac0d0b5a17a8"), Type = TextBlockType.Enumeration, Text = "**Paragon Construct Companions***" };
