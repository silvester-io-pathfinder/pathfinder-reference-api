...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class Anger : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDetailBlocks()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("310df961-e878-4039-a167-eee3d874d158"), Type = TextBlockType.Text, Text = "~ Emotional Fallout: You become fatigued until you (feat: Settle your Emotions | Settle Emotions)." };
            yield return new TextBlock { Id = Guid.Parse("21134819-dbf6-4f68-8868-81c0a17bf532"), Type = TextBlockType.Text, Text = "~ Focus Spell: (spell: athletic rush)" };
        }
