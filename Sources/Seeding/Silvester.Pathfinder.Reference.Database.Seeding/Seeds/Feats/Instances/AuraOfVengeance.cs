...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class AuraOfVengeance : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("43f7cc8e-f76a-41e5-b00a-178f2029e588"), Type = TextBlockType.Text, Text = "When you call upon others to take retribution, you also guide their aim. When you use (feat: Retributive Strike), your allies who make (action: Strikes | Strike) take only a -2 penalty, instead of a -5 penalty." };
        }
