...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class AnadiVenom : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("7a2c5c1f-3af4-4b47-bf6a-35453e2fceca"), Type = TextBlockType.Text, Text = "You envenom your fangs. If the next fangs (action: Strike) you make before the end of your turn hits and deals damage, the (action: Strike) deals an additional 1d6 poison damage. On a critical failure, the poison is wasted as normal. At 12th level, this poison damage increases to 2d6." };
        }
