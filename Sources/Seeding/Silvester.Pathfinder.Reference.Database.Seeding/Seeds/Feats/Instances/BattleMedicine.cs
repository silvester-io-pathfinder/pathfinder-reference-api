...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class BattleMedicine : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("e37558c3-f4d9-411f-8f35-d5e2e92f6616"), Type = TextBlockType.Text, Text = "You can patch up yourself or an adjacent ally, even in combat. Attempt a Medicine check with the same DC as for (action: Treat Wounds), and restore a corresponding amount of Hit Points; this does not remove the wounded condition. As with (action: Treat Wounds), you can attempt checks against higher DCs if you have the minimum proficiency rank. The target is then temporarily immune to your Battle Medicine for 1 day." };
        }
