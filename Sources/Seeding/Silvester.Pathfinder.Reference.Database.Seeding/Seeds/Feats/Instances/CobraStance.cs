...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class CobraStance : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("f9d3bc9e-d94c-4206-ade9-c1902124264c"), Type = TextBlockType.Text, Text = "You enter a tight stance, coiled up like a lashing cobra with your hands poised as venomous fangs. While in this stance, the only (action: Strikes | Strike) you can make are cobra fang unarmed attacks. These deal 1d4 poison damage; are in the brawling group; and have the (trait: agile), (trait: deadly d10), (trait: finesse), (trait: nonlethal), (trait: poison), and (trait: unarmed) traits." };
