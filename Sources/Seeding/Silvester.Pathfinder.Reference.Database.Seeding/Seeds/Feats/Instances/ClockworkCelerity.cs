...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class ClockworkCelerity : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDetailBlocks()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("cb0c7800-8671-4c6c-9ac6-3d7b2d014d6d"), Type = TextBlockType.Enumeration, Text = " Armor: You can use the extra action to (action: Step), (action: Stride), or use another movement action granted by your innovation (such as (action: Swim) if you have the (feat: Diving Armor) feat)." };
            ...
            yield return new TextBlock { Id = Guid.Parse("03246ca2-8ee0-40f2-8b5a-55c1d0bc2af1"), Type = TextBlockType.Enumeration, Text = " Weapon: You can use the extra action to (action: Strike) with your innovation or Reload your innovation." };
        }
