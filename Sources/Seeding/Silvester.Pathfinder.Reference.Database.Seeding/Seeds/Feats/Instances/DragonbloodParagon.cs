...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class DragonbloodParagon : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDetailBlocks()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("1e68af78-742f-4d78-982f-c3c84eb97b5d"), Type = TextBlockType.Text, Text = "~ Kobold Breath: Creatures that critically fail their save against your (feat: Kobold Breath) take 3d4 persistent damage of the type dealt by your draconic patron." };
            yield return new TextBlock { Id = Guid.Parse("f32c0564-e1fd-4494-98f6-7a9d2748cd41"), Type = TextBlockType.Text, Text = "~ Strongjaw Kobold: Your jaws unarmed attack gains the (trait: deadly d6) trait." };
            yield return new TextBlock { Id = Guid.Parse("de162c32-36b8-447d-b88b-7bd7b11ad40f"), Type = TextBlockType.Text, Text = "~ Venomtail Kobold: You produce enough venom to use the (feat: Tail Toxin) action twice per day." };
        }
