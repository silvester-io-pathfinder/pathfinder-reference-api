...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class CoreCannon : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("4143b211-6985-4151-9f7b-fe524551e805"), Type = TextBlockType.Text, Text = "Your body transforms into a powerful magical cannon. While immobile as a cannon, you can fire blasts of energy directly from your core, devastating your foes. You become immobilized until you use an (action: Interact) action to revert back to your standard form. While in your cannon form, the only actions you can use are to (action: Strike) with an energy blast unarmed attack or to (action: Interact) to revert back to your standard form. You can remain in your cannon form for up to 1 minute or until you take the action to revert back to your standard form, whichever comes first." };
