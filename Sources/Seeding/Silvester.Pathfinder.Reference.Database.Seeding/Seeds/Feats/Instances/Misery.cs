...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class Misery : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDetailBlocks()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("2da27367-e6e8-4a06-8f22-df1da1eadb6d"), Type = TextBlockType.Text, Text = "~ Emotional Fallout: You take an untyped penalty to any damage you would deal with any spell you cast until you (feat: Settle your Emotions| Settle Emotions). The penalty is –1 per spell level." };
            yield return new TextBlock { Id = Guid.Parse("d8b3242e-935e-4cb5-b8de-6fa72dd12ff9"), Type = TextBlockType.Text, Text = "~ Focus Spell: (spell: savor the sting)" };
        }
