...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class BadgerRage : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDetailBlocks()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("3b816f89-ed29-458b-a031-7e5e96460906"), Type = TextBlockType.Enumeration, Text = " : It can't use actions that have the (trait: concentrate) trait unless they also have the (trait: rage) trait. Though, the animal companion can (action: Seek) even while raging." };
