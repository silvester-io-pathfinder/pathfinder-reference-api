...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class EntitiesFromAfar : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("893ed462-e2bb-42c5-860c-2b2b33d232bf"), Type = TextBlockType.Text, Text = "You can call in aberrations to fight for you or to answer questions. You can cast (spell: summon entity) as an innate occult spell once per day. If you couldn&#39;t already cast occult spells, these spells use Intelligence as your spellcasting ability, and you become trained in spell attack rolls and spell DCs for occult spells; if you could already cast occult spells, your proficiency in spell attack rolls and spell DCs for occult spells increases to expert." };
