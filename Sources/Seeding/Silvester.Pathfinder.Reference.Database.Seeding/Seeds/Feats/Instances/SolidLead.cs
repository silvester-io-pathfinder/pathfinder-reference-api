...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class SolidLead : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("e8034fc7-4795-4e2f-a8d0-a7dc8f94ed39"), Type = TextBlockType.Text, Text = "Sometimes your case splinters into smaller mysteries, but you never lose sight of the big picture. Once per day when you give up on the subject of a lead due to using (action: Pursue a Lead) again, you can designate the lead you stopped pursuing as your solid lead for the day. Even though you stopped following the solid lead, you can change back to your solid lead any number of times by using a single action, which has the (trait: concentrate) trait. Doing so ends one of your current leads as normal." };
