...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class AncestralWeaponry : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("0e036b80-df01-411c-989c-537e3ae6688b"), Type = TextBlockType.Text, Text = "You blend monastic techniques with the ancestral fighting styles of your people. Choose an ancestry for which you have access to all weapons with that trait. For you, melee weapons with that ancestry trait and either the (trait: agile) or (trait: finesse) trait gain the (trait: monk | Monk - Item) trait." };
        }
