...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class ReboundingAssault : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDetailBlocks()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("decb8d76-1acc-433d-86d0-2a8562d2ecd7"), Type = TextBlockType.Text, Text = "If both attacks are successful, the bolt or bullet hits the thrown melee weapon instead of your target, adding its force into one attack. Combine the damage from both (action: Strikes|Strike), using the thrown weapon’s damage type, and add an additional 1d6 precision damage. The impact sends the melee weapon rebounding off the target and back to your hand." };
            yield return new TextBlock { Id = Guid.Parse("15f9e433-5ac5-40b7-8ef9-e9a4d01b0410"), Type = TextBlockType.Text, Text = "In any circumstance other than both attacks hitting, carry out the individual (action: Strikes|Strike) normally. The thrown weapon doesn’t rebound and remains in the target’s space as normal for thrown weapons." };
        }
