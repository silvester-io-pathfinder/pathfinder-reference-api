...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class CascadeBearersFlexibility : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("642ee6d0-3914-4b75-b910-b17cc3cf4128"), Type = TextBlockType.Text, Text = "You call upon your Cascade Bearer training to help you adjust a spell for the current situation. Until the end of your turn, you gain a single (trait: metamagic) feat from the druid class or the wizard class that has a level requirement of no more than half your level." };
        }
