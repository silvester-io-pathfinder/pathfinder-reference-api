...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class FusedStaff : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("073f55fe-1cf0-4b5a-8ee3-9b5820e15408"), Type = TextBlockType.Text, Text = "When you prepare a staff, you can hold it up to a weapon to merge the two items. You can switch the fused item’s form from the weapon to the staff or vice versa as a single action, which has the (trait: concentrate) trait. When the item is in staff form, you can (action: Cast the Spells | Cast a Spell) from the staff and benefit from any other abilities the staff grants. The staff and the weapon share their fundamental runes, using whichever weapon potency and whichever striking rune is higher level. They don’t share any other runes or specific abilities." };
            yield return new TextBlock { Id = Guid.Parse("320ae637-c1e3-4656-aa64-5ed24456ec4e"), Type = TextBlockType.Text, Text = "You can (action: Cast Spells | Cast a Spell) from the staff as part of a (feat: Spellstrike) even when the staff is in weapon form. Otherwise, you can’t cast the staff’s spells while it’s in weapon form." };
