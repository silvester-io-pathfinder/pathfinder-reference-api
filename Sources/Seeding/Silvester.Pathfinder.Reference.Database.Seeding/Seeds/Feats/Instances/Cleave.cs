...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class Cleave : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("75900be9-29ac-4b67-b051-321495078121"), Type = TextBlockType.Text, Text = "You swing clear through one foe and into another. Make a melee (Action: Strike) against the second foe." };
        }
