...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class BeneathNotice : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("f6efc794-565d-404c-9adb-9011af2ff293"), Type = TextBlockType.Text, Text = "You are skilled at hiding from your foes and targets among the common populace. You gain the (feat: Quick Disguise) and (feat: Slippery Secrets) skill feats. In addition, while in a crowd, you can (action: Impersonate) a nondescript member of the crowd as a three action activity (one action if you are legendary in Deception)." };
        }
