...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class EldritchNails : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("bf8b1821-2156-492b-bc16-809ef849b088"), Type = TextBlockType.Text, Text = "Your nails are supernaturally long and sharp. You gain a nails unarmed attack that deals 1d6 slashing damage. Your nails are in the brawling group and have the (trait: agile) and (trait: unarmed) traits. You can etch your nails with runes with the same cost and restrictions as for etching runes onto (item: handwraps of mighty blows); runes etched onto your nails apply to nails unarmed attacks with both hands but not to other unarmed attacks." };
