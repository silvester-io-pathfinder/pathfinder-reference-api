...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class AasimarsMercyRemoveDisease : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("49b043f5-f4dc-4301-8f88-87d8c768c014"), Type = TextBlockType.Text, Text = "You can cast (spell: remove disease) as a 4th-level divine innate spell once per day." };
        }
