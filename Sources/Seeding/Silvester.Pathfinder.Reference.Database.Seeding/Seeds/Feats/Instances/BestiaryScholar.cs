...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class BestiaryScholar : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDetailBlocks()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("f939c4ba-833c-4b9a-a83b-4866fc81b71a"), Type = TextBlockType.Text, Text = "You can use the chosen skill to (action: Recall Knowledge) to identify any creature normally identifiable by any of the above skills. In addition, when you critically succeed at identifying a creature, you gain a +1 circumstance bonus to your next attack roll or saving throw against that creature." };
        }
