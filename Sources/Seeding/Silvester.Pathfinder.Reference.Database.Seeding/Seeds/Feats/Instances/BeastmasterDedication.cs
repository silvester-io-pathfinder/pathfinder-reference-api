...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class BeastmasterDedication : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("54a8d3c8-ac8c-4ec8-af0b-155a2b249ac0"), Type = TextBlockType.Text, Text = "You gain the service of a young animal companion that travels with you and obeys your commands. The rules for animal companions appear on page 214. Contrary to the usual rules for animal companions, this feat can grant you a second animal companion. If you ever have more than one animal companion, you gain the (feat: Call Companion) action." };
