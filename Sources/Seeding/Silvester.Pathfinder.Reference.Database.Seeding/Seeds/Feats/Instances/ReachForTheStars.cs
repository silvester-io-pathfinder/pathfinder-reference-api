...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class ReachForTheStars : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDetailBlocks()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("f471cc42-47c0-4c64-9194-3008e7d87389"), Type = TextBlockType.Text, Text = "You can choose at which points in your (action: Leap) you detonate each boost, allowing you to change direction each time. You must then move in a straight line until you boost again or end your (action: Leap)." };
        }
