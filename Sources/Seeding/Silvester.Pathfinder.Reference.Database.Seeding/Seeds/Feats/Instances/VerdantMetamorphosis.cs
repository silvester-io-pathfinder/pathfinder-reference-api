...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Feats.Instances
{
    public class VerdantMetamorphosis : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("40d9acd1-ea61-482f-87b0-60e30ebd8c08"), Type = TextBlockType.Text, Text = "You transform into a plant version of yourself. You gain the plant trait and lose any trait that’s inappropriate for your new form (typically humanoid for a PC, but also possibly animal or fungus). You can change from a form that looks mostly like your old self into a tree or any other non-creature plant as a single action, which has the concentrate trait. This has the same effect as (Spell: tree shape), except you can turn into any kind of non-creature plant and your AC is 30." };
