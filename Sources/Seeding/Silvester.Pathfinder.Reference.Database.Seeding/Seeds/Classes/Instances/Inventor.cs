...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Classes.Instances
{
    ...
    {
        public static readonly Guid ID = Guid.Parse("d913024b-e339-4d8f-8234-44a7b4d1a869");
        ...
        {
            yield return new ClassMannerism { Id = Guid.Parse("2160d5a4-0f4d-4dae-aefb-9ba9898924aa"), Text = "Enjoy creating new things the world has never seen before." };
            yield return new ClassMannerism { Id = Guid.Parse("6e71f61c-fad8-479c-a6f0-ea8fda6fb5f2"), Text = "Be willing to take a chance on a theory, testing to see if your hypothesis proves accurate. If not, you probably record the results to try again later." };
            yield return new ClassMannerism { Id = Guid.Parse("c938545a-43db-43d8-b036-4dd02a07979f"), Text = "Wear clothes spattered with oil and grime, or venture off on excited and technical tangents when asked simple questions." };
        }

        protected override IEnumerable<ClassCharacteristic> GetCharacteristics()
        {
            yield return new ClassCharacteristic { Id = Guid.Parse("b2654146-0dac-41fd-86c0-5ad000389528"), Text = "Marvel at your inventions and the variety of unbelievable wonder they can bring." };
            yield return new ClassCharacteristic { Id = Guid.Parse("b5f61921-72e7-4035-950f-638dab266413"), Text = "Believe that you're a genius whose work is beyond understanding." };
            yield return new ClassCharacteristic { Id = Guid.Parse("5e5438e7-72c7-495a-ac17-572e66cd60fa"), Text = "Worry that your inventions might backfire or explode." };
        }
