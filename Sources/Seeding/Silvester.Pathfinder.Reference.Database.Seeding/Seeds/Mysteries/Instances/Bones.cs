...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Mysteries.Instances
{
    public class Bones : Template
    {
        ...
        protected override void GetEffects(BooleanEffectBuilder builder)
        {
            ...
            //Trained Skill
            builder.GainSpecificSkillProficiency(Guid.Parse("19a6436b-4ec1-405d-8dbd-df4740351c10"), Proficiencies.Instances.Trained.ID, Skills.Instances.Medicine.ID);

            //Granted Cantrip
            builder.GainSpecificSpell(Guid.Parse("5e0d98d2-60c6-47d3-bd6e-be596675edb2"), Spells.Instances.ChillTouch.ID);

            //Initial Revelation Spell
            builder.GainSpecificSpell(Guid.Parse("358eccdb-c22a-4eaa-8e50-ff80923e5d03"), Spells.Instances.SoulSiphon.ID);

            //Advanced Revelation Spell
            builder.GainSpecificSpell(Guid.Parse("1e8e5ef6-a341-4e2b-9f06-f7ea65372f6b"), Spells.Instances.ArmorOfBones.ID)
                .AddPrerequisites(Guid.Parse("f7b33586-f6eb-4201-933e-f7b652ec16be"), prerequisites =>
                {
                    prerequisites.HaveSpecificFeat(Guid.Parse("d65f4063-9c95-42fd-b98a-ac3df439ef59"), Feats.Instances.AdvancedRevelation.ID);
                });

            //Greater Revelation Spell
            builder.GainSpecificSpell(Guid.Parse("6488f973-910c-4957-9a27-86e386639aa5"), Spells.Instances.ClaimUndead.ID)
                .AddPrerequisites(Guid.Parse("327d7ceb-688b-48e6-b73f-b11eaad136d5"), prerequisites =>
                {
                    prerequisites.HaveSpecificFeat(Guid.Parse("18a0d798-5563-444f-ac64-c652aef82865"), Feats.Instances.GreaterRevelation.ID);
                });
        }
