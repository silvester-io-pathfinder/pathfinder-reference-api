...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Bloodlines
{
    ...
    {
        protected override Bloodline GetEntity(ISeedBuilder builder)
        {
            ...
            builder.AddEffect(bloodline, builder => GetEffects(builder), e => e.EffectId);

            builder.AddJoinData<Bloodline, Skill>(bloodline, GetSkills());
