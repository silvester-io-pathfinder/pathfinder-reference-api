...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Deities.Instances
{
    ...
    {
        public static readonly Guid ID = Guid.Parse("fedd9933-b96f-40a1-8e71-d5077efba098");
        ...
        protected override IEnumerable<TextBlock> GetDetails()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("481b0434-4503-4583-a808-83aae72e327f"), Type = TextBlockType.Text, Text = "Milani is the patron mother of those who war against oppression, rewarding those willing to sacrifice their lives and use whatever tools are available to fight for those who cannot defend themselves, especially people who have been captured or enslaved. Throughout Golarion, Milani is also known as the Everbloom, as the symbol of her church is a beautiful rose growing from blood-soaked soil." };
        }

        protected override void GetDevoteeEffect(BooleanEffectBuilder builder)
        {
            builder.GainSpecificSpell(Guid.Parse("ad21bcf0-cbd1-4619-b40b-cd3452934971"), Spells.Instances.MageArmor.ID);
            builder.GainSpecificSpell(Guid.Parse("fa6c24b0-f62d-4b7a-a042-66927582105e"), Spells.Instances.Enthrall.ID);
            builder.GainSpecificSpell(Guid.Parse("9c3ba563-918d-42f8-97b2-01f727656c85"), Spells.Instances.FireShield.ID);
        }
        ...
        protected override DivineIntercession? GetDivineIntercession()
        {
            ...
            return new DivineIntercession
            {
                ...
                {
                    Id = Guid.Parse("f8e3ff48-0e93-4d1d-b227-251c3ebc497e"),
        ...
        protected override SourcePage GetSourcePage() 
        {
            ...
            {
                Id = Guid.Parse("dd1750ae-32df-46f5-9fcb-a5e5bbebec9f"),
                SourceId = Sources.Instances.LostOmensGodsAndMagic.ID,
                Page = 66
            };
        }
