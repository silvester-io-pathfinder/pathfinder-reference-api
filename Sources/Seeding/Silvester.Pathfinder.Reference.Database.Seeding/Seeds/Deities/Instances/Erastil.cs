...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Deities.Instances
{
    ...
    {
        public static readonly Guid ID = Guid.Parse("24ab5ccc-3e3d-4195-b1df-2e32197ce6e0");
        ...
        protected override IEnumerable<TextBlock> GetDetails()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("31c64250-28bf-4576-97c3-9f7635145843"), Type = TextBlockType.Text, Text = "Unlike many other good deities, Erastil does not send his followers out into the world to fight and crush evil. Eschewing crusades and other ventures that take his followers away from their homes, Erastil watches over those who devote their lives to family and community. He is primarily an agricultural deity, specifically focusing on those aspects of nature that either can be tamed or are of use to his followers. His domain encompasses the plants and animals that farmers, hunters, and ranchers deal with in their everyday lives. While he is a protective deity, Erastil steps in only when quiet, pastoral lives are threatened. He desires his followers to live their lives in peace, with no risk of being conscripted into armies, devoured by monsters, or destroyed by magic." };
        }

        protected override void GetDevoteeEffect(BooleanEffectBuilder builder)
        {
            builder.GainSpecificSpell(Guid.Parse("42953a56-c15f-401a-bd73-4e035790b867"), Spells.Instances.TrueStrike.ID);
            builder.GainSpecificSpell(Guid.Parse("1658751c-ef0b-4038-b6c4-d8d228fae31f"), Spells.Instances.WallOfThorns.ID);
            builder.GainSpecificSpell(Guid.Parse("b8084947-a59a-4a5f-b2c4-1e335ce63a3f"), Spells.Instances.TreeStride.ID);
        }
        ...
        protected override DivineIntercession? GetDivineIntercession()
        {
            ...
            {
                Id = Guid.Parse("8d4860b4-af38-4a0e-9201-685df4d2ebd9"),
                ...
                {
                    Id = Guid.Parse("5f24f769-41a2-4d98-8188-cd0081916183"),
        ...
        protected override SourcePage GetSourcePage() 
        {
            ...
            {
                Id = Guid.Parse("875212dd-0623-49a9-a5f7-c2a8719ced71"),
