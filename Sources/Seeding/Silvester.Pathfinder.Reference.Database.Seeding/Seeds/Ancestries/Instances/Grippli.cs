...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Ancestries.Instances
{
    public class Grippli : Template
    {
        ...
        protected override void GetEffects(BooleanEffectBuilder builder)
        {
            ...
            builder.GainSpecificSense(Guid.Parse("8af0e30f-ee03-4eaa-8a09-3235f7fcfa25"), Senses.Instances.LowLightVision.ID, SenseAccuracies.Instances.Precise.ID);
        }
