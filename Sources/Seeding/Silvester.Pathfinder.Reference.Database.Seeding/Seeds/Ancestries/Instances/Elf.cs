...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Ancestries.Instances
{
    public class Elf : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDescription()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("497a9885-d112-459f-9773-dbbb13d74a41"), Type = TextBlockType.Text, Text = "If you want a character who is magical, mystical, and mysterious, you should play an elf." };
        }
        ...
        protected override void GetEffects(BooleanEffectBuilder builder)
        {
            ...
            builder.GainSpecificSense(Guid.Parse("b6e45568-f1a6-4571-b5f8-b85419f415fa"), Senses.Instances.LowLightVision.ID, SenseAccuracies.Instances.Precise.ID);
        }
