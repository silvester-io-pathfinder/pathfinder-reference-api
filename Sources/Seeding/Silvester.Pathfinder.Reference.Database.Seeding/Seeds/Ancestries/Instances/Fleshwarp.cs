...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Ancestries.Instances
{
    public class Fleshwarp : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDescription()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("99609083-47a6-4211-ac32-065c70ae9f04"), Type = TextBlockType.Text, Text = "If you want a character who is tough and hardy, can change their form as they grow, and can use their wholly unique appearance to inspire awe or fear in others, you should play a fleshwarp." };
        }
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("fcba88db-2a37-44f0-9361-3aacd39b2d8d"), Type = TextBlockType.Heading, Text = "Fleshwarp Legends" };
            yield return new TextBlock { Id = Guid.Parse("0f91950a-6ddc-4775-a632-7673935232e0"), Type = TextBlockType.Text, Text = "Legends of famous fleshwarps travel quickly amid fleshwarp communities." };
            yield return new TextBlock { Id = Guid.Parse("5f0a5a3e-8689-4287-99d0-b99802629481"), Type = TextBlockType.Text, Text = "Lady Kedley: A wealthy noble in a life she doesn't remember, Kedley emerged transformed from deep below Westcrown. She uses her family's vast fortune to aid other fleshwarps." };
            yield return new TextBlock { Id = Guid.Parse("a416ecc9-8f3b-4fc9-bed9-33b8f9794c55"), Type = TextBlockType.Text, Text = "Spinhead Vanluk: This Mana Wastes warlord brings mutants and fleshwarps under his banner. He (literally) has eyes in the back of his head." };

            yield return new TextBlock { Id = Guid.Parse("60bd1238-20a0-49ae-863f-ab0c758f0140"), Type = TextBlockType.Heading, Text = "Fleshwarp Motives" };
            yield return new TextBlock { Id = Guid.Parse("ab95721e-8df8-4028-8921-8ca05386b40d"), Type = TextBlockType.Text, Text = "Fleshwarps have a variety of reasons for taking up the life of an adventurer. Some are turned out of their homes by an uncaring parent or a suspicious mob. Other fleshwarps travel to learn more about their own transformation or to seek out others of their kind. A few even actively seek the means—either technological or magical—to undo their transformations or adopt a new form that won't incite repulsion or fear in common people. Still others understand that a good way to earn respect is to solve a community's problems—then quickly leave the area—and therefore fall into the role of itinerant adventurers-for-hire." };

            yield return new TextBlock { Id = Guid.Parse("398aad35-4ea5-4a82-a47e-1628439dcd99"), Type = TextBlockType.Heading, Text = "Fleshwarp Settlements" };
            yield return new TextBlock { Id = Guid.Parse("b1fde8be-0267-4496-acdd-f54703838adb"), Type = TextBlockType.Text, Text = "No settlements consisting entirely of fleshwarps exist openly outside of the Mana Wastes; elsewhere, citizens keep the secret so well that their community's existence isn't known to the world at large. Fleshwarps are more likely to live on the fringes of other settlements, working in industries where their hardy constitution is an advantage and their uncanny appearance isn't a liability. Some are herbalists or trappers, working in the wilderness and interacting with others only rarely. Locals might come to consider a fleshwarp their equal or friend, and take umbrage at outsiders who make a big deal out of the “monster” in their midst. Sentiment might turn quickly upon supernatural events or strange attacks, however, and, tragically, more than a few fleshwarps have been turned out of homes they've occupied for decades when faced with a misguided mob." };
        }

        protected override IEnumerable<TextBlock> GetAdditionalMechanics()
        {
            yield return new TextBlock { Id = Guid.Parse("a6466234-6bd6-4d88-9927-3c73a372b380"), Type = TextBlockType.Heading, Text = "Unusual Anatomy" };
            yield return new TextBlock { Id = Guid.Parse("69dc61cf-4d8b-42bd-b0b3-8862e5dc2e93"), Type = TextBlockType.Text, Text = "Your unorthodox body resists physical afflictions meant for other creatures. You gain a +1 circumstance bonus to saves against diseases and poisons." };
        }
        ...
        protected override void GetEffects(BooleanEffectBuilder builder)
        {
            ...
            builder.GainSpecificSense(Guid.Parse("61f202a8-62bc-4edf-a5dd-ba275ce8ec7a"), Senses.Instances.LowLightVision.ID, SenseAccuracies.Instances.Precise.ID);
