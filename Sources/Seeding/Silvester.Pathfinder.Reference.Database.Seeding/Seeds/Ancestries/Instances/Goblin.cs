...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Ancestries.Instances
{
    public class Goblin : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDescription()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("5dcef830-2406-4200-89ea-20e051cc7c3e"), Type = TextBlockType.Text, Text = "If you want a character who is eccentric, enthusiastic, and fun-loving, you should play a goblin." };
        }
        ...
        protected override void GetEffects(BooleanEffectBuilder builder)
        {
            ...
            builder.GainSpecificSense(Guid.Parse("638e99e6-49d8-4eae-a962-219ab5c81a68"), Senses.Instances.Darkvision.ID, SenseAccuracies.Instances.Precise.ID);
        }
