...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Ancestries.Instances
{
    public class Catfolk : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDescription()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("3bfeeff6-e1ca-4714-94c7-2822fea09a1d"), Type = TextBlockType.Text, Text = "If you want a character who is curious, brave, friendly, and nimble in body and mind, you should play a catfolk." };
        }
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("2c794e25-a42d-461e-a46c-3bfca850e860"), Type = TextBlockType.Heading, Text = "Catfolk Luck" };
            yield return new TextBlock { Id = Guid.Parse("b0fa45b3-fbc4-4586-a7c0-4e03e164d856"), Type = TextBlockType.Text, Text = "Catfolk are known for their luck, which they traditionally draw from spirits of creation that they've pleased or emulated. Many catfolk tend to experience this luck as an insistent urge that feels like a warning from a benevolent presence they can't perceive. Others experience it as a reflexive awareness of danger beyond their normal senses. More spiritual catfolk try to tune into the warnings from the spirits of fortune through an art known as serendipity reading." };

            yield return new TextBlock { Id = Guid.Parse("c1478ce2-cc75-4f28-acd2-c647974f8ef1"), Type = TextBlockType.Heading, Text = "Murraseth" };
            yield return new TextBlock { Id = Guid.Parse("3a7e287b-3655-43e4-a130-e34e9e6b7546"), Type = TextBlockType.Text, Text = "Murraseth is the largest of several remote catfolk-majority city-states in central Garund. Even distant catfolk take pride in its guilds and its Houses of Names—labyrinthine, live-in galleries for artists and performers who retell catfolk discoveries and tales. Many catfolk consider visiting a House of Names an important life milestone." };
            yield return new TextBlock { Id = Guid.Parse("51d8f4de-b695-4aa3-af21-131d6e672e23"), Type = TextBlockType.Text, Text = "Guilds dominate Murraseth. Perhaps the most distinctive of these groups is the Circle of Lifeshapers, comprised of polymorph specialists and healers." };

            yield return new TextBlock { Id = Guid.Parse("f8249849-aa1b-4ee3-87c1-c4d9ba2b792e"), Type = TextBlockType.Heading, Text = "Other Catfolk" };
            yield return new TextBlock { Id = Guid.Parse("dceef9fc-5c47-4eb9-b9ad-b705f6770568"), Type = TextBlockType.Text, Text = "Numerous catfolk ethnicities exist beyond the Inner Sea. The black-spotted Guarrxil of southern Arcadia are renowned for their principled mercenary companies and heroic rangers. The mysterious Caimurru of the western Arcadian coast trade more with First World caravans than with other mortals. The Lyashtaki catfolk of the Valashmai Jungle sometimes make treks far from the jungle via coast-hopping boats." };
        }

        protected override IEnumerable<TextBlock> GetAdditionalMechanics()
        {
            yield return new TextBlock { Id = Guid.Parse("1f1ed1ab-4a3d-4d5a-9efd-e87a33580485"), Type = TextBlockType.Heading, Text = "Land on your Feet" };
            yield return new TextBlock { Id = Guid.Parse("8f273f5c-70f2-49de-8dec-b0dce13717a3"), Type = TextBlockType.Text, Text = "When you fall, you take only half the normal damage and don't land prone." };
        }
        ...
        protected override void GetEffects(BooleanEffectBuilder builder)
        {
            ...
            builder.GainSpecificSense(Guid.Parse("82915505-3284-4962-8399-6bb53c311952"), Senses.Instances.LowLightVision.ID, SenseAccuracies.Instances.Precise.ID);
            builder.ModifyFallDistance(Guid.Parse("fb83244e-9de9-4761-9e65-8bff3db4cc0f"), ModifierType.Divide, modifier: 2);
