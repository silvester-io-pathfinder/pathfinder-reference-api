...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Ancestries.Instances
{
    public class Ratfolk : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDescription()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("95a1b330-0f7f-4243-96fe-8eccfc136e70"), Type = TextBlockType.Text, Text = "If you want a character who is smart, fast, well-traveled, and adaptable, try playing a ysoki!" };
        }
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("95340da1-81c7-4131-bb6f-c46c8b9997fd"), Type = TextBlockType.Heading, Text = "Ratfolk Settlements" };
            yield return new TextBlock { Id = Guid.Parse("b1f5ce8c-8b42-433a-8dff-6d2211cd0108"), Type = TextBlockType.Text, Text = "Ysoki congregate at trading cities and crossroads of all kinds. In Avistan, ratfolk are somewhat more prevalent in Druma, the Five Kings Mountains, and Taldor, as well as port cities like Absalom and Riddleport. Others carve out warrens far from human settlements, such as Numeria's Chitterhome. Garundi ysoki congregate in Katapesh and the Mana Wastes (where they're in demand as alchemists and tinkerers), though many sail as far as Thuvia, the Shackles, and Vidrian. Ysoki dwell throughout Casmaron. They are respected in Kelesh and well established in the caravan city of Ular Kel. Diguo-Dashu, the famous “Empire of Rats,” sprawls below central Tian Xia; however, ysoki also appear throughout that continent's Darklands, especially in the recently reestablished Second Ticker (see below) and the Deepmarket below Goka." };

            yield return new TextBlock { Id = Guid.Parse("c448b05e-e135-49ae-889e-a87d8aca4192"), Type = TextBlockType.Heading, Text = "Second Ticker" };
            yield return new TextBlock { Id = Guid.Parse("a6897e12-8418-43c5-a3a3-d9dae5d80833"), Type = TextBlockType.Text, Text = "Five centuries ago, the sorceress Hao Jin (Lost Omens Legends 46) thwarted a ratfolk surface invasion by transporting the ratfolk's Darklands province to her private demiplane. The demiplane recently collapsed, returning the sphere (now called Round Mountain) to its former site—thankfully just after Pathfinder agents had evacuated the area (then known as Broken Ticker). At first, the ysoki's delight at their reunification smoothed over the upheaval caused by Round Mountain's return. However, the event diverted nearby rivers and trade routes and caused many Broken Ticker ratfolk to lose their homes; the Round Mountain ysoki must now readjust to a world that forgot them; and Hao Jin is reluctant to arbitrate. The united realm of Second Ticker has thus become a powder keg, with only the threat of a nearby army of clockwork soldiers keeping it from exploding." };

            yield return new TextBlock { Id = Guid.Parse("343dea89-1986-4bce-a802-ad4cf0cad9e7"), Type = TextBlockType.Heading, Text = "Ysoki of the Red Planet" };
            yield return new TextBlock { Id = Guid.Parse("a40680e5-81ce-4625-b09a-016d9ea18988"), Type = TextBlockType.Text, Text = "To Golarion natives, Akiton appears as a pink star winking in the evening sky. The handful of explorers who've gone there and returned tell of a desert planet peopled by red-skinned humanoids, four-armed giants, and— most surprisingly of all—ysoki almost identical to Golarion's ratfolk, even down to a shared common language. These ysoki are expert traders as well as superlative gadgeteers; while they invent little themselves, they can repair or reverse-engineer nearly any sort of widget." };
        }

        protected override IEnumerable<TextBlock> GetAdditionalMechanics()
        {
            yield return new TextBlock { Id = Guid.Parse("61e2f40e-fb64-4048-b959-13679bc405ad"), Type = TextBlockType.Heading, Text = "" };
            yield return new TextBlock { Id = Guid.Parse("b02bc4c9-c8b6-46a0-a4e3-05a8813840bf"), Type = TextBlockType.Text, Text = "" };

            yield return new TextBlock { Id = Guid.Parse("ec6f6dc2-4c78-499b-b967-56bbad893d2b"), Type = TextBlockType.Heading, Text = "" };
            yield return new TextBlock { Id = Guid.Parse("58e5fdac-bad3-4625-92d8-ca999300ac30"), Type = TextBlockType.Text, Text = "" };

            yield return new TextBlock { Id = Guid.Parse("4914f3f4-8e46-4f9c-ba02-81d3ff4c1e26"), Type = TextBlockType.Heading, Text = "" };
            yield return new TextBlock { Id = Guid.Parse("00faafee-fb89-4232-978b-82639682cbc3"), Type = TextBlockType.Text, Text = "" };
        }
        ...
        protected override void GetEffects(BooleanEffectBuilder builder)
        {
            ...
            builder.GainSpecificSense(Guid.Parse("75fcc564-fb09-4f9a-b9b2-b6af823aecd7"), Senses.Instances.LowLightVision.ID, SenseAccuracies.Instances.Precise.ID);
        }
