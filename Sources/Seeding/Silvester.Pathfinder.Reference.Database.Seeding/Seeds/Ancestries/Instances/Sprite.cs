...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Ancestries.Instances
{
    public class Sprite : Template
    {
        ...
        protected override IEnumerable<TextBlock> GetDescription()
        {
            ...
            yield return new TextBlock { Id = Guid.Parse("5e978e1a-f953-4249-9f09-1410c0e0dc38"), Type = TextBlockType.Text, Text = "If you want a character who is tiny, mercurial, and curious, you should play a sprite." };
        }
        ...
        protected override void GetEffects(BooleanEffectBuilder builder)
        {
            ...
            builder.GainSpecificSense(Guid.Parse("4fe5827a-4aa1-4b0c-980e-f4b4d2d2acfe"), Senses.Instances.LowLightVision.ID, SenseAccuracies.Instances.Precise.ID);
