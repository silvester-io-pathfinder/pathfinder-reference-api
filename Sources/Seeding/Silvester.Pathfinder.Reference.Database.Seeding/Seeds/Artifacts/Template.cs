...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.Artifacts
{
    ...
    {
        protected override Artifact GetEntity(ISeedBuilder builder)
        {
            ...
            foreach(ArtifactDestructionEffect effect in GetDestructionEffects())
            {
                ...
                builder.AddJoinData<ArtifactDestructionEffect, Trait>(effect, GetDestructionEffectTraits(effect));
            ...
            foreach (ArtifactAction action in GetActions())
            {
                ...
                builder.AddRollableEffect(action, action.RollableEffect);
