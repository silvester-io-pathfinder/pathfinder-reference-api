...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.ClassFeatures.Rogues
{
    public class InitialProficiencies : Template
    {
        ...
        protected override void GetEffects(BooleanEffectBuilder builder)
        {
            ...
            builder.GainSpecificMeleeWeaponProficiency(Guid.Parse("6eab7472-b63a-448d-b87f-27069af39867"), Proficiencies.Instances.Trained.ID, MeleeWeapons.Instances.Rapier.ID);
            builder.GainSpecificMeleeWeaponProficiency(Guid.Parse("4e0fdeab-d986-49d7-bb46-d8fa35e698a8"), Proficiencies.Instances.Trained.ID, MeleeWeapons.Instances.Sap.ID);
            builder.GainSpecificRangedWeaponProficiency(Guid.Parse("9ba3d888-f23e-41e7-afd0-a3d331a7cdb5"), Proficiencies.Instances.Trained.ID, RangedWeapons.Instances.Shortbow.ID);
            builder.GainSpecificMeleeWeaponProficiency(Guid.Parse("855702ad-51a1-4f1c-bfec-3eac9c947371"), Proficiencies.Instances.Trained.ID, MeleeWeapons.Instances.Shortsword.ID);
