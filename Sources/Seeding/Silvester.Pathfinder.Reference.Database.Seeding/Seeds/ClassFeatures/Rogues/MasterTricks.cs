...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.ClassFeatures.Rogues
{
    public class MasterTricks : Template
    {
        ...
        protected override void GetEffects(BooleanEffectBuilder builder)
        {
            ...
            builder.GainSpecificMeleeWeaponProficiency(Guid.Parse("5b974a46-c1f7-4b79-a674-ecac5a752367"), Proficiencies.Instances.Master.ID, MeleeWeapons.Instances.Rapier.ID);
            builder.GainSpecificMeleeWeaponProficiency(Guid.Parse("3ca18dcb-856a-42bf-ad52-0ad4e7fb010d"), Proficiencies.Instances.Master.ID, MeleeWeapons.Instances.Sap.ID);
            builder.GainSpecificMeleeWeaponProficiency(Guid.Parse("dd4bfdd9-a82f-46d4-ac85-037de9ab7ce8"), Proficiencies.Instances.Master.ID, MeleeWeapons.Instances.Shortsword.ID);
            builder.GainSpecificRangedWeaponProficiency(Guid.Parse("5b9c77eb-d253-40e9-88a1-9725d28aa741"), Proficiencies.Instances.Master.ID, RangedWeapons.Instances.Shortbow.ID);
        }
