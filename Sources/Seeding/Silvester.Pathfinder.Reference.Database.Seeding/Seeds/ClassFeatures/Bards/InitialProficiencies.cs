...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.ClassFeatures.Bards
{
    public class InitialProficiencies : Template
    {
        ...
        protected override void GetEffects(BooleanEffectBuilder builder)
        {
            ...
            builder.GainSpecificMeleeWeaponProficiency(Guid.Parse("47209f3b-33cc-47a2-8d12-23dfd825126b"), Proficiencies.Instances.Trained.ID, MeleeWeapons.Instances.Longsword.ID);
            builder.GainSpecificMeleeWeaponProficiency(Guid.Parse("c8f9bd2e-9858-497c-9de9-57ab0cf2054e"), Proficiencies.Instances.Trained.ID, MeleeWeapons.Instances.Rapier.ID);
            builder.GainSpecificMeleeWeaponProficiency(Guid.Parse("eba35543-a7eb-4187-ae41-2c7c8ba45612"), Proficiencies.Instances.Trained.ID, MeleeWeapons.Instances.Sap.ID);
            builder.GainSpecificRangedWeaponProficiency(Guid.Parse("979bb1e9-7dc9-4f4f-92be-84cec1490d0b"), Proficiencies.Instances.Trained.ID, RangedWeapons.Instances.Shortbow.ID);
            builder.GainSpecificMeleeWeaponProficiency(Guid.Parse("c5f29f1b-40e8-457f-8edd-e9b794d2de51"), Proficiencies.Instances.Trained.ID, MeleeWeapons.Instances.Shortsword.ID);
            builder.GainSpecificMeleeWeaponProficiency(Guid.Parse("1e5d0cb0-0528-4451-ab82-ba96d3be7623"), Proficiencies.Instances.Trained.ID, MeleeWeapons.Instances.Whip.ID);
