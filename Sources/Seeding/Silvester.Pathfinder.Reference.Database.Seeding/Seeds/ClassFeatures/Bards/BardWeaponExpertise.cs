...
namespace Silvester.Pathfinder.Reference.Database.Seeding.Seeds.ClassFeatures.Bards
{
    public class BardWeaponExpertise : Template
    {
        ...
        protected override void GetEffects(BooleanEffectBuilder builder)
        {
            ...
            builder.GainSpecificMeleeWeaponProficiency(Guid.Parse("9b0c7dac-64b2-4b30-8d46-0cf09d8de245"), Proficiencies.Instances.Expert.ID, MeleeWeapons.Instances.Longsword.ID);
            builder.GainSpecificMeleeWeaponProficiency(Guid.Parse("62b87b20-af1e-42b3-be45-711d5c503f4e"), Proficiencies.Instances.Expert.ID, MeleeWeapons.Instances.Rapier.ID);
            builder.GainSpecificMeleeWeaponProficiency(Guid.Parse("adce44f0-8ab4-4136-b6f8-482a17302887"), Proficiencies.Instances.Expert.ID, MeleeWeapons.Instances.Sap.ID);
            builder.GainSpecificMeleeWeaponProficiency(Guid.Parse("3280081f-af9c-4231-b334-8810e60726c1"), Proficiencies.Instances.Expert.ID, MeleeWeapons.Instances.Shortsword.ID);
            builder.GainSpecificMeleeWeaponProficiency(Guid.Parse("c0998602-adf0-4ae5-adde-9746e68bbb2f"), Proficiencies.Instances.Expert.ID, MeleeWeapons.Instances.Whip.ID);
            
            builder.GainSpecificRangedWeaponProficiency(Guid.Parse("ee7e5cb9-0d96-4ae6-a72e-bc5e87db52d5"), Proficiencies.Instances.Expert.ID, RangedWeapons.Instances.Shortbow.ID);
