    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FeatTraitBinding", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FeatTraitBinding_Feats_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "Feats",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FeatTraitBinding_Traits_TraitId",
                        column: x => x.TraitId,
                        principalTable: "Traits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FeatTraitBinding_OwnerId",
                table: "FeatTraitBinding",
                column: "OwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_FeatTraitBinding_TraitId",
                table: "FeatTraitBinding",
                column: "TraitId");
