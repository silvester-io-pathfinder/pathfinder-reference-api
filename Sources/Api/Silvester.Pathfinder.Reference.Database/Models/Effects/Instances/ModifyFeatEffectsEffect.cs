...
namespace Silvester.Pathfinder.Reference.Database.Effects.Instances
{
    ...
    public static partial class BooleanEffectBuilderExtensions
    {
        ...
        {
            return builder.Add(new ModifyFeatEffectsEffect { Id = id, FeatId = featId, ModificationEffectId = modificationEffectId, ModificationEffect = BooleanEffectBuilder.CreateAnd(modificationEffectId, buildAction).Build() });
        }
    }
}
