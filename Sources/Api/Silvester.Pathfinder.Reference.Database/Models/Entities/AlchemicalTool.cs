...
{
    public class AlchemicalTool : BaseEntity, ISearchableEntity, INamedEntity
    {
    ...
    public class AlchemicalToolSearchConfigurator : SearchableEntityConfigurator<AlchemicalTool>
    {
