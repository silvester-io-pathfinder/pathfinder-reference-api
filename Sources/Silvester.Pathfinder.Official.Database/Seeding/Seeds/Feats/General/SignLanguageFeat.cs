...
namespace Silvester.Pathfinder.Official.Database.Seeding.Seeds.Feats.General
{
    public class SignLanguageFeat : AbstractFeatTemplate
    {
        ...
        {
            yield return new FeatDetailsBlock { Id = Guid.Parse("0f984b03-0710-45ec-b3d2-8b79b3bad4d1"), Text = "You learn the sign languages associated with the languages you know, allowing you to sign and understand signs. Sign languages typically require both hands to convey more complex concepts, and they are visual rather than auditory." };
            yield return new FeatDetailsBlock { Id = Guid.Parse("6f804bdb-e8ea-4b94-b8da-9dd428098588"), Text = "Sign language is difficult to understand during combat due to the level of attention needed, unlike basic gestures like pointing at a foe to suggest a target. Sign language is hard to use in areas of low visibility, just like speech is difficult in a noisy environment." };
        }
