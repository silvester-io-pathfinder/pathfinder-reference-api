...
namespace Silvester.Pathfinder.Official.Database.Seeding.Seeds.Feats.General
{
    public class RecognizeSpellFeat : AbstractFeatTemplate
    {
        ...
        protected override string ActionType => "Reaction";

        protected override Feat GetFeat()
        {
            return new Feat
            {
                Id = Guid.Parse("30763d23-d261-4295-b636-f94bca378bec"),
        ...
        protected override IEnumerable<Prerequisite> GetPrerequisites(FeatSeeder seeder)
        {
            yield return new OrPrerequisite
            {
                ...
                Choices =
                {
                    new SkillPrerequisite { Id = Guid.Parse("0d21ea88-7d57-4b4a-ae2f-137fc9a3cdb9"), RequiredSkillId = seeder.GetSkill("Arcana"), RequiredProficiencyId = seeder.GetProficiency("Trained") },
                    new SkillPrerequisite { Id = Guid.Parse("745a3458-4af6-40fd-8473-85b931080f08"), RequiredSkillId = seeder.GetSkill("Nature"), RequiredProficiencyId = seeder.GetProficiency("Trained") },
                    new SkillPrerequisite { Id = Guid.Parse("534558b4-37f0-4b30-bf0e-525eb52ee973"), RequiredSkillId = seeder.GetSkill("Occultism"), RequiredProficiencyId = seeder.GetProficiency("Trained") },
                    new SkillPrerequisite { Id = Guid.Parse("525699e1-c5e4-4677-8c3a-24d6be5f880e"), RequiredSkillId = seeder.GetSkill("Religion"), RequiredProficiencyId = seeder.GetProficiency("Trained") },
                }
            };
        }
