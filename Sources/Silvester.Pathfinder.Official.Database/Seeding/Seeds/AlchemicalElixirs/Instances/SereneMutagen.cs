...
namespace Silvester.Pathfinder.Official.Database.Seeding.Seeds.AlchemicalElixirs.Instances
{
    public class SereneMutagen : AbstractAlchemicalElixirTemplate
    {
        ...
        {
            yield return new AlchemicalElixirDetailBlock { Id = Guid.Parse("26d53eae-b1d3-4e3c-81d1-83d6d86633df"), Text = "You gain inner serenity, focused on fine details and steeled against mental assaults, but you find violence off-putting." };
        }
