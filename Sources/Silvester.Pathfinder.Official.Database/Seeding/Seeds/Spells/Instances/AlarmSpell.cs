...
namespace Silvester.Pathfinder.Official.Database.Seeding.Seeds.Spells.Instances
{
    public class AlarmSpell : AbstractSpellTemplate
    {
        ...
        {
            yield return new SpellHeightening { Id = Guid.Parse("730097a4-0886-4c81-a15e-b00fc7ec40c9"), Level = 3, Description = "You can specify criteria for which creatures sound the alarm spell—for instance, orcs or masked people." };
        }
