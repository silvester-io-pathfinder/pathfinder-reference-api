    ...
    public class FireShield : Template
    {
        ...
        public override IEnumerable<SpellHeightening> GetHeightenings()
        {
            yield return new SpellHeightening
            {
                ...
                Details =
                {
                    new TextBlock { Id = Guid.Parse(""), Type = TextBlockType.Text, Text = "The cold resistance increases by 5, and the fire damage increases by 1d6." }
                }
            };
        }
