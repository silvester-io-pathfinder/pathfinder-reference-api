...
namespace Silvester.Pathfinder.Official.Database.Seeding.Seeds.Spells.Instances
{
    ...
    {
        public static readonly Guid ID = Guid.Parse("9fc54f84-b805-4622-b83c-a7944ff53817");
        ...
        public override IEnumerable<SpellHeightening> GetHeightenings()
        {
            ...
            {
                Id = Guid.Parse("9fc54f84-b805-4622-b83c-a7944ff53817"), 
                Level = "+2",
                Details =
                {
                    new TextBlock { Id = Guid.Parse("9fc54f84-b805-4622-b83c-a7944ff53817"), Type = TextBlockType.Text, Text = "The Hit Points of each section of the wall increase by 10, and the cold damage dealt to creatures crossing a destroyed section increases by 1d6." }
                }
            };
        }
