...
namespace Silvester.Pathfinder.Official.Database.Seeding.Seeds.Spells.Instances
{
    ...
    {
        public static readonly Guid ID = Guid.Parse("e16b61a0-608e-4cdc-a3fb-89573d2d9648");
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("e16b61a0-608e-4cdc-a3fb-89573d2d9648"), Type = TextBlockType.Text, Text = "You cause the areas to appear to swell, bend, and break, twisting together in a bizarre spatial geometry. The cubes of the spell’s area can’t be adjacent to one another. A creature must attempt a Will save if it’s in one of the cubes when you Cast the Spell, or if it later enters one of the areas, with the following effects. A creature interacting with the illusion can also attempt a Will save to disbelieve the illusion, as normal." };
        }
        ...
        public override IEnumerable<RollableEffect> GetRollableEffects()
        {
            ...
            {
                Id = Guid.Parse("e16b61a0-608e-4cdc-a3fb-89573d2d9648"),
