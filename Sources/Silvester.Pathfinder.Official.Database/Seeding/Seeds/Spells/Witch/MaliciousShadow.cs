...
namespace Silvester.Pathfinder.Official.Database.Seeding.Seeds.Spells.Instances
{
    ...
    {
        public static readonly Guid ID = Guid.Parse("17a06477-0e8a-44f0-aea9-05c7eef0e9b0");
        ...
        public override IEnumerable<SpellHeightening> GetHeightenings()
        {
            ...
            {
                Id = Guid.Parse("17a06477-0e8a-44f0-aea9-05c7eef0e9b0"),
                Level = "+2",
                Details =
                {
                    new TextBlock { Id = Guid.Parse("17a06477-0e8a-44f0-aea9-05c7eef0e9b0"), Type = TextBlockType.Text, Text = "The Strike damage increases by 1d10." }
                }
            };
        }
