...
namespace Silvester.Pathfinder.Official.Database.Seeding.Seeds.Spells.Instances
{
    public class StealShadow : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse(""), Type = TextBlockType.Text, Text = "You steal a creature’s shadow, leaving it weakened and vulnerable.The target must attempt a Fortitude save." };
        }
        ...
        public override IEnumerable<SpellHeightening> GetHeightenings()
        {
            yield return new SpellHeightening
            {
                ...
                Details =
                {
                     new TextBlock { Id = Guid.Parse(""), Type = TextBlockType.Text, Text = "The damage when the spell is cast and when it is sustained increases by 1d4." }
                }
            };
        }
