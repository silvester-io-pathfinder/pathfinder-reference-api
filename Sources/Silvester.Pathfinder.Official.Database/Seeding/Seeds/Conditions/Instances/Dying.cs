...
{
    public class Dying : AbstractConditionTemplate
    {
        ...
        {
            yield return new ConditionDetailBlock { Id = Guid.Parse("522f0c99-e56b-4848-9adf-6579947713a2"), Text = "Death and Dying Rules", Type = ConditionDetailBlockType.Title};
            yield return new ConditionDetailBlock { Id = Guid.Parse("c4e5deec-51aa-4e93-92e1-9dda14f2d903"), Text = "The doomed, dying, unconscious, and wounded conditions all relate to the process of coming closer to death. The full rules are on pages 459–461. The most significant information not contained in the conditions themselves is this: When you’re reduced to 0 Hit Points, you’re knocked out with the following effects:", Type = ConditionDetailBlockType.Text };
            yield return new ConditionDetailBlock { Id = Guid.Parse("ee821b5c-04d4-4212-8f37-98b8a827cff5"), Text = "You immediately move your initiative position to directly before the turn in which you were reduced to 0 HP.”", Type = ConditionDetailBlockType.Enumeration };
            yield return new ConditionDetailBlock { Id = Guid.Parse("44052fce-df27-49bc-bc37-537fd6f0a7b0"), Text = "You gain the dying 1 condition. If the effect that knocked you out was a critical success from the attacker or the result of your critical failure, you gain the dying 2 condition instead. If you have the wounded condition, increase these values by your wounded value. If the damage came from a nonlethal attack or effect, you don’t gain the dying condition— you are instead unconscious with 0 Hit Points.", Type = ConditionDetailBlockType.Enumeration};
        }
    }
}
