    ...
    public class PoisonedDartGallery : AbstractHazardTemplate
    {
        ...
        protected override IEnumerable<HazardAction> GetActions(HazardSeeder seeder)
        {
            yield return new HazardAction
            {
                ...
                EffectDetails =
                {
                    new HazardActionEffectBlock { Id = Guid.Parse("eb77450e-c55c-43e4-b3c1-aadb7c0fe4e5"), Text = "The trap makes a poisoned dart Strike against the triggering creature, then rolls initiative." },
                },
                Effects = new HazardActionEffect[]
                {
                    new AttackHazardActionEffect
                    {
                        ...
                        AttackTypeId = seeder.GetAttackTypeByName("Ranged").Id,
                        ...
                        PoisonEffect = new StaggeredEffect
                        {
                            ...
                            Stages =
                            {
                                new StaggeredEffectStage
                                {
                                    ...
                                    Effects =
                                    {
                                        new DamagePoisonStageEffect {Id = Guid.Parse("c9d62b09-91f1-4e18-bd8e-e127cd634aff"), Damage = "1d6", DamageTypeId = seeder.GetDamageTypeByName("Poison").Id },
                                ...
                                new StaggeredEffectStage
                                {
                                    ...
                                    Effects =
                                    {
                                        new DamagePoisonStageEffect {Id = Guid.Parse("044dbf8d-f3cb-4993-afe9-981f70035070"), Damage = "2d6", DamageTypeId = seeder.GetDamageTypeByName("Poison").Id },
                                ...
                                new StaggeredEffectStage
                                {
                                    ...
                                    Effects =
                                    {
                                        new DamagePoisonStageEffect {Id = Guid.Parse("6f95b00b-9387-4bf5-9bda-844e25fd15c3"), Damage = "3d6", DamageTypeId = seeder.GetDamageTypeByName("Poison").Id },
            ...
            yield return new HazardAction
            {
                ...
                EffectDetails =
                {
                    new HazardActionEffectBlock { Id = Guid.Parse("f79173f5-49dc-4322-8be4-c4591b89d643"), Text = "The trap makes a poisoned dart Strike against the triggering creature." },
                },
                Effects = new HazardActionEffect[]
                {
                    new AttackHazardActionEffect
                        ...
                        PoisonEffect = new StaggeredEffect
                        {
                            ...
                            Stages =
                            {
                                new StaggeredEffectStage
                                {
                                    ...
                                    Effects =
                                    {
                                        new DamagePoisonStageEffect {Id = Guid.Parse("2c36b00c-3d05-4f99-9f29-c7fd4abd3a8c"), Damage = "1d6", DamageTypeId = seeder.GetDamageTypeByName("Poison").Id },
                                ...
                                new StaggeredEffectStage
                                {
                                    ...
                                    Effects =
                                    {
                                        new DamagePoisonStageEffect {Id = Guid.Parse("f3283d2d-844f-47b0-8995-919fd1e45016"), Damage = "2d6", DamageTypeId = seeder.GetDamageTypeByName("Poison").Id },
                                ...
                                new StaggeredEffectStage
                                {
                                    ...
                                    Effects =
                                    {
                                        new DamagePoisonStageEffect {Id = Guid.Parse("865ab974-a10e-4aef-a231-62232f5c5b1e"), Damage = "3d6", DamageTypeId = seeder.GetDamageTypeByName("Poison").Id },
