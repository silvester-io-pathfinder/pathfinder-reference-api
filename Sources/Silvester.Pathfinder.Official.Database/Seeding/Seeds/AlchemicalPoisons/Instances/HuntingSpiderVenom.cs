    ...
    public class HuntingSpiderVenom : AbstractAlchemicalPoisonTemplate
    {
        ...
        protected override IEnumerable<PoisonEffectStage> GetAlchemicalPoisonStages(AlchemicalPoisonSeeder seeder)
        {
            yield return new PoisonEffectStage
            {
                ...
                {
                    new DamagePoisonStageEffect { Id = Guid.Parse("a78408c4-2205-480a-8609-2cd28a755fe1"), Damage = "1d10", DamageType = seeder.GetDamageTypeByName("Poison")},
            ...
            yield return new PoisonEffectStage
            {
                ...
                Effects = new PoisonEffectStageEffect[]
                {
                    new DamagePoisonStageEffect { Id = Guid.Parse("0727811c-bfd4-4a38-9166-c94d17fd239f"), Damage = "1d12", DamageType = seeder.GetDamageTypeByName("Poison")},
            ...
            yield return new PoisonEffectStage
            {
                ...
                Effects = new PoisonEffectStageEffect[]
                {
                    new DamagePoisonStageEffect { Id = Guid.Parse("de183ff8-e257-433d-8768-043895f2ade5"), Damage = "2d6", DamageType = seeder.GetDamageTypeByName("Poison")},
