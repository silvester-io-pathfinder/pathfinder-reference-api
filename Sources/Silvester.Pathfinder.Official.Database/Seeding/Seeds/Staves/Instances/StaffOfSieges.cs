...
namespace Silvester.Pathfinder.Official.Database.Seeding.Seeds.Staves.Instances
{
    public class StaffOfSieges : Template
    {
        ...
        {
            yield return new TextBlock { Id = Guid.Parse(""), Type = TextBlockType.Text, Text = "This adamantine staff is fitted with mithral plates resembling battlements on a castle. Lesser cover, cover, and greater cover don't grant any bonus against your spell attacks or to saving throws against your spells that you cast from the staff." };
        }
        ...
        protected override IEnumerable<StavePotencyBinding> GetPotencies()
        {
            yield return new StavePotencyBinding
            {
                ...
                Spells = new StaveSpell[]
                {
                    ...
                    new StaveSpell { Id = Guid.Parse(""), Level = 1, SpellId = Spells.Instances.GustOfWind.ID},
                    new StaveSpell { Id = Guid.Parse(""), Level = 1, SpellId = Spells.Instances.Longstrider.ID},
                    ...
                    new StaveSpell { Id = Guid.Parse(""), Level = 3, SpellId = Spells.Instances.WallOfWind.ID},
                    new StaveSpell { Id = Guid.Parse(""), Level = 4, SpellId = Spells.Instances.HallucinatoryTerrain.ID},
                    new StaveSpell { Id = Guid.Parse(""), Level = 4, SpellId = Spells.Instances.SolidFog.ID},
                    ...
                    new StaveSpell { Id = Guid.Parse(""), Level = 5, SpellId = Spells.Instances.WallOfStone.ID},
                    ...
                    new StaveSpell { Id = Guid.Parse(""), Level = 7, SpellId = Spells.Instances.MagnificentMansion.ID},
                    new StaveSpell { Id = Guid.Parse(""), Level = 7, SpellId = Spells.Instances.PrismaticSpray.ID},
                    new StaveSpell { Id = Guid.Parse(""), Level = 8, SpellId = Spells.Instances.Earthquake.ID},
                    new StaveSpell { Id = Guid.Parse(""), Level = 8, SpellId = Spells.Instances.ScintillatingPattern.ID},
