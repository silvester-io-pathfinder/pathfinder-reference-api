...
namespace Silvester.Pathfinder.Official.Database.Seeding.Seeds.Focusses.Cleric.Instances
{
    ...
    {
        public static readonly Guid ID = Guid.Parse("e92a5b45-1e86-4fca-acc3-db135350e50c");

        public override Focus GetFocus()
        {
            return new ClericFocus
            {
                Id = ID,
                Name = "Splash of Art",
                Level = 1,
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("1198065e-d036-46ce-9cca-90f398c7c166"), Type = TextBlockType.Text, Text = "A deluge of colorful illusory paint, tools, or other symbols of art and artisanship drift down in the area. Roll 1d4 to determine the color of the illusion. Each creature in the area must attempt a Will save. A creature is unaffected on a success. On a failure or critical failure, the creature takes the results listed on the table relevant to the color." };
        }
        ...
        protected override SourcePage GetSourcePage()
        {
            ...
            {
                Id = Guid.Parse("46b60384-04cb-4b5c-a6bc-a679a1a0287a"),
