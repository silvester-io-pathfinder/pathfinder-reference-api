...
namespace Silvester.Pathfinder.Official.Database.Seeding.Seeds.Focusses.Sorcerer.Instances
{
    ...
    {
        public static readonly Guid ID = Guid.Parse("82f6ae3b-2fb3-4568-a14e-3e53dc8115f2");
        ...
        {
            yield return new TextBlock { Id = Guid.Parse("78fc8ef0-68cf-4e65-a8e1-fd9b4bb79c33"), Type = TextBlockType.Text, Text = "You spew energy from your mouth, dealing 5d6 damage. The area, damage type, and save depend on the dragon type in your bloodline." };
        }
        ...
        public override IEnumerable<SpellHeightening> GetHeightenings()
        {
            ...
            {
                Id = Guid.Parse("d15fbd56-b7a5-4121-bdf2-a7a01845893a"),
                Level = "+1",
                Details =
                {
                    new TextBlock { Id = Guid.Parse("807ac9b2-a03b-47ea-b394-95a69b8c63c1"), Type = TextBlockType.Text, Text = "The damage increases by 2d6." }
                }
            };
        }
        ...
        protected override SourcePage GetSourcePage()
        {
            ...
            {
                Id = Guid.Parse("7bf34629-1fd7-4bbc-8a76-7d0ad8af9654"),
