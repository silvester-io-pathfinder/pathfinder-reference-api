    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Conditions_Sources_SourcePageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConditionDetailBlock", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ConditionDetailBlock_Conditions_ConditionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CursesId = table.Column<Guid>(type: "uuid", nullable: true),
                    DiseasesId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Diseases_Traits_TraitsId",
                        column: x => x.TraitsId,
                        principalTable: "Traits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("d104a1f4-fb11-45c3-84b7-14880d673095"), "Degrees of Detection" },
                    { new Guid("ae1f94c2-5442-4eed-bfdc-54a3faadbcc4"), "Attitudes" },
                    { new Guid("18744a3c-8c8d-4298-8be7-f5e7e5dc0a6b"), "Death and Dying" },
                    { new Guid("655ed530-4d75-4816-af14-4cbbdd19531e"), "Lowered Abilities" },
                    { new Guid("224d0ea9-af56-49b9-946d-ce809b894701"), "Senses" }
                });

            migrationBuilder.InsertData(
                table: "Conditions",
                columns: new[] { "Id", "ConditionCategoryId", "Description", "Name", "OverridesConditionId", "SourcePageId" },
                values: new object[,]
                {
                    { new Guid("d1a95821-ef2b-4c73-8ec6-9ec6789c885d"), null, "You are the carrier of a disease, but you do not yet experience symptoms.", "Carrier", null, null },
                    { new Guid("9c93e839-3ea9-4baa-aada-951d8fbf9807"), null, "You are choked, either physically by something or someone, by something magical, or by the the effects of a disease or illness (such as coughing). You need to pass a flat DC check equal to the severity of the condition when you attempt to cast a spell that has a verbal component to it, or activate an item that has a command component to it.", "Choked", null, null },
                    { new Guid("b0cbbc02-bec0-4b21-9b61-8af5bb2fc62b"), null, "You are unable to communicate verbally with anyone. Additionally, you cannot cast any spells that have a verbal component to it, or activate an item that hase a command component to it.", "Muted", null, null },
                    { new Guid("d9b38c43-deee-4d47-a5a8-ee48ab4daa2d"), null, "You are conflicted with sudden spasms. The rulebooks do not mention any particular effects of spasming, so it is best left up to the discretion of the GM.", "Spasming", null, null },
                    { new Guid("a2d387ce-eec5-439b-9e2e-2ef38f0ff3fb"), null, "You are weighed down, either physically, magically or otherwise. You take a penalty to all your movement speeds, but your speed can never be reduced below 5 feet.", "Weighed Down", null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("ce414c75-a03c-4602-a0e0-8d81ac980fc5"), "Other" },
                    { new Guid("b084d3bf-72ac-49bc-bab2-21aa86c31fd2"), "Bleed" },
                    { new Guid("4712d8c3-ffe6-4db2-b28e-f94065b005bc"), "Bludgeoning" },
                    { new Guid("8095023e-8d92-4cdd-b294-846dc71fdb21"), "Piercing" },
                    { new Guid("d047f71a-eead-4685-b09c-03e11ad29d8b"), "Slashing" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("e4f9b68a-f157-4657-bb05-0b50d1e5b955"), "Pathfinder #155: Lord of the Black Sands" },
                    ...
                    { new Guid("51f273bd-9c56-4a21-82ca-df90e1e13955"), "Bestiary 2" },
                    { new Guid("643d5da8-e766-44c9-9748-7ad1ac97dcbf"), "Gamemastery Guide" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Traits",
                columns: new[] { "Id", "ActionsId", "CursesId", "Description", "DiseasesId", "FeatsId", "Name", "SpellsId" },
                values: new object[,]
                {
                    { new Guid("be9994ab-79ef-4ec0-9761-492059b0083a"), null, null, "An ability with this trait can take a character completely out of the fight or even kill them, and it’s harder to use on a more powerful character. If a spell has the incapacitation trait, any creature of more than twice the spell’s level treats the result of their check to prevent being incapacitated by the spell as one degree of success better, or the result of any check the spellcaster made to incapacitate them as one degree of success worse. If any other effect has the incapacitation trait, a creature of higher level than the item, creature, or hazard generating the effect gains the same benefits.", null, null, "Incapacitation", null },
                    { new Guid("fc3cb057-dcb6-4508-915a-0abd25679211"), null, null, "Evil effects often manipulate energy from evil-aligned Outer Planes and are antithetical to good divine servants or divine servants of good deities.", null, null, "Evil", null },
                    { new Guid("1ee8c64b-ad34-4b3b-a01c-a1057eea01f6"), null, null, "This effect alters a creature's emotions. Effects with this trait always have the mental trait as well. Creatures with special training or that have mechanical or artificial intelligence are immune to emotion effects.", null, null, "Emotion", null },
                    { new Guid("0cb3dbbc-941b-4e27-b46c-d0246dacc056"), null, null, "An effect with this trait applies one or more diseases. A disease is typically an affliction.", null, null, "Disease", null },
                    { new Guid("a23df7f5-acc6-4f87-9244-0fbbc77c70d2"), null, null, "Effects with this trait attempt to determine the presence or location of a person, object, or aura.", null, null, "Detection", null },
                    { new Guid("f1f5c47a-fec2-4983-8229-3c4e8b43f0b5"), null, null, "An effect with the death trait kills you immediately if it reduces you to 0 HP. Some death effects can bring you closer to death or slay you outright without reducing you to 0 HP.", null, null, "Death", null },
                    { new Guid("3d4c67f6-d5a1-4529-9559-02aa18d81054"), null, null, "A type of feat that any character can select, regardless of ancestry and class, as long as they meet the prerequisites. You can select a feat with this trait when your class grants a general feat.", null, null, "General", null },
                    { new Guid("9da1e40e-f9b8-4381-9167-229fee66f4f7"), null, null, "A spell you can cast at will that is automatically heightened to half your level rounded up.", null, null, "Cantrip", null },
                    { new Guid("856db08f-edad-472b-b870-65a8f16252a5"), null, null, "An ability with this trait involves an attack. For each attack you make beyond the first on your turn, you take a multiple attack penalty.", null, null, "Attack", null },
                    { new Guid("4fbbdfad-330f-4e0f-92dd-d070a59d7498"), null, null, "A general feat with the skill trait improves your skills and their actions or gives you new actions for a skill. A feat with this trait can be selected when a class grants a skill feat or general feat. Archetype feats with the skill trait can be selected in place of a skill feat if you have that archetype’s dedication feat.", null, null, "Skill", null },
                    { new Guid("c90d2554-1af6-45d7-9f20-f98aa0799887"), null, null, "Light effects overcome non-magical darkness in the area, and can counteract magical darkness. You must usually target darkness magic with your light magic directly to counteract the darkness, but some light spells automatically attempt to counteract darkness.", null, null, "Light", null },
                    { new Guid("06f2cf99-b089-4e34-b443-53028fdc2ae0"), null, null, "A healing effect restores a creature's body, typically by restoring Hit Points, but sometimes by removing diseases or other debilitating effects.", null, null, "Healing", null },
                    { new Guid("23655aa4-871f-416f-be14-1fc03bedef16"), null, null, "An effect with this trait is not inherently deadly. Damage from a nonlethal effect knocks a creature out rather than killing it. You can use a nonlethal weapon to make a lethal attack with a –2 circumstance penalty.", null, null, "Nonlethal", null },
                    { new Guid("e5b98ff4-8503-461c-870d-7b8c8e4811fa"), null, null, "Chaotic effects often manipulate energy from chaos-aligned Outer Planes and are anathema to lawful divine servants or divine servants of lawful deities.", null, null, "Chaotic", null },
                    { new Guid("315bf80d-594e-46ca-944e-cb8287df46fa"), null, null, "An effect with this trait depends on language comprehension. A linguistic effect that targets a creature works only if the target understands the language you are using.", null, null, "Linguistic", null },
                    { new Guid("7684fa81-e3a5-4224-8d57-bc61df53d54a"), null, null, "Effects with this trait determine what is likely to happen in the near future. Most predictions are divinations.", null, null, "Prediction", null },
                    { new Guid("33bf3198-48a1-4559-9a48-9881901f880b"), null, null, "Effects that slightly alter a creature’s form have the morph trait. Any Strikes specifically granted by a morph effect are magical. You can be affected by multiple morph spells at once, but if you morph the same body part more than once, the second morph effect attempts to counteract the first (in the same manner as two polymorph effects, described in that trait). Your morph effects might also end if you are polymorphed and the polymorph effect invalidates or overrides your morph effect. The GM determines which morph effects can be used together and which can’t.", null, null, "Morph", null },
                    { new Guid("39aba859-33a5-45df-b1fe-902f8e3c2273"), null, null, "Something with the magical trait is imbued with magical energies not tied to a specific tradition of magic. A magical item radiates a magic aura infused with its dominant school of magic.  Some items or effects are closely tied to a particular tradition of magic. In these cases, the item has the arcane, divine, occult, or primal trait instead of the magical trait. Any of these traits indicate that the item is magical.", null, null, "Magical", null },
                    { new Guid("739ead1c-4020-4673-96d2-4d0b543f6295"), null, null, "A curse is an effect that places some long-term affliction on a creature. Curses are always magical and are typically the result of a spell or trap. Effects with this trait can be removed only by effects that specifically target curses.  Afflictions with this trait are manifestations of potent ill will.A curse either lasts a specified amount of time or can be removed only by certain actions a character must perform or conditions they must meet.A curse with stages follows the rules for afflictions. (Gamemastery Guide pg. 251)", null, null, "Curse", null },
                    { new Guid("5f7b92e7-09d2-4717-8588-56b45c08a111"), null, null, "The GM rolls the check for this ability in secret.", null, null, "Secret", null },
                    { new Guid("c5e1a5e7-5d45-4826-b2ea-018b361770de"), null, null, "An action with this trait requires a degree of mental concentration and discipline.", null, null, "Concentrate", null },
                    { new Guid("08bac763-e881-4a70-b253-916191ee9713"), null, null, "An action with this trait involves moving from one space to another.", null, null, "Move", null },
                    { new Guid("f7ad867e-49e3-40e3-ad95-bbf461be2087"), null, null, "Fear effects evoke the emotion of fear. Effects with this trait always have the mental and emotion traits as well.", null, null, "Fear", null },
                    { new Guid("ccae1335-3555-4e55-9fe4-d22f6b9bc162"), null, null, "An activity with this trait takes a day or more, and can be used only during downtime", null, null, "Downtime", null },
                    { new Guid("dee6c869-337c-4f4c-ba3c-3c3e77c19857"), null, null, "You must physically manipulate an item or make gestures to use an action with this trait. Creatures without a suitable appendage can’t perform actions with this trait. Manipulate actions often trigger reactions.", null, null, "Manipulate", null },
                    { new Guid("9979d44e-3a35-4eef-a767-d3c974b5fbf6"), null, null, "A fortune effect beneficially alters how you roll your dice. You can never have more than one fortune effect alter a single roll. If multiple fortune effects would apply, you have to pick which to use. If a fortune effect and a misfortune effect would apply to the same roll, the two cancel each other out, and you roll normally.", null, null, "Fortune", null },
                    { new Guid("340e83a5-5a6e-4a5f-8658-7aede58da5a9"), null, null, "Teleportation effects allow you to instantaneously move from one point in space to another. Teleportation does not usually trigger reactions based on movement.", null, null, "Teleportation", null },
                    { new Guid("f91abbe0-0bec-4278-99d0-b12f044f8061"), null, null, "A scrying effect lets you see, hear, or otherwise get sensory information from a distance using a sensor or apparatus, rather than your own eyes and ears.", null, null, "Scrying", null },
                    { new Guid("4f8453ab-e7f8-4d2f-95e7-e0e53a32cbde"), null, null, "Effects with this trait see things as they truly are.", null, null, "Revelation", null },
                    { new Guid("aa2b017d-2e8c-460a-9069-6bf61b69dd72"), null, null, "Darkness effects extinguish non-magical light in the area, and can counteract less powerful magical light. You must usually target light magic with your darkness magic directly to counteract the light, but some darkness spells automatically attempt to counteract light.", null, null, "Darkness", null },
                    { new Guid("2bc07fcc-2113-4b39-a257-17851f1f216d"), null, null, "Vegetable creatures have the plant trait. They are distinct from normal plants. Magical effects with this trait manipulate or conjure plants or plant matter in some way. Those that manipulate plants have no effect in an area with no plants.", null, null, "Plant", null },
                    { new Guid("1a83b706-d9c1-4b46-bcf3-3c9bb82219ee"), null, null, "These effects transform the target into a new form. A target can’t be under the effect of more than one polymorph effect at a time. If it comes under the effect of a second polymorph effect, the second polymorph effect attempts to counteract the first. If it succeeds, it takes effect, and if it fails, the spell has no effect on that target. Any Strikes specifically granted by a polymorph effect are magical. Unless otherwise stated, polymorph spells don’t allow the target to take on the appearance of a specific individual creature, but rather just a generic creature of a general type or ancestry. If you take on a battle form with a polymorph spell, the special statistics can be adjusted only by circumstance bonuses, status bonuses, and penalties. Unless otherwise noted, the battle form prevents you from casting spells, speaking, and using most manipulate actions that require hands. (If there’s doubt about whether you can use an action, the GM decides.) Your gear is absorbed into you; the constant abilities of your gear still function, but you can’t activate any items.", null, null, "Polymorph", null },
                    { new Guid("2cbfa741-d7b5-465c-98b4-7a6bceae533e"), null, null, "A mental effect can alter the target’s mind. It has no effect on an object or a mindless creature.", null, null, "Mental", null },
                    { new Guid("39e2298b-bab0-49b7-8a0a-4ac1145611b0"), null, null, "An effect with this trait delivers a poison or deals poison damage. An item with this trait is poisonous and might cause an affliction.", null, null, "Poison", null },
                    { new Guid("e2bb08cb-cf59-4e29-8738-52c751405fb0"), null, null, "A visual effect can affect only creatures that can see it. This applies only to visible parts of the effect, as determined by the GM.", null, null, "Visual", null },
                    { new Guid("551070c6-e73a-4c0c-9a9c-f6425f38f5f0"), null, null, "This poison is delivered when breathed in.", null, null, "Inhaled", null },
                    { new Guid("561c7c89-44d2-492e-b12f-352af45b6a6b"), null, null, "This magic comes from the divine tradition, drawing power from deities or similar sources. Anything with this trait is magical.", null, null, "Divine", null },
                    { new Guid("a0e52203-1c57-4a58-bff2-7e262b56181f"), null, null, "This magic comes from the arcane tradition, which is built on logic and rationality. Anything with this trait is magical.", null, null, "Arcane", null },
                    { new Guid("812b4b93-b467-438f-9561-ef020545755f"), null, null, "An effect with the sonic trait functions only if it makes sound, meaning it has no effect in an area of silence or in a vacuum. This is different from an auditory spell, which is effective only if the target can hear it. A sonic effect might deal sonic damage. A creature with this trait has a magical connection to powerful sound.", null, null, "Sonic", null },
                    { new Guid("ece55c2d-2715-4e67-aa1e-736c019e89a6"), null, null, "Effects with this trait heal living creatures with positive energy, deal positive energy damage to undead, or manipulate positive energy. Planes with this trait are awash with life energy of such intensity that it can harm living creatures. Creatures with this trait are natives of the Positive Energy Plane. They can survive the basic environmental effects of the Positive Energy Plane.", null, null, "Positive", null },
                    { new Guid("30ed464b-6bf4-4a80-8c42-8bb95ecb751c"), null, null, "Effects with this trait heal undead creatures with negative energy, deal negative damage to living creatures, or manipulate negative energy. Planes with this trait are vast, empty reaches that suck the life from the living. Creatures with this trait are natives of the Negative Energy Plane. They can survive the basic environmental effects of the Negative Energy Plane.", null, null, "Negative", null },
                    { new Guid("e55f102e-414e-4210-b1b3-97d8c26bab6a"), null, null, "Effects with this trait deal force damage or create objects made of pure magical force.", null, null, "Force", null },
                    { new Guid("0e3307ce-952d-4d93-bcac-95bbf495ee85"), null, null, "This magic comes from the occult tradition, calling upon bizarre and ephemeral mysteries. Anything with this trait is magical.", null, null, "Occult", null },
                    { new Guid("dc6ca4d1-85f2-4be9-bc39-9a48b943b392"), null, null, "Effects with this trait deal electricity damage. A creature with this trait has a magical connection to electricity.", null, null, "Electricity", null },
                    { new Guid("44a15dce-b0cf-4d6a-a4be-92d759fdbaa3"), null, null, "Effects with this trait deal acid damage. Creatures with this trait have a magical connection to acid.", null, null, "Acid", null },
                    { new Guid("689bc25d-de13-418c-8da2-a9280936359d"), null, null, "Effects with the earth trait either manipulate or conjure earth. Those that manipulate earth have no effect in an area without earth. Creatures with this trait consist primarily of earth or have a magical connection to that element. Planes with this trait are mostly solid, with caverns and other hollow pockets.", null, null, "Earth", null },
                    { new Guid("d1aabc8c-b3fe-40eb-bfc2-ea72d3b7e0c0"), null, null, "Effects with the fire trait deal fire damage or either conjure or manipulate fire. Those that manipulate fire have no effect in an area without fire. Creatures with this trait consist primarily of fire or have a magical connection to that element. Planes with this trait are composed of flames that continually burn with no fuel source. Fire planes are extremely hostile to non-fire creatures.", null, null, "Fire", null },
                    { new Guid("ae21e02b-11a1-4c53-96ec-5961beb2761d"), null, null, "Effects with the water trait either manipulate or conjure water. Those that manipulate water have no effect in an area without water. Creatures with this trait consist primarily of water or have a magical connection to the element. Planes with this trait are mostly liquid, perhaps with pockets of breathable air.", null, null, "Water", null },
                    { new Guid("7cb74b87-4e13-4d8c-afa5-da8cbe671bfc"), null, null, "Effects with the air trait either manipulate or conjure air. Those that manipulate air have no effect in a vacuum or an area without air. Creatures with this trait consist primarily of air or have a magical connection to that element. Planes with this trait consist mostly of open spaces and air with various degrees of turbulence, though they also contain rare islands of floating stone and other elements and energies.", null, null, "Air", null },
                    { new Guid("4b9d47d5-3e89-41ba-8183-9e743c49a41a"), null, null, "This effect can cause a creature to fall asleep or get drowsy.", null, null, "Sleep", null },
                    { new Guid("36d65d85-b689-46da-86b6-4f0838f296e6"), null, null, "Effects with this trait deal cold damage. Creatures with this trait have a connection to magical cold.", null, null, "Cold", null },
                    { new Guid("3de4876d-2336-4d5e-bbbb-5b4e83ea6d49"), null, null, "This magic comes from the primal tradition, connecting to the natural world and instinct. Anything with this trait is magical.", null, null, "Primal", null },
                    { new Guid("5b33384c-0c98-4238-8257-8b911933308e"), null, null, "Anything that doesn't list another rarity trait (uncommon, rare, or unique) automatically has the common trait. This rarity indicates that an ability, item, or spell is available to all players who meet the prerequisites for it. A creature of this rarity is generally known and can be summoned with the appropriate summon spell.", null, null, "Common", null },
                    { new Guid("0c06a5b8-24e7-486b-bb98-91caef377013"), null, null, "Something of uncommon rarity requires special training or comes from a particular culture or part of the world. Some character choices give access to uncommon options, and the GM can choose to allow access for anyone. Less is known about uncommon creatures than common creatures. They typically can’t be summoned. The DC of Recall Knowledge checks related to these creature is increased by 2.", null, null, "Uncommon", null },
                    { new Guid("3078e40b-db78-4f39-9ffc-304e6a1993cf"), null, null, "This poison is delivered when drunk or eaten.", null, null, "Ingested", null },
                    { new Guid("0b49fe13-7684-43b9-b5a5-81b8c038dc9c"), null, null, "This poison is delivered by contact with the skin.", null, null, "Contact", null },
                    { new Guid("d748ac0d-6af3-4475-af4e-a72455960fe0"), null, null, "A verbal component is a vocalization of words of power. You must speak them in a strong voice, so it’s hard to conceal that you’re Casting a Spell. The spell gains the concentrate trait. You must be able to speak to provide this component.", null, null, "Verbal", null },
                    { new Guid("a6217da0-ad2a-43a0-88d4-ac85f1d68591"), null, null, "An olfactory effect can affect only creatures that can smell it. This applies only to olfactory parts of the effect, as determined by the GM.", null, null, "Olfactory", null },
                    { new Guid("44a18bec-0799-41a7-9b07-16113bb0623f"), null, null, "Auditory actions and effects rely on sound. An action with the auditory trait can be successfully performed only if the creature using the action can speak or otherwise produce the required sounds. A spell or effect with the auditory trait has its effect only if the target can hear it. This applies only to sound-based parts of the effect, as determined by the GM. This is different from a sonic effect, which still affects targets who can't hear it (such as deaf targets) as long as the effect itself makes sound.", null, null, "Auditory", null },
                    { new Guid("d751d93f-cff9-448f-8ab0-9a3c07eacbef"), null, null, "Effects and magic items with this trait are associated with the transmutation school of magic, typically changing something’s form.", null, null, "Transmutation", null },
                    { new Guid("2d643d25-b9aa-4544-b482-04b3475eb82b"), null, null, "Effects and magic items with this trait are associated with the necromancy school of magic, typically involving forces of life and death.", null, null, "Necromancy", null },
                    { new Guid("7f9fe1cb-c607-44c3-8f1a-b26d508cfce6"), null, null, "Effects and magic items with this trait are associated with the illusion school of magic, typically involving false sensory stimuli.", null, null, "Illusion", null },
                    { new Guid("f5f7ca8a-100a-4d93-aa07-e0f1bb3cbc49"), null, null, "Effects and magic items with this trait are associated with the evocation school of magic, typically involving energy and elemental forces.", null, null, "Evocation", null },
                    { new Guid("e7fd1927-8c01-4945-899e-a99d2e44662a"), null, null, "Effects and magic items with this trait are associated with the enchantment school of magic, typically involving mind control, emotion alteration, and other mental effects.", null, null, "Enchantment", null },
                    { new Guid("5bce1594-6c07-460f-b306-0db1fa30833b"), null, null, "The divination school of magic typically involves obtaining or transferring information, or predicting events.", null, null, "Divination", null },
                    { new Guid("6f187720-6664-44c6-8e09-2053ed1054d6"), null, null, "Effects and magic items with this trait are associated with the conjuration school of magic, typically involving summoning, creation, teleportation, or moving things from place to place.", null, null, "Conjuration", null },
                    { new Guid("c499214b-94fc-4103-8c7c-6f7a56b5c980"), null, null, "Effects and magic items with this trait are associated with the abjuration school of magic, typically involving protection or wards.", null, null, "Abjuration", null },
                    { new Guid("68d3b3ab-d2ed-4691-8609-7403c843c77f"), null, null, "A rules element with this trait is one-of-a-kind. The DC of Recall Knowledge checks related to creatures with this trait is increased by 10.", null, null, "Unique", null },
                    { new Guid("f2810f2b-6f8a-4fb1-b00f-a9d307f97eff"), null, null, "This rarity indicates that a rules element is very difficult to find in the game world. A rare feat, spell, item or the like is available to players only if the GM decides to include it in the game, typically through discovery during play. Creatures with this trait are rare. They typically can’t be summoned. The DC of Recall Knowledge checks related to these creatures is increased by 5.", null, null, "Rare", null },
                    { new Guid("574e4077-83a5-4865-95a3-29a556f873ed"), null, null, "This poison is delivered by damaging the recipient.", null, null, "Injury", null },
                    { new Guid("7b601f4a-9c05-426c-aa46-14e8fa989066"), null, null, "Afflictions with the virulent trait are harder to remove. You must succeed at two consecutive saves to reduce a virulent affliction’s stage by 1. A critical success reduces a virulent affliction’s stage by only 1 instead of by 2.", null, null, "Virulent", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("d4d10f5f-e6cc-4acc-a8b3-3a29de451366"), null, "Someone else is making your decisions for you, usually because you're being commanded or magically dominated. The controller dictates how you act and can make you use any of your actions, including attacks, reactions, or even Delay. The controller usually does not have to spend their own actions when controlling you.", "Controlled", null, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("87851575-72a5-4935-b284-7cb0551fadf2"), new Guid("ae1f94c2-5442-4eed-bfdc-54a3faadbcc4"), "This condition reflects a creature's disposition toward a particular character, and only supernatural effects (like a spell) can impose this condition on a PC. A creature that is friendly to a character likes that character. The character can attempt to Make a Request of a friendly creature, and the friendly creature is likely to agree to a simple and safe request that doesn't cost it much to fulfill. If the character or one of their allies uses hostile actions against the creature, the creature gains a worse attitude condition depending on the severity of the hostile action, as determined by the GM.", "Friendly", null, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("35e06ece-e68a-4201-a215-8e3a29f30840"), null, "You're forced to run away due to fear or some other compulsion. On your turn, you must spend each of your actions trying to escape the source of the fleeing condition as expediently as possible (such as by using move actions to flee, or opening doors barring your escape). The source is usually the effect or caster that gave you the condition, though some effects might define something else as the source. You can't Delay or Ready while fleeing.", "Fleeing", null, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("72287426-a2d9-4d8b-8b2a-9a696baa3f1d"), null, "You’re distracted or otherwise unable to focus your full attention on defense. You take a –2 circumstance penalty to AC. Some effects give you the flat-footed condition only to certain creatures or against certain attacks. Others—especially conditions—can make you universally flat-footed against everything. If a rule doesn’t specify that the condition applies only to certain circumstances, it applies to all of them; for example, many effects simply say “The target is flat-footed.”", "Flat-Footed", null, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("48d6ee37-8a18-4162-9164-9f7892045d2d"), null, "You're tired and can't summon much energy. You take a –1 status penalty to AC and saving throws. You can't use exploration activities performed while traveling, such as those listed here. You recover from fatigue after a full night's rest.", "Fatigued", null, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("33b600ff-067e-4a67-a1ce-c85cf2d2382c"), null, "You are compelled to focus your attention on something, distracting you from whatever else is going on around you. You take a –2 status penalty to Perception and skill checks, and you can't use actions with the concentrate trait unless they or their intended consequences are related to the subject of your fascination (as determined by the GM). For instance, you might be able to Seek and Recall Knowledge about the subject, but you likely couldn't cast a spell targeting a different creature. This condition ends if a creature uses hostile actions against you or any of your allies.", "Fascinated", null, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("f0366047-21ca-4f51-971e-4f7c72629b74"), new Guid("655ed530-4d75-4816-af14-4cbbdd19531e"), "You're physically weakened. Enfeebled always includes a value. When you are enfeebled, you take a status penalty equal to the condition value to Strength-based rolls and DCs, including Strength-based melee attack rolls, Strength-based damage rolls, and Athletics checks.", "Enfeebled", null, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("5da2ad79-54a0-429e-a52a-d654841fb268"), null, "You are carrying more weight than you can manage. While you’re encumbered, you’re clumsy 1 and take a 10-foot penalty to all your Speeds. As with all penalties to your Speed, this can’t reduce your Speed below 5 feet.", "Encumbered", null, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("06cdc6c0-2d59-414e-a1bf-1d1862bae2d7"), null, "You’re gripped by fear and struggle to control your nerves. The frightened condition always includes a value. You take a status penalty equal to this value to all your checks and DCs. Unless specified otherwise, at the end of each of your turns, the value of your frightened condition decreases by 1.", "Frightened", null, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("069fffa5-3fe0-4892-a04d-1bd28a6225a3"), new Guid("18744a3c-8c8d-4298-8be7-f5e7e5dc0a6b"), "You are bleeding out or otherwise at death’s door. While you have this condition, you are unconscious . Dying always includes a value, and if it ever reaches dying 4, you die. If you’re dying, you must attempt a recovery check at the start of your turn each round to determine whether you get better or worse. Your dying condition increases by 1 if you take damage while dying, or by 2 if you take damage from an enemy’s critical hit or a critical failure on your save. If you lose the dying condition by succeeding at a recovery check and are still at 0 Hit Points, you remain unconscious, but you can wake up as described in that condition. You lose the dying condition automatically and wake up if you ever have 1 Hit Point or more. Any time you lose the dying condition, you gain the wounded 1 condition, or increase your wounded condition value by 1 if you already have that condition.", "Dying", null, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("824a03c0-0108-4896-8c0a-8af3a09cd738"), new Guid("18744a3c-8c8d-4298-8be7-f5e7e5dc0a6b"), "A powerful force has gripped your soul, calling you closer to death. Doomed always includes a value. The dying value at which you die is reduced by your doomed value. If your maximum dying value is reduced to 0, you instantly die. When you die, you're no longer doomed. Your doomed value decreases by 1 each time you get a full night's rest.", "Doomed", null, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("31b26b64-2616-4d23-93de-f3dbc0c81b7d"), new Guid("224d0ea9-af56-49b9-946d-ce809b894701"), "You can't hear. You automatically critically fail Perception checks that require you to be able to hear. You take a –2 status penalty to Perception checks for initiative and checks that involve sound but also rely on other senses. If you perform an action with the auditory trait, you must succeed at a DC 5 flat check or the action is lost; attempt the check after spending the action but before any effects are applied. You are immune to auditory effects.", "Deafened", null, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("3c3ce9f5-aceb-4db8-810a-1291035cf709"), null, "After you die, you can’t act or be affected by spells that target creatures (unless they specifically target dead creatures), and for all other purposes you are an object. When you die, you are reduced to 0 Hit Points if you had a different amount, and you can’t be brought above 0 Hit Points as long as you remain dead. Some magic can bring creatures back to life, such as the resurrect ritual or the raise dead spell", "Dead", null, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("ff7b682f-13ff-464f-a230-89cc814186ea"), new Guid("224d0ea9-af56-49b9-946d-ce809b894701"), "Your eyes are overstimulated. If vision is your only precise sense, all creatures and objects are concealed from you.", "Dazzled", null, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("b9c63a02-449e-43c2-a236-5a3f851f766f"), null, "You don't have your wits about you, and you attack wildly. You are flat-footed, you don't treat anyone as your ally (though they might still treat you as theirs), and you can't Delay, Ready, or use reactions.  You use all your actions to Strike or cast offensive cantrips, though the GM can have you use other actions to facilitate attack, such as draw a weapon, move so that a target is in reach, and so forth. Your targets are determined randomly by the GM. If you have no other viable targets, you target yourself, automatically hitting but not scoring a critical hit. If it's impossible for you to attack or cast spells, you babble incoherently, wasting your actions.  Each time you take damage from an attack or spell, you can attempt a DC 11 flat check to recover from your confusion and end the condition.", "Confused", null, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("64d1cfdc-8539-4bf7-95f2-60d53788079b"), new Guid("224d0ea9-af56-49b9-946d-ce809b894701"), "While you are concealed from a creature, such as in a thick fog, you are difficult for that creature to see. You can still be observed, but you're tougher to target. A creature that you're concealed from must succeed at a DC 5 flat check when targeting you with an attack, spell, or other effect. Area effects aren't subject to this flat check. If the check fails, the attack, spell, or effect doesn't affect you.", "Concealed", null, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("740be8e2-cab8-4cbe-8065-fd71a6d2192e"), new Guid("655ed530-4d75-4816-af14-4cbbdd19531e"), "Your movements become clumsy and inexact. Clumsy always includes a value. You take a status penalty equal to the condition value to Dexterity-based checks and DCs, including AC, Reflex saves, ranged attack rolls, and skill checks using Acrobatics, Stealth, and Thievery.", "Clumsy", null, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("a263fc00-a122-416e-8213-a7214fa9a30f"), new Guid("655ed530-4d75-4816-af14-4cbbdd19531e"), "When a creature successfully drains you of blood or life force, you become less healthy. Drained always includes a value. You take a status penalty equal to your drained value on Constitution-based checks, such as Fortitude saves. You also lose a number of Hit Points equal to your level (minimum 1) times the drained value, and your maximum Hit Points are reduced by the same amount. For example, if you’re hit by an effect that inflicts drained 3 and you’re a 3rd-level character, you lose 9 Hit Points and reduce your maximum Hit Points by 9. Losing these Hit Points doesn’t count as taking damage. Each time you get a full night’s rest, your drained value decreases by 1. This increases your maximum Hit Points, but you don’t immediately recover the lost Hit Points.", "Drained", null, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("8ecb38b2-d7fb-440f-b096-cf381652b2ff"), null, "Broken is a condition that affects objects. An object is broken when damage has reduced its Hit Points to equal or less than its Broken Threshold. A broken object can't be used for its normal function, nor does it grant bonuses— with the exception of armor. Broken armor still grants its item bonus to AC, but it also imparts a status penalty to AC depending on its category: –1 for broken light armor, –2 for broken medium armor, or –3 for broken heavy armor.  A broken item still imposes penalties and limitations normally incurred by carrying, holding, or wearing it. For example, broken armor would still impose its Dexterity modifier cap, check penalty, and so forth.  If an effect makes an item broken automatically and the item has more HP than its Broken Threshold, that effect also reduces the item's current HP to the Broken Threshold.", "Broken", null, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("918a03c5-27d2-458f-8bbf-2d1933738415"), null, "You're held in place by another creature, giving you the flat-footed and immobilized conditions. If you attempt a manipulate action while grabbed, you must succeed at a DC 5 flat check or it is lost; roll the check after spending the action, but before any effects are applied.", "Grabbed", null, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("4f1b10d8-98e2-43f2-b3a4-22e6b11ea699"), new Guid("d104a1f4-fb11-45c3-84b7-14880d673095"), "While you're hidden from a creature, that creature knows the space you're in but can't tell precisely where you are. You typically become hidden by using Stealth to Hide. When Seeking a creature using only imprecise senses, it remains hidden, rather than observed. A creature you're hidden from is flat-footed to you, and it must succeed at a DC 11 flat check when targeting you with an attack, spell, or other effect or it fails to affect you. Area effects aren't subject to this flat check. A creature might be able to use the Seek action to try to observe you.", "Hidden", null, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("8f6d81d5-64f1-455e-80c8-7835accb6613"), new Guid("18744a3c-8c8d-4298-8be7-f5e7e5dc0a6b"), "You have been seriously injured. If you lose the dying condition and do not already have the wounded condition, you become wounded 1. If you already have the wounded condition when you lose the dying condition, your wounded condition value increases by 1. If you gain the dying condition while wounded, increase your dying condition value by your wounded value. The wounded condition ends if someone successfully restores Hit Points to you with Treat Wounds, or if you are restored to full Hit Points and rest for 10 minutes.", "Wounded", null, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("ca2e35fe-8529-4ba3-a860-1bbde1c1c8f8"), new Guid("ae1f94c2-5442-4eed-bfdc-54a3faadbcc4"), "This condition reflects a creature's disposition toward a particular character, and only supernatural effects (like a spell) can impose this condition on a PC. A creature that is unfriendly to a character dislikes and specifically distrusts that character. The unfriendly creature won't accept Requests from the character.", "Unfriendly", null, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("d7416bc0-79b9-42c0-9335-e420dd3e0f50"), new Guid("d104a1f4-fb11-45c3-84b7-14880d673095"), "When you are undetected by a creature, that creature cannot see you at all, has no idea what space you occupy, and can't target you, though you still can be affected by abilities that target an area. When you're undetected by a creature, that creature is flat-footed to you. A creature you're undetected by can guess which square you're in to try targeting you. It must pick a square and attempt an attack.This works like targeting a hidden creature(requiring a DC 11 flat check), but the flat check and attack roll are rolled in secret by the GM, who doesn't reveal whether the attack missed due to failing the flat check, failing the attack roll, or choosing the wrong square. A creature can use the Seek action to try to find you.", "Undetected", null, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("a9bb8a46-7442-4480-b008-c706d7d4ef2f"), new Guid("655ed530-4d75-4816-af14-4cbbdd19531e"), "Your thoughts and instincts are clouded. Stupefied always includes a value. You take a status penalty equal to this value on Intelligence-, Wisdom-, and Charisma-based checks and DCs, including Will saving throws, spell attack rolls, spell DCs, and skill checks that use these ability scores. Any time you attempt to Cast a Spell while stupefied, the spell is disrupted unless you succeed at a flat check with a DC equal to 5 + your stupefied value.", "Stupefied", null, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("f253f20f-d7d3-4fe6-bb19-8d521afd9436"), null, "You have fewer actions. Slowed always includes a value. When you regain your actions at the start of your turn, reduce the number of actions you regain by your slowed value. Because slowed has its effect at the start of your turn, you don't immediately lose actions if you become slowed during your turn.", "Slowed", null, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("c674e766-939d-47fa-9c94-80173d59741f"), null, "You feel ill. Sickened always includes a value. You take a status penalty equal to this value on all your checks and DCs. You can't willingly ingest anything—including elixirs and potions—while sickened. You can spend a single action retching in an attempt to recover, which lets you immediately attempt a Fortitude save against the DC of the effect that made you sickened. On a success, you reduce your sickened value by 1 (or by 2 on a critical success).", "Sickened", null, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("fce417f7-0b9c-4d87-9f0a-45ae5d9a4e53"), null, "You gain 1 additional action at the start of your turn each round. Many effects that make you quickened specify the types of actions you can use with this additional action. If you become quickened from multiple sources, you can use the extra action you’ve been granted for any single action allowed by any of the effects that made you quickened. Because quickened has its effect at the start of your turn, you don’t immediately gain actions if you become quickened during your turn.", "Quickened", null, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("170bff5c-bcac-433d-94a0-840da90112af"), new Guid("ae1f94c2-5442-4eed-bfdc-54a3faadbcc4"), "This condition reflects a creature's disposition toward a particular character, and only supernatural effects (like a spell) can impose this condition on a PC. A creature that is helpful to a character wishes to actively aid that character. It will accept reasonable Requests from that character, as long as such requests aren't at the expense of the helpful creature's goals or quality of life. If the character or one of their allies uses a hostile action against the creature, the creature gains a worse attitude condition depending on the severity of the hostile action, as determined by the GM.", "Helpful", null, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("b680a37e-cf30-4c4b-886f-a713282892af"), null, "You're lying on the ground. You are flat-footed and take a –2 circumstance penalty to attack rolls. The only move actions you can use while you're prone are Crawl and Stand. Standing up ends the prone condition. You can Take Cover while prone to hunker down and gain greater cover against ranged attacks, even if you don't have an object to get behind, gaining a +4 circumstance bonus to AC against ranged attacks (but you remain flat-footed). If you would be knocked prone while you're Climbing or Flying, you fall (see Falling for the rules on falling). You can't be knocked prone when Swimming.", "Prone", null, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("e224b6c0-c7aa-4a58-b00f-7c422a7c6250"), null, "Persistent damage comes from effects like acid, being on fire, or many other situations. It appears as “X persistent [type] damage,” where “X” is the amount of damage dealt and “[type]” is the damage type. Instead of taking persistent damage immediately, you take it at the end of each of your turns as long as you have the condition, rolling any damage dice anew each time. After you take persistent damage, roll a DC 15 flat check to see if you recover from the persistent damage. If you succeed, the condition ends.", "Persistent Damage", null, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("5007c3b2-b184-43b1-85d7-ad159d14ccb5"), null, "Your body is frozen in place. You have the flat-footed condition and can't act except to Recall Knowledge and use actions that require only the use of your mind (as determined by the GM). Your senses still function, but only in the areas you can perceive without moving your body, so you can't Seek while paralyzed.", "Paralyzed", null, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("6f1426bc-454d-4796-a6b5-a1569dd39ee6"), new Guid("d104a1f4-fb11-45c3-84b7-14880d673095"), "Anything in plain view is observed by you. If a creature takes measures to avoid detection, such as by using Stealth to Hide, it can become hidden or undetected instead of observed. If you have another precise sense instead of or in addition to sight, you might be able to observe a creature or object using that sense instead. You can observe a creature only with precise senses. When Seeking a creature using only imprecise senses, it remains hidden, rather than observed.", "Observed", null, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("b9db96ae-7d84-4616-8831-477d614b4dbd"), new Guid("224d0ea9-af56-49b9-946d-ce809b894701"), "While invisible, you can't be seen. You're undetected to everyone. Creatures can Seek to attempt to detect you; if a creature succeeds at its Perception check against your Stealth DC, you become hidden to that creature until you Sneak to become undetected again. If you become invisible while someone can already see you, you start out hidden to the observer (instead of undetected) until you successfully Sneak. You can't become observed while invisible except via special abilities or magic.", "Invisible", null, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("f13e0f97-112a-4ffa-843a-00b406ee963d"), new Guid("ae1f94c2-5442-4eed-bfdc-54a3faadbcc4"), "This condition reflects a creature's disposition toward a particular character, and only supernatural effects (like a spell) can impose this condition on a PC. A creature that is indifferent to a character doesn't really care one way or the other about that character. Assume a creature's attitude to a given character is indifferent unless specified otherwise.", "Indifferent", null, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("b335312b-5956-436b-a8df-c426704a41ba"), null, "You can't use any action with the move trait. If you're immobilized by something holding you in place and an external force would move you out of your space, the force must succeed at a check against either the DC of the effect holding you in place or the relevant defense (usually Fortitude DC) of the monster holding you in place.", "Immobilized", null, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("d56a5083-fa2f-4d9c-a968-0b7664e1c9cd"), new Guid("ae1f94c2-5442-4eed-bfdc-54a3faadbcc4"), "This condition reflects a creature's disposition toward a particular character, and only supernatural effects (like a spell) can impose this condition on a PC. A creature that is hostile to a character actively seeks to harm that character. It doesn't necessarily attack, but it won't accept Requests from the character.", "Hostile", null, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("8d531baa-8a75-4090-83d0-fd8721b76ae7"), null, "You have been turned to stone. You can’t act, nor can you sense anything. You become an object with a Bulk double your normal Bulk (typically 12 for a petrified Medium creature or 6 for a petrified Small creature), AC 9, Hardness 8, and the same current Hit Points you had when alive. You don’t have a Broken Threshold. When you’re turned back into flesh, you have the same number of Hit Points you had as a statue. If the statue is destroyed, you immediately die. While petrified, your mind and body are in stasis, so you don’t age or notice the passing of time.", "Petrified", null, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") }
                });

            migrationBuilder.InsertData(
                table: "Curses",
                columns: new[] { "Id", "Description", "DifficultyCheck", "Effect", "Name", "SavingThrowStatId", "TraitsId" },
                values: new object[,]
                {
                    { new Guid("7df1d5bf-f713-4416-a429-aaf001da62c9"), "This curse makes the hunter into the hunted, drawing the ire of animals wherever you go.", 38, "Creatures of the natural world abhor you. Whenever an animal becomes aware of you, it must attempt a Will save against the curse. On a failure, it attacks you and fights to the death.", "Reviled of Nature", new Guid("a71929b0-9dff-492a-9bf9-8f9cadda198c"), null },
                    { new Guid("777ae2c9-85e4-444a-9bce-8ef9af37eee4"), "With divine intervention, followers of a deity can bestow this curse upon an enemy of the faith.", 40, "You are marked by the deity invoked as an enemy of the church. You gain weakness 10 to damage dealt by worshippers of that deity.", "Sword of Anathema", new Guid("a71929b0-9dff-492a-9bf9-8f9cadda198c"), null },
                    { new Guid("cc8c8901-28c6-49d0-b157-5e360182bd46"), "A wizard’s ward is placed upon a single book, usually a spellbook. If you damage the book, you must attempt a save against the curse’s effect.", 22, "You take 5d6 damage of the same damage type as the damage you dealt to the book, and the damage can’t be healed as long as the curse lasts. Repairing the book, including replacing any missing text, ends this curse.", "Wizard's Ward", new Guid("a71929b0-9dff-492a-9bf9-8f9cadda198c"), null },
                    { new Guid("cb8e0c92-9867-4cf1-b70c-dbff7df35ef4"), "Even the most experienced combat veteran becomes as reckless as a rookie when suffering from sellsword’s folly.", 26, "The chaos of combat overwhelms you. Each time you roll initiative for a combat encounter, you must attempt a new saving throw against the curse; on a failure, you become confused for 1 round. This is an incapacitation effect.", "Sellsword's Folly", new Guid("a71929b0-9dff-492a-9bf9-8f9cadda198c"), null },
                    { new Guid("8f8119cf-ecf8-412d-ad29-04df287396bc"), "This hideous curse kills through constant hunger. You become gaunt and repeatedly gnash your teeth.", 20, "No matter how much you eat, you aren’t satiated. After 1 day, you begin starving. Each week, you receive a new saving throw against the curse.", "Curse of the Ravenous", new Guid("83f532a1-dad3-4dc8-b13d-77e69959444a"), null },
                    { new Guid("aac52ac8-ae3d-4386-a81d-05f38ae1372f"), "This legendary curse sends you into a sleep indistinguishable from death.", 28, "You fall asleep for 1 round (or permanently on a critical failure) and seem to be dead; a creature must succeed at a DC 30 Medicine check to realize you are alive. Noise doesn’t awaken you, but taking damage gives you a new saving throw against the curse.", "Curse of Slumber", new Guid("83f532a1-dad3-4dc8-b13d-77e69959444a"), null },
                    { new Guid("f9059558-883a-4d04-a080-5d5511da93de"), "A reviling earth curse usually appears across a specific geographical region, such as a ruined town, a necromancer’s domain, or a similar area.", 30, "When you enter the area, you become doomed 1, or doomed 2 on a critical failure.", "Reviling Earth", new Guid("83f532a1-dad3-4dc8-b13d-77e69959444a"), null },
                    { new Guid("377a9414-6b18-4634-a5e2-35ac9225a2da"), "This curse prevents your soul from moving on after death.", 31, " If you die while affected, your spirit is anchored to the Material Plane, and you become a ghost or other incorporeal undead.", "Spirit Anchor", new Guid("83f532a1-dad3-4dc8-b13d-77e69959444a"), null },
                    { new Guid("65c44561-e8b0-4f7a-b65c-3a42d458721e"), "This curse kills through dehydration in the same vein as the curse of the ravenous, but with deadly speed.", 32, "You gain no benefit from drinking water or other liquids and begin suffering from thirst. Each day, you receive a new saving throw against the curse.", "Unending Thirst", new Guid("83f532a1-dad3-4dc8-b13d-77e69959444a"), null },
                    { new Guid("9a5c5a35-e734-4557-ba0c-0b1d8cbea242"), "This punishment causes you to lose something dear to you whenever you rob or steal. If you have nothing to lose, the curse exacts its punishment upon your body instead.", 39, "Each time you steal something, you lose something more valuable—this item is whisked away and can’t be found again. Typically this item is one of greater monetary value, but it might be one of greater value in another sense, such as one of greater emotional value, or something you need to complete a task. If you aren’t carrying anything of greater value at the time of the theft, you lose one of your limbs instead, taking 10d6 slashing damage and losing use of that limb. The damage can’t be healed, nor the limb restored, until the stolen item is returned, even through use of spells like regenerate.", "Thief's Retribution", new Guid("83f532a1-dad3-4dc8-b13d-77e69959444a"), null },
                    { new Guid("2638d791-3e60-457d-8450-bf0a09099568"), "When you swear an oath, you must obey that oath or suffer terrible consequences.", 23, "Each time you make a promise to someone, an ornate symbol representing that promise is magically carved into your flesh. Breaking any of these promises causes the symbol tattoo to grow into a gaping wound, dealing 3d6 slashing damage to you; damage from the curse can’t be healed as long as the curse is still in effect.", "Oath of the Fresh", new Guid("83f532a1-dad3-4dc8-b13d-77e69959444a"), null },
                    { new Guid("db1b4014-4933-49fb-919d-843c3fbeb5fb"), "This curse plagues you with terrible nightmares whenever you sleep, preventing you from resting properly.", 16, "You must rest for 12 hours instead of 8 to avoid becoming fatigued and can’t gain any benefits from resting or long-term rest. You can still make your daily preparations.", "Curse of Nightmares", new Guid("a71929b0-9dff-492a-9bf9-8f9cadda198c"), null },
                    { new Guid("a93f6011-ae01-4927-9e74-485dd52be9e1"), "This curse protects a single book and activates against any creature who Steals it.", 18, "You begin to lose details from your memories, as well as a portion of your procedural memory. After being cursed, the first time you attempt a check using a skill in which you are trained or better, your proficiency rank in the skill used decreases by one rank for as long as you are cursed.", "Theft of Thought", new Guid("a71929b0-9dff-492a-9bf9-8f9cadda198c"), null },
                    { new Guid("debd8716-f744-4e4c-9e3a-4b6cdbdfc581"), "You are haunted by all those you have killed.", 19, "You see all creatures around you as those you have slain, still bearing their wounds. You can’t identify, Recall Knowledge about, or otherwise interact with these creatures in any way that involves seeing their true form without first succeeding at a Will save against the curse’s DC to see through the illusion. On a critical failure for such a Will save, you become frightened 1.", "Slayer's Haunt", new Guid("a71929b0-9dff-492a-9bf9-8f9cadda198c"), null },
                    { new Guid("a2866bc7-990e-4735-8090-ec6351a5cad1"), "You find all courage stolen from your heart. When faced with something frightening, you flee in terror or stand frozen in place.", 20, "At the start of your turn, if you are frightened, you become your choice of immobilized or fleeing until the end of that turn.", "Coward's Roots", new Guid("a71929b0-9dff-492a-9bf9-8f9cadda198c"), null },
                    { new Guid("c9d8ee02-8f76-42a8-a95a-fc0d05c073d5"), "A grave curse punishes you for stealing from a tomb or other resting place.", null, "ou are hounded by undead creatures of the same level as the curse. Every night, you must attempt a DC 15 flat check. On a failure, an incorporeal undead manifests to hassle and harry you throughout the night, retreating before it can take much damage and often preventing you from gaining a full night’s rest. Whenever you enter a graveyard or other area where bodies are buried, you must succeed at the same flat check or a body animates as a corporeal undead (typically a skeleton or zombie) to attack you. These undead are temporary and exist only to harry you; if you take control of the undead, move on, or otherwise avoid their attacks, incorporeal undead discorporate and corporeal undead collapse into ordinary corpses. The curse can be removed by returning the stolen items to their resting place.", "Grave Curse", new Guid("a71929b0-9dff-492a-9bf9-8f9cadda198c"), null }
                });
            ...
            migrationBuilder.InsertData(
                table: "SourcePage",
                columns: new[] { "Id", "Page", "SourceId" },
                values: new object[,]
                {
                    { new Guid("8014c08d-23c8-4525-8db4-79c4cef2f7e0"), 619, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("cf8fd91d-d02e-460e-81c7-6745f5b46690"), 620, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("22f3b334-9d9c-49fa-890f-e8a869daabc7"), 620, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("c2e6c0f8-283e-4580-bec2-26abf8b586e7"), 620, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("3f6ef9b5-9e0d-4ae7-9a3a-de2709f94003"), 620, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("7130351e-ad82-4ca7-b613-20b8743f03e3"), 620, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("1dbef0bc-4ffe-4e45-964f-83bbad2c884d"), 619, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("1ca1a968-dcb9-4353-b15e-e397cda35b48"), 619, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("f743a373-99c3-4e37-973a-cd274745c865"), 618, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("322bb3f0-b548-4f39-893f-1754529921ed"), 619, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("9693cf88-cb25-468d-a60b-becb5e1077a4"), 619, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("649223d0-1602-442a-8751-34c050b98392"), 619, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("162fb61e-213f-4fa8-bfa8-36e3ec271847"), 461, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("23bc81bd-d007-446b-acde-93d6586d4d24"), 619, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("a6317e26-779a-4558-afa5-525a9be21ca5"), 618, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("8d685714-66ec-4b52-bb2c-d105f158ae61"), 618, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("a0a8e076-7eb6-4e69-a115-b30d318a100a"), 618, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("b52512cc-bfab-429f-a40d-a0488043a296"), 618, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("535f3f02-9a6f-4b34-9080-460f626a969c"), 618, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("e7e4aa12-dadc-426b-8b3c-24a60d4abb25"), 619, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("d3c67fb1-62b1-4b8d-8017-1b913d634cff"), 620, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("6abe2c10-38b3-4b54-b11d-b1914e99b198"), 620, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("a2a53bc0-a6be-43ed-9427-b54ab63abdc3"), 119, new Guid("643d5da8-e766-44c9-9748-7ad1ac97dcbf") },
                    { new Guid("9ed612bb-91ee-4372-b68a-36eac922bee1"), 59, new Guid("51f273bd-9c56-4a21-82ca-df90e1e13955") },
                    { new Guid("7f3561ed-7175-4f9f-b654-8e25dee7c37b"), 119, new Guid("51f273bd-9c56-4a21-82ca-df90e1e13955") },
                    { new Guid("480e5953-ecf3-4be4-abe8-d2ef95e6dc44"), 120, new Guid("643d5da8-e766-44c9-9748-7ad1ac97dcbf") },
                    { new Guid("67b3423d-e15f-4997-81b5-f832f703e76f"), 119, new Guid("643d5da8-e766-44c9-9748-7ad1ac97dcbf") },
                    { new Guid("11ad942d-bb19-460c-a802-2db23239e202"), 118, new Guid("643d5da8-e766-44c9-9748-7ad1ac97dcbf") },
                    { new Guid("9e838c4f-13ff-4587-a840-f4bc36a01360"), 118, new Guid("643d5da8-e766-44c9-9748-7ad1ac97dcbf") },
                    { new Guid("8cd04e7c-ddd9-44eb-b774-cc90221b157b"), 118, new Guid("643d5da8-e766-44c9-9748-7ad1ac97dcbf") },
                    { new Guid("0e5abee1-6553-400c-a667-41bae3f6acfb"), 118, new Guid("643d5da8-e766-44c9-9748-7ad1ac97dcbf") },
                    { new Guid("1960dd05-ab39-4e03-9913-43f1d1b6a1b2"), 72, new Guid("51f273bd-9c56-4a21-82ca-df90e1e13955") },
                    { new Guid("0f9d2b87-94d8-4c77-b447-a0ac6afb81f4"), 119, new Guid("643d5da8-e766-44c9-9748-7ad1ac97dcbf") },
                    { new Guid("1746a261-7039-411f-b5b4-f40901a436a6"), 118, new Guid("643d5da8-e766-44c9-9748-7ad1ac97dcbf") },
                    { new Guid("cc5aec5c-f514-4626-bfe3-e62fcd7c8e3a"), 119, new Guid("643d5da8-e766-44c9-9748-7ad1ac97dcbf") },
                    { new Guid("664e842a-4b94-4d00-836d-4191c3b5df50"), 118, new Guid("643d5da8-e766-44c9-9748-7ad1ac97dcbf") },
                    { new Guid("65377178-dd5a-4a62-9d02-9b54f2a60ab6"), 118, new Guid("643d5da8-e766-44c9-9748-7ad1ac97dcbf") },
                    { new Guid("9f757d30-7c60-4217-a742-613ae6bb3830"), 119, new Guid("643d5da8-e766-44c9-9748-7ad1ac97dcbf") },
                    { new Guid("4ae81453-5952-413b-a8eb-0baab2ae85d9"), 118, new Guid("643d5da8-e766-44c9-9748-7ad1ac97dcbf") },
                    { new Guid("72e51025-a0c7-4fac-9944-d44fa353d2cf"), 118, new Guid("643d5da8-e766-44c9-9748-7ad1ac97dcbf") },
                    { new Guid("26ed3169-4bdd-4ff2-8392-3ea20f036ae9"), 73, new Guid("e4f9b68a-f157-4657-bb05-0b50d1e5b955") },
                    { new Guid("13952f0f-9ded-47eb-880c-415028b67700"), 120, new Guid("643d5da8-e766-44c9-9748-7ad1ac97dcbf") },
                    { new Guid("344af983-0fdd-4623-be6c-59587595cfe5"), 623, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("5108e12f-9672-4072-a697-d7602a132ccc"), 13, new Guid("51f273bd-9c56-4a21-82ca-df90e1e13955") },
                    { new Guid("3eadd81e-0338-4b94-85a0-6939831d8396"), 623, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("9af352ee-666e-46a3-a976-2d1f0be4bef5"), 620, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("17f5c739-aab8-4631-8ca7-8ab7508205d5"), 620, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("57922528-4da2-4416-8e4c-d460798e208c"), 620, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("d86c4397-fff6-431b-8de7-7e7c4024f050"), 620, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("f7112785-1068-4ad7-8521-5a46dac22f3c"), 620, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("95b85300-604c-4e3c-853c-4699f676bc49"), 621, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("6136be14-61d3-44fa-9e44-f2a5006a6098"), 623, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("504d4f87-0814-47b5-9377-ad05b72cd72a"), 621, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("24ad83ae-b7d1-4b0c-8706-c8cc022225d8"), 621, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("c928cb5b-b048-4877-9e65-d9e394ff0936"), 621, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("17810441-9218-4e9d-a962-1e7697516b2d"), 621, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("de1236fc-c4e3-4f46-b8e3-1f3e06b2314d"), 622, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("0ec62791-35c3-42a1-9840-eeae27f40c96"), 622, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("5486ed38-3692-4186-80e4-1746c21c7130"), 622, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("83fd1bb7-1466-4cb8-8eb9-3c14b5a90813"), 622, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("8cbcb7fb-2032-4b91-a811-46753e66f848"), 623, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("32ddb040-0f69-40b1-8c45-693df9034766"), 622, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("6b475166-4b71-4da5-b261-3b78d78adcde"), 622, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("81b59165-360f-4844-909f-bdff6fe8da0b"), 622, new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") }
                });
            ...
            migrationBuilder.InsertData(
                table: "ConditionDetailBlock",
                columns: new[] { "Id", "ConditionId", "Text", "Type" },
                values: new object[,]
                {
                    { new Guid("9be7ab5f-d8ec-4502-a9db-63cabc34043b"), new Guid("e224b6c0-c7aa-4a58-b00f-7c422a7c6250"), "The additional rules presented below apply to persistent damage in certain cases.", 1 },
                    { new Guid("15d4070a-18c0-458d-a6be-3749a7a35b4d"), new Guid("e224b6c0-c7aa-4a58-b00f-7c422a7c6250"), "Multiple Persistent Damage Conditions", 0 },
                    { new Guid("efd34683-7804-41ff-9901-17a9c3330359"), new Guid("e224b6c0-c7aa-4a58-b00f-7c422a7c6250"), "Immunities, resistances, and weaknesses all apply to persistent damage. If an effect deals initial damage in addition to persistent damage, apply immunities, resistances, and weaknesses separately to the initial damage and to the persistent damage. Usually, if an effect negates the initial damage, it also negates the persistent damage, such as with a slashing weapon that also deals persistent bleed damage because it cut you. The GM might rule otherwise in some situations.", 1 },
                    { new Guid("68a8b2ab-8c1b-4999-8c98-95e27153be58"), new Guid("e224b6c0-c7aa-4a58-b00f-7c422a7c6250"), "Immunities, Resistances, And Weaknesses", 0 },
                    { new Guid("d079a8d0-b445-4132-acb8-e9b73c5646d8"), new Guid("e224b6c0-c7aa-4a58-b00f-7c422a7c6250"), "Persistent Damage Rules", 0 },
                    { new Guid("1dd5d5f4-de04-4b34-882d-6fa19e239fbb"), new Guid("e224b6c0-c7aa-4a58-b00f-7c422a7c6250"), "You can take steps to help yourself recover from persistent damage, or an ally can help you, allowing you to attempt an additional flat check before the end of your turn. This is usually an activity requiring 2 actions, and it must be something that would reasonably improve your chances (as determined by the GM). For example, you might try to smother a flame or wash off acid. This allows you to attempt an extra flat check immediately, but only once per round.", 1 },
                    { new Guid("5732280a-9ddf-402f-a46b-c2aa85c5ec3e"), new Guid("e224b6c0-c7aa-4a58-b00f-7c422a7c6250"), "Reduce the DC of the flat check to 10 for a particularly appropriate type of help, such as dousing you in water to put out flames.", 2 },
                    { new Guid("8347426a-0c25-446e-9ac0-f06ecbd51d73"), new Guid("e224b6c0-c7aa-4a58-b00f-7c422a7c6250"), "The GM decides how your help works, using the following examples as guidelines when there's not a specific action that applies.", 1 },
                    { new Guid("ab2056b6-550f-41a8-a96d-869cc17e3576"), new Guid("e224b6c0-c7aa-4a58-b00f-7c422a7c6250"), "Assisted Recovery", 0 },
                    { new Guid("44052fce-df27-49bc-bc37-537fd6f0a7b0"), new Guid("069fffa5-3fe0-4892-a04d-1bd28a6225a3"), "You gain the dying 1 condition. If the effect that knocked you out was a critical success from the attacker or the result of your critical failure, you gain the dying 2 condition instead. If you have the wounded condition, increase these values by your wounded value. If the damage came from a nonlethal attack or effect, you don’t gain the dying condition— you are instead unconscious with 0 Hit Points.", 2 },
                    { new Guid("5fdc64fc-6041-4ab6-aa77-57004d59ac56"), new Guid("e224b6c0-c7aa-4a58-b00f-7c422a7c6250"), "The action to help might require a skill check or another roll to determine its effectiveness.", 2 },
                    { new Guid("73e3d268-5f96-4ec1-b30e-243ed27e4749"), new Guid("fce417f7-0b9c-4d87-9f0a-45ae5d9a4e53"), "Quickened, slowed, and stunned are the primary ways you can gain or lose actions on a turn. The rules for how this works appear on page 462. In brief, these conditions alter how many actions you regain at the start of your turn; thus, gaining the condition in the middle of your turn doesn’t adjust your number of actions on that turn. If you have conflicting conditions that affect your number of actions, you choose which actions you lose. For instance, the action gained from haste lets you only Stride or Strike, so if you need to lose one action because you’re also slowed, you might decide to lose the action from haste, letting you keep your other actions that can be used more flexibly.", 1 },
                    { new Guid("1d39c09f-0f28-41d5-a6d2-bba9edaca845"), new Guid("e224b6c0-c7aa-4a58-b00f-7c422a7c6250"), "Alter the number of actions required to help you if the means the helper uses are especially efficient or remarkably inefficient.", 2 },
                    { new Guid("0219a437-77c5-4ecb-a687-b4d22f0b325b"), new Guid("e224b6c0-c7aa-4a58-b00f-7c422a7c6250"), "Automatically end the condition due to the type of help, such as healing that restores you to your maximum HP to end persistent bleed damage, or submerging yourself in a lake to end persistent fire damage.", 2 },
                    { new Guid("3e517663-a8da-4a37-b25d-42b26182d6a1"), new Guid("fce417f7-0b9c-4d87-9f0a-45ae5d9a4e53"), "Some conditions prevent you from taking a certain subset of actions, typically reactions. Other conditions simply say you can’t act. When you can’t act, you’re unable to take any actions at all. Unlike slowed or stunned, these don’t change the number of actions you regain; they just prevent you from using them. That means if you are somehow cured of paralysis on your turn, you can act immediately.", 1 },
                    { new Guid("080c64f0-6e98-49f4-9ed1-b7b39a2b5bb0"), new Guid("fce417f7-0b9c-4d87-9f0a-45ae5d9a4e53"), "Gaining and Losing Actions", 0 },
                    { new Guid("ee821b5c-04d4-4212-8f37-98b8a827cff5"), new Guid("069fffa5-3fe0-4892-a04d-1bd28a6225a3"), "You immediately move your initiative position to directly before the turn in which you were reduced to 0 HP.”", 2 },
                    { new Guid("c4e5deec-51aa-4e93-92e1-9dda14f2d903"), new Guid("069fffa5-3fe0-4892-a04d-1bd28a6225a3"), "The doomed, dying, unconscious, and wounded conditions all relate to the process of coming closer to death. The full rules are on pages 459–461. The most significant information not contained in the conditions themselves is this: When you’re reduced to 0 Hit Points, you’re knocked out with the following effects:", 1 },
                    { new Guid("522f0c99-e56b-4848-9adf-6579947713a2"), new Guid("069fffa5-3fe0-4892-a04d-1bd28a6225a3"), "Death and Dying Rules", 0 },
                    { new Guid("2dd9a40b-b519-49b6-b860-1a2a8c89345f"), new Guid("e224b6c0-c7aa-4a58-b00f-7c422a7c6250"), "You can be simultaneously affected by multiple persistent damage conditions so long as they have different damage types. If you would gain more than one persistent damage condition with the same damage type, the higher amount of damage overrides the lower amount. The damage you take from persistent damage occurs all at once, so if something triggers when you take damage, it triggers only once; for example, if you're dying with several types of persistent damage, the persistent damage increases your dying condition only once.", 1 },
                    { new Guid("7a6f2181-416a-491a-9d86-cce240b39331"), new Guid("e224b6c0-c7aa-4a58-b00f-7c422a7c6250"), "Persistent damage runs its course and automatically ends after a certain amount of time as fire burns out, blood clots, and the like. The GM determines when this occurs, but it usually takes 1 minute.", 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("ecb312a5-4e27-43b9-89ec-1a615d9f9dc2"), null, "You're tied up and can barely move, or a creature has you pinned. You have the flat-footed and immobilized conditions, and you can't use any actions with the attack or manipulate traits except to attempt to Escape or Force Open your bonds. Restrained overrides grabbed.", "Restrained", new Guid("918a03c5-27d2-458f-8bbf-2d1933738415"), new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("4d045584-3a7f-433b-ad89-0f658c379923"), null, "You've become senseless. You can't act while stunned. Stunned usually includes a value, which indicates how many total actions you lose, possibly over multiple turns, from being stunned. Each time you regain actions (such as at the start of your turn), reduce the number you regain by your stunned value, then reduce your stunned value by the number of actions you lost. For example, if you were stunned 4, you would lose all 3 of your actions on your turn, reducing you to stunned 1; on your next turn, you would lose 1 more action, and then be able to use your remaining 2 actions normally. Stunned might also have a duration instead of a value, such as “stunned for 1 minute.” In this case, you lose all your actions for the listed duration. Stunned overrides slowed.If the duration of your stunned condition ends while you are slowed, you count the actions lost to the stunned condition toward those lost to being slowed. So, if you were stunned 1 and slowed 2 at the beginning of your turn, you would lose 1 action from stunned, and then lose only 1 additional action by being slowed, so you would still have 1 action remaining to use that turn.", "Stunned", new Guid("f253f20f-d7d3-4fe6-bb19-8d521afd9436"), new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("43bea701-97ae-4ab1-8e30-e42fcff51f41"), new Guid("d104a1f4-fb11-45c3-84b7-14880d673095"), "If you are unnoticed by a creature, that creature has no idea you are present at all. When you're unnoticed, you're also undetected by the creature. This condition matters for abilities that can be used only against targets totally unaware of your presence.", "Unnoticed", new Guid("ff7b682f-13ff-464f-a230-89cc814186ea"), new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("10ef1d07-27bd-4073-96f7-2a55a05a9831"), new Guid("18744a3c-8c8d-4298-8be7-f5e7e5dc0a6b"), "You're sleeping, or you've been knocked out. You can't act. You take a –4 status penalty to AC, Perception, and Reflex saves, and you have the blinded and flat-footed conditions. When you gain this condition, you fall prone and drop items you are wielding or holding unless the effect states otherwise or the GM determines you're in a position in which you wouldn't.", "Unconscious", new Guid("ff7b682f-13ff-464f-a230-89cc814186ea"), new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") },
                    { new Guid("e9e00854-3d42-48b7-9724-017c8a46e3c0"), new Guid("224d0ea9-af56-49b9-946d-ce809b894701"), "You can't see. All normal terrain is difficult terrain to you. You can't detect anything using vision. You automatically critically fail Perception checks that require you to be able to see, and if vision is your only precise sense, you take a –4 status penalty to Perception checks. You are immune to visual effects. Blinded overrides dazzled.", "Blinded", new Guid("ff7b682f-13ff-464f-a230-89cc814186ea"), new Guid("4e85ec44-4a72-4bea-a3e5-5e6d88882d75") }
                });

            migrationBuilder.InsertData(
                table: "CurseTrait",
                columns: new[] { "CursesId", "TraitsId" },
                values: new object[,]
                {
                    { new Guid("f9059558-883a-4d04-a080-5d5511da93de"), new Guid("739ead1c-4020-4673-96d2-4d0b543f6295") },
                    { new Guid("f9059558-883a-4d04-a080-5d5511da93de"), new Guid("39aba859-33a5-45df-b1fe-902f8e3c2273") },
                    { new Guid("377a9414-6b18-4634-a5e2-35ac9225a2da"), new Guid("30ed464b-6bf4-4a80-8c42-8bb95ecb751c") },
                    { new Guid("377a9414-6b18-4634-a5e2-35ac9225a2da"), new Guid("2d643d25-b9aa-4544-b482-04b3475eb82b") },
                    { new Guid("377a9414-6b18-4634-a5e2-35ac9225a2da"), new Guid("739ead1c-4020-4673-96d2-4d0b543f6295") },
                    { new Guid("377a9414-6b18-4634-a5e2-35ac9225a2da"), new Guid("39aba859-33a5-45df-b1fe-902f8e3c2273") },
                    { new Guid("65c44561-e8b0-4f7a-b65c-3a42d458721e"), new Guid("d751d93f-cff9-448f-8ab0-9a3c07eacbef") },
                    { new Guid("65c44561-e8b0-4f7a-b65c-3a42d458721e"), new Guid("739ead1c-4020-4673-96d2-4d0b543f6295") },
                    { new Guid("65c44561-e8b0-4f7a-b65c-3a42d458721e"), new Guid("39aba859-33a5-45df-b1fe-902f8e3c2273") },
                    { new Guid("9a5c5a35-e734-4557-ba0c-0b1d8cbea242"), new Guid("6f187720-6664-44c6-8e09-2053ed1054d6") },
                    { new Guid("9a5c5a35-e734-4557-ba0c-0b1d8cbea242"), new Guid("739ead1c-4020-4673-96d2-4d0b543f6295") },
                    { new Guid("f9059558-883a-4d04-a080-5d5511da93de"), new Guid("f1f5c47a-fec2-4983-8229-3c4e8b43f0b5") },
                    { new Guid("f9059558-883a-4d04-a080-5d5511da93de"), new Guid("2d643d25-b9aa-4544-b482-04b3475eb82b") },
                    { new Guid("cb8e0c92-9867-4cf1-b70c-dbff7df35ef4"), new Guid("e7fd1927-8c01-4945-899e-a99d2e44662a") },
                    { new Guid("aac52ac8-ae3d-4386-a81d-05f38ae1372f"), new Guid("39aba859-33a5-45df-b1fe-902f8e3c2273") },
                    { new Guid("9a5c5a35-e734-4557-ba0c-0b1d8cbea242"), new Guid("39aba859-33a5-45df-b1fe-902f8e3c2273") },
                    { new Guid("aac52ac8-ae3d-4386-a81d-05f38ae1372f"), new Guid("739ead1c-4020-4673-96d2-4d0b543f6295") },
                    { new Guid("aac52ac8-ae3d-4386-a81d-05f38ae1372f"), new Guid("be9994ab-79ef-4ec0-9761-492059b0083a") },
                    { new Guid("aac52ac8-ae3d-4386-a81d-05f38ae1372f"), new Guid("2d643d25-b9aa-4544-b482-04b3475eb82b") },
                    { new Guid("2638d791-3e60-457d-8450-bf0a09099568"), new Guid("39aba859-33a5-45df-b1fe-902f8e3c2273") },
                    { new Guid("2638d791-3e60-457d-8450-bf0a09099568"), new Guid("739ead1c-4020-4673-96d2-4d0b543f6295") },
                    { new Guid("2638d791-3e60-457d-8450-bf0a09099568"), new Guid("c499214b-94fc-4103-8c7c-6f7a56b5c980") },
                    { new Guid("8f8119cf-ecf8-412d-ad29-04df287396bc"), new Guid("39aba859-33a5-45df-b1fe-902f8e3c2273") },
                    { new Guid("8f8119cf-ecf8-412d-ad29-04df287396bc"), new Guid("739ead1c-4020-4673-96d2-4d0b543f6295") },
                    { new Guid("cc8c8901-28c6-49d0-b157-5e360182bd46"), new Guid("c499214b-94fc-4103-8c7c-6f7a56b5c980") },
                    { new Guid("a2866bc7-990e-4735-8090-ec6351a5cad1"), new Guid("39aba859-33a5-45df-b1fe-902f8e3c2273") },
                    { new Guid("a2866bc7-990e-4735-8090-ec6351a5cad1"), new Guid("739ead1c-4020-4673-96d2-4d0b543f6295") },
                    { new Guid("aac52ac8-ae3d-4386-a81d-05f38ae1372f"), new Guid("4b9d47d5-3e89-41ba-8183-9e743c49a41a") },
                    { new Guid("c9d8ee02-8f76-42a8-a95a-fc0d05c073d5"), new Guid("2d643d25-b9aa-4544-b482-04b3475eb82b") },
                    { new Guid("c9d8ee02-8f76-42a8-a95a-fc0d05c073d5"), new Guid("39aba859-33a5-45df-b1fe-902f8e3c2273") },
                    { new Guid("cc8c8901-28c6-49d0-b157-5e360182bd46"), new Guid("39aba859-33a5-45df-b1fe-902f8e3c2273") },
                    { new Guid("cb8e0c92-9867-4cf1-b70c-dbff7df35ef4"), new Guid("1ee8c64b-ad34-4b3b-a01c-a1057eea01f6") },
                    { new Guid("cb8e0c92-9867-4cf1-b70c-dbff7df35ef4"), new Guid("2cbfa741-d7b5-465c-98b4-7a6bceae533e") },
                    { new Guid("cb8e0c92-9867-4cf1-b70c-dbff7df35ef4"), new Guid("739ead1c-4020-4673-96d2-4d0b543f6295") },
                    { new Guid("cb8e0c92-9867-4cf1-b70c-dbff7df35ef4"), new Guid("39aba859-33a5-45df-b1fe-902f8e3c2273") },
                    { new Guid("7df1d5bf-f713-4416-a429-aaf001da62c9"), new Guid("e7fd1927-8c01-4945-899e-a99d2e44662a") },
                    { new Guid("7df1d5bf-f713-4416-a429-aaf001da62c9"), new Guid("1ee8c64b-ad34-4b3b-a01c-a1057eea01f6") },
                    { new Guid("7df1d5bf-f713-4416-a429-aaf001da62c9"), new Guid("2cbfa741-d7b5-465c-98b4-7a6bceae533e") },
                    { new Guid("7df1d5bf-f713-4416-a429-aaf001da62c9"), new Guid("739ead1c-4020-4673-96d2-4d0b543f6295") },
                    { new Guid("7df1d5bf-f713-4416-a429-aaf001da62c9"), new Guid("39aba859-33a5-45df-b1fe-902f8e3c2273") },
                    { new Guid("777ae2c9-85e4-444a-9bce-8ef9af37eee4"), new Guid("561c7c89-44d2-492e-b12f-352af45b6a6b") },
                    { new Guid("777ae2c9-85e4-444a-9bce-8ef9af37eee4"), new Guid("f5f7ca8a-100a-4d93-aa07-e0f1bb3cbc49") },
                    { new Guid("777ae2c9-85e4-444a-9bce-8ef9af37eee4"), new Guid("739ead1c-4020-4673-96d2-4d0b543f6295") },
                    { new Guid("a2866bc7-990e-4735-8090-ec6351a5cad1"), new Guid("f7ad867e-49e3-40e3-ad95-bbf461be2087") },
                    { new Guid("a2866bc7-990e-4735-8090-ec6351a5cad1"), new Guid("2cbfa741-d7b5-465c-98b4-7a6bceae533e") },
                    { new Guid("a2866bc7-990e-4735-8090-ec6351a5cad1"), new Guid("e7fd1927-8c01-4945-899e-a99d2e44662a") },
                    { new Guid("debd8716-f744-4e4c-9e3a-4b6cdbdfc581"), new Guid("39aba859-33a5-45df-b1fe-902f8e3c2273") },
                    { new Guid("debd8716-f744-4e4c-9e3a-4b6cdbdfc581"), new Guid("739ead1c-4020-4673-96d2-4d0b543f6295") },
                    { new Guid("debd8716-f744-4e4c-9e3a-4b6cdbdfc581"), new Guid("e2bb08cb-cf59-4e29-8738-52c751405fb0") },
                    { new Guid("debd8716-f744-4e4c-9e3a-4b6cdbdfc581"), new Guid("7f9fe1cb-c607-44c3-8f1a-b26d508cfce6") },
                    { new Guid("a93f6011-ae01-4927-9e74-485dd52be9e1"), new Guid("39aba859-33a5-45df-b1fe-902f8e3c2273") },
                    { new Guid("a93f6011-ae01-4927-9e74-485dd52be9e1"), new Guid("739ead1c-4020-4673-96d2-4d0b543f6295") },
                    { new Guid("a93f6011-ae01-4927-9e74-485dd52be9e1"), new Guid("2cbfa741-d7b5-465c-98b4-7a6bceae533e") },
                    { new Guid("a93f6011-ae01-4927-9e74-485dd52be9e1"), new Guid("e7fd1927-8c01-4945-899e-a99d2e44662a") },
                    { new Guid("db1b4014-4933-49fb-919d-843c3fbeb5fb"), new Guid("39aba859-33a5-45df-b1fe-902f8e3c2273") },
                    { new Guid("cc8c8901-28c6-49d0-b157-5e360182bd46"), new Guid("739ead1c-4020-4673-96d2-4d0b543f6295") },
                    { new Guid("db1b4014-4933-49fb-919d-843c3fbeb5fb"), new Guid("2cbfa741-d7b5-465c-98b4-7a6bceae533e") },
                    { new Guid("db1b4014-4933-49fb-919d-843c3fbeb5fb"), new Guid("7f9fe1cb-c607-44c3-8f1a-b26d508cfce6") },
                    { new Guid("c9d8ee02-8f76-42a8-a95a-fc0d05c073d5"), new Guid("739ead1c-4020-4673-96d2-4d0b543f6295") },
                    { new Guid("db1b4014-4933-49fb-919d-843c3fbeb5fb"), new Guid("739ead1c-4020-4673-96d2-4d0b543f6295") },
                    { new Guid("8f8119cf-ecf8-412d-ad29-04df287396bc"), new Guid("d751d93f-cff9-448f-8ab0-9a3c07eacbef") }
                });
            ...
            migrationBuilder.InsertData(
                table: "Diseases",
                columns: new[] { "Id", "Description", "DifficultyCheck", "Name", "Onset", "SavingThrowStatId", "SourcePageId", "Spoilers", "TraitsId" },
                values: new object[,]
                {
                    { new Guid("a126527c-f9d1-498f-9d53-ee01009a80e5"), "An akata implants its parasitic larval young into any creature it bites, but only Medium or Small humanoids make suitable hosts; all other creatures are immune to this disease", 17, "Void Death", "1 Day", new Guid("83f532a1-dad3-4dc8-b13d-77e69959444a"), new Guid("5108e12f-9672-4072-a697-d7602a132ccc"), false, null },
                    { new Guid("bdc9c07d-a3bf-4dc1-9ff1-657d2e956e17"), "Sometimes called bog foot, bog rot is caused by having waterlogged feet for an extended period of time. In addition to the usual cures for an affliction, bog rot can be cured through amputation of the affected appendages.", 13, "Bog Rot", "1 Day", new Guid("83f532a1-dad3-4dc8-b13d-77e69959444a"), new Guid("11ad942d-bb19-460c-a802-2db23239e202"), false, null },
                    { new Guid("aae01797-c896-4665-9681-4caae8d37800"), "This disease is capable of wiping out nations or even entire continents. A few pockets of the disease still remain in Iobaria, keeping that region’s population sparse.", 22, "Choking Death", "1 Day", new Guid("83f532a1-dad3-4dc8-b13d-77e69959444a"), new Guid("0e5abee1-6553-400c-a667-41bae3f6acfb"), false, null },
                    { new Guid("df53fbce-7ea5-4882-8aac-d589381514b2"), "Track the maximum stage you reach with each drug’s addiction. This maximum stage is separate from your current addiction stage for the drug. The maximum stage can’t be reduced, even if you fully remove the disease. When you take the drug, two things happen: you attempt a saving throw against addiction, and you suppress the effects of addiction for 1 day. Failing a save against addiction caused by taking the drug causes you to go to 1 stage higher than the maximum stage you had previously reached (2 stages higher on a critical failure). If you’re currently suffering from addiction when you attempt a save from taking the drug, you can’t improve your stage; if you succeed at the save, the stage remains the same as it was. When you attempt your save against addiction each week, the stage you are currently at can’t get worse—it can only stay the same or improve. The conditions from addiction can’t be removed while you are affected by the addiction, and suppressing addiction by taking the drug only avoids the effects—it doesn’t remove the disease.", null, "Addiction", "1 day", new Guid("83f532a1-dad3-4dc8-b13d-77e69959444a"), new Guid("480e5953-ecf3-4be4-abe8-d2ef95e6dc44"), false, null },
                    { new Guid("3ba38de5-8542-42e3-a2d4-13f4710177fa"), "No description was provided for this disease.", 29, "Daemonic Famine", "Immediate", new Guid("83f532a1-dad3-4dc8-b13d-77e69959444a"), new Guid("9ed612bb-91ee-4372-b68a-36eac922bee1"), false, null },
                    { new Guid("f644ab8a-66c3-4c79-8ac7-b3aeddf5ac19"), "An extended respiratory disease, tuberculosis can pose particular challenges to spellcasters and some performers due to the intense coughing fits it produces.", 15, "Tuberculosis", "1 Week", new Guid("83f532a1-dad3-4dc8-b13d-77e69959444a"), new Guid("72e51025-a0c7-4fac-9944-d44fa353d2cf"), false, null },
                    { new Guid("944b86e1-373a-4bb8-bf00-2c8a2664cdd2"), "Thought to be caused by a night hag’s curse, nightmare fever inflicts you with terrible nightmares, and you awaken with the wounds you received in your dreams. Some versions cause you to dream of being wounded by bludgeoning or piercing weapons, in which case you take that type of damage instead. Damage and the fatigued condition caused by the disease can’t be healed until the disease is removed.", 25, "Nightmare Fever", "Immediate", new Guid("a71929b0-9dff-492a-9bf9-8f9cadda198c"), new Guid("cc5aec5c-f514-4626-bfe3-e62fcd7c8e3a"), false, null },
                    { new Guid("131aef55-4306-47c2-a9d6-3200c8146154"), "No description was provided for this disease.", 18, "Cocytan Filth", "1d4 Days", new Guid("83f532a1-dad3-4dc8-b13d-77e69959444a"), new Guid("1960dd05-ab39-4e03-9913-43f1d1b6a1b2"), false, null },
                    { new Guid("e2848bfd-24f3-4512-b106-d7112316b282"), "Scarlet leprosy is widely feared for its devastating effects, crushing bones and organs while making recovery nearly impossible.Damage taken from scarlet leprosy can’t be healed until the disease is cured.", 19, "Scarlet Leprosy", "1 Day", new Guid("83f532a1-dad3-4dc8-b13d-77e69959444a"), new Guid("65377178-dd5a-4a62-9d02-9b54f2a60ab6"), false, null },
                    { new Guid("7e8fdfa0-6ccd-456b-ad87-c7bc0512fe93"), "A pernicious disease spread by bloodsucking insects, malaria sometimes enters long periods of dormancy. If you succumb to malaria, you may continue to be periodically affected by the disease, even if you’re cured. You can’t reduce your sickened condition while affected with malaria.", 16, "Malaria", "10 Days", new Guid("83f532a1-dad3-4dc8-b13d-77e69959444a"), new Guid("1746a261-7039-411f-b5b4-f40901a436a6"), false, null },
                    { new Guid("0420dbd7-79bc-420d-b926-6f1d66f6d14e"), "If you are wounded and exposed to persistent cold, you might contract bonechill.", 20, "Bonechill", "1 Day", new Guid("83f532a1-dad3-4dc8-b13d-77e69959444a"), new Guid("9e838c4f-13ff-4587-a840-f4bc36a01360"), false, null },
                    { new Guid("13952f0f-9ded-47eb-880c-415028b67700"), "A giant fly could carry any disease, but most transmit a virulent but not fatal infection called Fly Pox with their bite", 16, "Fly Pox", "1 Day", new Guid("83f532a1-dad3-4dc8-b13d-77e69959444a"), new Guid("13952f0f-9ded-47eb-880c-415028b67700"), false, null },
                    { new Guid("390c8350-3289-4f72-92ad-3490b8d0f8b5"), "A ghonhatine’s vomit carries an awful disease that, over time, can cause a suffering creature’s flesh to develop painful boils that eventually slough away, leaving gaping wounds", 28, "Fleshgout", "Immediate", new Guid("83f532a1-dad3-4dc8-b13d-77e69959444a"), new Guid("7f3561ed-7175-4f9f-b654-8e25dee7c37b"), false, null },
                    { new Guid("f8e30bb2-a932-44b8-bc10-d958d2094645"), "he relatively simple sore throat caused by this disease leads many victims to initially dismiss it as a mild illness, but scarlet fever can be deadly if left untreated. You can’t reduce your sickened condition while affected with scarlet fever.", 13, "Scarlet Fever", "2 Days", new Guid("83f532a1-dad3-4dc8-b13d-77e69959444a"), new Guid("664e842a-4b94-4d00-836d-4191c3b5df50"), false, null },
                    { new Guid("ab42f014-7b09-488b-a429-b2bf829cf5f2"), "This widespread illness can sweep through entire communities, leaving few unaffected. The first indication of the disease is a telltale swelling of glands. In some cases, the disease can move into your lungs (pneumonic plague) or blood (septicemic plague), which is even more fatal. If you have bubonic plague, you can’t remove the fatigued condition while affected.", 17, "Bubonic Plague", "1 Day", new Guid("83f532a1-dad3-4dc8-b13d-77e69959444a"), new Guid("8cd04e7c-ddd9-44eb-b774-cc90221b157b"), false, null },
                    { new Guid("ca8a8c1e-0426-48a4-81f3-38fbc309d348"), "An infection introduced through open wounds, tetanus can produce stiffness, muscle spasms strong enough to break bones, and ultimately death.", 14, "Tetanus", "10 Days", new Guid("83f532a1-dad3-4dc8-b13d-77e69959444a"), new Guid("4ae81453-5952-413b-a8eb-0baab2ae85d9"), false, null },
                    { new Guid("1ff214ef-2c78-4662-89c1-b541b06c93a0"), "The ceiling of the vault of the Black Desert is studded with deadly crystals that glimmer like stars above the dark sands. These crystals are radioactive and flood the vault with lethal energy. Creatures other than those native to the vault or who have survived there for a long time develop a disease called blightburn sickness. Creatures native to the Black Desert are immune, as are creatures who are affected by blightburn sickness but recover from it. The target can't recover from the disease's drained or sickened condition except by magic. The surest way to avoid contracting blightburn sickness is by wearing a blightburn ward, a piece of protective jewelry often found among urdefhans' gear or for sale in Shraen.", 32, "Blightburn Sickness", "1d4 Days", new Guid("83f532a1-dad3-4dc8-b13d-77e69959444a"), new Guid("26ed3169-4bdd-4ff2-8392-3ea20f036ae9"), true, null },
                    { new Guid("9e6fec9d-0ab3-450e-a0fa-a074ca4b4b6c"), "Many healers and alchemists suspect that sewer haze has a supernatural origin, given its association with particularly strong otyughs.", 23, "Sewer Haze", "2 Days", new Guid("83f532a1-dad3-4dc8-b13d-77e69959444a"), new Guid("9f757d30-7c60-4217-a742-613ae6bb3830"), false, null },
                    { new Guid("c98d0053-6cb5-4116-aab4-a16257f09d6a"), "Endemic to jungles of the Mwangi Expanse, blinding sickness is transmitted by dirty water or the bites of certain creatures.", 23, "Blinding Sickness", "Immediate", new Guid("83f532a1-dad3-4dc8-b13d-77e69959444a"), new Guid("67b3423d-e15f-4997-81b5-f832f703e76f"), false, null },
                    { new Guid("b11eaf26-1dfd-4ebb-95c4-4ed05af41ec4"), "This devastating fungus infects your hand and can be cured by amputating the limb before you reach stage 4.", 34, "Crimson Ooze", "Immediate", new Guid("83f532a1-dad3-4dc8-b13d-77e69959444a"), new Guid("0f9d2b87-94d8-4c77-b447-a0ac6afb81f4"), false, null },
                    { new Guid("94d803e5-9777-4b7f-96bf-0df87af5455f"), "Scholars suspect these brain parasites have an otherworldly or extraplanar origin. Though transmitted by the bites of infected targets, the disease remains relatively rare—most hosts are killed by the effects before they can pass it on. While infected, whenever you attack due to confusion, you bite your target (if you don’t have a jaws or fangs attack, you deal piercing damage as an unarmed attack with damage equal to your lowest unarmed attack).", 28, "Brain Worms", "1 Day", new Guid("83f532a1-dad3-4dc8-b13d-77e69959444a"), new Guid("a2a53bc0-a6be-43ed-9427-b54ab63abdc3"), false, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("7c34baea-48a6-4a49-8b15-8781a5c1ab47"), "PlaneLore", "Plane", new Guid("7c34baea-48a6-4a49-8b15-8781a5c1ab47"), new Guid("37406a59-0dd9-4766-8713-33b13b7740fd") },
                    { new Guid("e57522d4-5e50-44c7-bbcb-1c4d0d81baeb"), "PlaneLore", "Plane", new Guid("e57522d4-5e50-44c7-bbcb-1c4d0d81baeb"), new Guid("37406a59-0dd9-4766-8713-33b13b7740fd") },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("4fec4b99-9934-4872-993a-aec20fcf47e1"), new Guid("4fec4b99-9934-4872-993a-aec20fcf47e1"), "DeityLore", "Deity", new Guid("37406a59-0dd9-4766-8713-33b13b7740fd") },
                    ...
                    { new Guid("ca7cdddd-52b2-4352-9c72-230ecc190bcc"), new Guid("ca7cdddd-52b2-4352-9c72-230ecc190bcc"), "DeityLore", "Deity", new Guid("37406a59-0dd9-4766-8713-33b13b7740fd") },
            ...
            migrationBuilder.InsertData(
                table: "Lores",
                columns: new[] { "Id", "Discriminator", "Name", "PlaneId", "StatModifierId" },
                values: new object[] { new Guid("84410831-a91b-4556-96a0-7eeba0653279"), "PlaneLore", "Plane", new Guid("84410831-a91b-4556-96a0-7eeba0653279"), new Guid("37406a59-0dd9-4766-8713-33b13b7740fd") });

            migrationBuilder.InsertData(
                table: "Lores",
                columns: new[] { "Id", "DeityId", "Discriminator", "Name", "StatModifierId" },
                values: new object[] { new Guid("c624bf0e-d22c-4e01-8691-041083462102"), new Guid("c624bf0e-d22c-4e01-8691-041083462102"), "DeityLore", "Deity", new Guid("37406a59-0dd9-4766-8713-33b13b7740fd") });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("042a7b29-141c-4489-b084-86796a198da4"), new Guid("10ef1d07-27bd-4073-96f7-2a55a05a9831"), "If you are simply asleep, the GM decides you wake up either because you have had a restful night's sleep or something disrupted that rest.", 2 },
                    { new Guid("c6aa5055-28cd-4854-86db-881fab8977e2"), new Guid("10ef1d07-27bd-4073-96f7-2a55a05a9831"), "If you're unconscious because you're dying, you can't wake up while you have 0 Hit Points. If you are restored to 1 Hit Point or more via healing, you lose the dying and unconscious conditions and can act normally on your next turn.", 1 },
                    { new Guid("a4f63976-a4f5-402f-88be-f7e5425d1129"), new Guid("10ef1d07-27bd-4073-96f7-2a55a05a9831"), "If you're unconscious and have more than 1 Hit Point (typically because you are asleep or unconscious due to an effect), you wake up in one of the following ways. Each causes you to lose the unconscious condition.", 1 },
                    { new Guid("6f70d006-bd20-422d-ba07-22db1bf4f59f"), new Guid("10ef1d07-27bd-4073-96f7-2a55a05a9831"), "You take damage, provided the damage doesn't reduce you to 0 Hit Points. If the damage reduces you to 0 Hit Points, you remain unconscious and gain the dying condition as normal.", 2 },
                    { new Guid("a84e3630-44d8-4047-b3d9-d21bd140eadf"), new Guid("10ef1d07-27bd-4073-96f7-2a55a05a9831"), "You receive healing, other than the natural healing you get from resting.", 2 },
                    { new Guid("5be411d3-3892-464b-b651-9ccbea01a9c7"), new Guid("10ef1d07-27bd-4073-96f7-2a55a05a9831"), "If you are unconscious and at 0 Hit Points, but not dying, you naturally return to 1 Hit Point and awaken after sufficient time passes. The GM determines how long you remain unconscious, from a minimum of 10 minutes to several hours. If you receive healing during this time, you lose the unconscious condition and can act normally on your next turn.", 1 },
                    { new Guid("e60b28de-b1af-43af-ba61-daf960327a05"), new Guid("10ef1d07-27bd-4073-96f7-2a55a05a9831"), "There's loud noise going on around you—though this isn't automatic. At the start of your turn, you automatically attempt a Perception check against the noise's DC (or the lowest DC if there is more than one noise), waking up if you succeed. If creatures are attempting to stay quiet around you, this Perception check uses their Stealth DCs. Some magical effects make you sleep so deeply that they don't allow you to attempt this Perception check.", 2 },
                    { new Guid("1c0ad848-d2ea-45b4-a709-9d84395bb14d"), new Guid("10ef1d07-27bd-4073-96f7-2a55a05a9831"), "Someone shakes you awake with an Interact action.", 2 }
                });

            migrationBuilder.InsertData(
                table: "DiseaseStage",
                columns: new[] { "Id", "DiseaseId", "Duration", "Stage" },
                values: new object[,]
                {
                    { new Guid("c98d0053-6cb5-4116-aab4-a16257f09d76"), new Guid("c98d0053-6cb5-4116-aab4-a16257f09d6a"), new TimeSpan(1, 0, 0, 0, 0), 6 },
                    { new Guid("c98d0053-6cb5-4116-aab4-a16257f09d74"), new Guid("c98d0053-6cb5-4116-aab4-a16257f09d6a"), new TimeSpan(1, 0, 0, 0, 0), 5 },
                    { new Guid("0420dbd7-79bc-420d-b926-6f1d66f6d154"), new Guid("0420dbd7-79bc-420d-b926-6f1d66f6d14e"), new TimeSpan(1, 0, 0, 0, 0), 3 },
                    { new Guid("c98d0053-6cb5-4116-aab4-a16257f09d71"), new Guid("c98d0053-6cb5-4116-aab4-a16257f09d6a"), new TimeSpan(1, 0, 0, 0, 0), 4 },
                    { new Guid("c98d0053-6cb5-4116-aab4-a16257f09d78"), new Guid("c98d0053-6cb5-4116-aab4-a16257f09d6a"), null, 7 },
                    { new Guid("bdc9c07d-a3bf-4dc1-9ff1-657d2e956e18"), new Guid("bdc9c07d-a3bf-4dc1-9ff1-657d2e956e17"), new TimeSpan(1, 0, 0, 0, 0), 1 },
                    { new Guid("bdc9c07d-a3bf-4dc1-9ff1-657d2e956e1a"), new Guid("bdc9c07d-a3bf-4dc1-9ff1-657d2e956e17"), new TimeSpan(1, 0, 0, 0, 0), 2 },
                    { new Guid("bdc9c07d-a3bf-4dc1-9ff1-657d2e956e1d"), new Guid("bdc9c07d-a3bf-4dc1-9ff1-657d2e956e17"), new TimeSpan(1, 0, 0, 0, 0), 3 },
                    { new Guid("0420dbd7-79bc-420d-b926-6f1d66f6d14f"), new Guid("0420dbd7-79bc-420d-b926-6f1d66f6d14e"), new TimeSpan(1, 0, 0, 0, 0), 1 },
                    { new Guid("0420dbd7-79bc-420d-b926-6f1d66f6d151"), new Guid("0420dbd7-79bc-420d-b926-6f1d66f6d14e"), new TimeSpan(1, 0, 0, 0, 0), 2 },
                    { new Guid("0420dbd7-79bc-420d-b926-6f1d66f6d158"), new Guid("0420dbd7-79bc-420d-b926-6f1d66f6d14e"), new TimeSpan(1, 0, 0, 0, 0), 4 },
                    { new Guid("94d803e5-9777-4b7f-96bf-0df87af54568"), new Guid("94d803e5-9777-4b7f-96bf-0df87af5455f"), new TimeSpan(1, 0, 0, 0, 0), 4 },
                    { new Guid("94d803e5-9777-4b7f-96bf-0df87af54562"), new Guid("94d803e5-9777-4b7f-96bf-0df87af5455f"), new TimeSpan(1, 0, 0, 0, 0), 2 },
                    { new Guid("94d803e5-9777-4b7f-96bf-0df87af54565"), new Guid("94d803e5-9777-4b7f-96bf-0df87af5455f"), new TimeSpan(1, 0, 0, 0, 0), 3 },
                    { new Guid("c98d0053-6cb5-4116-aab4-a16257f09d6f"), new Guid("c98d0053-6cb5-4116-aab4-a16257f09d6a"), new TimeSpan(1, 0, 0, 0, 0), 3 },
                    { new Guid("94d803e5-9777-4b7f-96bf-0df87af5456c"), new Guid("94d803e5-9777-4b7f-96bf-0df87af5455f"), new TimeSpan(1, 0, 0, 0, 0), 5 },
                    { new Guid("94d803e5-9777-4b7f-96bf-0df87af5456e"), new Guid("94d803e5-9777-4b7f-96bf-0df87af5455f"), null, 6 },
                    { new Guid("ab42f014-7b09-488b-a429-b2bf829cf5f3"), new Guid("ab42f014-7b09-488b-a429-b2bf829cf5f2"), new TimeSpan(1, 0, 0, 0, 0), 1 },
                    { new Guid("ab42f014-7b09-488b-a429-b2bf829cf5f5"), new Guid("ab42f014-7b09-488b-a429-b2bf829cf5f2"), new TimeSpan(1, 0, 0, 0, 0), 2 },
                    { new Guid("ab42f014-7b09-488b-a429-b2bf829cf5f8"), new Guid("ab42f014-7b09-488b-a429-b2bf829cf5f2"), new TimeSpan(1, 0, 0, 0, 0), 3 },
                    { new Guid("131aef55-4306-47c2-a9d6-3200c8146159"), new Guid("131aef55-4306-47c2-a9d6-3200c8146154"), new TimeSpan(1, 0, 0, 0, 0), 3 },
                    { new Guid("aae01797-c896-4665-9681-4caae8d37803"), new Guid("aae01797-c896-4665-9681-4caae8d37800"), new TimeSpan(1, 0, 0, 0, 0), 2 },
                    { new Guid("94d803e5-9777-4b7f-96bf-0df87af54560"), new Guid("94d803e5-9777-4b7f-96bf-0df87af5455f"), new TimeSpan(1, 0, 0, 0, 0), 1 },
                    { new Guid("c98d0053-6cb5-4116-aab4-a16257f09d6d"), new Guid("c98d0053-6cb5-4116-aab4-a16257f09d6a"), new TimeSpan(1, 0, 0, 0, 0), 2 },
                    { new Guid("df53fbce-7ea5-4882-8aac-d589381514b5"), new Guid("df53fbce-7ea5-4882-8aac-d589381514b2"), new TimeSpan(7, 0, 0, 0, 0), 2 },
                    { new Guid("df53fbce-7ea5-4882-8aac-d589381514bc"), new Guid("df53fbce-7ea5-4882-8aac-d589381514b2"), new TimeSpan(7, 0, 0, 0, 0), 4 },
                    { new Guid("131aef55-4306-47c2-a9d6-3200c8146157"), new Guid("131aef55-4306-47c2-a9d6-3200c8146154"), new TimeSpan(1, 0, 0, 0, 0), 2 },
                    { new Guid("131aef55-4306-47c2-a9d6-3200c8146155"), new Guid("131aef55-4306-47c2-a9d6-3200c8146154"), new TimeSpan(4, 0, 0, 0, 0), 1 },
                    { new Guid("3ba38de5-8542-42e3-a2d4-13f4710177fd"), new Guid("3ba38de5-8542-42e3-a2d4-13f4710177fa"), new TimeSpan(1, 0, 0, 0, 0), 2 },
                    { new Guid("3ba38de5-8542-42e3-a2d4-13f4710177ff"), new Guid("3ba38de5-8542-42e3-a2d4-13f4710177fa"), new TimeSpan(1, 0, 0, 0, 0), 3 },
                    { new Guid("3ba38de5-8542-42e3-a2d4-13f471017801"), new Guid("3ba38de5-8542-42e3-a2d4-13f4710177fa"), new TimeSpan(1, 0, 0, 0, 0), 4 },
                    { new Guid("3ba38de5-8542-42e3-a2d4-13f471017803"), new Guid("3ba38de5-8542-42e3-a2d4-13f4710177fa"), new TimeSpan(7, 0, 0, 0, 0), 5 },
                    { new Guid("3ba38de5-8542-42e3-a2d4-13f471017805"), new Guid("3ba38de5-8542-42e3-a2d4-13f4710177fa"), null, 6 },
                    { new Guid("390c8350-3289-4f72-92ad-3490b8d0f8b6"), new Guid("390c8350-3289-4f72-92ad-3490b8d0f8b5"), new TimeSpan(0, 4, 0, 0, 0), 1 },
                    { new Guid("390c8350-3289-4f72-92ad-3490b8d0f8b8"), new Guid("390c8350-3289-4f72-92ad-3490b8d0f8b5"), new TimeSpan(1, 0, 0, 0, 0), 2 },
                    { new Guid("390c8350-3289-4f72-92ad-3490b8d0f8bb"), new Guid("390c8350-3289-4f72-92ad-3490b8d0f8b5"), new TimeSpan(1, 0, 0, 0, 0), 3 },
                    { new Guid("c98d0053-6cb5-4116-aab4-a16257f09d6b"), new Guid("c98d0053-6cb5-4116-aab4-a16257f09d6a"), new TimeSpan(1, 0, 0, 0, 0), 1 },
                    { new Guid("390c8350-3289-4f72-92ad-3490b8d0f8be"), new Guid("390c8350-3289-4f72-92ad-3490b8d0f8b5"), new TimeSpan(1, 0, 0, 0, 0), 4 },
                    { new Guid("390c8350-3289-4f72-92ad-3490b8d0f8c5"), new Guid("390c8350-3289-4f72-92ad-3490b8d0f8b5"), new TimeSpan(1, 0, 0, 0, 0), 6 },
                    { new Guid("a126527c-f9d1-498f-9d53-ee01009a80e6"), new Guid("a126527c-f9d1-498f-9d53-ee01009a80e5"), new TimeSpan(1, 0, 0, 0, 0), 1 },
                    { new Guid("a126527c-f9d1-498f-9d53-ee01009a80e8"), new Guid("a126527c-f9d1-498f-9d53-ee01009a80e5"), new TimeSpan(1, 0, 0, 0, 0), 2 },
                    { new Guid("a126527c-f9d1-498f-9d53-ee01009a80ea"), new Guid("a126527c-f9d1-498f-9d53-ee01009a80e5"), new TimeSpan(1, 0, 0, 0, 0), 3 },
                    { new Guid("a126527c-f9d1-498f-9d53-ee01009a80ec"), new Guid("a126527c-f9d1-498f-9d53-ee01009a80e5"), new TimeSpan(1, 0, 0, 0, 0), 4 },
                    { new Guid("a126527c-f9d1-498f-9d53-ee01009a80ef"), new Guid("a126527c-f9d1-498f-9d53-ee01009a80e5"), new TimeSpan(1, 0, 0, 0, 0), 5 },
                    { new Guid("a126527c-f9d1-498f-9d53-ee01009a80f2"), new Guid("a126527c-f9d1-498f-9d53-ee01009a80e5"), null, 6 },
                    { new Guid("df53fbce-7ea5-4882-8aac-d589381514b3"), new Guid("df53fbce-7ea5-4882-8aac-d589381514b2"), new TimeSpan(7, 0, 0, 0, 0), 1 },
                    { new Guid("aae01797-c896-4665-9681-4caae8d37805"), new Guid("aae01797-c896-4665-9681-4caae8d37800"), new TimeSpan(1, 0, 0, 0, 0), 3 },
                    { new Guid("df53fbce-7ea5-4882-8aac-d589381514b8"), new Guid("df53fbce-7ea5-4882-8aac-d589381514b2"), new TimeSpan(7, 0, 0, 0, 0), 3 },
                    { new Guid("390c8350-3289-4f72-92ad-3490b8d0f8c1"), new Guid("390c8350-3289-4f72-92ad-3490b8d0f8b5"), new TimeSpan(1, 0, 0, 0, 0), 5 },
                    { new Guid("aae01797-c896-4665-9681-4caae8d37808"), new Guid("aae01797-c896-4665-9681-4caae8d37800"), null, 4 },
                    { new Guid("aae01797-c896-4665-9681-4caae8d37801"), new Guid("aae01797-c896-4665-9681-4caae8d37800"), new TimeSpan(1, 0, 0, 0, 0), 1 },
                    { new Guid("3ba38de5-8542-42e3-a2d4-13f4710177fb"), new Guid("3ba38de5-8542-42e3-a2d4-13f4710177fa"), new TimeSpan(1, 0, 0, 0, 0), 1 },
                    { new Guid("f644ab8a-66c3-4c79-8ac7-b3aeddf5ac1c"), new Guid("f644ab8a-66c3-4c79-8ac7-b3aeddf5ac19"), new TimeSpan(7, 0, 0, 0, 0), 2 },
                    { new Guid("f644ab8a-66c3-4c79-8ac7-b3aeddf5ac1a"), new Guid("f644ab8a-66c3-4c79-8ac7-b3aeddf5ac19"), new TimeSpan(7, 0, 0, 0, 0), 1 },
                    { new Guid("944b86e1-373a-4bb8-bf00-2c8a2664cdd3"), new Guid("944b86e1-373a-4bb8-bf00-2c8a2664cdd2"), new TimeSpan(1, 0, 0, 0, 0), 1 },
                    { new Guid("944b86e1-373a-4bb8-bf00-2c8a2664cdd6"), new Guid("944b86e1-373a-4bb8-bf00-2c8a2664cdd2"), new TimeSpan(1, 0, 0, 0, 0), 2 },
                    { new Guid("944b86e1-373a-4bb8-bf00-2c8a2664cdd9"), new Guid("944b86e1-373a-4bb8-bf00-2c8a2664cdd2"), new TimeSpan(1, 0, 0, 0, 0), 3 },
                    { new Guid("944b86e1-373a-4bb8-bf00-2c8a2664cddd"), new Guid("944b86e1-373a-4bb8-bf00-2c8a2664cdd2"), new TimeSpan(1, 0, 0, 0, 0), 4 },
                    { new Guid("944b86e1-373a-4bb8-bf00-2c8a2664cde1"), new Guid("944b86e1-373a-4bb8-bf00-2c8a2664cdd2"), null, 5 },
                    { new Guid("b11eaf26-1dfd-4ebb-95c4-4ed05af41ec5"), new Guid("b11eaf26-1dfd-4ebb-95c4-4ed05af41ec4"), new TimeSpan(1, 0, 0, 0, 0), 1 },
                    { new Guid("f8e30bb2-a932-44b8-bc10-d958d2094646"), new Guid("f8e30bb2-a932-44b8-bc10-d958d2094645"), new TimeSpan(1, 0, 0, 0, 0), 1 },
                    { new Guid("f644ab8a-66c3-4c79-8ac7-b3aeddf5ac1e"), new Guid("f644ab8a-66c3-4c79-8ac7-b3aeddf5ac19"), new TimeSpan(7, 0, 0, 0, 0), 3 },
                    { new Guid("f8e30bb2-a932-44b8-bc10-d958d2094648"), new Guid("f8e30bb2-a932-44b8-bc10-d958d2094645"), new TimeSpan(1, 0, 0, 0, 0), 2 },
                    { new Guid("f8e30bb2-a932-44b8-bc10-d958d209464a"), new Guid("f8e30bb2-a932-44b8-bc10-d958d2094645"), new TimeSpan(1, 0, 0, 0, 0), 3 },
                    { new Guid("f8e30bb2-a932-44b8-bc10-d958d209464d"), new Guid("f8e30bb2-a932-44b8-bc10-d958d2094645"), null, 4 },
                    { new Guid("ca8a8c1e-0426-48a4-81f3-38fbc309d34e"), new Guid("ca8a8c1e-0426-48a4-81f3-38fbc309d348"), new TimeSpan(1, 0, 0, 0, 0), 3 },
                    { new Guid("ca8a8c1e-0426-48a4-81f3-38fbc309d34b"), new Guid("ca8a8c1e-0426-48a4-81f3-38fbc309d348"), new TimeSpan(1, 0, 0, 0, 0), 2 },
                    { new Guid("e2848bfd-24f3-4512-b106-d7112316b283"), new Guid("e2848bfd-24f3-4512-b106-d7112316b282"), new TimeSpan(1, 0, 0, 0, 0), 1 },
                    { new Guid("e2848bfd-24f3-4512-b106-d7112316b285"), new Guid("e2848bfd-24f3-4512-b106-d7112316b282"), new TimeSpan(1, 0, 0, 0, 0), 2 },
                    { new Guid("e2848bfd-24f3-4512-b106-d7112316b288"), new Guid("e2848bfd-24f3-4512-b106-d7112316b282"), new TimeSpan(1, 0, 0, 0, 0), 3 },
                    { new Guid("ca8a8c1e-0426-48a4-81f3-38fbc309d349"), new Guid("ca8a8c1e-0426-48a4-81f3-38fbc309d348"), new TimeSpan(7, 0, 0, 0, 0), 1 },
                    { new Guid("9e6fec9d-0ab3-450e-a0fa-a074ca4b4b6d"), new Guid("9e6fec9d-0ab3-450e-a0fa-a074ca4b4b6c"), new TimeSpan(1, 0, 0, 0, 0), 1 },
                    { new Guid("ca8a8c1e-0426-48a4-81f3-38fbc309d351"), new Guid("ca8a8c1e-0426-48a4-81f3-38fbc309d348"), null, 4 },
                    { new Guid("9e6fec9d-0ab3-450e-a0fa-a074ca4b4b6f"), new Guid("9e6fec9d-0ab3-450e-a0fa-a074ca4b4b6c"), new TimeSpan(1, 0, 0, 0, 0), 2 },
                    { new Guid("f644ab8a-66c3-4c79-8ac7-b3aeddf5ac21"), new Guid("f644ab8a-66c3-4c79-8ac7-b3aeddf5ac19"), new TimeSpan(7, 0, 0, 0, 0), 4 },
                    { new Guid("13952f0f-9ded-47eb-880c-415028b67705"), new Guid("13952f0f-9ded-47eb-880c-415028b67700"), new TimeSpan(1, 0, 0, 0, 0), 3 },
                    { new Guid("1ff214ef-2c78-4662-89c1-b541b06c93ac"), new Guid("1ff214ef-2c78-4662-89c1-b541b06c93a0"), new TimeSpan(365, 0, 0, 0, 0), 5 },
                    { new Guid("b11eaf26-1dfd-4ebb-95c4-4ed05af41ec7"), new Guid("b11eaf26-1dfd-4ebb-95c4-4ed05af41ec4"), new TimeSpan(1, 0, 0, 0, 0), 2 },
                    { new Guid("b11eaf26-1dfd-4ebb-95c4-4ed05af41eca"), new Guid("b11eaf26-1dfd-4ebb-95c4-4ed05af41ec4"), new TimeSpan(1, 0, 0, 0, 0), 3 },
                    { new Guid("b11eaf26-1dfd-4ebb-95c4-4ed05af41ece"), new Guid("b11eaf26-1dfd-4ebb-95c4-4ed05af41ec4"), new TimeSpan(1, 0, 0, 0, 0), 4 },
                    { new Guid("b11eaf26-1dfd-4ebb-95c4-4ed05af41ed2"), new Guid("b11eaf26-1dfd-4ebb-95c4-4ed05af41ec4"), new TimeSpan(1, 0, 0, 0, 0), 5 },
                    { new Guid("1ff214ef-2c78-4662-89c1-b541b06c93a9"), new Guid("1ff214ef-2c78-4662-89c1-b541b06c93a0"), new TimeSpan(31, 0, 0, 0, 0), 4 },
                    { new Guid("b11eaf26-1dfd-4ebb-95c4-4ed05af41ed5"), new Guid("b11eaf26-1dfd-4ebb-95c4-4ed05af41ec4"), null, 6 },
                    { new Guid("13952f0f-9ded-47eb-880c-415028b67701"), new Guid("13952f0f-9ded-47eb-880c-415028b67700"), new TimeSpan(1, 0, 0, 0, 0), 1 },
                    { new Guid("13952f0f-9ded-47eb-880c-415028b67703"), new Guid("13952f0f-9ded-47eb-880c-415028b67700"), new TimeSpan(1, 0, 0, 0, 0), 2 },
                    { new Guid("1ff214ef-2c78-4662-89c1-b541b06c93a6"), new Guid("1ff214ef-2c78-4662-89c1-b541b06c93a0"), new TimeSpan(7, 0, 0, 0, 0), 3 },
                    { new Guid("f644ab8a-66c3-4c79-8ac7-b3aeddf5ac23"), new Guid("f644ab8a-66c3-4c79-8ac7-b3aeddf5ac19"), null, 5 },
                    { new Guid("9e6fec9d-0ab3-450e-a0fa-a074ca4b4b72"), new Guid("9e6fec9d-0ab3-450e-a0fa-a074ca4b4b6c"), new TimeSpan(1, 0, 0, 0, 0), 3 },
                    { new Guid("13952f0f-9ded-47eb-880c-415028b67709"), new Guid("13952f0f-9ded-47eb-880c-415028b67700"), new TimeSpan(1, 0, 0, 0, 0), 5 },
                    { new Guid("1ff214ef-2c78-4662-89c1-b541b06c93a3"), new Guid("1ff214ef-2c78-4662-89c1-b541b06c93a0"), new TimeSpan(1, 0, 0, 0, 0), 2 },
                    { new Guid("7e8fdfa0-6ccd-456b-ad87-c7bc0512fe94"), new Guid("7e8fdfa0-6ccd-456b-ad87-c7bc0512fe93"), new TimeSpan(1, 0, 0, 0, 0), 1 },
                    { new Guid("7e8fdfa0-6ccd-456b-ad87-c7bc0512fe96"), new Guid("7e8fdfa0-6ccd-456b-ad87-c7bc0512fe93"), new TimeSpan(1, 0, 0, 0, 0), 2 },
                    { new Guid("1ff214ef-2c78-4662-89c1-b541b06c93a1"), new Guid("1ff214ef-2c78-4662-89c1-b541b06c93a0"), new TimeSpan(1, 0, 0, 0, 0), 1 },
                    { new Guid("7e8fdfa0-6ccd-456b-ad87-c7bc0512fe98"), new Guid("7e8fdfa0-6ccd-456b-ad87-c7bc0512fe93"), new TimeSpan(1, 0, 0, 0, 0), 3 },
                    { new Guid("7e8fdfa0-6ccd-456b-ad87-c7bc0512fe9b"), new Guid("7e8fdfa0-6ccd-456b-ad87-c7bc0512fe93"), new TimeSpan(1, 0, 0, 0, 0), 4 },
                    { new Guid("7e8fdfa0-6ccd-456b-ad87-c7bc0512fe9d"), new Guid("7e8fdfa0-6ccd-456b-ad87-c7bc0512fe93"), null, 5 },
                    { new Guid("13952f0f-9ded-47eb-880c-415028b67707"), new Guid("13952f0f-9ded-47eb-880c-415028b67700"), new TimeSpan(1, 0, 0, 0, 0), 4 }
                });

            migrationBuilder.InsertData(
                table: "DiseaseTrait",
                columns: new[] { "DiseasesId", "TraitsId" },
                values: new object[,]
                {
                    { new Guid("f644ab8a-66c3-4c79-8ac7-b3aeddf5ac19"), new Guid("0cb3dbbc-941b-4e27-b46c-d0246dacc056") },
                    { new Guid("1ff214ef-2c78-4662-89c1-b541b06c93a0"), new Guid("0cb3dbbc-941b-4e27-b46c-d0246dacc056") },
                    { new Guid("ca8a8c1e-0426-48a4-81f3-38fbc309d348"), new Guid("0cb3dbbc-941b-4e27-b46c-d0246dacc056") },
                    { new Guid("1ff214ef-2c78-4662-89c1-b541b06c93a0"), new Guid("0c06a5b8-24e7-486b-bb98-91caef377013") },
                    { new Guid("f8e30bb2-a932-44b8-bc10-d958d2094645"), new Guid("0cb3dbbc-941b-4e27-b46c-d0246dacc056") },
                    { new Guid("9e6fec9d-0ab3-450e-a0fa-a074ca4b4b6c"), new Guid("0cb3dbbc-941b-4e27-b46c-d0246dacc056") },
                    { new Guid("b11eaf26-1dfd-4ebb-95c4-4ed05af41ec4"), new Guid("0cb3dbbc-941b-4e27-b46c-d0246dacc056") },
                    { new Guid("aae01797-c896-4665-9681-4caae8d37800"), new Guid("0cb3dbbc-941b-4e27-b46c-d0246dacc056") },
                    { new Guid("ab42f014-7b09-488b-a429-b2bf829cf5f2"), new Guid("0cb3dbbc-941b-4e27-b46c-d0246dacc056") },
                    { new Guid("7e8fdfa0-6ccd-456b-ad87-c7bc0512fe93"), new Guid("0cb3dbbc-941b-4e27-b46c-d0246dacc056") },
                    { new Guid("94d803e5-9777-4b7f-96bf-0df87af5455f"), new Guid("7b601f4a-9c05-426c-aa46-14e8fa989066") },
                    { new Guid("94d803e5-9777-4b7f-96bf-0df87af5455f"), new Guid("0cb3dbbc-941b-4e27-b46c-d0246dacc056") },
                    { new Guid("944b86e1-373a-4bb8-bf00-2c8a2664cdd2"), new Guid("0e3307ce-952d-4d93-bcac-95bbf495ee85") },
                    { new Guid("9e6fec9d-0ab3-450e-a0fa-a074ca4b4b6c"), new Guid("7b601f4a-9c05-426c-aa46-14e8fa989066") },
                    { new Guid("0420dbd7-79bc-420d-b926-6f1d66f6d14e"), new Guid("0cb3dbbc-941b-4e27-b46c-d0246dacc056") },
                    { new Guid("0420dbd7-79bc-420d-b926-6f1d66f6d14e"), new Guid("3de4876d-2336-4d5e-bbbb-5b4e83ea6d49") },
                    { new Guid("944b86e1-373a-4bb8-bf00-2c8a2664cdd2"), new Guid("2d643d25-b9aa-4544-b482-04b3475eb82b") },
                    { new Guid("944b86e1-373a-4bb8-bf00-2c8a2664cdd2"), new Guid("0cb3dbbc-941b-4e27-b46c-d0246dacc056") },
                    { new Guid("bdc9c07d-a3bf-4dc1-9ff1-657d2e956e17"), new Guid("0cb3dbbc-941b-4e27-b46c-d0246dacc056") },
                    { new Guid("c98d0053-6cb5-4116-aab4-a16257f09d6a"), new Guid("0cb3dbbc-941b-4e27-b46c-d0246dacc056") },
                    { new Guid("e2848bfd-24f3-4512-b106-d7112316b282"), new Guid("0cb3dbbc-941b-4e27-b46c-d0246dacc056") },
                    { new Guid("e2848bfd-24f3-4512-b106-d7112316b282"), new Guid("7b601f4a-9c05-426c-aa46-14e8fa989066") },
                    { new Guid("0420dbd7-79bc-420d-b926-6f1d66f6d14e"), new Guid("2d643d25-b9aa-4544-b482-04b3475eb82b") },
                    { new Guid("b11eaf26-1dfd-4ebb-95c4-4ed05af41ec4"), new Guid("7b601f4a-9c05-426c-aa46-14e8fa989066") }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("11098127-44c6-4d82-9977-981fc20e637b"), new Guid("11098127-44c6-4d82-9977-981fc20e637b"), "StatPrerequisite", null, new Guid("f4206177-80d3-4c9c-8f79-357a608897fa"), 16 },
            ...
            migrationBuilder.InsertData(
                table: "Prerequisites",
                columns: new[] { "Id", "BindingId", "Discriminator", "OrPrerequisiteId", "SkillPrerequisite_RequiredProficiencyId", "RequiredSkillId" },
                values: new object[] { new Guid("99aa8f00-de7a-4968-9d1b-702c30912758"), new Guid("99aa8f00-de7a-4968-9d1b-702c30912758"), "SkillPrerequisite", null, new Guid("e75eb2e8-f901-4d74-8497-05b7f2e689a9"), new Guid("a14f7dbb-8a76-4b6e-8e67-6adb4f1b39b2") });

            migrationBuilder.InsertData(
                table: "Prerequisites",
                columns: new[] { "Id", "BindingId", "Discriminator", "OrPrerequisiteId", "RequiredStatId", "RequiredStatValue" },
                values: new object[] { new Guid("acd168ad-b9c9-406e-963d-ae3a449af924"), new Guid("acd168ad-b9c9-406e-963d-ae3a449af924"), "StatPrerequisite", null, new Guid("3e44bfc5-4aeb-4b46-9bdd-d4da39d40137"), 16 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("e412585e-1ba6-4f86-9c06-7f7ce9ae82f9"), new Guid("e412585e-1ba6-4f86-9c06-7f7ce9ae82f9"), "LorePrerequisite", null, new Guid("130841fd-de3b-45e7-bb97-c4ded6ec71e8") });

            migrationBuilder.InsertData(
                table: "Prerequisites",
                columns: new[] { "Id", "BindingId", "Discriminator", "OrPrerequisiteId", "SkillPrerequisite_RequiredProficiencyId", "RequiredSkillId" },
                values: new object[] { new Guid("56e776af-2740-4dc6-b0ce-d1d31abcea9f"), new Guid("56e776af-2740-4dc6-b0ce-d1d31abcea9f"), "SkillPrerequisite", null, new Guid("130841fd-de3b-45e7-bb97-c4ded6ec71e8"), new Guid("252ee579-951c-414e-bb69-7d2dfc324280") });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("3e5994d8-c6c5-43fb-acb3-1654a1850197"), new Guid("3e5994d8-c6c5-43fb-acb3-1654a1850197"), "SkillPrerequisite", null, new Guid("3c0b8610-4da2-4bb2-b7c9-1bd130ae8a56"), new Guid("eeb5a099-361f-41ab-aafd-7672f47bf9c3") },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("ca583e97-25e0-48a9-a63e-c2409c37f4f7"), new Guid("ca583e97-25e0-48a9-a63e-c2409c37f4f7"), "SkillPrerequisite", null, new Guid("3c0b8610-4da2-4bb2-b7c9-1bd130ae8a56"), new Guid("ab6c56d1-8f95-45db-b4a1-6bae20e30c47") },
            ...
            migrationBuilder.InsertData(
                table: "Prerequisites",
                columns: new[] { "Id", "BindingId", "Discriminator", "OrPrerequisiteId", "SkillPrerequisite_RequiredProficiencyId", "RequiredSkillId" },
                values: new object[] { new Guid("53cb716d-9671-4fe1-9c80-96d7dad779ca"), new Guid("53cb716d-9671-4fe1-9c80-96d7dad779ca"), "SkillPrerequisite", null, new Guid("5184371d-aad0-4d76-b43c-b03d5e930ddb"), new Guid("a14f7dbb-8a76-4b6e-8e67-6adb4f1b39b2") });

            migrationBuilder.InsertData(
                table: "Prerequisites",
                columns: new[] { "Id", "BindingId", "Discriminator", "OrPrerequisiteId", "RequiredProficiencyId" },
                values: new object[] { new Guid("526aa978-d5c8-4482-a522-73605e128b2c"), new Guid("526aa978-d5c8-4482-a522-73605e128b2c"), "LorePrerequisite", null, new Guid("5184371d-aad0-4d76-b43c-b03d5e930ddb") });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("9e063be7-70e3-495c-a14b-42ccfeb7ba35"), new Guid("9e063be7-70e3-495c-a14b-42ccfeb7ba35"), "SkillPrerequisite", null, new Guid("5184371d-aad0-4d76-b43c-b03d5e930ddb"), new Guid("252ee579-951c-414e-bb69-7d2dfc324280") }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("f89492d8-f55d-445c-85a8-cd34e13549ee"), new Guid("f89492d8-f55d-445c-85a8-cd34e13549ee"), "SkillPrerequisite", null, new Guid("e75eb2e8-f901-4d74-8497-05b7f2e689a9"), new Guid("2f33e759-98f4-4a19-a955-e2133197de04") }
                });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "ConditionId", "Discriminator", "DiseaseStageId", "Permanent", "Severity" },
                values: new object[,]
                {
                    { new Guid("13952f0f-9ded-47eb-880c-415028b6770a"), new Guid("f0366047-21ca-4f51-971e-4f7c72629b74"), "ConditionDiseaseStageEffect", new Guid("13952f0f-9ded-47eb-880c-415028b67709"), false, 2 },
                    { new Guid("13952f0f-9ded-47eb-880c-415028b6770b"), new Guid("48d6ee37-8a18-4162-9164-9f7892045d2d"), "ConditionDiseaseStageEffect", new Guid("13952f0f-9ded-47eb-880c-415028b67709"), false, null },
                    { new Guid("7e8fdfa0-6ccd-456b-ad87-c7bc0512fe95"), new Guid("c674e766-939d-47fa-9c94-80173d59741f"), "ConditionDiseaseStageEffect", new Guid("7e8fdfa0-6ccd-456b-ad87-c7bc0512fe94"), false, 1 },
                    { new Guid("7e8fdfa0-6ccd-456b-ad87-c7bc0512fe97"), new Guid("c674e766-939d-47fa-9c94-80173d59741f"), "ConditionDiseaseStageEffect", new Guid("7e8fdfa0-6ccd-456b-ad87-c7bc0512fe96"), false, 2 },
                    { new Guid("7e8fdfa0-6ccd-456b-ad87-c7bc0512fe99"), new Guid("c674e766-939d-47fa-9c94-80173d59741f"), "ConditionDiseaseStageEffect", new Guid("7e8fdfa0-6ccd-456b-ad87-c7bc0512fe98"), false, 2 }
                });

            migrationBuilder.InsertData(
                table: "DiseaseStageEffect",
                columns: new[] { "Id", "Discriminator", "DiseaseComesBackAfter", "DiseaseStageId", "Permanent" },
                values: new object[] { new Guid("7e8fdfa0-6ccd-456b-ad87-c7bc0512fe9a"), "RecurrenceDiseaseStageEffect", "1d4 Months", new Guid("7e8fdfa0-6ccd-456b-ad87-c7bc0512fe98"), false });

            migrationBuilder.InsertData(
                table: "DiseaseStageEffect",
                columns: new[] { "Id", "ConditionId", "Discriminator", "DiseaseStageId", "Permanent", "Severity" },
                values: new object[] { new Guid("7e8fdfa0-6ccd-456b-ad87-c7bc0512fe9c"), new Guid("10ef1d07-27bd-4073-96f7-2a55a05a9831"), "ConditionDiseaseStageEffect", new Guid("7e8fdfa0-6ccd-456b-ad87-c7bc0512fe9b"), false, null });

            migrationBuilder.InsertData(
                table: "DiseaseStageEffect",
                columns: new[] { "Id", "Damage", "DamageTypeId", "Discriminator", "DiseaseStageId", "Every", "IsDamagePersistent", "Permanent" },
                values: new object[] { new Guid("944b86e1-373a-4bb8-bf00-2c8a2664cdd8"), "4d6", new Guid("d047f71a-eead-4685-b09c-03e11ad29d8b"), "DamageDiseaseStageEffect", new Guid("944b86e1-373a-4bb8-bf00-2c8a2664cdd6"), null, false, false });

            migrationBuilder.InsertData(
                table: "DiseaseStageEffect",
                columns: new[] { "Id", "ConditionId", "Discriminator", "DiseaseStageId", "Permanent", "Severity" },
                values: new object[] { new Guid("944b86e1-373a-4bb8-bf00-2c8a2664cdd4"), new Guid("48d6ee37-8a18-4162-9164-9f7892045d2d"), "ConditionDiseaseStageEffect", new Guid("944b86e1-373a-4bb8-bf00-2c8a2664cdd3"), false, null });

            migrationBuilder.InsertData(
                table: "DiseaseStageEffect",
                columns: new[] { "Id", "Damage", "DamageTypeId", "Discriminator", "DiseaseStageId", "Every", "IsDamagePersistent", "Permanent" },
                values: new object[] { new Guid("944b86e1-373a-4bb8-bf00-2c8a2664cdd5"), "2d6", new Guid("d047f71a-eead-4685-b09c-03e11ad29d8b"), "DamageDiseaseStageEffect", new Guid("944b86e1-373a-4bb8-bf00-2c8a2664cdd3"), null, false, false });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("944b86e1-373a-4bb8-bf00-2c8a2664cdd7"), new Guid("48d6ee37-8a18-4162-9164-9f7892045d2d"), "ConditionDiseaseStageEffect", new Guid("944b86e1-373a-4bb8-bf00-2c8a2664cdd6"), false, null },
                    { new Guid("944b86e1-373a-4bb8-bf00-2c8a2664cdda"), new Guid("48d6ee37-8a18-4162-9164-9f7892045d2d"), "ConditionDiseaseStageEffect", new Guid("944b86e1-373a-4bb8-bf00-2c8a2664cdd9"), false, null }
                });

            migrationBuilder.InsertData(
                table: "DiseaseStageEffect",
                columns: new[] { "Id", "Damage", "DamageTypeId", "Discriminator", "DiseaseStageId", "Every", "IsDamagePersistent", "Permanent" },
                values: new object[] { new Guid("944b86e1-373a-4bb8-bf00-2c8a2664cddb"), "4d6", new Guid("d047f71a-eead-4685-b09c-03e11ad29d8b"), "DamageDiseaseStageEffect", new Guid("944b86e1-373a-4bb8-bf00-2c8a2664cdd9"), null, false, false });

            migrationBuilder.InsertData(
                table: "DiseaseStageEffect",
                columns: new[] { "Id", "Discriminator", "DiseaseStageId", "Effect", "Permanent" },
                values: new object[] { new Guid("944b86e1-373a-4bb8-bf00-2c8a2664cddc"), "OtherDiseaseStageEffect", new Guid("944b86e1-373a-4bb8-bf00-2c8a2664cdd9"), "Whenever you take slashing damage, you must succeed at a Will save against the disease’s DC or become frightened 2.", false });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("13952f0f-9ded-47eb-880c-415028b67708"), new Guid("f0366047-21ca-4f51-971e-4f7c72629b74"), "ConditionDiseaseStageEffect", new Guid("13952f0f-9ded-47eb-880c-415028b67707"), false, 2 },
                    { new Guid("7e8fdfa0-6ccd-456b-ad87-c7bc0512fe9e"), new Guid("3c3ce9f5-aceb-4db8-810a-1291035cf709"), "ConditionDiseaseStageEffect", new Guid("7e8fdfa0-6ccd-456b-ad87-c7bc0512fe9d"), false, null },
                    { new Guid("13952f0f-9ded-47eb-880c-415028b67706"), new Guid("f0366047-21ca-4f51-971e-4f7c72629b74"), "ConditionDiseaseStageEffect", new Guid("13952f0f-9ded-47eb-880c-415028b67705"), false, 2 },
                    { new Guid("b11eaf26-1dfd-4ebb-95c4-4ed05af41ecc"), new Guid("a9bb8a46-7442-4480-b008-c706d7d4ef2f"), "ConditionDiseaseStageEffect", new Guid("b11eaf26-1dfd-4ebb-95c4-4ed05af41eca"), false, 2 },
                    { new Guid("13952f0f-9ded-47eb-880c-415028b67702"), new Guid("f0366047-21ca-4f51-971e-4f7c72629b74"), "ConditionDiseaseStageEffect", new Guid("13952f0f-9ded-47eb-880c-415028b67701"), false, 1 },
                    { new Guid("aae01797-c896-4665-9681-4caae8d37804"), new Guid("a263fc00-a122-416e-8213-a7214fa9a30f"), "ConditionDiseaseStageEffect", new Guid("aae01797-c896-4665-9681-4caae8d37803"), false, 1 },
                    { new Guid("aae01797-c896-4665-9681-4caae8d37806"), new Guid("a263fc00-a122-416e-8213-a7214fa9a30f"), "ConditionDiseaseStageEffect", new Guid("aae01797-c896-4665-9681-4caae8d37805"), false, 2 },
                    { new Guid("aae01797-c896-4665-9681-4caae8d37807"), new Guid("b0cbbc02-bec0-4b21-9b61-8af5bb2fc62b"), "ConditionDiseaseStageEffect", new Guid("aae01797-c896-4665-9681-4caae8d37805"), false, null },
                    { new Guid("aae01797-c896-4665-9681-4caae8d37809"), new Guid("3c3ce9f5-aceb-4db8-810a-1291035cf709"), "ConditionDiseaseStageEffect", new Guid("aae01797-c896-4665-9681-4caae8d37808"), false, null },
                    { new Guid("b11eaf26-1dfd-4ebb-95c4-4ed05af41ec6"), new Guid("740be8e2-cab8-4cbe-8065-fd71a6d2192e"), "ConditionDiseaseStageEffect", new Guid("b11eaf26-1dfd-4ebb-95c4-4ed05af41ec5"), false, 1 },
                    { new Guid("b11eaf26-1dfd-4ebb-95c4-4ed05af41ec8"), new Guid("740be8e2-cab8-4cbe-8065-fd71a6d2192e"), "ConditionDiseaseStageEffect", new Guid("b11eaf26-1dfd-4ebb-95c4-4ed05af41ec7"), false, 2 }
                });

            migrationBuilder.InsertData(
                table: "DiseaseStageEffect",
                columns: new[] { "Id", "Discriminator", "DiseaseStageId", "Effect", "Permanent" },
                values: new object[] { new Guid("b11eaf26-1dfd-4ebb-95c4-4ed05af41ec9"), "OtherDiseaseStageEffect", new Guid("b11eaf26-1dfd-4ebb-95c4-4ed05af41ec7"), "Using the infected hand deals 3d6 persistent bleed damage.", false });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("13952f0f-9ded-47eb-880c-415028b67704"), new Guid("f0366047-21ca-4f51-971e-4f7c72629b74"), "ConditionDiseaseStageEffect", new Guid("13952f0f-9ded-47eb-880c-415028b67703"), false, 1 },
                    { new Guid("b11eaf26-1dfd-4ebb-95c4-4ed05af41ecb"), new Guid("740be8e2-cab8-4cbe-8065-fd71a6d2192e"), "ConditionDiseaseStageEffect", new Guid("b11eaf26-1dfd-4ebb-95c4-4ed05af41eca"), false, 2 }
                });

            migrationBuilder.InsertData(
                table: "DiseaseStageEffect",
                columns: new[] { "Id", "Discriminator", "DiseaseStageId", "Effect", "Permanent" },
                values: new object[] { new Guid("b11eaf26-1dfd-4ebb-95c4-4ed05af41ecd"), "OtherDiseaseStageEffect", new Guid("b11eaf26-1dfd-4ebb-95c4-4ed05af41eca"), "The infected hand is unusable.", false });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("b11eaf26-1dfd-4ebb-95c4-4ed05af41ecf"), new Guid("740be8e2-cab8-4cbe-8065-fd71a6d2192e"), "ConditionDiseaseStageEffect", new Guid("b11eaf26-1dfd-4ebb-95c4-4ed05af41ece"), false, 3 },
                    { new Guid("b11eaf26-1dfd-4ebb-95c4-4ed05af41ed0"), new Guid("a9bb8a46-7442-4480-b008-c706d7d4ef2f"), "ConditionDiseaseStageEffect", new Guid("b11eaf26-1dfd-4ebb-95c4-4ed05af41ece"), false, 3 }
                });

            migrationBuilder.InsertData(
                table: "DiseaseStageEffect",
                columns: new[] { "Id", "Discriminator", "DiseaseStageId", "Effect", "Permanent" },
                values: new object[] { new Guid("b11eaf26-1dfd-4ebb-95c4-4ed05af41ed1"), "OtherDiseaseStageEffect", new Guid("b11eaf26-1dfd-4ebb-95c4-4ed05af41ece"), "The infected hand is unusable.", true });

            migrationBuilder.InsertData(
                table: "DiseaseStageEffect",
                columns: new[] { "Id", "ConditionId", "Discriminator", "DiseaseStageId", "Permanent", "Severity" },
                values: new object[] { new Guid("b11eaf26-1dfd-4ebb-95c4-4ed05af41ed3"), new Guid("b9c63a02-449e-43c2-a236-5a3f851f766f"), "ConditionDiseaseStageEffect", new Guid("b11eaf26-1dfd-4ebb-95c4-4ed05af41ed2"), false, null });

            migrationBuilder.InsertData(
                table: "DiseaseStageEffect",
                columns: new[] { "Id", "Discriminator", "DiseaseStageId", "Effect", "Permanent" },
                values: new object[] { new Guid("b11eaf26-1dfd-4ebb-95c4-4ed05af41ed4"), "OtherDiseaseStageEffect", new Guid("b11eaf26-1dfd-4ebb-95c4-4ed05af41ed2"), "Damage does not end the confused condition.", false });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("b11eaf26-1dfd-4ebb-95c4-4ed05af41ed6"), new Guid("3c3ce9f5-aceb-4db8-810a-1291035cf709"), "ConditionDiseaseStageEffect", new Guid("b11eaf26-1dfd-4ebb-95c4-4ed05af41ed5"), false, null },
                    { new Guid("944b86e1-373a-4bb8-bf00-2c8a2664cdde"), new Guid("48d6ee37-8a18-4162-9164-9f7892045d2d"), "ConditionDiseaseStageEffect", new Guid("944b86e1-373a-4bb8-bf00-2c8a2664cddd"), false, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("944b86e1-373a-4bb8-bf00-2c8a2664cddf"), "6d6", new Guid("d047f71a-eead-4685-b09c-03e11ad29d8b"), "DamageDiseaseStageEffect", new Guid("944b86e1-373a-4bb8-bf00-2c8a2664cddd"), null, false, false },
                    { new Guid("e2848bfd-24f3-4512-b106-d7112316b286"), "2d6", new Guid("4712d8c3-ffe6-4db2-b28e-f94065b005bc"), "DamageDiseaseStageEffect", new Guid("e2848bfd-24f3-4512-b106-d7112316b285"), null, false, false }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("944b86e1-373a-4bb8-bf00-2c8a2664cde2"), new Guid("10ef1d07-27bd-4073-96f7-2a55a05a9831"), "ConditionDiseaseStageEffect", new Guid("944b86e1-373a-4bb8-bf00-2c8a2664cde1"), false, null },
                    { new Guid("ca8a8c1e-0426-48a4-81f3-38fbc309d350"), new Guid("d9b38c43-deee-4d47-a5a8-ee48ab4daa2d"), "ConditionDiseaseStageEffect", new Guid("ca8a8c1e-0426-48a4-81f3-38fbc309d34e"), false, null },
                    { new Guid("ca8a8c1e-0426-48a4-81f3-38fbc309d352"), new Guid("3c3ce9f5-aceb-4db8-810a-1291035cf709"), "ConditionDiseaseStageEffect", new Guid("ca8a8c1e-0426-48a4-81f3-38fbc309d351"), false, null },
                    { new Guid("f644ab8a-66c3-4c79-8ac7-b3aeddf5ac1b"), new Guid("d1a95821-ef2b-4c73-8ec6-9ec6789c885d"), "ConditionDiseaseStageEffect", new Guid("f644ab8a-66c3-4c79-8ac7-b3aeddf5ac1a"), false, null },
                    { new Guid("f644ab8a-66c3-4c79-8ac7-b3aeddf5ac1d"), new Guid("9c93e839-3ea9-4baa-aada-951d8fbf9807"), "ConditionDiseaseStageEffect", new Guid("f644ab8a-66c3-4c79-8ac7-b3aeddf5ac1c"), false, 5 },
                    { new Guid("f644ab8a-66c3-4c79-8ac7-b3aeddf5ac20"), new Guid("9c93e839-3ea9-4baa-aada-951d8fbf9807"), "ConditionDiseaseStageEffect", new Guid("f644ab8a-66c3-4c79-8ac7-b3aeddf5ac1e"), false, 15 }
                });

            migrationBuilder.InsertData(
                table: "DiseaseStageEffect",
                columns: new[] { "Id", "Discriminator", "DiseaseStageId", "Effect", "Permanent" },
                values: new object[] { new Guid("f644ab8a-66c3-4c79-8ac7-b3aeddf5ac1f"), "OtherDiseaseStageEffect", new Guid("f644ab8a-66c3-4c79-8ac7-b3aeddf5ac1e"), "Can't recover from the fatigued condition.", false });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("f644ab8a-66c3-4c79-8ac7-b3aeddf5ac22"), new Guid("10ef1d07-27bd-4073-96f7-2a55a05a9831"), "ConditionDiseaseStageEffect", new Guid("f644ab8a-66c3-4c79-8ac7-b3aeddf5ac21"), false, null },
                    { new Guid("f644ab8a-66c3-4c79-8ac7-b3aeddf5ac24"), new Guid("3c3ce9f5-aceb-4db8-810a-1291035cf709"), "ConditionDiseaseStageEffect", new Guid("f644ab8a-66c3-4c79-8ac7-b3aeddf5ac23"), false, null },
                    { new Guid("1ff214ef-2c78-4662-89c1-b541b06c93a2"), new Guid("a263fc00-a122-416e-8213-a7214fa9a30f"), "ConditionDiseaseStageEffect", new Guid("1ff214ef-2c78-4662-89c1-b541b06c93a1"), false, 1 },
                    { new Guid("1ff214ef-2c78-4662-89c1-b541b06c93a4"), new Guid("a263fc00-a122-416e-8213-a7214fa9a30f"), "ConditionDiseaseStageEffect", new Guid("1ff214ef-2c78-4662-89c1-b541b06c93a3"), false, 2 },
                    { new Guid("1ff214ef-2c78-4662-89c1-b541b06c93a5"), new Guid("c674e766-939d-47fa-9c94-80173d59741f"), "ConditionDiseaseStageEffect", new Guid("1ff214ef-2c78-4662-89c1-b541b06c93a3"), false, 1 },
                    { new Guid("1ff214ef-2c78-4662-89c1-b541b06c93a7"), new Guid("a263fc00-a122-416e-8213-a7214fa9a30f"), "ConditionDiseaseStageEffect", new Guid("1ff214ef-2c78-4662-89c1-b541b06c93a6"), false, 2 },
                    { new Guid("1ff214ef-2c78-4662-89c1-b541b06c93a8"), new Guid("c674e766-939d-47fa-9c94-80173d59741f"), "ConditionDiseaseStageEffect", new Guid("1ff214ef-2c78-4662-89c1-b541b06c93a6"), false, 2 },
                    { new Guid("1ff214ef-2c78-4662-89c1-b541b06c93aa"), new Guid("a263fc00-a122-416e-8213-a7214fa9a30f"), "ConditionDiseaseStageEffect", new Guid("1ff214ef-2c78-4662-89c1-b541b06c93a9"), false, 3 },
                    { new Guid("1ff214ef-2c78-4662-89c1-b541b06c93ab"), new Guid("c674e766-939d-47fa-9c94-80173d59741f"), "ConditionDiseaseStageEffect", new Guid("1ff214ef-2c78-4662-89c1-b541b06c93a9"), false, 3 },
                    { new Guid("ca8a8c1e-0426-48a4-81f3-38fbc309d34f"), new Guid("5007c3b2-b184-43b1-85d7-ad159d14ccb5"), "ConditionDiseaseStageEffect", new Guid("ca8a8c1e-0426-48a4-81f3-38fbc309d34e"), false, null },
                    { new Guid("ca8a8c1e-0426-48a4-81f3-38fbc309d34d"), new Guid("b0cbbc02-bec0-4b21-9b61-8af5bb2fc62b"), "ConditionDiseaseStageEffect", new Guid("ca8a8c1e-0426-48a4-81f3-38fbc309d34b"), false, null },
                    { new Guid("ca8a8c1e-0426-48a4-81f3-38fbc309d34c"), new Guid("740be8e2-cab8-4cbe-8065-fd71a6d2192e"), "ConditionDiseaseStageEffect", new Guid("ca8a8c1e-0426-48a4-81f3-38fbc309d34b"), false, 2 },
                    { new Guid("ca8a8c1e-0426-48a4-81f3-38fbc309d34a"), new Guid("740be8e2-cab8-4cbe-8065-fd71a6d2192e"), "ConditionDiseaseStageEffect", new Guid("ca8a8c1e-0426-48a4-81f3-38fbc309d349"), false, 1 }
                });

            migrationBuilder.InsertData(
                table: "DiseaseStageEffect",
                columns: new[] { "Id", "Damage", "DamageTypeId", "Discriminator", "DiseaseStageId", "Every", "IsDamagePersistent", "Permanent" },
                values: new object[] { new Guid("944b86e1-373a-4bb8-bf00-2c8a2664cde3"), "6d6", new Guid("d047f71a-eead-4685-b09c-03e11ad29d8b"), "DamageDiseaseStageEffect", new Guid("944b86e1-373a-4bb8-bf00-2c8a2664cde1"), null, false, false });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("f8e30bb2-a932-44b8-bc10-d958d2094647"), new Guid("c674e766-939d-47fa-9c94-80173d59741f"), "ConditionDiseaseStageEffect", new Guid("f8e30bb2-a932-44b8-bc10-d958d2094646"), false, 1 },
                    { new Guid("f8e30bb2-a932-44b8-bc10-d958d2094649"), new Guid("c674e766-939d-47fa-9c94-80173d59741f"), "ConditionDiseaseStageEffect", new Guid("f8e30bb2-a932-44b8-bc10-d958d2094648"), false, 2 },
                    { new Guid("f8e30bb2-a932-44b8-bc10-d958d209464b"), new Guid("c674e766-939d-47fa-9c94-80173d59741f"), "ConditionDiseaseStageEffect", new Guid("f8e30bb2-a932-44b8-bc10-d958d209464a"), false, 3 },
                    { new Guid("f8e30bb2-a932-44b8-bc10-d958d209464c"), new Guid("b0cbbc02-bec0-4b21-9b61-8af5bb2fc62b"), "ConditionDiseaseStageEffect", new Guid("f8e30bb2-a932-44b8-bc10-d958d209464a"), false, null },
                    { new Guid("f8e30bb2-a932-44b8-bc10-d958d209464e"), new Guid("3c3ce9f5-aceb-4db8-810a-1291035cf709"), "ConditionDiseaseStageEffect", new Guid("f8e30bb2-a932-44b8-bc10-d958d209464d"), false, null }
                });

            migrationBuilder.InsertData(
                table: "DiseaseStageEffect",
                columns: new[] { "Id", "Damage", "DamageTypeId", "Discriminator", "DiseaseStageId", "Every", "IsDamagePersistent", "Permanent" },
                values: new object[] { new Guid("e2848bfd-24f3-4512-b106-d7112316b284"), "2d6", new Guid("4712d8c3-ffe6-4db2-b28e-f94065b005bc"), "DamageDiseaseStageEffect", new Guid("e2848bfd-24f3-4512-b106-d7112316b283"), null, false, false });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("944b86e1-373a-4bb8-bf00-2c8a2664cde0"), "OtherDiseaseStageEffect", new Guid("944b86e1-373a-4bb8-bf00-2c8a2664cddd"), "Whenever you take slashing damage, you must succeed at a Will save against the disease’s DC or become paralyzed for 1 round.", false },
                    { new Guid("aae01797-c896-4665-9681-4caae8d37802"), "OtherDiseaseStageEffect", new Guid("aae01797-c896-4665-9681-4caae8d37801"), "Hoarse voice, but no other symptoms.", false }
                });

            migrationBuilder.InsertData(
                table: "DiseaseStageEffect",
                columns: new[] { "Id", "Damage", "DamageTypeId", "Discriminator", "DiseaseStageId", "Every", "IsDamagePersistent", "Permanent" },
                values: new object[] { new Guid("e2848bfd-24f3-4512-b106-d7112316b289"), "4d6", new Guid("4712d8c3-ffe6-4db2-b28e-f94065b005bc"), "DamageDiseaseStageEffect", new Guid("e2848bfd-24f3-4512-b106-d7112316b288"), null, false, false });

            migrationBuilder.InsertData(
                table: "DiseaseStageEffect",
                columns: new[] { "Id", "Discriminator", "DiseaseStageId", "Effect", "Permanent" },
                values: new object[] { new Guid("e2848bfd-24f3-4512-b106-d7112316b28a"), "OtherDiseaseStageEffect", new Guid("e2848bfd-24f3-4512-b106-d7112316b288"), "You cannot heal any Hit Point damage.", false });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("9e6fec9d-0ab3-450e-a0fa-a074ca4b4b6e"), new Guid("a9bb8a46-7442-4480-b008-c706d7d4ef2f"), "ConditionDiseaseStageEffect", new Guid("9e6fec9d-0ab3-450e-a0fa-a074ca4b4b6d"), false, 2 },
                    { new Guid("9e6fec9d-0ab3-450e-a0fa-a074ca4b4b70"), new Guid("a9bb8a46-7442-4480-b008-c706d7d4ef2f"), "ConditionDiseaseStageEffect", new Guid("9e6fec9d-0ab3-450e-a0fa-a074ca4b4b6f"), false, 2 },
                    { new Guid("9e6fec9d-0ab3-450e-a0fa-a074ca4b4b71"), new Guid("a263fc00-a122-416e-8213-a7214fa9a30f"), "ConditionDiseaseStageEffect", new Guid("9e6fec9d-0ab3-450e-a0fa-a074ca4b4b6f"), false, 2 },
                    { new Guid("9e6fec9d-0ab3-450e-a0fa-a074ca4b4b73"), new Guid("a9bb8a46-7442-4480-b008-c706d7d4ef2f"), "ConditionDiseaseStageEffect", new Guid("9e6fec9d-0ab3-450e-a0fa-a074ca4b4b72"), false, 3 },
                    { new Guid("9e6fec9d-0ab3-450e-a0fa-a074ca4b4b74"), new Guid("a263fc00-a122-416e-8213-a7214fa9a30f"), "ConditionDiseaseStageEffect", new Guid("9e6fec9d-0ab3-450e-a0fa-a074ca4b4b72"), false, 3 }
                });

            migrationBuilder.InsertData(
                table: "DiseaseStageEffect",
                columns: new[] { "Id", "Discriminator", "DiseaseStageId", "Effect", "Permanent" },
                values: new object[] { new Guid("e2848bfd-24f3-4512-b106-d7112316b287"), "OtherDiseaseStageEffect", new Guid("e2848bfd-24f3-4512-b106-d7112316b285"), "Whenever you gain the wounded condition, increase the condition value by 1.", false });

            migrationBuilder.InsertData(
                table: "DiseaseStageEffect",
                columns: new[] { "Id", "Damage", "DamageTypeId", "Discriminator", "DiseaseStageId", "Every", "IsDamagePersistent", "Permanent" },
                values: new object[] { new Guid("ab42f014-7b09-488b-a429-b2bf829cf5fb"), "1d6", new Guid("b084d3bf-72ac-49bc-bab2-21aa86c31fd2"), "DamageDiseaseStageEffect", new Guid("ab42f014-7b09-488b-a429-b2bf829cf5f8"), "1d20 Minutes", true, false });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("94d803e5-9777-4b7f-96bf-0df87af54569"), new Guid("a9bb8a46-7442-4480-b008-c706d7d4ef2f"), "ConditionDiseaseStageEffect", new Guid("94d803e5-9777-4b7f-96bf-0df87af54568"), false, 4 },
                    { new Guid("ab42f014-7b09-488b-a429-b2bf829cf5f9"), new Guid("f0366047-21ca-4f51-971e-4f7c72629b74"), "ConditionDiseaseStageEffect", new Guid("ab42f014-7b09-488b-a429-b2bf829cf5f8"), false, 3 },
                    { new Guid("a126527c-f9d1-498f-9d53-ee01009a80e7"), new Guid("d1a95821-ef2b-4c73-8ec6-9ec6789c885d"), "ConditionDiseaseStageEffect", new Guid("a126527c-f9d1-498f-9d53-ee01009a80e6"), false, null },
                    { new Guid("a126527c-f9d1-498f-9d53-ee01009a80e9"), new Guid("a263fc00-a122-416e-8213-a7214fa9a30f"), "ConditionDiseaseStageEffect", new Guid("a126527c-f9d1-498f-9d53-ee01009a80e8"), false, 1 },
                    { new Guid("a126527c-f9d1-498f-9d53-ee01009a80eb"), new Guid("a263fc00-a122-416e-8213-a7214fa9a30f"), "ConditionDiseaseStageEffect", new Guid("a126527c-f9d1-498f-9d53-ee01009a80ea"), false, 1 },
                    { new Guid("a126527c-f9d1-498f-9d53-ee01009a80ed"), new Guid("a263fc00-a122-416e-8213-a7214fa9a30f"), "ConditionDiseaseStageEffect", new Guid("a126527c-f9d1-498f-9d53-ee01009a80ec"), false, 2 },
                    { new Guid("a126527c-f9d1-498f-9d53-ee01009a80ee"), new Guid("48d6ee37-8a18-4162-9164-9f7892045d2d"), "ConditionDiseaseStageEffect", new Guid("a126527c-f9d1-498f-9d53-ee01009a80ec"), false, null },
                    { new Guid("a126527c-f9d1-498f-9d53-ee01009a80f0"), new Guid("a263fc00-a122-416e-8213-a7214fa9a30f"), "ConditionDiseaseStageEffect", new Guid("a126527c-f9d1-498f-9d53-ee01009a80ef"), false, 2 },
                    { new Guid("a126527c-f9d1-498f-9d53-ee01009a80f1"), new Guid("48d6ee37-8a18-4162-9164-9f7892045d2d"), "ConditionDiseaseStageEffect", new Guid("a126527c-f9d1-498f-9d53-ee01009a80ef"), false, null },
                    { new Guid("a126527c-f9d1-498f-9d53-ee01009a80f3"), new Guid("3c3ce9f5-aceb-4db8-810a-1291035cf709"), "ConditionDiseaseStageEffect", new Guid("a126527c-f9d1-498f-9d53-ee01009a80f2"), false, null }
                });

            migrationBuilder.InsertData(
                table: "DiseaseStageEffect",
                columns: new[] { "Id", "Discriminator", "DiseaseStageId", "Effect", "Permanent" },
                values: new object[] { new Guid("a126527c-f9d1-498f-9d53-ee01009a80f4"), "OtherDiseaseStageEffect", new Guid("a126527c-f9d1-498f-9d53-ee01009a80f2"), "The corpse rises as a void zombie (page 288) in 2d4 hours.", false });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("df53fbce-7ea5-4882-8aac-d589381514b4"), new Guid("48d6ee37-8a18-4162-9164-9f7892045d2d"), "ConditionDiseaseStageEffect", new Guid("df53fbce-7ea5-4882-8aac-d589381514b3"), false, null },
                    { new Guid("df53fbce-7ea5-4882-8aac-d589381514b6"), new Guid("48d6ee37-8a18-4162-9164-9f7892045d2d"), "ConditionDiseaseStageEffect", new Guid("df53fbce-7ea5-4882-8aac-d589381514b5"), false, null },
                    { new Guid("df53fbce-7ea5-4882-8aac-d589381514b7"), new Guid("c674e766-939d-47fa-9c94-80173d59741f"), "ConditionDiseaseStageEffect", new Guid("df53fbce-7ea5-4882-8aac-d589381514b5"), false, 1 },
                    { new Guid("df53fbce-7ea5-4882-8aac-d589381514b9"), new Guid("48d6ee37-8a18-4162-9164-9f7892045d2d"), "ConditionDiseaseStageEffect", new Guid("df53fbce-7ea5-4882-8aac-d589381514b8"), false, null },
                    { new Guid("df53fbce-7ea5-4882-8aac-d589381514ba"), new Guid("c674e766-939d-47fa-9c94-80173d59741f"), "ConditionDiseaseStageEffect", new Guid("df53fbce-7ea5-4882-8aac-d589381514b8"), false, 1 },
                    { new Guid("df53fbce-7ea5-4882-8aac-d589381514bb"), new Guid("a263fc00-a122-416e-8213-a7214fa9a30f"), "ConditionDiseaseStageEffect", new Guid("df53fbce-7ea5-4882-8aac-d589381514b8"), false, 1 },
                    { new Guid("390c8350-3289-4f72-92ad-3490b8d0f8c6"), new Guid("3c3ce9f5-aceb-4db8-810a-1291035cf709"), "ConditionDiseaseStageEffect", new Guid("390c8350-3289-4f72-92ad-3490b8d0f8c5"), false, null },
                    { new Guid("390c8350-3289-4f72-92ad-3490b8d0f8c4"), new Guid("a263fc00-a122-416e-8213-a7214fa9a30f"), "ConditionDiseaseStageEffect", new Guid("390c8350-3289-4f72-92ad-3490b8d0f8c1"), false, 4 },
                    { new Guid("390c8350-3289-4f72-92ad-3490b8d0f8c3"), new Guid("f0366047-21ca-4f51-971e-4f7c72629b74"), "ConditionDiseaseStageEffect", new Guid("390c8350-3289-4f72-92ad-3490b8d0f8c1"), false, 2 },
                    { new Guid("390c8350-3289-4f72-92ad-3490b8d0f8c2"), new Guid("10ef1d07-27bd-4073-96f7-2a55a05a9831"), "ConditionDiseaseStageEffect", new Guid("390c8350-3289-4f72-92ad-3490b8d0f8c1"), false, null },
                    { new Guid("131aef55-4306-47c2-a9d6-3200c8146156"), new Guid("f0366047-21ca-4f51-971e-4f7c72629b74"), "ConditionDiseaseStageEffect", new Guid("131aef55-4306-47c2-a9d6-3200c8146155"), false, 1 },
                    { new Guid("131aef55-4306-47c2-a9d6-3200c8146158"), new Guid("f0366047-21ca-4f51-971e-4f7c72629b74"), "ConditionDiseaseStageEffect", new Guid("131aef55-4306-47c2-a9d6-3200c8146157"), false, 2 },
                    { new Guid("131aef55-4306-47c2-a9d6-3200c814615a"), new Guid("f0366047-21ca-4f51-971e-4f7c72629b74"), "ConditionDiseaseStageEffect", new Guid("131aef55-4306-47c2-a9d6-3200c8146159"), false, 3 },
                    { new Guid("3ba38de5-8542-42e3-a2d4-13f4710177fc"), new Guid("d1a95821-ef2b-4c73-8ec6-9ec6789c885d"), "ConditionDiseaseStageEffect", new Guid("3ba38de5-8542-42e3-a2d4-13f4710177fb"), false, null },
                    { new Guid("3ba38de5-8542-42e3-a2d4-13f4710177fe"), new Guid("f0366047-21ca-4f51-971e-4f7c72629b74"), "ConditionDiseaseStageEffect", new Guid("3ba38de5-8542-42e3-a2d4-13f4710177fd"), false, 1 },
                    { new Guid("3ba38de5-8542-42e3-a2d4-13f471017800"), new Guid("f0366047-21ca-4f51-971e-4f7c72629b74"), "ConditionDiseaseStageEffect", new Guid("3ba38de5-8542-42e3-a2d4-13f4710177ff"), false, 2 },
                    { new Guid("3ba38de5-8542-42e3-a2d4-13f471017802"), new Guid("f0366047-21ca-4f51-971e-4f7c72629b74"), "ConditionDiseaseStageEffect", new Guid("3ba38de5-8542-42e3-a2d4-13f471017801"), false, 2 },
                    { new Guid("df53fbce-7ea5-4882-8aac-d589381514bd"), new Guid("48d6ee37-8a18-4162-9164-9f7892045d2d"), "ConditionDiseaseStageEffect", new Guid("df53fbce-7ea5-4882-8aac-d589381514bc"), false, null },
                    { new Guid("3ba38de5-8542-42e3-a2d4-13f471017804"), new Guid("f0366047-21ca-4f51-971e-4f7c72629b74"), "ConditionDiseaseStageEffect", new Guid("3ba38de5-8542-42e3-a2d4-13f471017803"), false, 3 },
                    { new Guid("390c8350-3289-4f72-92ad-3490b8d0f8b7"), new Guid("d1a95821-ef2b-4c73-8ec6-9ec6789c885d"), "ConditionDiseaseStageEffect", new Guid("390c8350-3289-4f72-92ad-3490b8d0f8b6"), false, null },
                    { new Guid("390c8350-3289-4f72-92ad-3490b8d0f8b9"), new Guid("f0366047-21ca-4f51-971e-4f7c72629b74"), "ConditionDiseaseStageEffect", new Guid("390c8350-3289-4f72-92ad-3490b8d0f8b8"), false, 1 },
                    { new Guid("390c8350-3289-4f72-92ad-3490b8d0f8ba"), new Guid("a263fc00-a122-416e-8213-a7214fa9a30f"), "ConditionDiseaseStageEffect", new Guid("390c8350-3289-4f72-92ad-3490b8d0f8b8"), false, 1 },
                    { new Guid("390c8350-3289-4f72-92ad-3490b8d0f8bc"), new Guid("f0366047-21ca-4f51-971e-4f7c72629b74"), "ConditionDiseaseStageEffect", new Guid("390c8350-3289-4f72-92ad-3490b8d0f8bb"), false, 2 },
                    { new Guid("390c8350-3289-4f72-92ad-3490b8d0f8bd"), new Guid("a263fc00-a122-416e-8213-a7214fa9a30f"), "ConditionDiseaseStageEffect", new Guid("390c8350-3289-4f72-92ad-3490b8d0f8bb"), false, 2 },
                    { new Guid("390c8350-3289-4f72-92ad-3490b8d0f8bf"), new Guid("f0366047-21ca-4f51-971e-4f7c72629b74"), "ConditionDiseaseStageEffect", new Guid("390c8350-3289-4f72-92ad-3490b8d0f8be"), false, 2 },
                    { new Guid("390c8350-3289-4f72-92ad-3490b8d0f8c0"), new Guid("a263fc00-a122-416e-8213-a7214fa9a30f"), "ConditionDiseaseStageEffect", new Guid("390c8350-3289-4f72-92ad-3490b8d0f8be"), false, 3 },
                    { new Guid("3ba38de5-8542-42e3-a2d4-13f471017806"), new Guid("3c3ce9f5-aceb-4db8-810a-1291035cf709"), "ConditionDiseaseStageEffect", new Guid("3ba38de5-8542-42e3-a2d4-13f471017805"), false, null },
                    { new Guid("ab42f014-7b09-488b-a429-b2bf829cf5fa"), new Guid("48d6ee37-8a18-4162-9164-9f7892045d2d"), "ConditionDiseaseStageEffect", new Guid("ab42f014-7b09-488b-a429-b2bf829cf5f8"), false, null },
                    { new Guid("df53fbce-7ea5-4882-8aac-d589381514be"), new Guid("c674e766-939d-47fa-9c94-80173d59741f"), "ConditionDiseaseStageEffect", new Guid("df53fbce-7ea5-4882-8aac-d589381514bc"), false, 2 },
                    { new Guid("df53fbce-7ea5-4882-8aac-d589381514c0"), new Guid("a9bb8a46-7442-4480-b008-c706d7d4ef2f"), "ConditionDiseaseStageEffect", new Guid("df53fbce-7ea5-4882-8aac-d589381514bc"), false, 2 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0420dbd7-79bc-420d-b926-6f1d66f6d15a"), "OtherDiseaseStageEffect", new Guid("0420dbd7-79bc-420d-b926-6f1d66f6d158"), "You cannot heal cold damage until the disease is cured.", false },
                    { new Guid("0420dbd7-79bc-420d-b926-6f1d66f6d15b"), "OtherDiseaseStageEffect", new Guid("0420dbd7-79bc-420d-b926-6f1d66f6d158"), "All cold temperature effects are one step more severe for the victim.", false }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("94d803e5-9777-4b7f-96bf-0df87af54561"), new Guid("a9bb8a46-7442-4480-b008-c706d7d4ef2f"), "ConditionDiseaseStageEffect", new Guid("94d803e5-9777-4b7f-96bf-0df87af54560"), false, 2 },
                    { new Guid("94d803e5-9777-4b7f-96bf-0df87af54563"), new Guid("a9bb8a46-7442-4480-b008-c706d7d4ef2f"), "ConditionDiseaseStageEffect", new Guid("94d803e5-9777-4b7f-96bf-0df87af54562"), false, 2 }
                });

            migrationBuilder.InsertData(
                table: "DiseaseStageEffect",
                columns: new[] { "Id", "Discriminator", "DiseaseStageId", "Effect", "Permanent" },
                values: new object[] { new Guid("94d803e5-9777-4b7f-96bf-0df87af54564"), "OtherDiseaseStageEffect", new Guid("94d803e5-9777-4b7f-96bf-0df87af54562"), "Whenever you take damage, you must succeed at a Will save against the disease’s DC or become confused for 1 round.", false });

            migrationBuilder.InsertData(
                table: "DiseaseStageEffect",
                columns: new[] { "Id", "ConditionId", "Discriminator", "DiseaseStageId", "Permanent", "Severity" },
                values: new object[] { new Guid("94d803e5-9777-4b7f-96bf-0df87af54566"), new Guid("a9bb8a46-7442-4480-b008-c706d7d4ef2f"), "ConditionDiseaseStageEffect", new Guid("94d803e5-9777-4b7f-96bf-0df87af54565"), false, 3 });

            migrationBuilder.InsertData(
                table: "DiseaseStageEffect",
                columns: new[] { "Id", "Discriminator", "DiseaseStageId", "Effect", "Permanent" },
                values: new object[] { new Guid("94d803e5-9777-4b7f-96bf-0df87af54567"), "OtherDiseaseStageEffect", new Guid("94d803e5-9777-4b7f-96bf-0df87af54565"), "Whenever you take damage, you must succeed at a Will save against the disease’s DC or become confused for 1 minute.", false });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("1ff214ef-2c78-4662-89c1-b541b06c93ad"), new Guid("a263fc00-a122-416e-8213-a7214fa9a30f"), "ConditionDiseaseStageEffect", new Guid("1ff214ef-2c78-4662-89c1-b541b06c93ac"), false, 4 },
                    { new Guid("94d803e5-9777-4b7f-96bf-0df87af5456a"), new Guid("b9c63a02-449e-43c2-a236-5a3f851f766f"), "ConditionDiseaseStageEffect", new Guid("94d803e5-9777-4b7f-96bf-0df87af54568"), false, null }
                });

            migrationBuilder.InsertData(
                table: "DiseaseStageEffect",
                columns: new[] { "Id", "Discriminator", "DiseaseStageId", "Effect", "Permanent" },
                values: new object[] { new Guid("94d803e5-9777-4b7f-96bf-0df87af5456b"), "OtherDiseaseStageEffect", new Guid("94d803e5-9777-4b7f-96bf-0df87af54568"), "Damage does not end the confused condition.", false });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("94d803e5-9777-4b7f-96bf-0df87af5456d"), new Guid("10ef1d07-27bd-4073-96f7-2a55a05a9831"), "ConditionDiseaseStageEffect", new Guid("94d803e5-9777-4b7f-96bf-0df87af5456c"), false, null },
                    { new Guid("94d803e5-9777-4b7f-96bf-0df87af5456f"), new Guid("3c3ce9f5-aceb-4db8-810a-1291035cf709"), "ConditionDiseaseStageEffect", new Guid("94d803e5-9777-4b7f-96bf-0df87af5456e"), false, null },
                    { new Guid("ab42f014-7b09-488b-a429-b2bf829cf5f4"), new Guid("48d6ee37-8a18-4162-9164-9f7892045d2d"), "ConditionDiseaseStageEffect", new Guid("ab42f014-7b09-488b-a429-b2bf829cf5f3"), false, null },
                    { new Guid("ab42f014-7b09-488b-a429-b2bf829cf5f6"), new Guid("f0366047-21ca-4f51-971e-4f7c72629b74"), "ConditionDiseaseStageEffect", new Guid("ab42f014-7b09-488b-a429-b2bf829cf5f5"), false, 2 },
                    { new Guid("ab42f014-7b09-488b-a429-b2bf829cf5f7"), new Guid("48d6ee37-8a18-4162-9164-9f7892045d2d"), "ConditionDiseaseStageEffect", new Guid("ab42f014-7b09-488b-a429-b2bf829cf5f5"), false, null },
                    { new Guid("0420dbd7-79bc-420d-b926-6f1d66f6d159"), new Guid("5007c3b2-b184-43b1-85d7-ad159d14ccb5"), "ConditionDiseaseStageEffect", new Guid("0420dbd7-79bc-420d-b926-6f1d66f6d158"), false, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0420dbd7-79bc-420d-b926-6f1d66f6d157"), "OtherDiseaseStageEffect", new Guid("0420dbd7-79bc-420d-b926-6f1d66f6d154"), "All cold temperature effects are one step more severe for the victim.", false },
                    { new Guid("0420dbd7-79bc-420d-b926-6f1d66f6d156"), "OtherDiseaseStageEffect", new Guid("0420dbd7-79bc-420d-b926-6f1d66f6d154"), "You cannot heal cold damage until the disease is cured.", false }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0420dbd7-79bc-420d-b926-6f1d66f6d155"), new Guid("740be8e2-cab8-4cbe-8065-fd71a6d2192e"), "ConditionDiseaseStageEffect", new Guid("0420dbd7-79bc-420d-b926-6f1d66f6d154"), false, 3 },
                    { new Guid("c98d0053-6cb5-4116-aab4-a16257f09d6c"), new Guid("d1a95821-ef2b-4c73-8ec6-9ec6789c885d"), "ConditionDiseaseStageEffect", new Guid("c98d0053-6cb5-4116-aab4-a16257f09d6b"), false, null },
                    { new Guid("c98d0053-6cb5-4116-aab4-a16257f09d6e"), new Guid("f0366047-21ca-4f51-971e-4f7c72629b74"), "ConditionDiseaseStageEffect", new Guid("c98d0053-6cb5-4116-aab4-a16257f09d6d"), false, 1 },
                    { new Guid("c98d0053-6cb5-4116-aab4-a16257f09d70"), new Guid("f0366047-21ca-4f51-971e-4f7c72629b74"), "ConditionDiseaseStageEffect", new Guid("c98d0053-6cb5-4116-aab4-a16257f09d6f"), false, 2 },
                    { new Guid("c98d0053-6cb5-4116-aab4-a16257f09d72"), new Guid("f0366047-21ca-4f51-971e-4f7c72629b74"), "ConditionDiseaseStageEffect", new Guid("c98d0053-6cb5-4116-aab4-a16257f09d71"), false, 2 },
                    { new Guid("c98d0053-6cb5-4116-aab4-a16257f09d73"), new Guid("e9e00854-3d42-48b7-9724-017c8a46e3c0"), "ConditionDiseaseStageEffect", new Guid("c98d0053-6cb5-4116-aab4-a16257f09d71"), true, null },
                    { new Guid("c98d0053-6cb5-4116-aab4-a16257f09d75"), new Guid("f0366047-21ca-4f51-971e-4f7c72629b74"), "ConditionDiseaseStageEffect", new Guid("c98d0053-6cb5-4116-aab4-a16257f09d74"), false, 4 },
                    { new Guid("c98d0053-6cb5-4116-aab4-a16257f09d77"), new Guid("10ef1d07-27bd-4073-96f7-2a55a05a9831"), "ConditionDiseaseStageEffect", new Guid("c98d0053-6cb5-4116-aab4-a16257f09d76"), false, null },
                    { new Guid("df53fbce-7ea5-4882-8aac-d589381514bf"), new Guid("a263fc00-a122-416e-8213-a7214fa9a30f"), "ConditionDiseaseStageEffect", new Guid("df53fbce-7ea5-4882-8aac-d589381514bc"), false, 2 },
                    { new Guid("c98d0053-6cb5-4116-aab4-a16257f09d79"), new Guid("3c3ce9f5-aceb-4db8-810a-1291035cf709"), "ConditionDiseaseStageEffect", new Guid("c98d0053-6cb5-4116-aab4-a16257f09d78"), false, null },
                    { new Guid("bdc9c07d-a3bf-4dc1-9ff1-657d2e956e1b"), new Guid("740be8e2-cab8-4cbe-8065-fd71a6d2192e"), "ConditionDiseaseStageEffect", new Guid("bdc9c07d-a3bf-4dc1-9ff1-657d2e956e1a"), false, 1 },
                    { new Guid("bdc9c07d-a3bf-4dc1-9ff1-657d2e956e1c"), new Guid("a2d387ce-eec5-439b-9e2e-2ef38f0ff3fb"), "ConditionDiseaseStageEffect", new Guid("bdc9c07d-a3bf-4dc1-9ff1-657d2e956e1a"), false, 5 },
                    { new Guid("bdc9c07d-a3bf-4dc1-9ff1-657d2e956e1e"), new Guid("740be8e2-cab8-4cbe-8065-fd71a6d2192e"), "ConditionDiseaseStageEffect", new Guid("bdc9c07d-a3bf-4dc1-9ff1-657d2e956e1d"), false, 2 },
                    { new Guid("bdc9c07d-a3bf-4dc1-9ff1-657d2e956e1f"), new Guid("a2d387ce-eec5-439b-9e2e-2ef38f0ff3fb"), "ConditionDiseaseStageEffect", new Guid("bdc9c07d-a3bf-4dc1-9ff1-657d2e956e1d"), false, 10 },
                    { new Guid("0420dbd7-79bc-420d-b926-6f1d66f6d150"), new Guid("740be8e2-cab8-4cbe-8065-fd71a6d2192e"), "ConditionDiseaseStageEffect", new Guid("0420dbd7-79bc-420d-b926-6f1d66f6d14f"), false, 1 },
                    { new Guid("0420dbd7-79bc-420d-b926-6f1d66f6d152"), new Guid("740be8e2-cab8-4cbe-8065-fd71a6d2192e"), "ConditionDiseaseStageEffect", new Guid("0420dbd7-79bc-420d-b926-6f1d66f6d151"), false, 2 }
                });

            migrationBuilder.InsertData(
                table: "DiseaseStageEffect",
                columns: new[] { "Id", "Discriminator", "DiseaseStageId", "Effect", "Permanent" },
                values: new object[] { new Guid("0420dbd7-79bc-420d-b926-6f1d66f6d153"), "OtherDiseaseStageEffect", new Guid("0420dbd7-79bc-420d-b926-6f1d66f6d151"), "You cannot heal cold damage until the disease is cured.", false });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("bdc9c07d-a3bf-4dc1-9ff1-657d2e956e19"), new Guid("740be8e2-cab8-4cbe-8065-fd71a6d2192e"), "ConditionDiseaseStageEffect", new Guid("bdc9c07d-a3bf-4dc1-9ff1-657d2e956e18"), false, 1 },
                    { new Guid("1ff214ef-2c78-4662-89c1-b541b06c93ae"), new Guid("c674e766-939d-47fa-9c94-80173d59741f"), "ConditionDiseaseStageEffect", new Guid("1ff214ef-2c78-4662-89c1-b541b06c93ac"), false, 3 }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConditionDetailBlock_ConditionId",
                table: "ConditionDetailBlock",
                column: "ConditionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Traits_CursesId",
                table: "Traits",
                column: "CursesId");

            migrationBuilder.CreateIndex(
                name: "IX_Traits_DiseasesId",
                table: "Traits",
                column: "DiseasesId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Traits_Curses_CursesId",
                table: "Traits",
                column: "CursesId",
                principalTable: "Curses",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Traits_Diseases_DiseasesId",
                table: "Traits",
                column: "DiseasesId",
                principalTable: "Diseases",
                principalColumn: "Id",
