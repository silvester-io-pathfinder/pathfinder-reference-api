...
RUN dotnet restore ./Sources/Silvester.Pathfinder.Reference.Api.sln 
RUN dotnet test ./Sources/Silvester.Pathfinder.Reference.Api.sln 
RUN dotnet publish ./Sources/Silvester.Pathfinder.Reference.Api.sln -c Release -o /build/publish
